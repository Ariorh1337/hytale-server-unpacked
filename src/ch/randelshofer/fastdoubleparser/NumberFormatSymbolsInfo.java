...
class NumberFormatSymbolsInfo {
   ...
   static boolean containsFormatChars(NumberFormatSymbols symbols) {
      ...
      return containsChars((Collection<Character>)symbols.decimalSeparator(), (CharSet)formatCharSet)
         || containsChars((Collection<Character>)symbols.groupingSeparator(), (CharSet)formatCharSet)
         || containsChars(symbols.exponentSeparator(), formatCharSet)
         || containsChars((Collection<Character>)symbols.minusSign(), (CharSet)formatCharSet)
         || containsChars((Collection<Character>)symbols.plusSign(), (CharSet)formatCharSet)
