...
public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Byte2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      double[] value = this.value;
      Byte2DoubleOpenHashMap.EntryIterator i = new Byte2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2DoubleOpenHashMap.MapIterator<Consumer<? super Byte2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Byte2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2DoubleOpenHashMap.MapSpliterator<Consumer<? super Byte2DoubleMap.Entry>, Byte2DoubleOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2DoubleMap.Entry> action, int index) {
         action.accept(Byte2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Byte2DoubleOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2DoubleOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2DoubleOpenHashMap.MapSpliterator<ByteConsumer, Byte2DoubleOpenHashMap.KeySpliterator>
      ...
      final Byte2DoubleOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2DoubleMap.Entry, Entry<Byte, Double>, ByteDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2DoubleOpenHashMap.this.key[this.index] == e.getKey()
            && Double.doubleToLongBits(Byte2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2DoubleMap.Entry> spliterator() {
         return Byte2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
         if (Byte2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2DoubleOpenHashMap.this.new MapEntry(Byte2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2DoubleOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
         Byte2DoubleOpenHashMap.MapEntry entry = Byte2DoubleOpenHashMap.this.new MapEntry();
         if (Byte2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2DoubleOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Byte2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Byte2DoubleOpenHashMap.this.realSize() / Byte2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2DoubleOpenHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Byte2DoubleOpenHashMap.MapSpliterator<DoubleConsumer, Byte2DoubleOpenHashMap.ValueSpliterator>
      ...
      final Byte2DoubleOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
