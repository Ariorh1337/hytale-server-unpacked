...
public class Byte2ObjectOpenHashMap<V> extends AbstractByte2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Byte2ObjectOpenHashMap.this.new ValueSpliterator();
            }
   ...
   public int hashCode() {
      ...
      while (j-- != 0) {
         ...
         if (this != this.value[i]) {
            var5 ^= this.value[i] == null ? 0 : this.value[i].hashCode();
         }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      V[] value = this.value;
      Byte2ObjectOpenHashMap<V>.EntryIterator i = new Byte2ObjectOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Byte2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Byte2ObjectOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Byte2ObjectMap.Entry<V>>, Byte2ObjectOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ObjectMap.Entry<V>> action, int index) {
         action.accept(Byte2ObjectOpenHashMap.this.new MapEntry(index));
      }

      final Byte2ObjectOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ObjectOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Byte2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Byte2ObjectMap.Entry<V>>>
      implements ObjectIterator<Byte2ObjectMap.Entry<V>> {
      private final Byte2ObjectOpenHashMap<V>.MapEntry entry = Byte2ObjectOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Byte2ObjectOpenHashMap<V>.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2ObjectOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2ObjectOpenHashMap<V>.MapSpliterator<ByteConsumer, Byte2ObjectOpenHashMap<V>.KeySpliterator>
      ...
      final Byte2ObjectOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ObjectOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2ObjectMap.Entry<V>, Entry<Byte, V>, ByteObjectPair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2ObjectOpenHashMap.this.key[this.index] == e.getKey() && Objects.equals(Byte2ObjectOpenHashMap.this.value[this.index], e.getValue());
      }

      @Override
      public int hashCode() {
         return Byte2ObjectOpenHashMap.this.key[this.index]
            ^ (Byte2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Byte2ObjectOpenHashMap.this.value[this.index].hashCode());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Byte2ObjectMap.Entry<V>> spliterator() {
         return Byte2ObjectOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Byte) {
            ...
            byte curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(k) & Byte2ObjectOpenHashMap.this.mask]) == 0) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask]) != 0) {
               if (k == curr) {
                  return Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v);
               }
            }
         ...
         if (e.getKey() != null && e.getKey() instanceof Byte) {
            ...
            if (k == 0) {
               ...
               if (curr == k) {
                  ...
                  while ((curr = key[pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask]) != 0) {
                     if (curr == k && Objects.equals(Byte2ObjectOpenHashMap.this.value[pos], v)) {
                        Byte2ObjectOpenHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
         if (Byte2ObjectOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2ObjectOpenHashMap.this.new MapEntry(Byte2ObjectOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2ObjectOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2ObjectOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2ObjectMap.Entry<V>> consumer) {
         Byte2ObjectOpenHashMap<V>.MapEntry entry = Byte2ObjectOpenHashMap.this.new MapEntry();
         if (Byte2ObjectOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Byte2ObjectOpenHashMap.this.n;
      int last = -1;
      int c = Byte2ObjectOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2ObjectOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            byte curr;
            for (pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Byte2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Byte2ObjectOpenHashMap.this.realSize() / Byte2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2ObjectOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Byte2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Byte2ObjectOpenHashMap<V>.ValueSpliterator>
      ...
      final Byte2ObjectOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ObjectOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
