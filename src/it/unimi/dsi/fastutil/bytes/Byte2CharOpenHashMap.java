...
public class Byte2CharOpenHashMap extends AbstractByte2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Byte2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      char[] value = this.value;
      Byte2CharOpenHashMap.EntryIterator i = new Byte2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2CharOpenHashMap.MapIterator<Consumer<? super Byte2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2CharMap.Entry> action, int index) {
         action.accept(this.entry = Byte2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2CharOpenHashMap.MapSpliterator<Consumer<? super Byte2CharMap.Entry>, Byte2CharOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2CharMap.Entry> action, int index) {
         action.accept(Byte2CharOpenHashMap.this.new MapEntry(index));
      }

      final Byte2CharOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Byte2CharOpenHashMap.MapIterator<Consumer<? super Byte2CharMap.Entry>>
      implements ObjectIterator<Byte2CharMap.Entry> {
      private final Byte2CharOpenHashMap.MapEntry entry = Byte2CharOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Byte2CharOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2CharOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Byte2CharOpenHashMap.MapSpliterator<ByteConsumer, Byte2CharOpenHashMap.KeySpliterator> implements ByteSpliterator {
      ...
      final Byte2CharOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2CharMap.Entry, Entry<Byte, Character>, ByteCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2CharOpenHashMap.this.key[this.index] == e.getKey() && Byte2CharOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements Byte2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2CharMap.Entry> spliterator() {
         return Byte2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2CharMap.Entry> consumer) {
         if (Byte2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2CharOpenHashMap.this.new MapEntry(Byte2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2CharOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2CharMap.Entry> consumer) {
         Byte2CharOpenHashMap.MapEntry entry = Byte2CharOpenHashMap.this.new MapEntry();
         if (Byte2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Byte2CharOpenHashMap.this.n;
      int last = -1;
      int c = Byte2CharOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2CharOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            byte curr;
            for (pos = pos + 1 & Byte2CharOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Byte2CharOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2CharOpenHashMap.this.size - this.c
            : Math.min(
               Byte2CharOpenHashMap.this.size - this.c,
               (long)((double)Byte2CharOpenHashMap.this.realSize() / Byte2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Byte2CharOpenHashMap.MapSpliterator<CharConsumer, Byte2CharOpenHashMap.ValueSpliterator>
      ...
      final Byte2CharOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
