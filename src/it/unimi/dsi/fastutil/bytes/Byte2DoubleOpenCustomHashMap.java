...
public class Byte2DoubleOpenCustomHashMap extends AbstractByte2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Byte2DoubleOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      double[] value = this.value;
      Byte2DoubleOpenCustomHashMap.EntryIterator i = new Byte2DoubleOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2DoubleOpenCustomHashMap.MapIterator<Consumer<? super Byte2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Byte2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2DoubleOpenCustomHashMap.MapSpliterator<Consumer<? super Byte2DoubleMap.Entry>, Byte2DoubleOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2DoubleMap.Entry> action, int index) {
         action.accept(Byte2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }

      final Byte2DoubleOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Byte2DoubleOpenCustomHashMap.MapIterator<Consumer<? super Byte2DoubleMap.Entry>>
      implements ObjectIterator<Byte2DoubleMap.Entry> {
      private final Byte2DoubleOpenCustomHashMap.MapEntry entry = Byte2DoubleOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Byte2DoubleOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2DoubleOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2DoubleOpenCustomHashMap.MapSpliterator<ByteConsumer, Byte2DoubleOpenCustomHashMap.KeySpliterator>
      ...
      final Byte2DoubleOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Byte2DoubleMap.Entry, Entry<Byte, Double>, ByteDoublePair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Byte, Double> e = (Entry<Byte, Double>)o;
         return Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(Byte2DoubleOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.double2int(Byte2DoubleOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2DoubleMap.Entry> spliterator() {
         return Byte2DoubleOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Double) {
            ...
            if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
               return Byte2DoubleOpenCustomHashMap.this.containsNullKey
                  && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[Byte2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v);
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Double) {
               ...
               if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
                  ...
                  if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                     ...
                     while ((curr = key[pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask]) != 0) {
                        if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)
                           && Double.doubleToLongBits(Byte2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
                           Byte2DoubleOpenCustomHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Byte2DoubleOpenCustomHashMap.this.new MapEntry(Byte2DoubleOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2DoubleOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2DoubleOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2DoubleMap.Entry> consumer) {
         Byte2DoubleOpenCustomHashMap.MapEntry entry = Byte2DoubleOpenCustomHashMap.this.new MapEntry();
         if (Byte2DoubleOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Byte2DoubleOpenCustomHashMap.this.n;
      int last = -1;
      int c = Byte2DoubleOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2DoubleOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            byte curr;
            for (pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2DoubleOpenCustomHashMap.this.size - this.c
            : Math.min(
               Byte2DoubleOpenCustomHashMap.this.size - this.c,
               (long)((double)Byte2DoubleOpenCustomHashMap.this.realSize() / Byte2DoubleOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Byte2DoubleOpenCustomHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Byte2DoubleOpenCustomHashMap.MapSpliterator<DoubleConsumer, Byte2DoubleOpenCustomHashMap.ValueSpliterator>
      ...
      final Byte2DoubleOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2DoubleOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
