...
public class Byte2LongOpenHashMap extends AbstractByte2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Byte2LongOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      long[] value = this.value;
      Byte2LongOpenHashMap.EntryIterator i = new Byte2LongOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2LongOpenHashMap.MapIterator<Consumer<? super Byte2LongMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2LongMap.Entry> action, int index) {
         action.accept(this.entry = Byte2LongOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2LongOpenHashMap.MapSpliterator<Consumer<? super Byte2LongMap.Entry>, Byte2LongOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2LongMap.Entry> action, int index) {
         action.accept(Byte2LongOpenHashMap.this.new MapEntry(index));
      }

      final Byte2LongOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2LongOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2LongOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2LongOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Byte2LongOpenHashMap.MapSpliterator<ByteConsumer, Byte2LongOpenHashMap.KeySpliterator> implements ByteSpliterator {
      ...
      final Byte2LongOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2LongOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2LongMap.Entry, Entry<Byte, Long>, ByteLongPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2LongOpenHashMap.this.key[this.index] == e.getKey() && Byte2LongOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2LongMap.Entry> spliterator() {
         return Byte2LongOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2LongMap.Entry> consumer) {
         if (Byte2LongOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2LongOpenHashMap.this.new MapEntry(Byte2LongOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2LongOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2LongOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2LongMap.Entry> consumer) {
         Byte2LongOpenHashMap.MapEntry entry = Byte2LongOpenHashMap.this.new MapEntry();
         if (Byte2LongOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2LongOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2LongOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2LongOpenHashMap.this.size - this.c
            : Math.min(
               Byte2LongOpenHashMap.this.size - this.c,
               (long)((double)Byte2LongOpenHashMap.this.realSize() / Byte2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2LongOpenHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Byte2LongOpenHashMap.MapSpliterator<LongConsumer, Byte2LongOpenHashMap.ValueSpliterator>
      ...
      final Byte2LongOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2LongOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
