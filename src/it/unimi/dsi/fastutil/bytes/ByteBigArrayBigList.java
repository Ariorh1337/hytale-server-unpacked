...
public class ByteBigArrayBigList extends AbstractByteBigList implements RandomAccess, Cloneable, Serializable {
   ...
   public int compareTo(ByteBigArrayBigList l) {
      ...
      int i;
      for (i = 0; i < s1 && i < s2; i++) {
         byte e1 = BigArrays.get(a1, i);
         byte e2 = BigArrays.get(a2, i);
         int r;
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      ...
      for (int i = 0; i < this.size; i++) {
         s.writeByte(BigArrays.get(this.a, i));
      }
   }
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      ...
      for (int i = 0; i < this.size; i++) {
         BigArrays.set(this.a, i, s.readByte());
      }
   }
   ...
   private final class Spliterator implements ByteSpliterator {
      ...
      public ByteSpliterator trySplit() {
         ...
         this.pos = myNewPos;
         this.hasSplit = true;
         return ByteBigArrayBigList.this.new Spliterator(oldPos, retMax, true);
      }
   }
