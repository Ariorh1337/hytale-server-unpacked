...
public final class Byte2ShortFunctions {
   ...
   public static Byte2ShortFunction singleton(byte key, short value) {
      return new Byte2ShortFunctions.Singleton(key, value);
   }
   ...
   public static Byte2ShortFunction synchronize(Byte2ShortFunction f) {
      return new Byte2ShortFunctions.SynchronizedFunction(f);
   }

   public static Byte2ShortFunction synchronize(Byte2ShortFunction f, Object sync) {
      return new Byte2ShortFunctions.SynchronizedFunction(f, sync);
   }

   public static Byte2ShortFunction unmodifiable(Byte2ShortFunction f) {
      return new Byte2ShortFunctions.UnmodifiableFunction(f);
   }
   ...
   public static Byte2ShortFunction primitive(Function<? super Byte, ? extends Short> f) {
      ...
      if (f instanceof Byte2ShortFunction) {
         ...
         return f instanceof IntUnaryOperator
            ? key -> SafeMath.safeIntToShort(((IntUnaryOperator)f).applyAsInt(key))
            : new Byte2ShortFunctions.PrimitiveFunction(f);
      }
   }
