...
public class Byte2ByteOpenCustomHashMap extends AbstractByte2ByteMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Byte2ByteOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      byte[] value = this.value;
      Byte2ByteOpenCustomHashMap.EntryIterator i = new Byte2ByteOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2ByteOpenCustomHashMap.MapIterator<Consumer<? super Byte2ByteMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Byte2ByteOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2ByteOpenCustomHashMap.MapSpliterator<Consumer<? super Byte2ByteMap.Entry>, Byte2ByteOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ByteMap.Entry> action, int index) {
         action.accept(Byte2ByteOpenCustomHashMap.this.new MapEntry(index));
      }

      final Byte2ByteOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ByteOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2ByteOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      @Override
      public ByteSpliterator spliterator() {
         return Byte2ByteOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2ByteOpenCustomHashMap.MapSpliterator<ByteConsumer, Byte2ByteOpenCustomHashMap.KeySpliterator>
      ...
      final Byte2ByteOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ByteOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2ByteMap.Entry, Entry<Byte, Byte>, ByteBytePair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2ByteOpenCustomHashMap.this.strategy.equals(Byte2ByteOpenCustomHashMap.this.key[this.index], e.getKey())
            && Byte2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ByteMap.Entry> implements Byte2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2ByteMap.Entry> spliterator() {
         return Byte2ByteOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
         if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Byte2ByteOpenCustomHashMap.this.new MapEntry(Byte2ByteOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2ByteOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2ByteOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2ByteMap.Entry> consumer) {
         Byte2ByteOpenCustomHashMap.MapEntry entry = Byte2ByteOpenCustomHashMap.this.new MapEntry();
         if (Byte2ByteOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2ByteOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2ByteOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2ByteOpenCustomHashMap.this.size - this.c
            : Math.min(
               Byte2ByteOpenCustomHashMap.this.size - this.c,
               (long)((double)Byte2ByteOpenCustomHashMap.this.realSize() / Byte2ByteOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Byte2ByteOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Byte2ByteOpenCustomHashMap.MapSpliterator<ByteConsumer, Byte2ByteOpenCustomHashMap.ValueSpliterator>
      implements ByteSpliterator {
      ...
      final Byte2ByteOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ByteOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
