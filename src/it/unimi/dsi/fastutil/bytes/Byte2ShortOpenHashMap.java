...
public class Byte2ShortOpenHashMap extends AbstractByte2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Byte2ShortOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      short[] value = this.value;
      Byte2ShortOpenHashMap.EntryIterator i = new Byte2ShortOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2ShortOpenHashMap.MapIterator<Consumer<? super Byte2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Byte2ShortOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2ShortOpenHashMap.MapSpliterator<Consumer<? super Byte2ShortMap.Entry>, Byte2ShortOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ShortMap.Entry> action, int index) {
         action.accept(Byte2ShortOpenHashMap.this.new MapEntry(index));
      }

      final Byte2ShortOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ShortOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2ShortOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2ShortOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2ShortOpenHashMap.MapSpliterator<ByteConsumer, Byte2ShortOpenHashMap.KeySpliterator>
      ...
      final Byte2ShortOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ShortOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2ShortMap.Entry, Entry<Byte, Short>, ByteShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2ShortOpenHashMap.this.key[this.index] == e.getKey() && Byte2ShortOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2ShortMap.Entry> spliterator() {
         return Byte2ShortOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
         if (Byte2ShortOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2ShortOpenHashMap.this.new MapEntry(Byte2ShortOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2ShortOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2ShortOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2ShortMap.Entry> consumer) {
         Byte2ShortOpenHashMap.MapEntry entry = Byte2ShortOpenHashMap.this.new MapEntry();
         if (Byte2ShortOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2ShortOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2ShortOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2ShortOpenHashMap.this.size - this.c
            : Math.min(
               Byte2ShortOpenHashMap.this.size - this.c,
               (long)((double)Byte2ShortOpenHashMap.this.realSize() / Byte2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2ShortOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Byte2ShortOpenHashMap.MapSpliterator<ShortConsumer, Byte2ShortOpenHashMap.ValueSpliterator>
      ...
      final Byte2ShortOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ShortOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
