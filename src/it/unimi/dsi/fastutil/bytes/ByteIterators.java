...
public final class ByteIterators {
   ...
   public static ByteIterator asByteIterator(Iterator i) {
      return i instanceof ByteIterator ? (ByteIterator)i : new ByteIterators.IteratorWrapper(i);
   }
   ...
   public static ByteListIterator asByteIterator(ListIterator i) {
      return i instanceof ByteListIterator ? (ByteListIterator)i : new ByteIterators.ListIteratorWrapper(i);
   }
