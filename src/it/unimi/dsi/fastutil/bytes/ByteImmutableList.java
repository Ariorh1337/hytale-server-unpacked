...
public class ByteImmutableList extends ByteLists.ImmutableListBase implements ByteList, RandomAccess, Cloneable, Serializable {
   ...
   public static ByteImmutableList of(byte... init) {
      return init.length == 0 ? of() : new ByteImmutableList(init);
   }
   ...
   public byte[] toByteArray() {
      return this.a.length == 0 ? ByteArrays.EMPTY_ARRAY : (byte[])this.a.clone();
   }
   ...
   public ByteSpliterator spliterator() {
      return new ByteImmutableList.Spliterator();
   }
   ...
   public ByteList subList(int from, int to) {
      if (from == 0 && to == this.size()) {
         ...
         if (from == to) {
            ...
            return new ByteImmutableList.ImmutableSubList(this, from, to);
         }
      }
   }
   ...
   public boolean equals(Object o) {
      if (o == this) {
         ...
         return false;
      } else if (o instanceof ByteImmutableList) {
         return this.equals((ByteImmutableList)o);
      } else {
         return o instanceof ByteImmutableList.ImmutableSubList ? ((ByteImmutableList.ImmutableSubList)o).equals(this) : super.equals(o);
      }
   }
   ...
   public int compareTo(List<? extends Byte> l) {
      ...
      } else if (l instanceof ByteImmutableList.ImmutableSubList) {
         ByteImmutableList.ImmutableSubList other = (ByteImmutableList.ImmutableSubList)l;
   ...
   private static final class ImmutableSubList extends ByteLists.ImmutableListBase implements RandomAccess, Serializable {
      ...
      @Override
      public ByteSpliterator spliterator() {
         return new ByteImmutableList.ImmutableSubList.SubListSpliterator();
      }
      ...
      public boolean equals(Object o) {
         ...
         } else if (o instanceof ByteImmutableList.ImmutableSubList) {
            ByteImmutableList.ImmutableSubList other = (ByteImmutableList.ImmutableSubList)o;
      ...
      public ByteList subList(int from, int to) {
         ...
         if (from == to) {
            ...
            return new ByteImmutableList.ImmutableSubList(this.innerList, from + this.from, to + this.from);
         }
      }

      private final class SubListSpliterator extends ByteSpliterators.EarlyBindingSizeIndexBasedSpliterator {
         SubListSpliterator() {
         ...
         protected final ByteImmutableList.ImmutableSubList.SubListSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class Spliterator implements ByteSpliterator {
      ...
      public Spliterator() {
         this(0, ByteImmutableList.this.a.length);
      }
      ...
      public ByteSpliterator trySplit() {
         ...
         int oldPos = this.pos;
         this.pos = myNewPos;
         return ByteImmutableList.this.new Spliterator(oldPos, retMax);
      }
   }
}
