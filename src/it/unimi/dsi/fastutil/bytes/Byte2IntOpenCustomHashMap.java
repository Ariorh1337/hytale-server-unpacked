...
public class Byte2IntOpenCustomHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Byte2IntOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      int[] value = this.value;
      Byte2IntOpenCustomHashMap.EntryIterator i = new Byte2IntOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2IntOpenCustomHashMap.MapIterator<Consumer<? super Byte2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
         action.accept(this.entry = Byte2IntOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2IntOpenCustomHashMap.MapSpliterator<Consumer<? super Byte2IntMap.Entry>, Byte2IntOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
         action.accept(Byte2IntOpenCustomHashMap.this.new MapEntry(index));
      }

      final Byte2IntOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2IntOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2IntOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2IntOpenCustomHashMap.MapSpliterator<ByteConsumer, Byte2IntOpenCustomHashMap.KeySpliterator>
      ...
      final Byte2IntOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2IntMap.Entry, Entry<Byte, Integer>, ByteIntPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2IntOpenCustomHashMap.this.strategy.equals(Byte2IntOpenCustomHashMap.this.key[this.index], e.getKey())
            && Byte2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Byte2IntOpenCustomHashMap.this.strategy.hashCode(Byte2IntOpenCustomHashMap.this.key[this.index])
            ^ Byte2IntOpenCustomHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2IntMap.Entry> spliterator() {
         return Byte2IntOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
         if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Byte2IntOpenCustomHashMap.this.new MapEntry(Byte2IntOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2IntOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2IntOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
         Byte2IntOpenCustomHashMap.MapEntry entry = Byte2IntOpenCustomHashMap.this.new MapEntry();
         if (Byte2IntOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2IntOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2IntOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2IntOpenCustomHashMap.this.size - this.c
            : Math.min(
               Byte2IntOpenCustomHashMap.this.size - this.c,
               (long)((double)Byte2IntOpenCustomHashMap.this.realSize() / Byte2IntOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Byte2IntOpenCustomHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Byte2IntOpenCustomHashMap.MapSpliterator<IntConsumer, Byte2IntOpenCustomHashMap.ValueSpliterator>
      ...
      final Byte2IntOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
