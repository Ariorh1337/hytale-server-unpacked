...
public class Byte2FloatOpenCustomHashMap extends AbstractByte2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Byte2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      float[] value = this.value;
      Byte2FloatOpenCustomHashMap.EntryIterator i = new Byte2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2FloatOpenCustomHashMap.MapIterator<Consumer<? super Byte2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Byte2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Byte2FloatMap.Entry>, Byte2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2FloatMap.Entry> action, int index) {
         action.accept(Byte2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Byte2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2FloatOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2FloatOpenCustomHashMap.MapSpliterator<ByteConsumer, Byte2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Byte2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2FloatMap.Entry, Entry<Byte, Float>, ByteFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Byte2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2FloatMap.Entry> spliterator() {
         return Byte2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
         if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Byte2FloatOpenCustomHashMap.this.new MapEntry(Byte2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2FloatOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2FloatMap.Entry> consumer) {
         Byte2FloatOpenCustomHashMap.MapEntry entry = Byte2FloatOpenCustomHashMap.this.new MapEntry();
         if (Byte2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Byte2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Byte2FloatOpenCustomHashMap.this.realSize() / Byte2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Byte2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Byte2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Byte2FloatOpenCustomHashMap.ValueSpliterator>
      ...
      final Byte2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
