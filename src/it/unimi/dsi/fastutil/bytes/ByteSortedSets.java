...
public final class ByteSortedSets {
   ...
   public static class Singleton extends ByteSets.Singleton implements ByteSortedSet, Serializable, Cloneable {
      ...
      @Override
      public ByteSortedSet subSet(byte from, byte to) {
         return this.compare(from, this.element) <= 0 && this.compare(this.element, to) < 0 ? this : ByteSortedSets.EMPTY_SET;
      }

      @Override
      public ByteSortedSet headSet(byte to) {
         return this.compare(this.element, to) < 0 ? this : ByteSortedSets.EMPTY_SET;
      }

      @Override
      public ByteSortedSet tailSet(byte from) {
         return this.compare(from, this.element) <= 0 ? this : ByteSortedSets.EMPTY_SET;
      }
