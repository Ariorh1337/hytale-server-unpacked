...
public final class ByteLists {
   ...
   public static ByteList synchronize(ByteList l) {
      return l instanceof RandomAccess ? new ByteLists.SynchronizedRandomAccessList(l) : new ByteLists.SynchronizedList(l);
   }

   public static ByteList synchronize(ByteList l, Object sync) {
      return l instanceof RandomAccess ? new ByteLists.SynchronizedRandomAccessList(l, sync) : new ByteLists.SynchronizedList(l, sync);
   }

   public static ByteList unmodifiable(ByteList l) {
      return l instanceof RandomAccess ? new ByteLists.UnmodifiableRandomAccessList(l) : new ByteLists.UnmodifiableList(l);
   }
   ...
   abstract static class ImmutableListBase extends AbstractByteList implements ByteList {
      @Deprecated
      @Override
