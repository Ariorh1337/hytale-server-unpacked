      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Byte2LongAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Byte2LongMap.Entry>() {
            final Comparator<? super Byte2LongMap.Entry> comparator = Byte2LongAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Byte.compare(x.getByteKey(), y.getByteKey())
               : (x, y) -> Byte2LongAVLTreeMap.this.actualComparator.compare(x.getByteKey(), y.getByteKey());
