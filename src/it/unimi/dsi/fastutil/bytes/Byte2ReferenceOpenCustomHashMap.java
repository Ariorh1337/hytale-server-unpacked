...
public class Byte2ReferenceOpenCustomHashMap<V> extends AbstractByte2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Byte2ReferenceOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      V[] value = this.value;
      Byte2ReferenceOpenCustomHashMap<V>.EntryIterator i = new Byte2ReferenceOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super Byte2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Byte2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Byte2ReferenceMap.Entry<V>>, Byte2ReferenceOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Byte2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }

      final Byte2ReferenceOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ReferenceOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2ReferenceOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator<ByteConsumer, Byte2ReferenceOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Byte2ReferenceOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ReferenceOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2ReferenceMap.Entry<V>, Entry<Byte, V>, ByteReferencePair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())
      ...
      public int hashCode() {
         return Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(Byte2ReferenceOpenCustomHashMap.this.key[this.index])
            ^ (
               Byte2ReferenceOpenCustomHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Byte2ReferenceOpenCustomHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Byte2ReferenceMap.Entry<V>> spliterator() {
         return Byte2ReferenceOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Byte) {
            ...
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
               return Byte2ReferenceOpenCustomHashMap.this.containsNullKey
                  && Byte2ReferenceOpenCustomHashMap.this.value[Byte2ReferenceOpenCustomHashMap.this.n] == v;
            }
      ...
      public boolean remove(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Byte) {
            ...
            if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(k, (byte)0)) {
               ...
               byte curr;
               int pos;
               if ((curr = key[pos = HashCommon.mix(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask])
                  == 0) {
                  return false;
               }
      ...
      public void forEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Byte2ReferenceOpenCustomHashMap.this.new MapEntry(Byte2ReferenceOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2ReferenceOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2ReferenceMap.Entry<V>> consumer) {
         Byte2ReferenceOpenCustomHashMap<V>.MapEntry entry = Byte2ReferenceOpenCustomHashMap.this.new MapEntry();
         if (Byte2ReferenceOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2ReferenceOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2ReferenceOpenCustomHashMap.this.size - this.c
            : Math.min(
               Byte2ReferenceOpenCustomHashMap.this.size - this.c,
               (long)((double)Byte2ReferenceOpenCustomHashMap.this.realSize() / Byte2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Byte2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Byte2ReferenceOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Byte2ReferenceOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2ReferenceOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
