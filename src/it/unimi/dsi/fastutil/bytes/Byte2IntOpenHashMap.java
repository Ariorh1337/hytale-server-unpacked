...
public class Byte2IntOpenHashMap extends AbstractByte2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Byte2IntOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      int[] value = this.value;
      Byte2IntOpenHashMap.EntryIterator i = new Byte2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Byte2IntOpenHashMap.MapIterator<Consumer<? super Byte2IntMap.Entry>> implements ObjectIterator<Byte2IntMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
         action.accept(this.entry = Byte2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2IntOpenHashMap.MapSpliterator<Consumer<? super Byte2IntMap.Entry>, Byte2IntOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2IntMap.Entry> action, int index) {
         action.accept(Byte2IntOpenHashMap.this.new MapEntry(index));
      }

      final Byte2IntOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Byte2IntOpenHashMap.MapIterator<Consumer<? super Byte2IntMap.Entry>>
   ...
   private final class KeyIterator extends Byte2IntOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2IntOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Byte2IntOpenHashMap.MapSpliterator<ByteConsumer, Byte2IntOpenHashMap.KeySpliterator> implements ByteSpliterator {
      ...
      final Byte2IntOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2IntMap.Entry> spliterator() {
         return Byte2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2IntMap.Entry> consumer) {
         if (Byte2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2IntOpenHashMap.this.new MapEntry(Byte2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2IntOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2IntMap.Entry> consumer) {
         Byte2IntOpenHashMap.MapEntry entry = Byte2IntOpenHashMap.this.new MapEntry();
         if (Byte2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2IntOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2IntOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2IntOpenHashMap.this.size - this.c
            : Math.min(
               Byte2IntOpenHashMap.this.size - this.c,
               (long)((double)Byte2IntOpenHashMap.this.realSize() / Byte2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2IntOpenHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator extends Byte2IntOpenHashMap.MapSpliterator<IntConsumer, Byte2IntOpenHashMap.ValueSpliterator> implements IntSpliterator {
      ...
      final Byte2IntOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
