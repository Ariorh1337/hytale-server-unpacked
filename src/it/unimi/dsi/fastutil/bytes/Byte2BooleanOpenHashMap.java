...
public class Byte2BooleanOpenHashMap extends AbstractByte2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Byte2BooleanOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      byte[] key = this.key;
      boolean[] value = this.value;
      Byte2BooleanOpenHashMap.EntryIterator i = new Byte2BooleanOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Byte2BooleanOpenHashMap.MapIterator<Consumer<? super Byte2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Byte2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Byte2BooleanOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Byte2BooleanOpenHashMap.MapSpliterator<Consumer<? super Byte2BooleanMap.Entry>, Byte2BooleanOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Byte2BooleanMap.Entry> action, int index) {
         action.accept(Byte2BooleanOpenHashMap.this.new MapEntry(index));
      }

      final Byte2BooleanOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2BooleanOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Byte2BooleanOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractByteSet {
      ...
      public ByteSpliterator spliterator() {
         return Byte2BooleanOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Byte2BooleanOpenHashMap.MapSpliterator<ByteConsumer, Byte2BooleanOpenHashMap.KeySpliterator>
      ...
      final Byte2BooleanOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2BooleanOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Byte2BooleanMap.Entry, Entry<Byte, Boolean>, ByteBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Byte2BooleanOpenHashMap.this.key[this.index] == e.getKey() && Byte2BooleanOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Byte2BooleanMap.Entry> implements Byte2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Byte2BooleanMap.Entry> spliterator() {
         return Byte2BooleanOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
         if (Byte2BooleanOpenHashMap.this.containsNullKey) {
            consumer.accept(Byte2BooleanOpenHashMap.this.new MapEntry(Byte2BooleanOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Byte2BooleanOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Byte2BooleanOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Byte2BooleanMap.Entry> consumer) {
         Byte2BooleanOpenHashMap.MapEntry entry = Byte2BooleanOpenHashMap.this.new MapEntry();
         if (Byte2BooleanOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Byte2BooleanOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Byte2BooleanOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Byte2BooleanOpenHashMap.this.size - this.c
            : Math.min(
               Byte2BooleanOpenHashMap.this.size - this.c,
               (long)((double)Byte2BooleanOpenHashMap.this.realSize() / Byte2BooleanOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Byte2BooleanOpenHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Byte2BooleanOpenHashMap.MapSpliterator<BooleanConsumer, Byte2BooleanOpenHashMap.ValueSpliterator>
      ...
      final Byte2BooleanOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Byte2BooleanOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
