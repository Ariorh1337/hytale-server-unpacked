         ...
         while (j-- != 0) {
            executorCompletionService.submit(() -> {
               ...
               while (true) {
                  ...
                  ByteArrays.Segment segment = queue.take();
                  ...
                  while (p <= ix) {
                     ...
                     if (level < 0 && count[c] > 1) {
                        if (count[c] < 1024) {
                           ...
                           queue.add(new ByteArrays.Segment(p, count[c], level + 1));
                        }
                     }
            ...
            while (true) {
               ...
               while (b > c || (comparison = Byte.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        invokeAll(
                           new ByteArrays.ForkJoinQuickSort(x, this.from, this.from + s), new ByteArrays.ForkJoinQuickSort(x, this.to - comparison, this.to)
                        );
                     } else if (s > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort(x, this.from, this.from + s));
                     } else {
                        invokeAll(new ByteArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
                     }
            ...
            while (true) {
               ...
               while (b > c || (comparison = (t = Byte.compare(x[b], v)) == 0 ? Byte.compare(y[b], w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        invokeAll(
                           new ByteArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s),
                           new ByteArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to)
                        );
                     } else if (s > 1) {
                        invokeAll(new ByteArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s));
                     } else {
                        invokeAll(new ByteArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ByteArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp));
                     } else {
                        invokeAll(new ByteArrays.ForkJoinQuickSortComp(x, this.to - comparison, this.to, this.comp));
                     }
               ...
               while (b > c || (comparison = Byte.compare(x[this.perm[b]], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s));
                     } else {
                        invokeAll(new ByteArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - comparison, this.to));
                     }
