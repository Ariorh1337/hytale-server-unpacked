...
public final class ObjectIterators {
   ...
   public static <K> ObjectIterator<K> asObjectIterator(Iterator<K> i) {
      return i instanceof ObjectIterator ? (ObjectIterator)i : new ObjectIterators.IteratorWrapper<>(i);
   }

   public static <K> ObjectListIterator<K> asObjectIterator(ListIterator<K> i) {
      return i instanceof ObjectListIterator ? (ObjectListIterator)i : new ObjectIterators.ListIteratorWrapper<>(i);
   }
