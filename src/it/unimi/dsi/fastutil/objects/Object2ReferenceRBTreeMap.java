...
public class Object2ReferenceRBTreeMap<K, V> extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable, Cloneable {
            ...
            while (true) {
               ...
               if (!this.dirPath[i - 1]) {
                  ...
                  if (this.nodePath[i - 1].succ() || y.black()) {
                     ...
                     Object2ReferenceRBTreeMap.Entry<K, V> x = this.nodePath[i - 1];
                     x.black(false);
                     y.black(true);
                     x.left = y.right;
                     y.right = x;
      ...
      if (p.black()) {
         for (; i > 0; i--) {
            ...
            if (!this.dirPath[i - 1]) {
               ...
               Object2ReferenceRBTreeMap.Entry<K, V> w = this.nodePath[i - 1].left;
               if (!w.black()) {
                  w.black(true);
                  this.nodePath[i - 1].black(false);
               ...
               if (!w.pred() && !w.left.black() || !w.succ() && !w.right.black()) {
                  if (w.pred() || w.left.black()) {
                     Object2ReferenceRBTreeMap.Entry<K, V> y = w.right;
                     y.black(true);
                     w.black(false);
                     w.right = y.left;
                     y.left = w;
   ...
   public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>>() {
            final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = Object2ReferenceRBTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2ReferenceSortedMap<K, V> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2ReferenceRBTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2ReferenceRBTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2ReferenceRBTreeMap.this.containsKey(k);
      }
      ...
      public Object2ReferenceSortedMap<K, V> headMap(K to) {
         if (this.top) {
            ...
            return Object2ReferenceRBTreeMap.this.compare(to, (K)this.to) < 0
               ? Object2ReferenceRBTreeMap.this.new Submap(this.from, this.bottom, to, false)
               : this;
         }
      }
      ...
      public Object2ReferenceSortedMap<K, V> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2ReferenceRBTreeMap.this.compare(from, (K)this.from) > 0
               ? Object2ReferenceRBTreeMap.this.new Submap(from, false, this.to, this.top)
               : this;
         }
      }
      ...
      public Object2ReferenceSortedMap<K, V> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2ReferenceRBTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2ReferenceRBTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2ReferenceRBTreeMap.Entry<K, V> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2ReferenceRBTreeMap.this.locateKey((K)this.from);
            if (Object2ReferenceRBTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2ReferenceRBTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2ReferenceRBTreeMap.Entry<K, V> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2ReferenceRBTreeMap.this.locateKey((K)this.to);
            if (Object2ReferenceRBTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2ReferenceRBTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2ReferenceRBTreeMap<K, V>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2ReferenceRBTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2ReferenceRBTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
