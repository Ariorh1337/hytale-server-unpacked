...
public final class ObjectLists {
   ...
   public static <K> ObjectList<K> synchronize(ObjectList<K> l) {
      return l instanceof RandomAccess ? new ObjectLists.SynchronizedRandomAccessList<>(l) : new ObjectLists.SynchronizedList<>(l);
   }

   public static <K> ObjectList<K> synchronize(ObjectList<K> l, Object sync) {
      return l instanceof RandomAccess ? new ObjectLists.SynchronizedRandomAccessList<>(l, sync) : new ObjectLists.SynchronizedList<>(l, sync);
   }

   public static <K> ObjectList<K> unmodifiable(ObjectList<? extends K> l) {
      return l instanceof RandomAccess ? new ObjectLists.UnmodifiableRandomAccessList<>(l) : new ObjectLists.UnmodifiableList<>(l);
   }
