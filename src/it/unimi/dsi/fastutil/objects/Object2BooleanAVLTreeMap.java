...
public class Object2BooleanAVLTreeMap<K> extends AbstractObject2BooleanSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2BooleanAVLTreeMap.Entry<K> parent(Object2BooleanAVLTreeMap.Entry<K> e) {
      ...
      Object2BooleanAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2BooleanAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
            final Comparator<? super Object2BooleanMap.Entry<K>> comparator = Object2BooleanAVLTreeMap.this.actualComparator == null
   ...
   private Object2BooleanAVLTreeMap.Entry<K> readTree(
      ObjectInputStream s, int n, Object2BooleanAVLTreeMap.Entry<K> pred, Object2BooleanAVLTreeMap.Entry<K> succ
   ...
   private final class Submap extends AbstractObject2BooleanSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2BooleanAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2BooleanAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2BooleanAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2BooleanSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2BooleanAVLTreeMap.this.compare(to, (K)this.to) < 0
               ? Object2BooleanAVLTreeMap.this.new Submap(this.from, this.bottom, to, false)
               : this;
         }
      }
      ...
      public Object2BooleanSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2BooleanAVLTreeMap.this.compare(from, (K)this.from) > 0
               ? Object2BooleanAVLTreeMap.this.new Submap(from, false, this.to, this.top)
               : this;
         }
      }
      ...
      public Object2BooleanSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2BooleanAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2BooleanAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2BooleanAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2BooleanAVLTreeMap.this.locateKey((K)this.from);
            if (Object2BooleanAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2BooleanAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2BooleanAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2BooleanAVLTreeMap.this.locateKey((K)this.to);
            if (Object2BooleanAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2BooleanAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2BooleanAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2BooleanAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2BooleanAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
