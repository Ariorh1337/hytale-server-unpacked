...
public class Object2ReferenceOpenCustomHashMap<K, V> extends AbstractObject2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Object2ReferenceOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      V[] value = this.value;
      Object2ReferenceOpenCustomHashMap<K, V>.EntryIterator i = new Object2ReferenceOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2ReferenceOpenCustomHashMap<K, V>.MapIterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(this.entry = Object2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2ReferenceOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>, Object2ReferenceOpenCustomHashMap<K, V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(Object2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }

      final Object2ReferenceOpenCustomHashMap<K, V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2ReferenceOpenCustomHashMap<K, V>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2ReferenceOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2ReferenceOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super K>, Object2ReferenceOpenCustomHashMap<K, V>.KeySpliterator>
      ...
      final Object2ReferenceOpenCustomHashMap<K, V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2ReferenceMap.Entry<K, V>, Entry<K, V>, ObjectReferencePair<K, V> {
      ...
      public boolean equals(Object o) {
         ...
         return Object2ReferenceOpenCustomHashMap.this.strategy.equals(Object2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())
      ...
      public int hashCode() {
         return Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceOpenCustomHashMap.this.key[this.index])
            ^ (
               Object2ReferenceOpenCustomHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Object2ReferenceOpenCustomHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceMap.FastEntrySet<K, V> {
      ...
      public ObjectSpliterator<Object2ReferenceMap.Entry<K, V>> spliterator() {
         return Object2ReferenceOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         K curr;
         int pos;
         if ((curr = key[pos = HashCommon.mix(Object2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceOpenCustomHashMap.this.mask])
            == null) {
            return false;
         }
      ...
      public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
         if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Object2ReferenceOpenCustomHashMap.this.new MapEntry(Object2ReferenceOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2ReferenceOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Object2ReferenceOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
         Object2ReferenceOpenCustomHashMap<K, V>.MapEntry entry = Object2ReferenceOpenCustomHashMap.this.new MapEntry();
         if (Object2ReferenceOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2ReferenceOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Object2ReferenceOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2ReferenceOpenCustomHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2ReferenceOpenCustomHashMap.this.size - this.c
            : Math.min(
               Object2ReferenceOpenCustomHashMap.this.size - this.c,
               (long)((double)Object2ReferenceOpenCustomHashMap.this.realSize() / Object2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2ReferenceOpenCustomHashMap<K, V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Object2ReferenceOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super V>, Object2ReferenceOpenCustomHashMap<K, V>.ValueSpliterator>
      ...
      final Object2ReferenceOpenCustomHashMap<K, V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
