...
public class Object2FloatRBTreeMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable {
            ...
            while (true) {
               ...
               if (!this.dirPath[i - 1]) {
                  ...
                  if (this.nodePath[i - 1].succ() || y.black()) {
                     ...
                     Object2FloatRBTreeMap.Entry<K> x = this.nodePath[i - 1];
                     x.black(false);
                     y.black(true);
                     x.left = y.right;
                     y.right = x;
      ...
      if (p.black()) {
         for (; i > 0; i--) {
            ...
            if (!this.dirPath[i - 1]) {
               ...
               Object2FloatRBTreeMap.Entry<K> w = this.nodePath[i - 1].left;
               if (!w.black()) {
                  w.black(true);
                  this.nodePath[i - 1].black(false);
               ...
               if (!w.pred() && !w.left.black() || !w.succ() && !w.right.black()) {
                  if (w.pred() || w.left.black()) {
                     Object2FloatRBTreeMap.Entry<K> y = w.right;
                     y.black(true);
                     w.black(false);
                     w.right = y.left;
                     y.left = w;
   ...
   public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
            final Comparator<? super Object2FloatMap.Entry<K>> comparator = Object2FloatRBTreeMap.this.actualComparator == null
   ...
   private static final class Entry<K> extends AbstractObject2FloatMap.BasicEntry<K> implements Cloneable {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(this.key, e.getKey()) && Float.floatToIntBits(this.value) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class Submap extends AbstractObject2FloatSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2FloatRBTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2FloatRBTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2FloatRBTreeMap.this.containsKey(k);
      }
      ...
      public Object2FloatSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2FloatRBTreeMap.this.compare(to, (K)this.to) < 0 ? Object2FloatRBTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2FloatSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2FloatRBTreeMap.this.compare(from, (K)this.from) > 0 ? Object2FloatRBTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2FloatSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2FloatRBTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2FloatRBTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2FloatRBTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2FloatRBTreeMap.this.locateKey((K)this.from);
            if (Object2FloatRBTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2FloatRBTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2FloatRBTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2FloatRBTreeMap.this.locateKey((K)this.to);
            if (Object2FloatRBTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2FloatRBTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2FloatRBTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2FloatRBTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2FloatRBTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
