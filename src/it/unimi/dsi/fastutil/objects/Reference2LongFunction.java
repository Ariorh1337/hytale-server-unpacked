...
@FunctionalInterface
public interface Reference2LongFunction<K> extends it.unimi.dsi.fastutil.Function<K, Long>, ToLongFunction<K> {
   @Override
   ...
   default Long get(Object key) {
      Object k = key;
      long v;
      return (v = this.getLong(k)) == this.defaultReturnValue() && !this.containsKey(k) ? null : v;
   }
   ...
   default Long remove(Object key) {
      Object k = key;
      return this.containsKey(k) ? this.removeLong(k) : null;
   }
