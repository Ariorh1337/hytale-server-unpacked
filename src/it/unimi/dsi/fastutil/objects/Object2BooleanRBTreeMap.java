...
public class Object2BooleanRBTreeMap<K> extends AbstractObject2BooleanSortedMap<K> implements Serializable, Cloneable {
            ...
            while (true) {
               ...
               if (!this.dirPath[i - 1]) {
                  ...
                  if (this.nodePath[i - 1].succ() || y.black()) {
                     ...
                     Object2BooleanRBTreeMap.Entry<K> x = this.nodePath[i - 1];
                     x.black(false);
                     y.black(true);
                     x.left = y.right;
                     y.right = x;
      ...
      if (p.black()) {
         for (; i > 0; i--) {
            ...
            if (!this.dirPath[i - 1]) {
               ...
               Object2BooleanRBTreeMap.Entry<K> w = this.nodePath[i - 1].left;
               if (!w.black()) {
                  w.black(true);
                  this.nodePath[i - 1].black(false);
               ...
               if (!w.pred() && !w.left.black() || !w.succ() && !w.right.black()) {
                  if (w.pred() || w.left.black()) {
                     Object2BooleanRBTreeMap.Entry<K> y = w.right;
                     y.black(true);
                     w.black(false);
                     w.right = y.left;
                     y.left = w;
   ...
   public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2BooleanMap.Entry<K>>() {
            final Comparator<? super Object2BooleanMap.Entry<K>> comparator = Object2BooleanRBTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2BooleanSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2BooleanRBTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2BooleanRBTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2BooleanRBTreeMap.this.containsKey(k);
      }
      ...
      public Object2BooleanSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2BooleanRBTreeMap.this.compare(to, (K)this.to) < 0 ? Object2BooleanRBTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2BooleanSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2BooleanRBTreeMap.this.compare(from, (K)this.from) > 0
               ? Object2BooleanRBTreeMap.this.new Submap(from, false, this.to, this.top)
               : this;
         }
      }
      ...
      public Object2BooleanSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2BooleanRBTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2BooleanRBTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2BooleanRBTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2BooleanRBTreeMap.this.locateKey((K)this.from);
            if (Object2BooleanRBTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2BooleanRBTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2BooleanRBTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2BooleanRBTreeMap.this.locateKey((K)this.to);
            if (Object2BooleanRBTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2BooleanRBTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2BooleanRBTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2BooleanRBTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2BooleanRBTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
