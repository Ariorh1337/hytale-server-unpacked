...
public class Reference2BooleanOpenHashMap<K> extends AbstractReference2BooleanMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Reference2BooleanOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      boolean[] value = this.value;
      Reference2BooleanOpenHashMap<K>.EntryIterator i = new Reference2BooleanOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2BooleanOpenHashMap<K>.MapIterator<Consumer<? super Reference2BooleanMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2BooleanMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2BooleanOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2BooleanOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2BooleanMap.Entry<K>>, Reference2BooleanOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2BooleanMap.Entry<K>> action, int index) {
         action.accept(Reference2BooleanOpenHashMap.this.new MapEntry(index));
      }

      final Reference2BooleanOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2BooleanOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2BooleanOpenHashMap<K>.MapIterator<Consumer<? super Reference2BooleanMap.Entry<K>>>
      implements ObjectIterator<Reference2BooleanMap.Entry<K>> {
      private final Reference2BooleanOpenHashMap<K>.MapEntry entry = Reference2BooleanOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2BooleanOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2BooleanOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2BooleanOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2BooleanOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2BooleanOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2BooleanOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2BooleanOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2BooleanMap.Entry<K>, Entry<K, Boolean>, ReferenceBooleanPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2BooleanOpenHashMap.this.key[this.index] == e.getKey() && Reference2BooleanOpenHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return System.identityHashCode(Reference2BooleanOpenHashMap.this.key[this.index])
            ^ (Reference2BooleanOpenHashMap.this.value[this.index] ? 1231 : 1237);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2BooleanMap.Entry<K>> implements Reference2BooleanMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2BooleanMap.Entry<K>> spliterator() {
         return Reference2BooleanOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Boolean) {
            ...
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2BooleanOpenHashMap.this.mask]) == null) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask]) != null) {
               if (k == curr) {
                  return Reference2BooleanOpenHashMap.this.value[pos] == v;
               }
            }
         ...
         if (e.getValue() != null && e.getValue() instanceof Boolean) {
            ...
            if (k == null) {
               ...
               if (curr == k) {
                  ...
                  while ((curr = key[pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask]) != null) {
                     if (curr == k && Reference2BooleanOpenHashMap.this.value[pos] == v) {
                        Reference2BooleanOpenHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
         if (Reference2BooleanOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2BooleanOpenHashMap.this.new MapEntry(Reference2BooleanOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2BooleanOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2BooleanOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2BooleanMap.Entry<K>> consumer) {
         Reference2BooleanOpenHashMap<K>.MapEntry entry = Reference2BooleanOpenHashMap.this.new MapEntry();
         if (Reference2BooleanOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2BooleanOpenHashMap.this.n;
      int last = -1;
      int c = Reference2BooleanOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2BooleanOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2BooleanOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2BooleanOpenHashMap.this.size - this.c
            : Math.min(
               Reference2BooleanOpenHashMap.this.size - this.c,
               (long)((double)Reference2BooleanOpenHashMap.this.realSize() / Reference2BooleanOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2BooleanOpenHashMap<K>.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Reference2BooleanOpenHashMap<K>.MapSpliterator<BooleanConsumer, Reference2BooleanOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2BooleanOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2BooleanOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
