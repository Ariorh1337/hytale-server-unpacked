...
public class Object2IntOpenCustomHashMap<K> extends AbstractObject2IntMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Object2IntOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      int[] value = this.value;
      Object2IntOpenCustomHashMap<K>.EntryIterator i = new Object2IntOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2IntOpenCustomHashMap<K>.MapIterator<Consumer<? super Object2IntMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2IntMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2IntOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2IntOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Object2IntMap.Entry<K>>, Object2IntOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2IntMap.Entry<K>> action, int index) {
         action.accept(Object2IntOpenCustomHashMap.this.new MapEntry(index));
      }

      final Object2IntOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2IntOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2IntOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2IntOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2IntOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Object2IntOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Object2IntOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2IntOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2IntMap.Entry<K>, Entry<K, Integer>, ObjectIntPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[this.index], e.getKey())
            && Object2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2IntMap.Entry<K>> spliterator() {
         return Object2IntOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
         if (Object2IntOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Object2IntOpenCustomHashMap.this.new MapEntry(Object2IntOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2IntOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Object2IntOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2IntMap.Entry<K>> consumer) {
         Object2IntOpenCustomHashMap<K>.MapEntry entry = Object2IntOpenCustomHashMap.this.new MapEntry();
         if (Object2IntOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2IntOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2IntOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2IntOpenCustomHashMap.this.size - this.c
            : Math.min(
               Object2IntOpenCustomHashMap.this.size - this.c,
               (long)((double)Object2IntOpenCustomHashMap.this.realSize() / Object2IntOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2IntOpenCustomHashMap<K>.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Object2IntOpenCustomHashMap<K>.MapSpliterator<IntConsumer, Object2IntOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Object2IntOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2IntOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
