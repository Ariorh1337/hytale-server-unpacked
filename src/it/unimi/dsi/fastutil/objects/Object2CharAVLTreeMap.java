...
public class Object2CharAVLTreeMap<K> extends AbstractObject2CharSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2CharAVLTreeMap.Entry<K> parent(Object2CharAVLTreeMap.Entry<K> e) {
      ...
      Object2CharAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2CharAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2CharMap.Entry<K>>() {
            final Comparator<? super Object2CharMap.Entry<K>> comparator = Object2CharAVLTreeMap.this.actualComparator == null
               ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey())
               : (x, y) -> Object2CharAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
   ...
   private final class Submap extends AbstractObject2CharSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2CharAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2CharAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2CharAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2CharSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2CharAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2CharAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2CharSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2CharAVLTreeMap.this.compare(from, (K)this.from) > 0 ? Object2CharAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2CharSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2CharAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2CharAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2CharAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2CharAVLTreeMap.this.locateKey((K)this.from);
            if (Object2CharAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2CharAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2CharAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2CharAVLTreeMap.this.locateKey((K)this.to);
            if (Object2CharAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2CharAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2CharAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2CharAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2CharAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
