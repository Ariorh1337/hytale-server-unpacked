...
public class Object2DoubleAVLTreeMap<K> extends AbstractObject2DoubleSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2DoubleAVLTreeMap.Entry<K> parent(Object2DoubleAVLTreeMap.Entry<K> e) {
      ...
      Object2DoubleAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2DoubleAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2DoubleMap.Entry<K>>() {
            final Comparator<? super Object2DoubleMap.Entry<K>> comparator = Object2DoubleAVLTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2DoubleSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2DoubleAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2DoubleAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2DoubleAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2DoubleSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2DoubleAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2DoubleAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2DoubleSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2DoubleAVLTreeMap.this.compare(from, (K)this.from) > 0
               ? Object2DoubleAVLTreeMap.this.new Submap(from, false, this.to, this.top)
               : this;
         }
      }
      ...
      public Object2DoubleSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2DoubleAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2DoubleAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2DoubleAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2DoubleAVLTreeMap.this.locateKey((K)this.from);
            if (Object2DoubleAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2DoubleAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2DoubleAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2DoubleAVLTreeMap.this.locateKey((K)this.to);
            if (Object2DoubleAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2DoubleAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2DoubleAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2DoubleAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2DoubleAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
