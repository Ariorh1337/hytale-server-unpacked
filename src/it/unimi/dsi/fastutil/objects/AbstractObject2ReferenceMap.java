...
public abstract class AbstractObject2ReferenceMap<K, V> extends AbstractObject2ReferenceFunction<K, V> implements Object2ReferenceMap<K, V>, Serializable {
   ...
   public boolean containsKey(Object k) {
      ObjectIterator<Object2ReferenceMap.Entry<K, V>> i = this.object2ReferenceEntrySet().iterator();
   ...
   public void putAll(Map<? extends K, ? extends V> m) {
      if (m instanceof Object2ReferenceMap) {
         ...
         while (i.hasNext()) {
            Object2ReferenceMap.Entry<? extends K, ? extends V> e = i.next();
   ...
   public static class BasicEntry<K, V> implements Object2ReferenceMap.Entry<K, V> {
      ...
      public boolean equals(Object o) {
         if (!(o instanceof Entry)) {
            return false;
         } else if (o instanceof Object2ReferenceMap.Entry) {
            Object2ReferenceMap.Entry<K, V> e = (Object2ReferenceMap.Entry<K, V>)o;
