...
public class Object2ByteOpenHashMap<K> extends AbstractObject2ByteMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Object2ByteOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      byte[] value = this.value;
      Object2ByteOpenHashMap<K>.EntryIterator i = new Object2ByteOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2ByteOpenHashMap<K>.MapIterator<Consumer<? super Object2ByteMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2ByteMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2ByteOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2ByteOpenHashMap<K>.MapSpliterator<Consumer<? super Object2ByteMap.Entry<K>>, Object2ByteOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2ByteMap.Entry<K>> action, int index) {
         action.accept(Object2ByteOpenHashMap.this.new MapEntry(index));
      }

      final Object2ByteOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ByteOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Object2ByteOpenHashMap<K>.MapIterator<Consumer<? super Object2ByteMap.Entry<K>>>
      implements ObjectIterator<Object2ByteMap.Entry<K>> {
      private final Object2ByteOpenHashMap<K>.MapEntry entry = Object2ByteOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Object2ByteOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2ByteOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Object2ByteOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Object2ByteOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Object2ByteOpenHashMap<K>.KeySpliterator>
      ...
      final Object2ByteOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ByteOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2ByteMap.Entry<K>, Entry<K, Byte>, ObjectBytePair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(Object2ByteOpenHashMap.this.key[this.index], e.getKey()) && Object2ByteOpenHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return (Object2ByteOpenHashMap.this.key[this.index] == null ? 0 : Object2ByteOpenHashMap.this.key[this.index].hashCode())
            ^ Object2ByteOpenHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements Object2ByteMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2ByteMap.Entry<K>> spliterator() {
         return Object2ByteOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
         if (Object2ByteOpenHashMap.this.containsNullKey) {
            consumer.accept(Object2ByteOpenHashMap.this.new MapEntry(Object2ByteOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2ByteOpenHashMap.this.key[pos] != null) {
               consumer.accept(Object2ByteOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2ByteMap.Entry<K>> consumer) {
         Object2ByteOpenHashMap<K>.MapEntry entry = Object2ByteOpenHashMap.this.new MapEntry();
         if (Object2ByteOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Object2ByteOpenHashMap.this.n;
      int last = -1;
      int c = Object2ByteOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2ByteOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Object2ByteOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Object2ByteOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2ByteOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2ByteOpenHashMap.this.size - this.c
            : Math.min(
               Object2ByteOpenHashMap.this.size - this.c,
               (long)((double)Object2ByteOpenHashMap.this.realSize() / Object2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Object2ByteOpenHashMap<K>.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Object2ByteOpenHashMap<K>.MapSpliterator<ByteConsumer, Object2ByteOpenHashMap<K>.ValueSpliterator>
      ...
      final Object2ByteOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ByteOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
