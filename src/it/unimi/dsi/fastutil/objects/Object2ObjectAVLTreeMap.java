...
public class Object2ObjectAVLTreeMap<K, V> extends AbstractObject2ObjectSortedMap<K, V> implements Serializable, Cloneable {
   ...
   private Object2ObjectAVLTreeMap.Entry<K, V> parent(Object2ObjectAVLTreeMap.Entry<K, V> e) {
      ...
      Object2ObjectAVLTreeMap.Entry<K, V> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2ObjectAVLTreeMap.Entry<K, V> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2ObjectMap.Entry<K, V>>() {
            final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = Object2ObjectAVLTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2ObjectSortedMap<K, V> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2ObjectAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2ObjectAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2ObjectAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2ObjectSortedMap<K, V> headMap(K to) {
         if (this.top) {
            ...
            return Object2ObjectAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2ObjectAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2ObjectSortedMap<K, V> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2ObjectAVLTreeMap.this.compare(from, (K)this.from) > 0
               ? Object2ObjectAVLTreeMap.this.new Submap(from, false, this.to, this.top)
               : this;
         }
      }
      ...
      public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2ObjectAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2ObjectAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2ObjectAVLTreeMap.Entry<K, V> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2ObjectAVLTreeMap.this.locateKey((K)this.from);
            if (Object2ObjectAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2ObjectAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2ObjectAVLTreeMap.Entry<K, V> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2ObjectAVLTreeMap.this.locateKey((K)this.to);
            if (Object2ObjectAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2ObjectAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2ObjectAVLTreeMap<K, V>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2ObjectAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2ObjectAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
