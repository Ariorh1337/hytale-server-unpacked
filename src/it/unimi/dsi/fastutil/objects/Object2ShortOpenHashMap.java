...
public class Object2ShortOpenHashMap<K> extends AbstractObject2ShortMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Object2ShortOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      short[] value = this.value;
      Object2ShortOpenHashMap<K>.EntryIterator i = new Object2ShortOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2ShortOpenHashMap<K>.MapIterator<Consumer<? super Object2ShortMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2ShortMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2ShortOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2ShortOpenHashMap<K>.MapSpliterator<Consumer<? super Object2ShortMap.Entry<K>>, Object2ShortOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2ShortMap.Entry<K>> action, int index) {
         action.accept(Object2ShortOpenHashMap.this.new MapEntry(index));
      }

      final Object2ShortOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ShortOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2ShortOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2ShortOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2ShortOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Object2ShortOpenHashMap<K>.KeySpliterator>
      ...
      final Object2ShortOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ShortOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2ShortMap.Entry<K>, Entry<K, Short>, ObjectShortPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(Object2ShortOpenHashMap.this.key[this.index], e.getKey()) && Object2ShortOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2ShortMap.Entry<K>> spliterator() {
         return Object2ShortOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
         if (Object2ShortOpenHashMap.this.containsNullKey) {
            consumer.accept(Object2ShortOpenHashMap.this.new MapEntry(Object2ShortOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2ShortOpenHashMap.this.key[pos] != null) {
               consumer.accept(Object2ShortOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2ShortMap.Entry<K>> consumer) {
         Object2ShortOpenHashMap<K>.MapEntry entry = Object2ShortOpenHashMap.this.new MapEntry();
         if (Object2ShortOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2ShortOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2ShortOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2ShortOpenHashMap.this.size - this.c
            : Math.min(
               Object2ShortOpenHashMap.this.size - this.c,
               (long)((double)Object2ShortOpenHashMap.this.realSize() / Object2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Object2ShortOpenHashMap<K>.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Object2ShortOpenHashMap<K>.MapSpliterator<ShortConsumer, Object2ShortOpenHashMap<K>.ValueSpliterator>
      ...
      final Object2ShortOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ShortOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
