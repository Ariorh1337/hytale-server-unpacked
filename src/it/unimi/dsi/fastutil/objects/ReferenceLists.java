...
public final class ReferenceLists {
   ...
   public static <K> ReferenceList<K> synchronize(ReferenceList<K> l) {
      return l instanceof RandomAccess ? new ReferenceLists.SynchronizedRandomAccessList<>(l) : new ReferenceLists.SynchronizedList<>(l);
   }

   public static <K> ReferenceList<K> synchronize(ReferenceList<K> l, Object sync) {
      return l instanceof RandomAccess ? new ReferenceLists.SynchronizedRandomAccessList<>(l, sync) : new ReferenceLists.SynchronizedList<>(l, sync);
   }

   public static <K> ReferenceList<K> unmodifiable(ReferenceList<? extends K> l) {
      return l instanceof RandomAccess ? new ReferenceLists.UnmodifiableRandomAccessList<>(l) : new ReferenceLists.UnmodifiableList<>(l);
   }
   ...
   abstract static class ImmutableListBase<K> extends AbstractReferenceList<K> implements ReferenceList<K> {
      @Deprecated
      @Override
