...
public class Reference2LongOpenCustomHashMap<K> extends AbstractReference2LongMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Reference2LongOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      long[] value = this.value;
      Reference2LongOpenCustomHashMap<K>.EntryIterator i = new Reference2LongOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2LongOpenCustomHashMap<K>.MapIterator<Consumer<? super Reference2LongMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2LongMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2LongOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2LongOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Reference2LongMap.Entry<K>>, Reference2LongOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2LongMap.Entry<K>> action, int index) {
         action.accept(Reference2LongOpenCustomHashMap.this.new MapEntry(index));
      }

      final Reference2LongOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2LongOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2LongOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2LongOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2LongOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2LongOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Reference2LongOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2LongOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Reference2LongMap.Entry<K>, Entry<K, Long>, ReferenceLongPair<K> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<K, Long> e = (Entry<K, Long>)o;
         return Reference2LongOpenCustomHashMap.this.strategy.equals(Reference2LongOpenCustomHashMap.this.key[this.index], e.getKey())
            && Reference2LongOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements Reference2LongMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2LongMap.Entry<K>> spliterator() {
         return Reference2LongOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Long) {
            ...
            if (Reference2LongOpenCustomHashMap.this.strategy.equals(k, null)) {
               return Reference2LongOpenCustomHashMap.this.containsNullKey
                  && Reference2LongOpenCustomHashMap.this.value[Reference2LongOpenCustomHashMap.this.n] == v;
            }

            K[] key = Reference2LongOpenCustomHashMap.this.key;
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Reference2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2LongOpenCustomHashMap.this.mask])
               == null) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
         if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Reference2LongOpenCustomHashMap.this.new MapEntry(Reference2LongOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2LongOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Reference2LongOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2LongMap.Entry<K>> consumer) {
         Reference2LongOpenCustomHashMap<K>.MapEntry entry = Reference2LongOpenCustomHashMap.this.new MapEntry();
         if (Reference2LongOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2LongOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2LongOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2LongOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2LongOpenCustomHashMap.this.size - this.c
            : Math.min(
               Reference2LongOpenCustomHashMap.this.size - this.c,
               (long)((double)Reference2LongOpenCustomHashMap.this.realSize() / Reference2LongOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2LongOpenCustomHashMap<K>.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Reference2LongOpenCustomHashMap<K>.MapSpliterator<LongConsumer, Reference2LongOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Reference2LongOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2LongOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
