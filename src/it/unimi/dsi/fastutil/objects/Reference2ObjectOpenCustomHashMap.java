...
public class Reference2ObjectOpenCustomHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Reference2ObjectOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      V[] value = this.value;
      Reference2ObjectOpenCustomHashMap<K, V>.EntryIterator i = new Reference2ObjectOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ObjectOpenCustomHashMap<K, V>.MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ObjectMap.Entry<K, V>> action, int index) {
         action.accept(this.entry = Reference2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2ObjectOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>, Reference2ObjectOpenCustomHashMap<K, V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ObjectMap.Entry<K, V>> action, int index) {
         action.accept(Reference2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }

      final Reference2ObjectOpenCustomHashMap<K, V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ObjectOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2ObjectOpenCustomHashMap<K, V>.MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>>
      implements ObjectIterator<Reference2ObjectMap.Entry<K, V>> {
      private final Reference2ObjectOpenCustomHashMap<K, V>.MapEntry entry = Reference2ObjectOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2ObjectOpenCustomHashMap<K, V>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2ObjectOpenCustomHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2ObjectOpenCustomHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2ObjectOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super K>, Reference2ObjectOpenCustomHashMap<K, V>.KeySpliterator>
      ...
      final Reference2ObjectOpenCustomHashMap<K, V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ObjectOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Entry<K, V>, ReferenceObjectPair<K, V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Reference2ObjectOpenCustomHashMap.this.strategy.equals(Reference2ObjectOpenCustomHashMap.this.key[this.index], e.getKey())
            && Objects.equals(Reference2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
      }

      @Override
      public int hashCode() {
         return Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(Reference2ObjectOpenCustomHashMap.this.key[this.index])
            ^ (Reference2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Reference2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
      ...
      public ObjectSpliterator<Reference2ObjectMap.Entry<K, V>> spliterator() {
         return Reference2ObjectOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (Reference2ObjectOpenCustomHashMap.this.strategy.equals(k, null)) {
            return Reference2ObjectOpenCustomHashMap.this.containsNullKey
               && Objects.equals(Reference2ObjectOpenCustomHashMap.this.value[Reference2ObjectOpenCustomHashMap.this.n], v);
         }

         K[] key = Reference2ObjectOpenCustomHashMap.this.key;
         K curr;
         int pos;
         if ((curr = key[pos = HashCommon.mix(Reference2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ObjectOpenCustomHashMap.this.mask])
            == null) {
            return false;
         }
      ...
      public void forEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
         if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Reference2ObjectOpenCustomHashMap.this.new MapEntry(Reference2ObjectOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2ObjectOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Reference2ObjectOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2ObjectMap.Entry<K, V>> consumer) {
         Reference2ObjectOpenCustomHashMap<K, V>.MapEntry entry = Reference2ObjectOpenCustomHashMap.this.new MapEntry();
         if (Reference2ObjectOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2ObjectOpenCustomHashMap.this.n;
      int last = -1;
      int c = Reference2ObjectOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2ObjectOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2ObjectOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ObjectOpenCustomHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ObjectOpenCustomHashMap.this.size - this.c
            : Math.min(
               Reference2ObjectOpenCustomHashMap.this.size - this.c,
               (long)((double)Reference2ObjectOpenCustomHashMap.this.realSize() / Reference2ObjectOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ObjectOpenCustomHashMap<K, V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Reference2ObjectOpenCustomHashMap<K, V>.MapSpliterator<Consumer<? super V>, Reference2ObjectOpenCustomHashMap<K, V>.ValueSpliterator>
      ...
      final Reference2ObjectOpenCustomHashMap<K, V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ObjectOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
