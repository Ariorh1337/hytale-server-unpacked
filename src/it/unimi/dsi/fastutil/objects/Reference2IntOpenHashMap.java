...
public class Reference2IntOpenHashMap<K> extends AbstractReference2IntMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Reference2IntOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      int[] value = this.value;
      Reference2IntOpenHashMap<K>.EntryIterator i = new Reference2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2IntOpenHashMap<K>.MapIterator<Consumer<? super Reference2IntMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2IntMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2IntOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2IntMap.Entry<K>>, Reference2IntOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2IntMap.Entry<K>> action, int index) {
         action.accept(Reference2IntOpenHashMap.this.new MapEntry(index));
      }

      final Reference2IntOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2IntOpenHashMap<K>.MapIterator<Consumer<? super Reference2IntMap.Entry<K>>>
      implements ObjectIterator<Reference2IntMap.Entry<K>> {
      private final Reference2IntOpenHashMap<K>.MapEntry entry = Reference2IntOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2IntOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2IntOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2IntOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2IntOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2IntOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2IntOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2IntMap.Entry<K>, Entry<K, Integer>, ReferenceIntPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2IntOpenHashMap.this.key[this.index] == e.getKey() && Reference2IntOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements Reference2IntMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2IntMap.Entry<K>> spliterator() {
         return Reference2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
         if (Reference2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2IntOpenHashMap.this.new MapEntry(Reference2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2IntOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2IntMap.Entry<K>> consumer) {
         Reference2IntOpenHashMap<K>.MapEntry entry = Reference2IntOpenHashMap.this.new MapEntry();
         if (Reference2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2IntOpenHashMap.this.n;
      int last = -1;
      int c = Reference2IntOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2IntOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2IntOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2IntOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2IntOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2IntOpenHashMap.this.size - this.c
            : Math.min(
               Reference2IntOpenHashMap.this.size - this.c,
               (long)((double)Reference2IntOpenHashMap.this.realSize() / Reference2IntOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2IntOpenHashMap<K>.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Reference2IntOpenHashMap<K>.MapSpliterator<IntConsumer, Reference2IntOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2IntOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
