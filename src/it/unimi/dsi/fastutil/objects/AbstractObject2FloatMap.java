...
public abstract class AbstractObject2FloatMap<K> extends AbstractObject2FloatFunction<K> implements Object2FloatMap<K>, Serializable {
   ...
   public boolean containsKey(Object k) {
      ObjectIterator<Object2FloatMap.Entry<K>> i = this.object2FloatEntrySet().iterator();
   ...
   public void putAll(Map<? extends K, ? extends Float> m) {
      if (m instanceof Object2FloatMap) {
         ...
         while (i.hasNext()) {
            Object2FloatMap.Entry<? extends K> e = i.next();
   ...
   public boolean equals(Object o) {
      ...
      Map<?, ?> m = (Map<?, ?>)o;
      return m.size() != this.size() ? false : this.object2FloatEntrySet().containsAll(m.entrySet());
   }
   ...
   public static class BasicEntry<K> implements Object2FloatMap.Entry<K> {
      ...
      public boolean equals(Object o) {
         if (!(o instanceof Entry)) {
            return false;
         } else if (o instanceof Object2FloatMap.Entry) {
            Object2FloatMap.Entry<K> e = (Object2FloatMap.Entry<K>)o;
            ...
            return value != null && value instanceof Float
               ? Objects.equals(this.key, key) && Float.floatToIntBits(this.value) == Float.floatToIntBits((Float)value)
               : false;
         }
      }
