...
public class Object2ReferenceOpenHashMap<K, V> extends AbstractObject2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Object2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      V[] value = this.value;
      Object2ReferenceOpenHashMap<K, V>.EntryIterator i = new Object2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(this.entry = Object2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super Object2ReferenceMap.Entry<K, V>>, Object2ReferenceOpenHashMap<K, V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(Object2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Object2ReferenceOpenHashMap<K, V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2ReferenceOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super K>, Object2ReferenceOpenHashMap<K, V>.KeySpliterator>
      ...
      final Object2ReferenceOpenHashMap<K, V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2ReferenceMap.Entry<K, V>, Entry<K, V>, ObjectReferencePair<K, V> {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(Object2ReferenceOpenHashMap.this.key[this.index], e.getKey())
            && Object2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceMap.FastEntrySet<K, V> {
      ...
      public ObjectSpliterator<Object2ReferenceMap.Entry<K, V>> spliterator() {
         return Object2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
         if (Object2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Object2ReferenceOpenHashMap.this.new MapEntry(Object2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2ReferenceOpenHashMap.this.key[pos] != null) {
               consumer.accept(Object2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> consumer) {
         Object2ReferenceOpenHashMap<K, V>.MapEntry entry = Object2ReferenceOpenHashMap.this.new MapEntry();
         if (Object2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2ReferenceOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2ReferenceOpenHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Object2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Object2ReferenceOpenHashMap.this.realSize() / Object2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Object2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super V>, Object2ReferenceOpenHashMap<K, V>.ValueSpliterator>
      ...
      final Object2ReferenceOpenHashMap<K, V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
