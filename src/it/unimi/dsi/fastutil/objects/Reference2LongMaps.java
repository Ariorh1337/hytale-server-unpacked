...
public final class Reference2LongMaps {
   ...
   public static <K> Reference2LongMap<K> singleton(K key, long value) {
      return new Reference2LongMaps.Singleton<>(key, value);
   }
