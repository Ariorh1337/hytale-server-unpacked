...
public class Object2LongAVLTreeMap<K> extends AbstractObject2LongSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2LongAVLTreeMap.Entry<K> parent(Object2LongAVLTreeMap.Entry<K> e) {
      ...
      Object2LongAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2LongAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2LongMap.Entry<K>>() {
            final Comparator<? super Object2LongMap.Entry<K>> comparator = Object2LongAVLTreeMap.this.actualComparator == null
               ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey())
               : (x, y) -> Object2LongAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
   ...
   private final class Submap extends AbstractObject2LongSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2LongAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2LongAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2LongAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2LongSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2LongAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2LongAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2LongSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2LongAVLTreeMap.this.compare(from, (K)this.from) > 0 ? Object2LongAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2LongSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2LongAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2LongAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2LongAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2LongAVLTreeMap.this.locateKey((K)this.from);
            if (Object2LongAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2LongAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2LongAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2LongAVLTreeMap.this.locateKey((K)this.to);
            if (Object2LongAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2LongAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2LongAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2LongAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2LongAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
