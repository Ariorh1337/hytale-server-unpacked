...
public interface Object2DoubleMap<K> extends Object2DoubleFunction<K>, Map<K, Double> {
   ...
   default void forEach(BiConsumer<? super K, ? super Double> consumer) {
      ...
      Consumer<Object2DoubleMap.Entry<K>> wrappingConsumer = entry -> consumer.accept(entry.getKey(), entry.getDoubleValue());
   ...
   interface Entry<K> extends java.util.Map.Entry<K, Double> {
