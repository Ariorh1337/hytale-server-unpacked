...
public class Reference2ReferenceOpenHashMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Reference2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      V[] value = this.value;
      Reference2ReferenceOpenHashMap<K, V>.EntryIterator i = new Reference2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(this.entry = Reference2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>, Reference2ReferenceOpenHashMap<K, V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action, int index) {
         action.accept(Reference2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Reference2ReferenceOpenHashMap<K, V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super Reference2ReferenceMap.Entry<K, V>>>
      implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> {
      private final Reference2ReferenceOpenHashMap<K, V>.MapEntry entry = Reference2ReferenceOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2ReferenceOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2ReferenceOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super K>, Reference2ReferenceOpenHashMap<K, V>.KeySpliterator>
      ...
      final Reference2ReferenceOpenHashMap<K, V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2ReferenceMap.Entry<K, V>, Entry<K, V>, ReferenceReferencePair<K, V> {
      ...
      @Override
      public int hashCode() {
         return System.identityHashCode(Reference2ReferenceOpenHashMap.this.key[this.index])
            ^ (
               Reference2ReferenceOpenHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Reference2ReferenceOpenHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
      ...
      public ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> spliterator() {
         return Reference2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
         if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2ReferenceOpenHashMap.this.new MapEntry(Reference2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2ReferenceOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> consumer) {
         Reference2ReferenceOpenHashMap<K, V>.MapEntry entry = Reference2ReferenceOpenHashMap.this.new MapEntry();
         if (Reference2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2ReferenceOpenHashMap.this.n;
      int last = -1;
      int c = Reference2ReferenceOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2ReferenceOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ReferenceOpenHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Reference2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Reference2ReferenceOpenHashMap.this.realSize() / Reference2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ReferenceOpenHashMap<K, V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Reference2ReferenceOpenHashMap<K, V>.MapSpliterator<Consumer<? super V>, Reference2ReferenceOpenHashMap<K, V>.ValueSpliterator>
      ...
      final Reference2ReferenceOpenHashMap<K, V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
