...
public interface Object2LongMap<K> extends Object2LongFunction<K>, Map<K, Long> {
   ...
   default void forEach(BiConsumer<? super K, ? super Long> consumer) {
      ...
      Consumer<Object2LongMap.Entry<K>> wrappingConsumer = entry -> consumer.accept(entry.getKey(), entry.getLongValue());
   ...
   interface Entry<K> extends java.util.Map.Entry<K, Long> {
      long getLongValue();
