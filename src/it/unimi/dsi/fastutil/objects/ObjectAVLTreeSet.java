...
public class ObjectAVLTreeSet<K> extends AbstractObjectSortedSet<K> implements Serializable, Cloneable, ObjectSortedSet<K> {
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  ObjectAVLTreeSet.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   private final class Subset extends AbstractObjectSortedSet<K> implements Serializable, ObjectSortedSet<K> {
      ...
      final boolean in(K k) {
         return (this.bottom || ObjectAVLTreeSet.this.compare(k, (K)this.from) >= 0) && (this.top || ObjectAVLTreeSet.this.compare(k, (K)this.to) < 0);
      }
      ...
      public ObjectSortedSet<K> headSet(K to) {
         if (this.top) {
            ...
            return ObjectAVLTreeSet.this.compare(to, (K)this.to) < 0 ? ObjectAVLTreeSet.this.new Subset(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public ObjectSortedSet<K> tailSet(K from) {
         if (this.bottom) {
            ...
            return ObjectAVLTreeSet.this.compare(from, (K)this.from) > 0 ? ObjectAVLTreeSet.this.new Subset(from, false, this.to, this.top) : this;
         }
      }
      ...
      public ObjectSortedSet<K> subSet(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(ObjectAVLTreeSet.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(ObjectAVLTreeSet.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public ObjectAVLTreeSet.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = ObjectAVLTreeSet.this.locateKey((K)this.from);
            if (ObjectAVLTreeSet.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || ObjectAVLTreeSet.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public ObjectAVLTreeSet.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = ObjectAVLTreeSet.this.locateKey((K)this.to);
            if (ObjectAVLTreeSet.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || ObjectAVLTreeSet.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private final class SubsetIterator extends ObjectAVLTreeSet<K>.SetIterator {
         ...
         void updatePrevious() {
            this.prev = this.prev.prev();
            if (!Subset.this.bottom && this.prev != null && ObjectAVLTreeSet.this.compare(this.prev.key, (K)Subset.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Subset.this.top && this.next != null && ObjectAVLTreeSet.this.compare(this.next.key, (K)Subset.this.to) >= 0) {
               this.next = null;
            }
         }
      }
