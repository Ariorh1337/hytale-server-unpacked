...
public class Reference2ByteOpenCustomHashMap<K> extends AbstractReference2ByteMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Reference2ByteOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      byte[] value = this.value;
      Reference2ByteOpenCustomHashMap<K>.EntryIterator i = new Reference2ByteOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ByteOpenCustomHashMap<K>.MapIterator<Consumer<? super Reference2ByteMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2ByteOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2ByteOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Reference2ByteMap.Entry<K>>, Reference2ByteOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
         action.accept(Reference2ByteOpenCustomHashMap.this.new MapEntry(index));
      }

      final Reference2ByteOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2ByteOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2ByteOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2ByteOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2ByteOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Reference2ByteOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Reference2ByteMap.Entry<K>, Entry<K, Byte>, ReferenceBytePair<K> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Reference2ByteOpenCustomHashMap.this.strategy.equals(Reference2ByteOpenCustomHashMap.this.key[this.index], e.getKey())
            && Reference2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements Reference2ByteMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2ByteMap.Entry<K>> spliterator() {
         return Reference2ByteOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Byte) {
            ...
            if (Reference2ByteOpenCustomHashMap.this.strategy.equals(k, null)) {
               return Reference2ByteOpenCustomHashMap.this.containsNullKey
                  && Reference2ByteOpenCustomHashMap.this.value[Reference2ByteOpenCustomHashMap.this.n] == v;
            }

            K[] key = Reference2ByteOpenCustomHashMap.this.key;
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Reference2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2ByteOpenCustomHashMap.this.mask])
               == null) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
         if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Reference2ByteOpenCustomHashMap.this.new MapEntry(Reference2ByteOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2ByteOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Reference2ByteOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
         Reference2ByteOpenCustomHashMap<K>.MapEntry entry = Reference2ByteOpenCustomHashMap.this.new MapEntry();
         if (Reference2ByteOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2ByteOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2ByteOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ByteOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ByteOpenCustomHashMap.this.size - this.c
            : Math.min(
               Reference2ByteOpenCustomHashMap.this.size - this.c,
               (long)((double)Reference2ByteOpenCustomHashMap.this.realSize() / Reference2ByteOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ByteOpenCustomHashMap<K>.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Reference2ByteOpenCustomHashMap<K>.MapSpliterator<ByteConsumer, Reference2ByteOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Reference2ByteOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
