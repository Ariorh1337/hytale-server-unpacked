...
public class Reference2FloatOpenHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Reference2FloatOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      float[] value = this.value;
      Reference2FloatOpenHashMap<K>.EntryIterator i = new Reference2FloatOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2FloatOpenHashMap<K>.MapIterator<Consumer<? super Reference2FloatMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2FloatMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2FloatOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2FloatOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2FloatMap.Entry<K>>, Reference2FloatOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2FloatMap.Entry<K>> action, int index) {
         action.accept(Reference2FloatOpenHashMap.this.new MapEntry(index));
      }

      final Reference2FloatOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2FloatOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2FloatOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2FloatOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2FloatOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2FloatOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2FloatMap.Entry<K>, Entry<K, Float>, ReferenceFloatPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2FloatOpenHashMap.this.key[this.index] == e.getKey()
            && Float.floatToIntBits(Reference2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return System.identityHashCode(Reference2FloatOpenHashMap.this.key[this.index])
            ^ HashCommon.float2int(Reference2FloatOpenHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements Reference2FloatMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2FloatMap.Entry<K>> spliterator() {
         return Reference2FloatOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
         if (Reference2FloatOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2FloatOpenHashMap.this.new MapEntry(Reference2FloatOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2FloatOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2FloatOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
         Reference2FloatOpenHashMap<K>.MapEntry entry = Reference2FloatOpenHashMap.this.new MapEntry();
         if (Reference2FloatOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2FloatOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2FloatOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2FloatOpenHashMap.this.size - this.c
            : Math.min(
               Reference2FloatOpenHashMap.this.size - this.c,
               (long)((double)Reference2FloatOpenHashMap.this.realSize() / Reference2FloatOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2FloatOpenHashMap<K>.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Reference2FloatOpenHashMap<K>.MapSpliterator<FloatConsumer, Reference2FloatOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2FloatOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
