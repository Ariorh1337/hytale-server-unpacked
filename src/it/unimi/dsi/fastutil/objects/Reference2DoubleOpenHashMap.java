...
public class Reference2DoubleOpenHashMap<K> extends AbstractReference2DoubleMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Reference2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      double[] value = this.value;
      Reference2DoubleOpenHashMap<K>.EntryIterator i = new Reference2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2DoubleOpenHashMap<K>.MapIterator<Consumer<? super Reference2DoubleMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2DoubleMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2DoubleOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2DoubleMap.Entry<K>>, Reference2DoubleOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2DoubleMap.Entry<K>> action, int index) {
         action.accept(Reference2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Reference2DoubleOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2DoubleOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2DoubleOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2DoubleOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2DoubleOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2DoubleMap.Entry<K>, Entry<K, Double>, ReferenceDoublePair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2DoubleOpenHashMap.this.key[this.index] == e.getKey()
            && Double.doubleToLongBits(Reference2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return System.identityHashCode(Reference2DoubleOpenHashMap.this.key[this.index])
            ^ HashCommon.double2int(Reference2DoubleOpenHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2DoubleMap.Entry<K>> spliterator() {
         return Reference2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
         if (Reference2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2DoubleOpenHashMap.this.new MapEntry(Reference2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2DoubleOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2DoubleMap.Entry<K>> consumer) {
         Reference2DoubleOpenHashMap<K>.MapEntry entry = Reference2DoubleOpenHashMap.this.new MapEntry();
         if (Reference2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2DoubleOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2DoubleOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Reference2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Reference2DoubleOpenHashMap.this.realSize() / Reference2DoubleOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2DoubleOpenHashMap<K>.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Reference2DoubleOpenHashMap<K>.MapSpliterator<DoubleConsumer, Reference2DoubleOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2DoubleOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
