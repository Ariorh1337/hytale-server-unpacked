...
public class Reference2ShortOpenHashMap<K> extends AbstractReference2ShortMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Reference2ShortOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      short[] value = this.value;
      Reference2ShortOpenHashMap<K>.EntryIterator i = new Reference2ShortOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ShortOpenHashMap<K>.MapIterator<Consumer<? super Reference2ShortMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ShortMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2ShortOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2ShortOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2ShortMap.Entry<K>>, Reference2ShortOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ShortMap.Entry<K>> action, int index) {
         action.accept(Reference2ShortOpenHashMap.this.new MapEntry(index));
      }

      final Reference2ShortOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ShortOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2ShortOpenHashMap<K>.MapIterator<Consumer<? super Reference2ShortMap.Entry<K>>>
      implements ObjectIterator<Reference2ShortMap.Entry<K>> {
      private final Reference2ShortOpenHashMap<K>.MapEntry entry = Reference2ShortOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2ShortOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2ShortOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2ShortOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2ShortOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2ShortOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2ShortOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ShortOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2ShortMap.Entry<K>, Entry<K, Short>, ReferenceShortPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2ShortOpenHashMap.this.key[this.index] == e.getKey() && Reference2ShortOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ShortMap.Entry<K>> implements Reference2ShortMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2ShortMap.Entry<K>> spliterator() {
         return Reference2ShortOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Short) {
            ...
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2ShortOpenHashMap.this.mask]) == null) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Reference2ShortOpenHashMap.this.mask]) != null) {
               if (k == curr) {
                  return Reference2ShortOpenHashMap.this.value[pos] == v;
               }
            }
         ...
         if (e.getValue() != null && e.getValue() instanceof Short) {
            ...
            if (k == null) {
               ...
               if (curr == k) {
                  ...
                  while ((curr = key[pos = pos + 1 & Reference2ShortOpenHashMap.this.mask]) != null) {
                     if (curr == k && Reference2ShortOpenHashMap.this.value[pos] == v) {
                        Reference2ShortOpenHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
         if (Reference2ShortOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2ShortOpenHashMap.this.new MapEntry(Reference2ShortOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2ShortOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2ShortOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2ShortMap.Entry<K>> consumer) {
         Reference2ShortOpenHashMap<K>.MapEntry entry = Reference2ShortOpenHashMap.this.new MapEntry();
         if (Reference2ShortOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2ShortOpenHashMap.this.n;
      int last = -1;
      int c = Reference2ShortOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2ShortOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2ShortOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2ShortOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ShortOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ShortOpenHashMap.this.size - this.c
            : Math.min(
               Reference2ShortOpenHashMap.this.size - this.c,
               (long)((double)Reference2ShortOpenHashMap.this.realSize() / Reference2ShortOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ShortOpenHashMap<K>.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Reference2ShortOpenHashMap<K>.MapSpliterator<ShortConsumer, Reference2ShortOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2ShortOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ShortOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
