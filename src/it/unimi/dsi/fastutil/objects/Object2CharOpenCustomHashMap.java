...
public class Object2CharOpenCustomHashMap<K> extends AbstractObject2CharMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Object2CharOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      char[] value = this.value;
      Object2CharOpenCustomHashMap<K>.EntryIterator i = new Object2CharOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2CharOpenCustomHashMap<K>.MapIterator<Consumer<? super Object2CharMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2CharMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2CharOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2CharOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Object2CharMap.Entry<K>>, Object2CharOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2CharMap.Entry<K>> action, int index) {
         action.accept(Object2CharOpenCustomHashMap.this.new MapEntry(index));
      }

      final Object2CharOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2CharOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Object2CharOpenCustomHashMap<K>.MapIterator<Consumer<? super Object2CharMap.Entry<K>>>
      implements ObjectIterator<Object2CharMap.Entry<K>> {
      private final Object2CharOpenCustomHashMap<K>.MapEntry entry = Object2CharOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Object2CharOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2CharOpenCustomHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Object2CharOpenCustomHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Object2CharOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Object2CharOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Object2CharOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2CharOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2CharMap.Entry<K>, Entry<K, Character>, ObjectCharPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[this.index], e.getKey())
            && Object2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Object2CharOpenCustomHashMap.this.strategy.hashCode(Object2CharOpenCustomHashMap.this.key[this.index])
            ^ Object2CharOpenCustomHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<K>> implements Object2CharMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2CharMap.Entry<K>> spliterator() {
         return Object2CharOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask]) == null) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask]) != null) {
               if (Object2CharOpenCustomHashMap.this.strategy.equals(k, curr)) {
                  return Object2CharOpenCustomHashMap.this.value[pos] == v;
               }
            }
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            if (Object2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
               ...
               if (Object2CharOpenCustomHashMap.this.strategy.equals(curr, k)) {
                  ...
                  while ((curr = key[pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask]) != null) {
                     if (Object2CharOpenCustomHashMap.this.strategy.equals(curr, k) && Object2CharOpenCustomHashMap.this.value[pos] == v) {
                        Object2CharOpenCustomHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
         if (Object2CharOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Object2CharOpenCustomHashMap.this.new MapEntry(Object2CharOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2CharOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Object2CharOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2CharMap.Entry<K>> consumer) {
         Object2CharOpenCustomHashMap<K>.MapEntry entry = Object2CharOpenCustomHashMap.this.new MapEntry();
         if (Object2CharOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Object2CharOpenCustomHashMap.this.n;
      int last = -1;
      int c = Object2CharOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2CharOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2CharOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2CharOpenCustomHashMap.this.size - this.c
            : Math.min(
               Object2CharOpenCustomHashMap.this.size - this.c,
               (long)((double)Object2CharOpenCustomHashMap.this.realSize() / Object2CharOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2CharOpenCustomHashMap<K>.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Object2CharOpenCustomHashMap<K>.MapSpliterator<CharConsumer, Object2CharOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Object2CharOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2CharOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
