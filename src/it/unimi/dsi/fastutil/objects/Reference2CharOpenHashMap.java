...
public class Reference2CharOpenHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Reference2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      char[] value = this.value;
      Reference2CharOpenHashMap<K>.EntryIterator i = new Reference2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2CharOpenHashMap<K>.MapIterator<Consumer<? super Reference2CharMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2CharMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2CharOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2CharMap.Entry<K>>, Reference2CharOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2CharMap.Entry<K>> action, int index) {
         action.accept(Reference2CharOpenHashMap.this.new MapEntry(index));
      }

      final Reference2CharOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2CharOpenHashMap<K>.MapIterator<Consumer<? super Reference2CharMap.Entry<K>>>
      implements ObjectIterator<Reference2CharMap.Entry<K>> {
      private final Reference2CharOpenHashMap<K>.MapEntry entry = Reference2CharOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2CharOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2CharOpenHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2CharOpenHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2CharOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2CharOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2CharOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2CharMap.Entry<K>, Entry<K, Character>, ReferenceCharPair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2CharOpenHashMap.this.key[this.index] == e.getKey() && Reference2CharOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2CharMap.Entry<K>> spliterator() {
         return Reference2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(System.identityHashCode(k)) & Reference2CharOpenHashMap.this.mask]) == null) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Reference2CharOpenHashMap.this.mask]) != null) {
               if (k == curr) {
                  return Reference2CharOpenHashMap.this.value[pos] == v;
               }
            }
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            if (k == null) {
               ...
               if (curr == k) {
                  ...
                  while ((curr = key[pos = pos + 1 & Reference2CharOpenHashMap.this.mask]) != null) {
                     if (curr == k && Reference2CharOpenHashMap.this.value[pos] == v) {
                        Reference2CharOpenHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
         if (Reference2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2CharOpenHashMap.this.new MapEntry(Reference2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2CharOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
         Reference2CharOpenHashMap<K>.MapEntry entry = Reference2CharOpenHashMap.this.new MapEntry();
         if (Reference2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2CharOpenHashMap.this.n;
      int last = -1;
      int c = Reference2CharOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2CharOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2CharOpenHashMap.this.mask; (curr = key[pos]) != null; pos = pos + 1 & Reference2CharOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2CharOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2CharOpenHashMap.this.size - this.c
            : Math.min(
               Reference2CharOpenHashMap.this.size - this.c,
               (long)((double)Reference2CharOpenHashMap.this.realSize() / Reference2CharOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2CharOpenHashMap<K>.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Reference2CharOpenHashMap<K>.MapSpliterator<CharConsumer, Reference2CharOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2CharOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
