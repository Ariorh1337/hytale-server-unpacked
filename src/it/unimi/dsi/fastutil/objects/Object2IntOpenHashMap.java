   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2IntOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2IntOpenHashMap.this.size - this.c
            : Math.min(
               Object2IntOpenHashMap.this.size - this.c,
               (long)((double)Object2IntOpenHashMap.this.realSize() / Object2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
