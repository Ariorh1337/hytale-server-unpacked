...
public class Object2ReferenceArrayMap<K, V> extends AbstractObject2ReferenceMap<K, V> implements Serializable, Cloneable {
   ...
   public Object2ReferenceArrayMap(Object2ReferenceMap<K, V> m) {
      ...
      for (Object2ReferenceMap.Entry<K, V> e : m.object2ReferenceEntrySet()) {
         this.key[i] = e.getKey();
   ...
   public Object2ReferenceMap.FastEntrySet<K, V> object2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Object2ReferenceArrayMap.EntrySet();
      }
   ...
   public ObjectSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Object2ReferenceArrayMap.KeySet();
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new Object2ReferenceArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceMap.FastEntrySet<K, V> {
         ...
         return new ObjectIterator<Object2ReferenceMap.Entry<K, V>>() {
            ...
            public Object2ReferenceMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractObject2ReferenceMap.BasicEntry<>(
                     (K)Object2ReferenceArrayMap.this.key[this.curr = this.next], (V)Object2ReferenceArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Object2ReferenceMap.Entry<K, V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractObject2ReferenceMap.BasicEntry<>(
                        (K)Object2ReferenceArrayMap.this.key[this.curr = this.next], (V)Object2ReferenceArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Object2ReferenceMap.Entry<K, V>> spliterator() {
         return new Object2ReferenceArrayMap.EntrySet.EntrySetSpliterator(0, Object2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Object2ReferenceMap.Entry<K, V>> action) {
         ...
         for (int max = Object2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractObject2ReferenceMap.BasicEntry<>((K)Object2ReferenceArrayMap.this.key[i], (V)Object2ReferenceArrayMap.this.value[i]));
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Object2ReferenceMap.Entry<K, V> get(int location) {
            return new AbstractObject2ReferenceMap.BasicEntry<>(
               (K)Object2ReferenceArrayMap.this.key[location], (V)Object2ReferenceArrayMap.this.value[location]
            );
         }

         protected final Object2ReferenceArrayMap<K, V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return new ObjectIterator<K>() {
            ...
            public void forEachRemaining(Consumer<? super K> action) {
               ...
               while (this.pos < max) {
                  action.accept((K)Object2ReferenceArrayMap.this.key[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<K> spliterator() {
         return new Object2ReferenceArrayMap.KeySet.KeySetSpliterator(0, Object2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super K> action) {
         ...
         for (int max = Object2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((K)Object2ReferenceArrayMap.this.key[i]);
         }
      }
      ...
      final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
         ...
         protected final Object2ReferenceArrayMap<K, V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractReferenceCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Object2ReferenceArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Object2ReferenceArrayMap.ValuesCollection.ValuesSpliterator(0, Object2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Object2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((V)Object2ReferenceArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final Object2ReferenceArrayMap<K, V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
