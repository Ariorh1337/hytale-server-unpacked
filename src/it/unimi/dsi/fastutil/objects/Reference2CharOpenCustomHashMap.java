...
public class Reference2CharOpenCustomHashMap<K> extends AbstractReference2CharMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Reference2CharOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      char[] value = this.value;
      Reference2CharOpenCustomHashMap<K>.EntryIterator i = new Reference2CharOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2CharOpenCustomHashMap<K>.MapIterator<Consumer<? super Reference2CharMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2CharMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2CharOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2CharOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Reference2CharMap.Entry<K>>, Reference2CharOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2CharMap.Entry<K>> action, int index) {
         action.accept(Reference2CharOpenCustomHashMap.this.new MapEntry(index));
      }

      final Reference2CharOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2CharOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2CharOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2CharOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Reference2CharOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Reference2CharMap.Entry<K>, Entry<K, Character>, ReferenceCharPair<K> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[this.index], e.getKey())
            && Reference2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2CharMap.Entry<K>> spliterator() {
         return Reference2CharOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            if (Reference2CharOpenCustomHashMap.this.strategy.equals(k, null)) {
               return Reference2CharOpenCustomHashMap.this.containsNullKey
                  && Reference2CharOpenCustomHashMap.this.value[Reference2CharOpenCustomHashMap.this.n] == v;
            }

            K[] key = Reference2CharOpenCustomHashMap.this.key;
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Reference2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2CharOpenCustomHashMap.this.mask])
               == null) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
         if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Reference2CharOpenCustomHashMap.this.new MapEntry(Reference2CharOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2CharOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Reference2CharOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2CharMap.Entry<K>> consumer) {
         Reference2CharOpenCustomHashMap<K>.MapEntry entry = Reference2CharOpenCustomHashMap.this.new MapEntry();
         if (Reference2CharOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2CharOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2CharOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2CharOpenCustomHashMap.this.size - this.c
            : Math.min(
               Reference2CharOpenCustomHashMap.this.size - this.c,
               (long)((double)Reference2CharOpenCustomHashMap.this.realSize() / Reference2CharOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Reference2CharOpenCustomHashMap<K>.MapSpliterator<CharConsumer, Reference2CharOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Reference2CharOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2CharOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
