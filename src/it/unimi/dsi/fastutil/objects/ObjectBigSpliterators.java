...
public final class ObjectBigSpliterators {
   ...
   public abstract static class EarlyBindingSizeIndexBasedSpliterator<K> extends ObjectBigSpliterators.AbstractIndexBasedSpliterator<K> {
   ...
   public abstract static class LateBindingSizeIndexBasedSpliterator<K> extends ObjectBigSpliterators.AbstractIndexBasedSpliterator<K> {
