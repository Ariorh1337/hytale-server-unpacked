...
public final class Reference2CharMaps {
   ...
   public static <K> Reference2CharMap<K> singleton(K key, char value) {
      return new Reference2CharMaps.Singleton<>(key, value);
   }
