...
public class Reference2FloatOpenCustomHashMap<K> extends AbstractReference2FloatMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Reference2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      float[] value = this.value;
      Reference2FloatOpenCustomHashMap<K>.EntryIterator i = new Reference2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2FloatOpenCustomHashMap<K>.MapIterator<Consumer<? super Reference2FloatMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2FloatMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2FloatOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Reference2FloatMap.Entry<K>>, Reference2FloatOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2FloatMap.Entry<K>> action, int index) {
         action.accept(Reference2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Reference2FloatOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Reference2FloatOpenCustomHashMap<K>.MapIterator<Consumer<? super Reference2FloatMap.Entry<K>>>
      implements ObjectIterator<Reference2FloatMap.Entry<K>> {
      private final Reference2FloatOpenCustomHashMap<K>.MapEntry entry = Reference2FloatOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
      ...
      public void forEach(Consumer<? super K> consumer) {
         ...
         while (pos-- != 0) {
            K k = Reference2FloatOpenCustomHashMap.this.key[pos];
            if (k != null) {
               consumer.accept(k);
            }
         }
   ...
   private final class KeySpliterator
      extends Reference2FloatOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2FloatOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Reference2FloatOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Reference2FloatMap.Entry<K>, Entry<K, Float>, ReferenceFloatPair<K> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Reference2FloatOpenCustomHashMap.this.strategy.hashCode(Reference2FloatOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.float2int(Reference2FloatOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2FloatMap.Entry<K>> implements Reference2FloatMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2FloatMap.Entry<K>> spliterator() {
         return Reference2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
               return Reference2FloatOpenCustomHashMap.this.containsNullKey
                  && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[Reference2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }

            K[] key = Reference2FloatOpenCustomHashMap.this.key;
            K curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Reference2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Reference2FloatOpenCustomHashMap.this.mask])
               == null) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask]) != null) {
               if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                  return Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
               }
            }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (Reference2FloatOpenCustomHashMap.this.strategy.equals(k, null)) {
               ...
               if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                  ...
                  while ((curr = key[pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask]) != null) {
                     if (Reference2FloatOpenCustomHashMap.this.strategy.equals(curr, k)
                        && Float.floatToIntBits(Reference2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                        Reference2FloatOpenCustomHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
         if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Reference2FloatOpenCustomHashMap.this.new MapEntry(Reference2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2FloatOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Reference2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2FloatMap.Entry<K>> consumer) {
         Reference2FloatOpenCustomHashMap<K>.MapEntry entry = Reference2FloatOpenCustomHashMap.this.new MapEntry();
         if (Reference2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Reference2FloatOpenCustomHashMap.this.n;
      int last = -1;
      int c = Reference2FloatOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            K curr;
            for (pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask;
               (curr = key[pos]) != null;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2FloatOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Reference2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Reference2FloatOpenCustomHashMap.this.realSize() / Reference2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Reference2FloatOpenCustomHashMap<K>.MapSpliterator<FloatConsumer, Reference2FloatOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Reference2FloatOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
