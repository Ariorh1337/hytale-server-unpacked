...
@FunctionalInterface
public interface Object2ByteFunction<K> extends it.unimi.dsi.fastutil.Function<K, Byte>, ToIntFunction<K> {
   @Override
   ...
   default Byte get(Object key) {
      Object k = key;
      byte v;
      return (v = this.getByte(k)) == this.defaultReturnValue() && !this.containsKey(k) ? null : v;
   }
   ...
   default Byte remove(Object key) {
      Object k = key;
      return this.containsKey(k) ? this.removeByte(k) : null;
   }
