...
public interface Object2BooleanMap<K> extends Object2BooleanFunction<K>, Map<K, Boolean> {
   ...
   default void forEach(BiConsumer<? super K, ? super Boolean> consumer) {
      ObjectSet<Object2BooleanMap.Entry<K>> entrySet = this.object2BooleanEntrySet();
      Consumer<Object2BooleanMap.Entry<K>> wrappingConsumer = entry -> consumer.accept(entry.getKey(), entry.getBooleanValue());
      if (entrySet instanceof Object2BooleanMap.FastEntrySet) {
         ((Object2BooleanMap.FastEntrySet)entrySet).fastForEach(wrappingConsumer);
      } else {
   ...
   interface Entry<K> extends java.util.Map.Entry<K, Boolean> {
