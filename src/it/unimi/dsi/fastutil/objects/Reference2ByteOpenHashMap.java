...
public class Reference2ByteOpenHashMap<K> extends AbstractReference2ByteMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Reference2ByteOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      byte[] value = this.value;
      Reference2ByteOpenHashMap<K>.EntryIterator i = new Reference2ByteOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ByteOpenHashMap<K>.MapIterator<Consumer<? super Reference2ByteMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
         action.accept(this.entry = Reference2ByteOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Reference2ByteOpenHashMap<K>.MapSpliterator<Consumer<? super Reference2ByteMap.Entry<K>>, Reference2ByteOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Reference2ByteMap.Entry<K>> action, int index) {
         action.accept(Reference2ByteOpenHashMap.this.new MapEntry(index));
      }

      final Reference2ByteOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Reference2ByteOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Reference2ByteOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Reference2ByteOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Reference2ByteOpenHashMap<K>.KeySpliterator>
      ...
      final Reference2ByteOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Reference2ByteMap.Entry<K>, Entry<K, Byte>, ReferenceBytePair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2ByteOpenHashMap.this.key[this.index] == e.getKey() && Reference2ByteOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements Reference2ByteMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Reference2ByteMap.Entry<K>> spliterator() {
         return Reference2ByteOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
         if (Reference2ByteOpenHashMap.this.containsNullKey) {
            consumer.accept(Reference2ByteOpenHashMap.this.new MapEntry(Reference2ByteOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Reference2ByteOpenHashMap.this.key[pos] != null) {
               consumer.accept(Reference2ByteOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Reference2ByteMap.Entry<K>> consumer) {
         Reference2ByteOpenHashMap<K>.MapEntry entry = Reference2ByteOpenHashMap.this.new MapEntry();
         if (Reference2ByteOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Reference2ByteOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ByteOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ByteOpenHashMap.this.size - this.c
            : Math.min(
               Reference2ByteOpenHashMap.this.size - this.c,
               (long)((double)Reference2ByteOpenHashMap.this.realSize() / Reference2ByteOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ByteOpenHashMap<K>.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Reference2ByteOpenHashMap<K>.MapSpliterator<ByteConsumer, Reference2ByteOpenHashMap<K>.ValueSpliterator>
      ...
      final Reference2ByteOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Reference2ByteOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
