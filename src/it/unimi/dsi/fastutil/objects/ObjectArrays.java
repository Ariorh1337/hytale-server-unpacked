               ...
               while (b > c || (comparison = ((Comparable)x[b]).compareTo(v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ObjectArrays.ForkJoinQuickSort(x, this.from, this.from + s));
                     } else {
                        invokeAll(new ObjectArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = (t = ((Comparable)x[b]).compareTo(v)) == 0 ? ((Comparable)y[b]).compareTo(w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ObjectArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s));
                     } else {
                        invokeAll(new ObjectArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ObjectArrays.ForkJoinQuickSortComp<>(x, this.from, this.from + s, this.comp));
                     } else {
                        invokeAll(new ObjectArrays.ForkJoinQuickSortComp<>(x, this.to - comparison, this.to, this.comp));
                     }
               ...
               while (b > c || (comparison = ((Comparable)x[this.perm[b]]).compareTo(v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s));
                     } else {
                        invokeAll(new ObjectArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - comparison, this.to));
                     }
