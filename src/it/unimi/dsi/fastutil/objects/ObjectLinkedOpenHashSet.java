      ...
      public void remove() {
         ...
         if (this.prev == -1) {
            ...
            ObjectLinkedOpenHashSet.this.link[this.prev] = ObjectLinkedOpenHashSet.this.link[this.prev]
               ^ (ObjectLinkedOpenHashSet.this.link[this.prev] ^ this.next & 4294967295L) & 4294967295L;
         }
         ...
         if (this.next == -1) {
            ...
            ObjectLinkedOpenHashSet.this.link[this.next] = ObjectLinkedOpenHashSet.this.link[this.next]
               ^ (ObjectLinkedOpenHashSet.this.link[this.next] ^ (this.prev & 4294967295L) << 32) & -4294967296L;
         }
