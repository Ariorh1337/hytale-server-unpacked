...
public class Object2ShortAVLTreeMap<K> extends AbstractObject2ShortSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2ShortAVLTreeMap.Entry<K> parent(Object2ShortAVLTreeMap.Entry<K> e) {
      ...
      Object2ShortAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2ShortAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2ShortMap.Entry<K>>() {
            final Comparator<? super Object2ShortMap.Entry<K>> comparator = Object2ShortAVLTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2ShortSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2ShortAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2ShortAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2ShortAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2ShortSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2ShortAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2ShortAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2ShortSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2ShortAVLTreeMap.this.compare(from, (K)this.from) > 0 ? Object2ShortAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2ShortSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2ShortAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2ShortAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2ShortAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2ShortAVLTreeMap.this.locateKey((K)this.from);
            if (Object2ShortAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2ShortAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2ShortAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2ShortAVLTreeMap.this.locateKey((K)this.to);
            if (Object2ShortAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2ShortAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2ShortAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2ShortAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2ShortAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
