...
public class Object2IntAVLTreeMap<K> extends AbstractObject2IntSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2IntAVLTreeMap.Entry<K> parent(Object2IntAVLTreeMap.Entry<K> e) {
      ...
      Object2IntAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2IntAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2IntMap.Entry<K>>() {
            final Comparator<? super Object2IntMap.Entry<K>> comparator = Object2IntAVLTreeMap.this.actualComparator == null
               ? (x, y) -> ((Comparable)x.getKey()).compareTo(y.getKey())
               : (x, y) -> Object2IntAVLTreeMap.this.actualComparator.compare(x.getKey(), y.getKey());
   ...
   private final class Submap extends AbstractObject2IntSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2IntAVLTreeMap.this.compare(k, (K)this.from) >= 0) && (this.top || Object2IntAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2IntAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2IntSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2IntAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2IntAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2IntSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2IntAVLTreeMap.this.compare(from, (K)this.from) > 0 ? Object2IntAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2IntSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2IntAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2IntAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2IntAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2IntAVLTreeMap.this.locateKey((K)this.from);
            if (Object2IntAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2IntAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2IntAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2IntAVLTreeMap.this.locateKey((K)this.to);
            if (Object2IntAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2IntAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2IntAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2IntAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2IntAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
