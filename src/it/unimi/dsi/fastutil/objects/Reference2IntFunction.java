...
@FunctionalInterface
public interface Reference2IntFunction<K> extends it.unimi.dsi.fastutil.Function<K, Integer>, ToIntFunction<K> {
   @Override
   ...
   default Integer get(Object key) {
      Object k = key;
      int v;
      return (v = this.getInt(k)) == this.defaultReturnValue() && !this.containsKey(k) ? null : v;
   }
   ...
   default Integer remove(Object key) {
      Object k = key;
      return this.containsKey(k) ? this.removeInt(k) : null;
   }
