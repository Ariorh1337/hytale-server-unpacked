...
public class Object2ObjectArrayMap<K, V> extends AbstractObject2ObjectMap<K, V> implements Serializable, Cloneable {
   ...
   private final class EntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectMap.FastEntrySet<K, V> {
         ...
         return new ObjectIterator<Object2ObjectMap.Entry<K, V>>() {
            ...
            public Object2ObjectMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractObject2ObjectMap.BasicEntry<>(
                     (K)Object2ObjectArrayMap.this.key[this.curr = this.next], (V)Object2ObjectArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Object2ObjectMap.Entry<K, V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractObject2ObjectMap.BasicEntry<>(
                        (K)Object2ObjectArrayMap.this.key[this.curr = this.next], (V)Object2ObjectArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public void forEach(Consumer<? super Object2ObjectMap.Entry<K, V>> action) {
         ...
         for (int max = Object2ObjectArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractObject2ObjectMap.BasicEntry<>((K)Object2ObjectArrayMap.this.key[i], (V)Object2ObjectArrayMap.this.value[i]));
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Object2ObjectMap.Entry<K, V> get(int location) {
            return new AbstractObject2ObjectMap.BasicEntry<>((K)Object2ObjectArrayMap.this.key[location], (V)Object2ObjectArrayMap.this.value[location]);
         }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return new ObjectIterator<K>() {
            ...
            public void forEachRemaining(Consumer<? super K> action) {
               ...
               while (this.pos < max) {
                  action.accept((K)Object2ObjectArrayMap.this.key[this.pos++]);
               }
            }
         };
      }
      ...
      public void forEach(Consumer<? super K> action) {
         ...
         for (int max = Object2ObjectArrayMap.this.size; i < max; i++) {
            action.accept((K)Object2ObjectArrayMap.this.key[i]);
         }
      }
   ...
   private final class ValuesCollection extends AbstractObjectCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Object2ObjectArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Object2ObjectArrayMap.this.size; i < max; i++) {
            action.accept((V)Object2ObjectArrayMap.this.value[i]);
         }
      }
