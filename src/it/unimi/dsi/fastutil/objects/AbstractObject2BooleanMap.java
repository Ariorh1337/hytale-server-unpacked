...
public abstract class AbstractObject2BooleanMap<K> extends AbstractObject2BooleanFunction<K> implements Object2BooleanMap<K>, Serializable {
   ...
   public boolean containsKey(Object k) {
      ObjectIterator<Object2BooleanMap.Entry<K>> i = this.object2BooleanEntrySet().iterator();
   ...
   public void putAll(Map<? extends K, ? extends Boolean> m) {
      if (m instanceof Object2BooleanMap) {
         ...
         while (i.hasNext()) {
            Object2BooleanMap.Entry<? extends K> e = i.next();
   ...
   public boolean equals(Object o) {
      ...
      Map<?, ?> m = (Map<?, ?>)o;
      return m.size() != this.size() ? false : this.object2BooleanEntrySet().containsAll(m.entrySet());
   }
   ...
   public static class BasicEntry<K> implements Object2BooleanMap.Entry<K> {
      ...
      public boolean equals(Object o) {
         if (!(o instanceof Entry)) {
            return false;
         } else if (o instanceof Object2BooleanMap.Entry) {
            Object2BooleanMap.Entry<K> e = (Object2BooleanMap.Entry<K>)o;
            return Objects.equals(this.key, e.getKey()) && this.value == e.getBooleanValue();
         } else {
            Entry<?, ?> e = (Entry<?, ?>)o;
            Object key = e.getKey();
            Object value = e.getValue();
            return value != null && value instanceof Boolean ? Objects.equals(this.key, key) && this.value == (Boolean)value : false;
         }
      }
