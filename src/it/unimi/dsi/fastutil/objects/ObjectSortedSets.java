...
public final class ObjectSortedSets {
   ...
   public static class Singleton<K> extends ObjectSets.Singleton<K> implements ObjectSortedSet<K>, Serializable, Cloneable {
      ...
      @Override
      public ObjectSortedSet<K> subSet(K from, K to) {
         return this.compare(from, this.element) <= 0 && this.compare(this.element, to) < 0 ? this : ObjectSortedSets.EMPTY_SET;
      }

      @Override
      public ObjectSortedSet<K> headSet(K to) {
         return this.compare(this.element, to) < 0 ? this : ObjectSortedSets.EMPTY_SET;
      }

      @Override
      public ObjectSortedSet<K> tailSet(K from) {
         return this.compare(from, this.element) <= 0 ? this : ObjectSortedSets.EMPTY_SET;
      }
