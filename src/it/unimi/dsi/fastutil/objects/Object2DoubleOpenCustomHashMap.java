...
public class Object2DoubleOpenCustomHashMap<K> extends AbstractObject2DoubleMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Object2DoubleOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      double[] value = this.value;
      Object2DoubleOpenCustomHashMap<K>.EntryIterator i = new Object2DoubleOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2DoubleOpenCustomHashMap<K>.MapIterator<Consumer<? super Object2DoubleMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2DoubleMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2DoubleOpenCustomHashMap<K>.MapSpliterator<Consumer<? super Object2DoubleMap.Entry<K>>, Object2DoubleOpenCustomHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2DoubleMap.Entry<K>> action, int index) {
         action.accept(Object2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }

      final Object2DoubleOpenCustomHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2DoubleOpenCustomHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2DoubleOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2DoubleOpenCustomHashMap<K>.MapSpliterator<Consumer<? super K>, Object2DoubleOpenCustomHashMap<K>.KeySpliterator>
      ...
      final Object2DoubleOpenCustomHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2DoubleMap.Entry<K>, Entry<K, Double>, ObjectDoublePair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Object2DoubleOpenCustomHashMap.this.strategy.equals(Object2DoubleOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double.doubleToLongBits(Object2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements Object2DoubleMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2DoubleMap.Entry<K>> spliterator() {
         return Object2DoubleOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean remove(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Double) {
            ...
            if (Object2DoubleOpenCustomHashMap.this.strategy.equals(k, null)) {
               ...
               K curr;
               int pos;
               if ((curr = key[pos = HashCommon.mix(Object2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Object2DoubleOpenCustomHashMap.this.mask])
                  == null) {
                  return false;
               }
      ...
      public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
         if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Object2DoubleOpenCustomHashMap.this.new MapEntry(Object2DoubleOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2DoubleOpenCustomHashMap.this.key[pos] != null) {
               consumer.accept(Object2DoubleOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
         Object2DoubleOpenCustomHashMap<K>.MapEntry entry = Object2DoubleOpenCustomHashMap.this.new MapEntry();
         if (Object2DoubleOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2DoubleOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2DoubleOpenCustomHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2DoubleOpenCustomHashMap.this.size - this.c
            : Math.min(
               Object2DoubleOpenCustomHashMap.this.size - this.c,
               (long)((double)Object2DoubleOpenCustomHashMap.this.realSize() / Object2DoubleOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2DoubleOpenCustomHashMap<K>.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Object2DoubleOpenCustomHashMap<K>.MapSpliterator<DoubleConsumer, Object2DoubleOpenCustomHashMap<K>.ValueSpliterator>
      ...
      final Object2DoubleOpenCustomHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
