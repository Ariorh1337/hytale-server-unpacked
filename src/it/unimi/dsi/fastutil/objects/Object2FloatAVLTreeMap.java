...
public class Object2FloatAVLTreeMap<K> extends AbstractObject2FloatSortedMap<K> implements Serializable, Cloneable {
   ...
   private Object2FloatAVLTreeMap.Entry<K> parent(Object2FloatAVLTreeMap.Entry<K> e) {
      ...
      Object2FloatAVLTreeMap.Entry<K> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Object2FloatAVLTreeMap.Entry<K> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Object2FloatMap.Entry<K>>() {
            final Comparator<? super Object2FloatMap.Entry<K>> comparator = Object2FloatAVLTreeMap.this.actualComparator == null
   ...
   private final class Submap extends AbstractObject2FloatSortedMap<K> implements Serializable {
      ...
      final boolean in(K k) {
         return (this.bottom || Object2FloatAVLTreeMap.this.compare(k, (K)this.from) >= 0)
            && (this.top || Object2FloatAVLTreeMap.this.compare(k, (K)this.to) < 0);
      }
      ...
      @Override
      public boolean containsKey(Object k) {
         return k == null ? false : this.in((K)k) && Object2FloatAVLTreeMap.this.containsKey(k);
      }
      ...
      public Object2FloatSortedMap<K> headMap(K to) {
         if (this.top) {
            ...
            return Object2FloatAVLTreeMap.this.compare(to, (K)this.to) < 0 ? Object2FloatAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Object2FloatSortedMap<K> tailMap(K from) {
         if (this.bottom) {
            ...
            return Object2FloatAVLTreeMap.this.compare(from, (K)this.from) > 0 ? Object2FloatAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Object2FloatSortedMap<K> subMap(K from, K to) {
         ...
         if (!this.top) {
            to = (K)(Object2FloatAVLTreeMap.this.compare(to, (K)this.to) < 0 ? to : this.to);
         }

         if (!this.bottom) {
            from = (K)(Object2FloatAVLTreeMap.this.compare(from, (K)this.from) > 0 ? from : this.from);
         }
      ...
      public Object2FloatAVLTreeMap.Entry<K> firstEntry() {
         ...
         if (this.bottom) {
            ...
            e = Object2FloatAVLTreeMap.this.locateKey((K)this.from);
            if (Object2FloatAVLTreeMap.this.compare(e.key, (K)this.from) < 0) {
               e = e.next();
            }
         }

         return e != null && (this.top || Object2FloatAVLTreeMap.this.compare(e.key, (K)this.to) < 0) ? e : null;
      }
      ...
      public Object2FloatAVLTreeMap.Entry<K> lastEntry() {
         ...
         if (this.top) {
            ...
            e = Object2FloatAVLTreeMap.this.locateKey((K)this.to);
            if (Object2FloatAVLTreeMap.this.compare(e.key, (K)this.to) >= 0) {
               e = e.prev();
            }
         }

         return e != null && (this.bottom || Object2FloatAVLTreeMap.this.compare(e.key, (K)this.from) >= 0) ? e : null;
      }
      ...
      private class SubmapIterator extends Object2FloatAVLTreeMap<K>.TreeIterator {
         ...
         void updatePrevious() {
            ...
            if (!Submap.this.bottom && this.prev != null && Object2FloatAVLTreeMap.this.compare(this.prev.key, (K)Submap.this.from) < 0) {
               this.prev = null;
            }
         }
         ...
         void updateNext() {
            this.next = this.next.next();
            if (!Submap.this.top && this.next != null && Object2FloatAVLTreeMap.this.compare(this.next.key, (K)Submap.this.to) >= 0) {
               this.next = null;
            }
         }
      }
