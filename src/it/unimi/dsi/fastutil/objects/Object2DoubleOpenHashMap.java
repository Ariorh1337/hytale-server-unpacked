...
public class Object2DoubleOpenHashMap<K> extends AbstractObject2DoubleMap<K> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Object2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      double[] value = this.value;
      Object2DoubleOpenHashMap<K>.EntryIterator i = new Object2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Object2DoubleOpenHashMap<K>.MapIterator<Consumer<? super Object2DoubleMap.Entry<K>>>
      ...
      final void acceptOnIndex(Consumer<? super Object2DoubleMap.Entry<K>> action, int index) {
         action.accept(this.entry = Object2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Object2DoubleOpenHashMap<K>.MapSpliterator<Consumer<? super Object2DoubleMap.Entry<K>>, Object2DoubleOpenHashMap<K>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Object2DoubleMap.Entry<K>> action, int index) {
         action.accept(Object2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Object2DoubleOpenHashMap<K>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Object2DoubleOpenHashMap<K>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractObjectSet<K> {
      ...
      public ObjectSpliterator<K> spliterator() {
         return Object2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Object2DoubleOpenHashMap<K>.MapSpliterator<Consumer<? super K>, Object2DoubleOpenHashMap<K>.KeySpliterator>
      ...
      final Object2DoubleOpenHashMap<K>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Object2DoubleMap.Entry<K>, Entry<K, Double>, ObjectDoublePair<K> {
      ...
      public boolean equals(Object o) {
         ...
         return Objects.equals(Object2DoubleOpenHashMap.this.key[this.index], e.getKey())
            && Double.doubleToLongBits(Object2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>> implements Object2DoubleMap.FastEntrySet<K> {
      ...
      public ObjectSpliterator<Object2DoubleMap.Entry<K>> spliterator() {
         return Object2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
         if (Object2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Object2DoubleOpenHashMap.this.new MapEntry(Object2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Object2DoubleOpenHashMap.this.key[pos] != null) {
               consumer.accept(Object2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Object2DoubleMap.Entry<K>> consumer) {
         Object2DoubleOpenHashMap<K>.MapEntry entry = Object2DoubleOpenHashMap.this.new MapEntry();
         if (Object2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Object2DoubleOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Object2DoubleOpenHashMap<K>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Object2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Object2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Object2DoubleOpenHashMap.this.realSize() / Object2DoubleOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Object2DoubleOpenHashMap<K>.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Object2DoubleOpenHashMap<K>.MapSpliterator<DoubleConsumer, Object2DoubleOpenHashMap<K>.ValueSpliterator>
      ...
      final Object2DoubleOpenHashMap<K>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Object2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
