...
public class Reference2ReferenceArrayMap<K, V> extends AbstractReference2ReferenceMap<K, V> implements Serializable, Cloneable {
   ...
   public Reference2ReferenceArrayMap(Reference2ReferenceMap<K, V> m) {
      ...
      for (Reference2ReferenceMap.Entry<K, V> e : m.reference2ReferenceEntrySet()) {
         this.key[i] = e.getKey();
   ...
   public Reference2ReferenceMap.FastEntrySet<K, V> reference2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Reference2ReferenceArrayMap.EntrySet();
      }
   ...
   public ReferenceSet<K> keySet() {
      if (this.keys == null) {
         this.keys = new Reference2ReferenceArrayMap.KeySet();
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new Reference2ReferenceArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> {
         ...
         return new ObjectIterator<Reference2ReferenceMap.Entry<K, V>>() {
            ...
            public Reference2ReferenceMap.Entry<K, V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractReference2ReferenceMap.BasicEntry<>(
                     (K)Reference2ReferenceArrayMap.this.key[this.curr = this.next], (V)Reference2ReferenceArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractReference2ReferenceMap.BasicEntry<>(
                        (K)Reference2ReferenceArrayMap.this.key[this.curr = this.next], (V)Reference2ReferenceArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
         return new ObjectIterator<Reference2ReferenceMap.Entry<K, V>>() {
            ...
            public Reference2ReferenceMap.Entry<K, V> next() {
               ...
               this.entry.key = (K)Reference2ReferenceArrayMap.this.key[this.curr = this.next];
      ...
      public ObjectSpliterator<Reference2ReferenceMap.Entry<K, V>> spliterator() {
         return new Reference2ReferenceArrayMap.EntrySet.EntrySetSpliterator(0, Reference2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Reference2ReferenceMap.Entry<K, V>> action) {
         ...
         for (int max = Reference2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept(
               new AbstractReference2ReferenceMap.BasicEntry<>((K)Reference2ReferenceArrayMap.this.key[i], (V)Reference2ReferenceArrayMap.this.value[i])
            );
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Reference2ReferenceMap.Entry<K, V> get(int location) {
            return new AbstractReference2ReferenceMap.BasicEntry<>(
               (K)Reference2ReferenceArrayMap.this.key[location], (V)Reference2ReferenceArrayMap.this.value[location]
            );
         }

         protected final Reference2ReferenceArrayMap<K, V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractReferenceSet<K> {
      ...
      public ObjectIterator<K> iterator() {
         return new ObjectIterator<K>() {
            ...
            public void forEachRemaining(Consumer<? super K> action) {
               ...
               while (this.pos < max) {
                  action.accept((K)Reference2ReferenceArrayMap.this.key[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<K> spliterator() {
         return new Reference2ReferenceArrayMap.KeySet.KeySetSpliterator(0, Reference2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super K> action) {
         ...
         for (int max = Reference2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((K)Reference2ReferenceArrayMap.this.key[i]);
         }
      }
      ...
      final class KeySetSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<K> implements ObjectSpliterator<K> {
         ...
         protected final Reference2ReferenceArrayMap<K, V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractReferenceCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Reference2ReferenceArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Reference2ReferenceArrayMap.ValuesCollection.ValuesSpliterator(0, Reference2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Reference2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((V)Reference2ReferenceArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final Reference2ReferenceArrayMap<K, V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
