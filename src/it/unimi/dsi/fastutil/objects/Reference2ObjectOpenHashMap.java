...
public class Reference2ObjectOpenHashMap<K, V> extends AbstractReference2ObjectMap<K, V> implements Serializable, Cloneable, Hash {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      K[] key = this.key;
      V[] value = this.value;
      Reference2ObjectOpenHashMap<K, V>.EntryIterator i = new Reference2ObjectOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Reference2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>>
   ...
   private final class EntrySpliterator
      extends Reference2ObjectOpenHashMap<K, V>.MapSpliterator<Consumer<? super Reference2ObjectMap.Entry<K, V>>, Reference2ObjectOpenHashMap<K, V>.EntrySpliterator>
   ...
   private final class KeyIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super K>> implements ObjectIterator<K> {
      public KeyIterator() {
      }
   ...
   private final class KeySpliterator
      extends Reference2ObjectOpenHashMap<K, V>.MapSpliterator<Consumer<? super K>, Reference2ObjectOpenHashMap<K, V>.KeySpliterator>
   ...
   final class MapEntry implements Reference2ObjectMap.Entry<K, V>, Entry<K, V>, ReferenceObjectPair<K, V> {
      ...
      public boolean equals(Object o) {
         ...
         return Reference2ObjectOpenHashMap.this.key[this.index] == e.getKey()
            && Objects.equals(Reference2ObjectOpenHashMap.this.value[this.index], e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectMap.FastEntrySet<K, V> {
      ...
      public boolean contains(Object o) {
         ...
         V v = (V)e.getValue();
         if (k == null) {
            return Reference2ObjectOpenHashMap.this.containsNullKey
               && Objects.equals(Reference2ObjectOpenHashMap.this.value[Reference2ObjectOpenHashMap.this.n], v);
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Reference2ObjectOpenHashMap<K, V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Reference2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Reference2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Reference2ObjectOpenHashMap.this.realSize() / Reference2ObjectOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Reference2ObjectOpenHashMap<K, V>.MapSpliterator<Consumer<? super V>, Reference2ObjectOpenHashMap<K, V>.ValueSpliterator>
