      ...
      public void remove() {
         ...
         if (this.prev == -1) {
            ...
            ObjectLinkedOpenCustomHashSet.this.link[this.prev] = ObjectLinkedOpenCustomHashSet.this.link[this.prev]
               ^ (ObjectLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 4294967295L) & 4294967295L;
         }
         ...
         if (this.next == -1) {
            ...
            ObjectLinkedOpenCustomHashSet.this.link[this.next] = ObjectLinkedOpenCustomHashSet.this.link[this.next]
               ^ (ObjectLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 4294967295L) << 32) & -4294967296L;
         }
