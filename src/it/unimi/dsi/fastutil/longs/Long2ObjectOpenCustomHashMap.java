...
public class Long2ObjectOpenCustomHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Long2ObjectOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(Consumer<? super V> consumer) {
               ...
               while (pos-- != 0) {
                  if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      V[] value = this.value;
      Long2ObjectOpenCustomHashMap<V>.EntryIterator i = new Long2ObjectOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Long2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super Long2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Long2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Long2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Long2ObjectMap.Entry<V>>, Long2ObjectOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2ObjectMap.Entry<V>> action, int index) {
         action.accept(Long2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }

      final Long2ObjectOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2ObjectOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Long2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super Long2ObjectMap.Entry<V>>>
      implements ObjectIterator<Long2ObjectMap.Entry<V>> {
      private final Long2ObjectOpenCustomHashMap<V>.MapEntry entry = Long2ObjectOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2ObjectOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2ObjectOpenCustomHashMap<V>.MapSpliterator<java.util.function.LongConsumer, Long2ObjectOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Long2ObjectOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2ObjectOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Long2ObjectMap.Entry<V>, Entry<Long, V>, LongObjectPair<V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[this.index], e.getKey())
            && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
      }

      @Override
      public int hashCode() {
         return Long2ObjectOpenCustomHashMap.this.strategy.hashCode(Long2ObjectOpenCustomHashMap.this.key[this.index])
            ^ (Long2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Long2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements Long2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Long2ObjectMap.Entry<V>> spliterator() {
         return Long2ObjectOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Long) {
            ...
            if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
               return Long2ObjectOpenCustomHashMap.this.containsNullKey
                  && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[Long2ObjectOpenCustomHashMap.this.n], v);
            }
         ...
         if (e.getKey() != null && e.getKey() instanceof Long) {
            ...
            if (Long2ObjectOpenCustomHashMap.this.strategy.equals(k, 0L)) {
               ...
               if (Long2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                  ...
                  while ((curr = key[pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask]) != 0L) {
                     if (Long2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && Objects.equals(Long2ObjectOpenCustomHashMap.this.value[pos], v)) {
                        Long2ObjectOpenCustomHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
         if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Long2ObjectOpenCustomHashMap.this.new MapEntry(Long2ObjectOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2ObjectOpenCustomHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2ObjectOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2ObjectMap.Entry<V>> consumer) {
         Long2ObjectOpenCustomHashMap<V>.MapEntry entry = Long2ObjectOpenCustomHashMap.this.new MapEntry();
         if (Long2ObjectOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Long2ObjectOpenCustomHashMap.this.n;
      int last = -1;
      int c = Long2ObjectOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2ObjectOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            long curr;
            for (pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask; (curr = key[pos]) != 0L; pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2ObjectOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2ObjectOpenCustomHashMap.this.size - this.c
            : Math.min(
               Long2ObjectOpenCustomHashMap.this.size - this.c,
               (long)((double)Long2ObjectOpenCustomHashMap.this.realSize() / Long2ObjectOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Long2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Long2ObjectOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Long2ObjectOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2ObjectOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
