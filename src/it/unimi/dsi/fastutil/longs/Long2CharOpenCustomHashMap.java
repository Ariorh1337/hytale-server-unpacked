...
public class Long2CharOpenCustomHashMap extends AbstractLong2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Long2CharOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      char[] value = this.value;
      Long2CharOpenCustomHashMap.EntryIterator i = new Long2CharOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Long2CharOpenCustomHashMap.MapIterator<Consumer<? super Long2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Long2CharMap.Entry> action, int index) {
         action.accept(this.entry = Long2CharOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2CharOpenCustomHashMap.MapSpliterator<Consumer<? super Long2CharMap.Entry>, Long2CharOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2CharMap.Entry> action, int index) {
         action.accept(Long2CharOpenCustomHashMap.this.new MapEntry(index));
      }

      final Long2CharOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2CharOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Long2CharOpenCustomHashMap.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2CharOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2CharOpenCustomHashMap.MapSpliterator<java.util.function.LongConsumer, Long2CharOpenCustomHashMap.KeySpliterator>
      ...
      final Long2CharOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2CharOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Long2CharMap.Entry, Entry<Long, Character>, LongCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[this.index], e.getKey())
            && Long2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Long2CharMap.Entry> spliterator() {
         return Long2CharOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Long2CharMap.Entry> consumer) {
         if (Long2CharOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Long2CharOpenCustomHashMap.this.new MapEntry(Long2CharOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2CharOpenCustomHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2CharOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2CharMap.Entry> consumer) {
         Long2CharOpenCustomHashMap.MapEntry entry = Long2CharOpenCustomHashMap.this.new MapEntry();
         if (Long2CharOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2CharOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2CharOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2CharOpenCustomHashMap.this.size - this.c
            : Math.min(
               Long2CharOpenCustomHashMap.this.size - this.c,
               (long)((double)Long2CharOpenCustomHashMap.this.realSize() / Long2CharOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Long2CharOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Long2CharOpenCustomHashMap.MapSpliterator<CharConsumer, Long2CharOpenCustomHashMap.ValueSpliterator>
      ...
      final Long2CharOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2CharOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
