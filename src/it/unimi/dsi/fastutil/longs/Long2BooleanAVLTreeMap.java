...
public class Long2BooleanAVLTreeMap extends AbstractLong2BooleanSortedMap implements Serializable, Cloneable {
   ...
   private Long2BooleanAVLTreeMap.Entry parent(Long2BooleanAVLTreeMap.Entry e) {
      ...
      Long2BooleanAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Long2BooleanAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2BooleanMap.Entry>() {
            final Comparator<? super Long2BooleanMap.Entry> comparator = Long2BooleanAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey())
               : (x, y) -> Long2BooleanAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
