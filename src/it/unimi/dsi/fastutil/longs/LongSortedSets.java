...
public final class LongSortedSets {
   ...
   public static class Singleton extends LongSets.Singleton implements LongSortedSet, Serializable, Cloneable {
      ...
      @Override
      public LongSortedSet subSet(long from, long to) {
         return this.compare(from, this.element) <= 0 && this.compare(this.element, to) < 0 ? this : LongSortedSets.EMPTY_SET;
      }

      @Override
      public LongSortedSet headSet(long to) {
         return this.compare(this.element, to) < 0 ? this : LongSortedSets.EMPTY_SET;
      }

      @Override
      public LongSortedSet tailSet(long from) {
         return this.compare(from, this.element) <= 0 ? this : LongSortedSets.EMPTY_SET;
      }
