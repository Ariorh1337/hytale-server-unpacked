...
public class LongBigArrayBigList extends AbstractLongBigList implements RandomAccess, Cloneable, Serializable {
   ...
   public int compareTo(LongBigArrayBigList l) {
      ...
      int i;
      for (i = 0; i < s1 && i < s2; i++) {
         long e1 = BigArrays.get(a1, i);
         long e2 = BigArrays.get(a2, i);
         int r;
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      ...
      for (int i = 0; i < this.size; i++) {
         s.writeLong(BigArrays.get(this.a, i));
      }
   }
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      ...
      for (int i = 0; i < this.size; i++) {
         BigArrays.set(this.a, i, s.readLong());
      }
   }
   ...
   private final class Spliterator implements LongSpliterator {
      ...
      public LongSpliterator trySplit() {
         ...
         this.pos = myNewPos;
         this.hasSplit = true;
         return LongBigArrayBigList.this.new Spliterator(oldPos, retMax, true);
      }
   }
