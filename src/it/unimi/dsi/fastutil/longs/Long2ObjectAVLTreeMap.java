...
public class Long2ObjectAVLTreeMap<V> extends AbstractLong2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   final Long2ObjectAVLTreeMap.Entry<V> findKey(long k) {
      Long2ObjectAVLTreeMap.Entry<V> e = this.tree;
   ...
   final Long2ObjectAVLTreeMap.Entry<V> locateKey(long k) {
      Long2ObjectAVLTreeMap.Entry<V> e = this.tree;
      Long2ObjectAVLTreeMap.Entry<V> last = this.tree;
   ...
   public V put(long k, V v) {
      Long2ObjectAVLTreeMap.Entry<V> e = this.add(k);
      V oldValue = e.value;
      e.value = v;
      return oldValue;
   }

   private Long2ObjectAVLTreeMap.Entry<V> add(long k) {
      this.modified = false;
      Long2ObjectAVLTreeMap.Entry<V> e = null;
      if (this.tree == null) {
         this.count++;
         e = this.tree = this.lastEntry = this.firstEntry = new Long2ObjectAVLTreeMap.Entry<>(k, this.defRetValue);
         this.modified = true;
      } else {
         Long2ObjectAVLTreeMap.Entry<V> p = this.tree;
         Long2ObjectAVLTreeMap.Entry<V> q = null;
         Long2ObjectAVLTreeMap.Entry<V> y = this.tree;
         Long2ObjectAVLTreeMap.Entry<V> z = null;
         Long2ObjectAVLTreeMap.Entry<V> w = null;
         int i = 0;
         ...
         while (true) {
            ...
            if (this.dirPath[i++] = cmp > 0) {
               if (p.succ()) {
                  this.count++;
                  e = new Long2ObjectAVLTreeMap.Entry<>(k, this.defRetValue);
                  this.modified = true;
                  if (p.right == null) {
                     this.lastEntry = e;
                  }
         ...
         if (y.balance() == -2) {
            Long2ObjectAVLTreeMap.Entry<V> x = y.left;
            if (x.balance() == -1) {
               w = x;
               if (x.succ()) {
                  x.succ(false);
            ...
            Long2ObjectAVLTreeMap.Entry<V> x = y.right;
            if (x.balance() == 1) {
               w = x;
               if (x.pred()) {
                  x.pred(false);
   ...
   private Long2ObjectAVLTreeMap.Entry<V> parent(Long2ObjectAVLTreeMap.Entry<V> e) {
      if (e == this.tree) {
         return null;
      }

      Long2ObjectAVLTreeMap.Entry<V> y = e;
      Long2ObjectAVLTreeMap.Entry<V> x = e;

      while (!y.succ()) {
         if (x.pred()) {
            Long2ObjectAVLTreeMap.Entry<V> p = x.left;
            if (p == null || p.right != e) {
               while (!y.succ()) {
                  y = y.right;
               }
      ...
      Long2ObjectAVLTreeMap.Entry<V> p = y.right;
      if (p == null || p.left != e) {
         while (!x.pred()) {
            x = x.left;
         }
   ...
   public V remove(long k) {
      ...
      if (p.succ()) {
         ...
         Long2ObjectAVLTreeMap.Entry<V> r = p.right;
         if (r.pred()) {
            r.left = p.left;
            r.pred(p.pred());
            if (!r.pred()) {
            ...
            while (true) {
               Long2ObjectAVLTreeMap.Entry<V> s = r.left;
               if (s.pred()) {
                  if (s.succ()) {
                     r.pred(s);
                  } else {
      ...
      while (q != null) {
         Long2ObjectAVLTreeMap.Entry<V> y = q;
         q = this.parent(y);
         if (!dir) {
            dir = q != null && q.left != y;
            y.incBalance();
            ...
            if (y.balance() == 2) {
               ...
               if (x.balance() == -1) {
                  assert x.balance() == -1;
                  Long2ObjectAVLTreeMap.Entry<V> w = x.left;
                  x.left = w.right;
                  w.right = x;
                  y.right = w.left;
                  w.left = y;
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Long2ObjectAVLTreeMap.Entry<V> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public boolean containsValue(Object v) {
      Long2ObjectAVLTreeMap<V>.ValueIterator i = new Long2ObjectAVLTreeMap.ValueIterator();
      int j = this.count;
   ...
   @Override
   public V get(long k) {
      Long2ObjectAVLTreeMap.Entry<V> e = this.findKey(k);
   ...
   public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2ObjectMap.Entry<V>>() {
            final Comparator<? super Long2ObjectMap.Entry<V>> comparator = Long2ObjectAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey())
               : (x, y) -> Long2ObjectAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
            ...
            public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
               return Long2ObjectAVLTreeMap.this.new EntryIterator(from.getLongKey());
            }
            ...
            public boolean contains(Object o) {
               if (o != null && o instanceof java.util.Map.Entry) {
                  ...
                  Long2ObjectAVLTreeMap.Entry<V> f = Long2ObjectAVLTreeMap.this.findKey((Long)e.getKey());
                  return e.equals(f);
               } else {
                  return false;
               }
   ...
   public Long2ObjectSortedMap<V> headMap(long to) {
      return new Long2ObjectAVLTreeMap.Submap(0L, true, to, false);
   }

   @Override
   public Long2ObjectSortedMap<V> tailMap(long from) {
      return new Long2ObjectAVLTreeMap.Submap(from, false, 0L, true);
   }

   @Override
   public Long2ObjectSortedMap<V> subMap(long from, long to) {
      return new Long2ObjectAVLTreeMap.Submap(from, false, to, false);
   }
   ...
   public Long2ObjectAVLTreeMap<V> clone() {
      ...
      Long2ObjectAVLTreeMap.Entry<V> rp = new Long2ObjectAVLTreeMap.Entry<>();
      Long2ObjectAVLTreeMap.Entry<V> rq = new Long2ObjectAVLTreeMap.Entry<>();
      Long2ObjectAVLTreeMap.Entry<V> p = rp;
      rp.left(this.tree);
      Long2ObjectAVLTreeMap.Entry<V> q = rq;
      rq.pred(null);

      while (true) {
         if (!p.pred()) {
            Long2ObjectAVLTreeMap.Entry<V> e = p.left.clone();
            e.pred(q.left);
            e.succ(q);
            q.left(e);
            p = p.left;
         ...
         if (!p.succ()) {
            Long2ObjectAVLTreeMap.Entry<V> e = p.right.clone();
            e.succ(q.right);
            e.pred(q);
            q.right(e);
         }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int n = this.count;
      Long2ObjectAVLTreeMap<V>.EntryIterator i = new Long2ObjectAVLTreeMap.EntryIterator();
      s.defaultWriteObject();

      while (n-- != 0) {
         Long2ObjectAVLTreeMap.Entry<V> e = i.nextEntry();
         s.writeLong(e.key);
         s.writeObject(e.value);
      }
   }

   private Long2ObjectAVLTreeMap.Entry<V> readTree(ObjectInputStream s, int n, Long2ObjectAVLTreeMap.Entry<V> pred, Long2ObjectAVLTreeMap.Entry<V> succ) throws IOException, ClassNotFoundException {
      if (n == 1) {
         Long2ObjectAVLTreeMap.Entry<V> top = new Long2ObjectAVLTreeMap.Entry<>(s.readLong(), (V)s.readObject());
         top.pred(pred);
         top.succ(succ);
         return top;
      }
      ...
      if (n == 2) {
         Long2ObjectAVLTreeMap.Entry<V> top = new Long2ObjectAVLTreeMap.Entry<>(s.readLong(), (V)s.readObject());
         top.right(new Long2ObjectAVLTreeMap.Entry<>(s.readLong(), (V)s.readObject()));
         top.right.pred(top);
         top.balance(1);
         top.pred(pred);
         top.right.succ(succ);
      ...
      Long2ObjectAVLTreeMap.Entry<V> top = new Long2ObjectAVLTreeMap.Entry<>();
   ...
   private static final class Entry<V> extends AbstractLong2ObjectMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Long2ObjectAVLTreeMap.Entry<V> pred) {
         this.info |= 1073741824;
         this.left = pred;
      }

      void succ(Long2ObjectAVLTreeMap.Entry<V> succ) {
         this.info |= Integer.MIN_VALUE;
         this.right = succ;
      }

      void left(Long2ObjectAVLTreeMap.Entry<V> left) {
         this.info &= -1073741825;
         this.left = left;
      }

      void right(Long2ObjectAVLTreeMap.Entry<V> right) {
         this.info &= Integer.MAX_VALUE;
         this.right = right;
      }
      ...
      Long2ObjectAVLTreeMap.Entry<V> next() {
         Long2ObjectAVLTreeMap.Entry<V> next = this.right;
      ...
      Long2ObjectAVLTreeMap.Entry<V> prev() {
         Long2ObjectAVLTreeMap.Entry<V> prev = this.left;
      ...
      public Long2ObjectAVLTreeMap.Entry<V> clone() {
         Long2ObjectAVLTreeMap.Entry<V> c;
         try {
            c = (Long2ObjectAVLTreeMap.Entry<V>)super.clone();
         } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
         }
   ...
   private class KeySet extends AbstractLong2ObjectSortedMap<V>.KeySet {
      ...
      public LongBidirectionalIterator iterator(long from) {
         return Long2ObjectAVLTreeMap.this.new KeyIterator(from);
      }
   }
   ...
   private final class Submap extends AbstractLong2ObjectSortedMap<V> implements Serializable {
      ...
      @Override
      public void clear() {
         Long2ObjectAVLTreeMap<V>.Submap.SubmapIterator i = new Long2ObjectAVLTreeMap.Submap.SubmapIterator();
      ...
      public V remove(long k) {
         ...
         V oldValue = Long2ObjectAVLTreeMap.this.remove(k);
      ...
      public Long2ObjectSortedMap<V> headMap(long to) {
         if (this.top) {
            return Long2ObjectAVLTreeMap.this.new Submap(this.from, this.bottom, to, false);
         } else {
            return Long2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? Long2ObjectAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Long2ObjectSortedMap<V> tailMap(long from) {
         if (this.bottom) {
            return Long2ObjectAVLTreeMap.this.new Submap(from, false, this.to, this.top);
         } else {
            return Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? Long2ObjectAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Long2ObjectSortedMap<V> subMap(long from, long to) {
         if (this.top && this.bottom) {
            return Long2ObjectAVLTreeMap.this.new Submap(from, false, to, false);
         }
         ...
         return !this.top && !this.bottom && from == this.from && to == this.to ? this : Long2ObjectAVLTreeMap.this.new Submap(from, false, to, false);
      }
      ...
      public Long2ObjectAVLTreeMap.Entry<V> firstEntry() {
         ...
         return e != null && (this.top || Long2ObjectAVLTreeMap.this.compare(e.key, this.to) < 0) ? e : null;
      }
      ...
      public Long2ObjectAVLTreeMap.Entry<V> lastEntry() {
         ...
         return e != null && (this.bottom || Long2ObjectAVLTreeMap.this.compare(e.key, this.from) >= 0) ? e : null;
      }

      @Override
      public long firstLongKey() {
         Long2ObjectAVLTreeMap.Entry<V> e = this.firstEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      @Override
      public long lastLongKey() {
         Long2ObjectAVLTreeMap.Entry<V> e = this.lastEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      private class SubmapIterator extends Long2ObjectAVLTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(long k) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Long2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Long2ObjectAVLTreeMap.this.compare(k, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
   ...
   private class TreeIterator {
      ...
      TreeIterator(long k) {
         if ((this.next = Long2ObjectAVLTreeMap.this.locateKey(k)) != null) {
            if (Long2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
