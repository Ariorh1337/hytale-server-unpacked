...
public class Long2FloatArrayMap extends AbstractLong2FloatMap implements Serializable, Cloneable {
   ...
   public Long2FloatArrayMap(Map<? extends Long, ? extends Float> m) {
      ...
      for (Entry<? extends Long, ? extends Float> e : m.entrySet()) {
         this.key[i] = e.getKey();
   ...
   public Long2FloatMap.FastEntrySet long2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2FloatArrayMap.EntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2FloatArrayMap.KeySet();
      }
   ...
   public FloatCollection values() {
      if (this.values == null) {
         this.values = new Long2FloatArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Long2FloatMap.Entry> iterator() {
         return new ObjectIterator<Long2FloatMap.Entry>() {
            ...
            public void forEachRemaining(Consumer<? super Long2FloatMap.Entry> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractLong2FloatMap.BasicEntry(Long2FloatArrayMap.this.key[this.curr = this.next], Long2FloatArrayMap.this.value[this.next++])
                  );
               }
            }
         };
      ...
      public ObjectSpliterator<Long2FloatMap.Entry> spliterator() {
         return new Long2FloatArrayMap.EntrySet.EntrySetSpliterator(0, Long2FloatArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Long2FloatMap.Entry> action) {
         ...
         for (int max = Long2FloatArrayMap.this.size; i < max; i++) {
         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Long)) {
               ...
               return Long2FloatArrayMap.this.containsKey(k)
                  && Float.floatToIntBits(Long2FloatArrayMap.this.get(k)) == Float.floatToIntBits((Float)e.getValue());
            } else {
               return false;
            }
         }
      ...
      final class EntrySetSpliterator
         ...
         protected final Long2FloatArrayMap.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return new Long2FloatArrayMap.KeySet.KeySetSpliterator(0, Long2FloatArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends LongSpliterators.EarlyBindingSizeIndexBasedSpliterator implements LongSpliterator {
         ...
         protected final Long2FloatArrayMap.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractFloatCollection {
      ...
      public FloatSpliterator spliterator() {
         return new Long2FloatArrayMap.ValuesCollection.ValuesSpliterator(0, Long2FloatArrayMap.this.size);
      }
      ...
      final class ValuesSpliterator extends FloatSpliterators.EarlyBindingSizeIndexBasedSpliterator implements FloatSpliterator {
         ...
         protected final Long2FloatArrayMap.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
