...
public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap implements Serializable, Cloneable {
   ...
   private Long2DoubleAVLTreeMap.Entry parent(Long2DoubleAVLTreeMap.Entry e) {
      ...
      Long2DoubleAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Long2DoubleAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2DoubleMap.Entry>() {
            final Comparator<? super Long2DoubleMap.Entry> comparator = Long2DoubleAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey())
               : (x, y) -> Long2DoubleAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
