...
public abstract class AbstractLongList extends AbstractLongCollection implements LongList, LongStack {
   ...
   public LongList subList(int from, int to) {
      ...
      if (from > to) {
         ...
         return this instanceof RandomAccess ? new AbstractLongList.LongRandomAccessSubList(this, from, to) : new AbstractLongList.LongSubList(this, from, to);
      }
   }
   ...
   public static class LongSubList extends AbstractLongList implements Serializable {
      ...
      public LongSpliterator spliterator() {
         return this.l instanceof RandomAccess ? new AbstractLongList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator();
      }
