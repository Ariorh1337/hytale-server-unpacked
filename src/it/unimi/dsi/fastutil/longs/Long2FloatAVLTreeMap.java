...
public class Long2FloatAVLTreeMap extends AbstractLong2FloatSortedMap implements Serializable, Cloneable {
   ...
   private Long2FloatAVLTreeMap.Entry parent(Long2FloatAVLTreeMap.Entry e) {
      ...
      Long2FloatAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Long2FloatAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Long2FloatMap.Entry>() {
            final Comparator<? super Long2FloatMap.Entry> comparator = Long2FloatAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Long.compare(x.getLongKey(), y.getLongKey())
               : (x, y) -> Long2FloatAVLTreeMap.this.actualComparator.compare(x.getLongKey(), y.getLongKey());
