...
public final class LongLists {
   ...
   public static LongList synchronize(LongList l) {
      return l instanceof RandomAccess ? new LongLists.SynchronizedRandomAccessList(l) : new LongLists.SynchronizedList(l);
   }

   public static LongList synchronize(LongList l, Object sync) {
      return l instanceof RandomAccess ? new LongLists.SynchronizedRandomAccessList(l, sync) : new LongLists.SynchronizedList(l, sync);
   }

   public static LongList unmodifiable(LongList l) {
      return l instanceof RandomAccess ? new LongLists.UnmodifiableRandomAccessList(l) : new LongLists.UnmodifiableList(l);
   }
