...
public class Long2BooleanOpenCustomHashMap extends AbstractLong2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Long2BooleanOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(BooleanConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      boolean[] value = this.value;
      Long2BooleanOpenCustomHashMap.EntryIterator i = new Long2BooleanOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Long2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Long2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Long2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Long2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2BooleanOpenCustomHashMap.MapSpliterator<Consumer<? super Long2BooleanMap.Entry>, Long2BooleanOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2BooleanMap.Entry> action, int index) {
         action.accept(Long2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }

      final Long2BooleanOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2BooleanOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Long2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Long2BooleanMap.Entry>>
      implements ObjectIterator<Long2BooleanMap.Entry> {
      private final Long2BooleanOpenCustomHashMap.MapEntry entry = Long2BooleanOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Long2BooleanOpenCustomHashMap.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2BooleanOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2BooleanOpenCustomHashMap.MapSpliterator<java.util.function.LongConsumer, Long2BooleanOpenCustomHashMap.KeySpliterator>
      ...
      final Long2BooleanOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2BooleanOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Long2BooleanMap.Entry, Entry<Long, Boolean>, LongBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Long2BooleanOpenCustomHashMap.this.strategy.equals(Long2BooleanOpenCustomHashMap.this.key[this.index], e.getKey())
            && Long2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Long2BooleanOpenCustomHashMap.this.strategy.hashCode(Long2BooleanOpenCustomHashMap.this.key[this.index])
            ^ (Long2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2BooleanMap.Entry> implements Long2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Long2BooleanMap.Entry> spliterator() {
         return Long2BooleanOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getKey() != null && e.getKey() instanceof Long) {
            if (e.getValue() != null && e.getValue() instanceof Boolean) {
               ...
               if (Long2BooleanOpenCustomHashMap.this.strategy.equals(k, 0L)) {
                  ...
                  long curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix(Long2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Long2BooleanOpenCustomHashMap.this.mask])
                     == 0L) {
                     return false;
                  }
      ...
      public void forEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
         if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Long2BooleanOpenCustomHashMap.this.new MapEntry(Long2BooleanOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2BooleanOpenCustomHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2BooleanOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2BooleanMap.Entry> consumer) {
         Long2BooleanOpenCustomHashMap.MapEntry entry = Long2BooleanOpenCustomHashMap.this.new MapEntry();
         if (Long2BooleanOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Long2BooleanOpenCustomHashMap.this.n;
      int last = -1;
      int c = Long2BooleanOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2BooleanOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            long curr;
            for (pos = pos + 1 & Long2BooleanOpenCustomHashMap.this.mask; (curr = key[pos]) != 0L; pos = pos + 1 & Long2BooleanOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2BooleanOpenCustomHashMap.this.size - this.c
            : Math.min(
               Long2BooleanOpenCustomHashMap.this.size - this.c,
               (long)((double)Long2BooleanOpenCustomHashMap.this.realSize() / Long2BooleanOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Long2BooleanOpenCustomHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Long2BooleanOpenCustomHashMap.MapSpliterator<BooleanConsumer, Long2BooleanOpenCustomHashMap.ValueSpliterator>
      ...
      final Long2BooleanOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2BooleanOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
