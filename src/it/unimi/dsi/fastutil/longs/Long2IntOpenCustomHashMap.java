...
public class Long2IntOpenCustomHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Long2IntOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      int[] value = this.value;
      Long2IntOpenCustomHashMap.EntryIterator i = new Long2IntOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Long2IntOpenCustomHashMap.MapIterator<Consumer<? super Long2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Long2IntMap.Entry> action, int index) {
         action.accept(this.entry = Long2IntOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2IntOpenCustomHashMap.MapSpliterator<Consumer<? super Long2IntMap.Entry>, Long2IntOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2IntMap.Entry> action, int index) {
         action.accept(Long2IntOpenCustomHashMap.this.new MapEntry(index));
      }

      final Long2IntOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Long2IntOpenCustomHashMap.MapIterator<Consumer<? super Long2IntMap.Entry>>
      implements ObjectIterator<Long2IntMap.Entry> {
      private final Long2IntOpenCustomHashMap.MapEntry entry = Long2IntOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Long2IntOpenCustomHashMap.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2IntOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2IntOpenCustomHashMap.MapSpliterator<java.util.function.LongConsumer, Long2IntOpenCustomHashMap.KeySpliterator>
      ...
      final Long2IntOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Long2IntMap.Entry, Entry<Long, Integer>, LongIntPair {
      ...
      public boolean equals(Object o) {
         ...
         return Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[this.index], e.getKey())
            && Long2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Long2IntOpenCustomHashMap.this.strategy.hashCode(Long2IntOpenCustomHashMap.this.key[this.index])
            ^ Long2IntOpenCustomHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Long2IntMap.Entry> spliterator() {
         return Long2IntOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Long2IntMap.Entry> consumer) {
         if (Long2IntOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Long2IntOpenCustomHashMap.this.new MapEntry(Long2IntOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2IntOpenCustomHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2IntOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2IntMap.Entry> consumer) {
         Long2IntOpenCustomHashMap.MapEntry entry = Long2IntOpenCustomHashMap.this.new MapEntry();
         if (Long2IntOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Long2IntOpenCustomHashMap.this.n;
      int last = -1;
      int c = Long2IntOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2IntOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            long curr;
            for (pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask; (curr = key[pos]) != 0L; pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2IntOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2IntOpenCustomHashMap.this.size - this.c
            : Math.min(
               Long2IntOpenCustomHashMap.this.size - this.c,
               (long)((double)Long2IntOpenCustomHashMap.this.realSize() / Long2IntOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Long2IntOpenCustomHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Long2IntOpenCustomHashMap.MapSpliterator<IntConsumer, Long2IntOpenCustomHashMap.ValueSpliterator>
      ...
      final Long2IntOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
