...
public abstract class AbstractLong2BooleanMap extends AbstractLong2BooleanFunction implements Long2BooleanMap, Serializable {
   ...
   public boolean containsKey(long k) {
      ObjectIterator<Long2BooleanMap.Entry> i = this.long2BooleanEntrySet().iterator();
   ...
   public void putAll(Map<? extends Long, ? extends Boolean> m) {
      if (m instanceof Long2BooleanMap) {
         ...
         int n = m.size();
         Iterator<? extends Entry<? extends Long, ? extends Boolean>> i = m.entrySet().iterator();

         while (n-- != 0) {
            Entry<? extends Long, ? extends Boolean> e = (Entry<? extends Long, ? extends Boolean>)i.next();
   ...
   public static class BasicEntry implements Long2BooleanMap.Entry {
      ...
      public boolean equals(Object o) {
         if (!(o instanceof Entry)) {
            return false;
         } else if (o instanceof Long2BooleanMap.Entry) {
