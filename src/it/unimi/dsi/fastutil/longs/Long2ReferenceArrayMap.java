...
public class Long2ReferenceArrayMap<V> extends AbstractLong2ReferenceMap<V> implements Serializable, Cloneable {
   ...
   public Long2ReferenceArrayMap(Long2ReferenceMap<V> m) {
      ...
      for (Long2ReferenceMap.Entry<V> e : m.long2ReferenceEntrySet()) {
   ...
   public Long2ReferenceMap.FastEntrySet<V> long2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Long2ReferenceArrayMap.EntrySet();
      }
   ...
   public LongSet keySet() {
      if (this.keys == null) {
         this.keys = new Long2ReferenceArrayMap.KeySet();
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new Long2ReferenceArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Long2ReferenceMap.Entry<V>> implements Long2ReferenceMap.FastEntrySet<V> {
         ...
         return new ObjectIterator<Long2ReferenceMap.Entry<V>>() {
            ...
            public Long2ReferenceMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractLong2ReferenceMap.BasicEntry<>(
                     Long2ReferenceArrayMap.this.key[this.curr = this.next], (V)Long2ReferenceArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Long2ReferenceMap.Entry<V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractLong2ReferenceMap.BasicEntry<>(
                        Long2ReferenceArrayMap.this.key[this.curr = this.next], (V)Long2ReferenceArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Long2ReferenceMap.Entry<V>> spliterator() {
         return new Long2ReferenceArrayMap.EntrySet.EntrySetSpliterator(0, Long2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Long2ReferenceMap.Entry<V>> action) {
         ...
         for (int max = Long2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractLong2ReferenceMap.BasicEntry<>(Long2ReferenceArrayMap.this.key[i], (V)Long2ReferenceArrayMap.this.value[i]));
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Long2ReferenceMap.Entry<V> get(int location) {
            return new AbstractLong2ReferenceMap.BasicEntry<>(Long2ReferenceArrayMap.this.key[location], (V)Long2ReferenceArrayMap.this.value[location]);
         }

         protected final Long2ReferenceArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return new Long2ReferenceArrayMap.KeySet.KeySetSpliterator(0, Long2ReferenceArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends LongSpliterators.EarlyBindingSizeIndexBasedSpliterator implements LongSpliterator {
         ...
         protected final Long2ReferenceArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractReferenceCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Long2ReferenceArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Long2ReferenceArrayMap.ValuesCollection.ValuesSpliterator(0, Long2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Long2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((V)Long2ReferenceArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final Long2ReferenceArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
