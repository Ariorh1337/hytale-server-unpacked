...
public final class LongIterators {
   ...
   public static LongIterator asLongIterator(Iterator i) {
      if (i instanceof LongIterator) {
         ...
         return i instanceof OfLong ? new LongIterators.PrimitiveIteratorWrapper((OfLong)i) : new LongIterators.IteratorWrapper(i);
      }
   }

   public static LongListIterator asLongIterator(ListIterator i) {
      return i instanceof LongListIterator ? (LongListIterator)i : new LongIterators.ListIteratorWrapper(i);
   }
