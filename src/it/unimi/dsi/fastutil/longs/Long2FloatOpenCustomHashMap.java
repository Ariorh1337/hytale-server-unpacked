...
public class Long2FloatOpenCustomHashMap extends AbstractLong2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Long2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      float[] value = this.value;
      Long2FloatOpenCustomHashMap.EntryIterator i = new Long2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Long2FloatOpenCustomHashMap.MapIterator<Consumer<? super Long2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Long2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Long2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Long2FloatMap.Entry>, Long2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2FloatMap.Entry> action, int index) {
         action.accept(Long2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Long2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Long2FloatOpenCustomHashMap.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2FloatOpenCustomHashMap.MapSpliterator<java.util.function.LongConsumer, Long2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Long2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Long2FloatMap.Entry, Entry<Long, Float>, LongFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Long2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Long2FloatMap.Entry> spliterator() {
         return Long2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Long2FloatMap.Entry> consumer) {
         if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Long2FloatOpenCustomHashMap.this.new MapEntry(Long2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2FloatOpenCustomHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2FloatMap.Entry> consumer) {
         Long2FloatOpenCustomHashMap.MapEntry entry = Long2FloatOpenCustomHashMap.this.new MapEntry();
         if (Long2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Long2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Long2FloatOpenCustomHashMap.this.realSize() / Long2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Long2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Long2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Long2FloatOpenCustomHashMap.ValueSpliterator>
      ...
      final Long2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
