...
public class Long2IntOpenHashMap extends AbstractLong2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Long2IntOpenHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(IntConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Long2IntOpenHashMap.this.key[pos] != 0L) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      long[] key = this.key;
      int[] value = this.value;
      Long2IntOpenHashMap.EntryIterator i = new Long2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Long2IntOpenHashMap.MapIterator<Consumer<? super Long2IntMap.Entry>> implements ObjectIterator<Long2IntMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Long2IntMap.Entry> action, int index) {
         action.accept(this.entry = Long2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Long2IntOpenHashMap.MapSpliterator<Consumer<? super Long2IntMap.Entry>, Long2IntOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Long2IntMap.Entry> action, int index) {
         action.accept(Long2IntOpenHashMap.this.new MapEntry(index));
      }

      final Long2IntOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Long2IntOpenHashMap.MapIterator<Consumer<? super Long2IntMap.Entry>>
      implements ObjectIterator<Long2IntMap.Entry> {
      private final Long2IntOpenHashMap.MapEntry entry = Long2IntOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Long2IntOpenHashMap.MapIterator<java.util.function.LongConsumer> implements LongIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractLongSet {
      ...
      public LongSpliterator spliterator() {
         return Long2IntOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Long2IntOpenHashMap.MapSpliterator<java.util.function.LongConsumer, Long2IntOpenHashMap.KeySpliterator>
      ...
      final Long2IntOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Long2IntMap.Entry, Entry<Long, Integer>, LongIntPair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Long, Integer> e = (Entry<Long, Integer>)o;
         return Long2IntOpenHashMap.this.key[this.index] == e.getKey() && Long2IntOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Long2IntMap.Entry> implements Long2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Long2IntMap.Entry> spliterator() {
         return Long2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Integer) {
            ...
            long curr;
            int pos;
            if ((curr = key[pos = (int)HashCommon.mix(k) & Long2IntOpenHashMap.this.mask]) == 0L) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Long2IntOpenHashMap.this.mask]) != 0L) {
               if (k == curr) {
                  return Long2IntOpenHashMap.this.value[pos] == v;
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Integer) {
               ...
               if (k == 0L) {
                  ...
                  if (curr == k) {
                     ...
                     while ((curr = key[pos = pos + 1 & Long2IntOpenHashMap.this.mask]) != 0L) {
                        if (curr == k && Long2IntOpenHashMap.this.value[pos] == v) {
                           Long2IntOpenHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Long2IntMap.Entry> consumer) {
         if (Long2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Long2IntOpenHashMap.this.new MapEntry(Long2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Long2IntOpenHashMap.this.key[pos] != 0L) {
               consumer.accept(Long2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Long2IntMap.Entry> consumer) {
         Long2IntOpenHashMap.MapEntry entry = Long2IntOpenHashMap.this.new MapEntry();
         if (Long2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Long2IntOpenHashMap.this.n;
      int last = -1;
      int c = Long2IntOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Long2IntOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            long curr;
            for (pos = pos + 1 & Long2IntOpenHashMap.this.mask; (curr = key[pos]) != 0L; pos = pos + 1 & Long2IntOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2IntOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2IntOpenHashMap.this.size - this.c
            : Math.min(
               Long2IntOpenHashMap.this.size - this.c,
               (long)((double)Long2IntOpenHashMap.this.realSize() / Long2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Long2IntOpenHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator extends Long2IntOpenHashMap.MapSpliterator<IntConsumer, Long2IntOpenHashMap.ValueSpliterator> implements IntSpliterator {
      ...
      final Long2IntOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Long2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
