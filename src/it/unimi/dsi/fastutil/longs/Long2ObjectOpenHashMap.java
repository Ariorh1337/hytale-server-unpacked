...
public class Long2ObjectOpenHashMap<V> extends AbstractLong2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   private final class EntryIterator
      extends Long2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Long2ObjectMap.Entry<V>>>
   ...
   private final class EntrySpliterator
      extends Long2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Long2ObjectMap.Entry<V>>, Long2ObjectOpenHashMap<V>.EntrySpliterator>
   ...
   private final class KeySpliterator
      extends Long2ObjectOpenHashMap<V>.MapSpliterator<java.util.function.LongConsumer, Long2ObjectOpenHashMap<V>.KeySpliterator>
   ...
   final class MapEntry implements Long2ObjectMap.Entry<V>, Entry<Long, V>, LongObjectPair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Long2ObjectOpenHashMap.this.key[this.index] == e.getKey() && Objects.equals(Long2ObjectOpenHashMap.this.value[this.index], e.getValue());
      }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Long2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Long2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Long2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Long2ObjectOpenHashMap.this.realSize() / Long2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueSpliterator
      extends Long2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Long2ObjectOpenHashMap<V>.ValueSpliterator>
