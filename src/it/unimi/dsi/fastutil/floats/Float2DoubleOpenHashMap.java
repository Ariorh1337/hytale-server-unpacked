...
public class Float2DoubleOpenHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Float2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      double[] value = this.value;
      Float2DoubleOpenHashMap.EntryIterator i = new Float2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2DoubleOpenHashMap.MapIterator<Consumer<? super Float2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Float2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2DoubleOpenHashMap.MapSpliterator<Consumer<? super Float2DoubleMap.Entry>, Float2DoubleOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2DoubleMap.Entry> action, int index) {
         action.accept(Float2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Float2DoubleOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2DoubleOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2DoubleOpenHashMap.MapSpliterator<FloatConsumer, Float2DoubleOpenHashMap.KeySpliterator>
      ...
      final Float2DoubleOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2DoubleMap.Entry, Entry<Float, Double>, FloatDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey())
            && Double.doubleToLongBits(Float2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2DoubleMap.Entry> spliterator() {
         return Float2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2DoubleMap.Entry> consumer) {
         if (Float2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Float2DoubleOpenHashMap.this.new MapEntry(Float2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2DoubleOpenHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2DoubleMap.Entry> consumer) {
         Float2DoubleOpenHashMap.MapEntry entry = Float2DoubleOpenHashMap.this.new MapEntry();
         if (Float2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2DoubleOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            float curr;
            for (pos = pos + 1 & Float2DoubleOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Float2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Float2DoubleOpenHashMap.this.realSize() / Float2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Float2DoubleOpenHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Float2DoubleOpenHashMap.MapSpliterator<DoubleConsumer, Float2DoubleOpenHashMap.ValueSpliterator>
      ...
      final Float2DoubleOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
