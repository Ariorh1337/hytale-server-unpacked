...
public class Float2ObjectArrayMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Float2ObjectMap.FastEntrySet<V> float2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new Float2ObjectArrayMap.EntrySet();
      }
   ...
   public FloatSet keySet() {
      if (this.keys == null) {
         this.keys = new Float2ObjectArrayMap.KeySet();
      }
   ...
   public ObjectCollection<V> values() {
      if (this.values == null) {
         this.values = new Float2ObjectArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> {
         ...
         return new ObjectIterator<Float2ObjectMap.Entry<V>>() {
            ...
            public Float2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractFloat2ObjectMap.BasicEntry<>(
                     Float2ObjectArrayMap.this.key[this.curr = this.next], (V)Float2ObjectArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Float2ObjectMap.Entry<V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractFloat2ObjectMap.BasicEntry<>(
                        Float2ObjectArrayMap.this.key[this.curr = this.next], (V)Float2ObjectArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Float2ObjectMap.Entry<V>> spliterator() {
         return new Float2ObjectArrayMap.EntrySet.EntrySetSpliterator(0, Float2ObjectArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> action) {
         ...
         for (int max = Float2ObjectArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractFloat2ObjectMap.BasicEntry<>(Float2ObjectArrayMap.this.key[i], (V)Float2ObjectArrayMap.this.value[i]));
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> action) {
         ...
         for (int max = Float2ObjectArrayMap.this.size; i < max; i++) {
            ...
            entry.value = (V)Float2ObjectArrayMap.this.value[i];
            action.accept(entry);
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Float2ObjectMap.Entry<V> get(int location) {
            return new AbstractFloat2ObjectMap.BasicEntry<>(Float2ObjectArrayMap.this.key[location], (V)Float2ObjectArrayMap.this.value[location]);
         }

         protected final Float2ObjectArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return new Float2ObjectArrayMap.KeySet.KeySetSpliterator(0, Float2ObjectArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends FloatSpliterators.EarlyBindingSizeIndexBasedSpliterator implements FloatSpliterator {
         ...
         protected final Float2ObjectArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractObjectCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Float2ObjectArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Float2ObjectArrayMap.ValuesCollection.ValuesSpliterator(0, Float2ObjectArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Float2ObjectArrayMap.this.size; i < max; i++) {
            action.accept((V)Float2ObjectArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final V get(int location) {
            return (V)Float2ObjectArrayMap.this.value[location];
         }

         protected final Float2ObjectArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
