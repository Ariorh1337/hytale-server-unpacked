...
public class Float2ByteOpenHashMap extends AbstractFloat2ByteMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Float2ByteOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      byte[] value = this.value;
      Float2ByteOpenHashMap.EntryIterator i = new Float2ByteOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2ByteOpenHashMap.MapIterator<Consumer<? super Float2ByteMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Float2ByteOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2ByteOpenHashMap.MapSpliterator<Consumer<? super Float2ByteMap.Entry>, Float2ByteOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2ByteMap.Entry> action, int index) {
         action.accept(Float2ByteOpenHashMap.this.new MapEntry(index));
      }

      final Float2ByteOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ByteOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2ByteOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2ByteOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2ByteOpenHashMap.MapSpliterator<FloatConsumer, Float2ByteOpenHashMap.KeySpliterator>
      ...
      final Float2ByteOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ByteOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2ByteMap.Entry, Entry<Float, Byte>, FloatBytePair {
      ...
      public boolean equals(Object o) {
         ...
         return Float.floatToIntBits(Float2ByteOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey())
            && Float2ByteOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2ByteMap.Entry> spliterator() {
         return Float2ByteOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2ByteMap.Entry> consumer) {
         if (Float2ByteOpenHashMap.this.containsNullKey) {
            consumer.accept(Float2ByteOpenHashMap.this.new MapEntry(Float2ByteOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2ByteOpenHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2ByteOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2ByteMap.Entry> consumer) {
         Float2ByteOpenHashMap.MapEntry entry = Float2ByteOpenHashMap.this.new MapEntry();
         if (Float2ByteOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2ByteOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2ByteOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2ByteOpenHashMap.this.size - this.c
            : Math.min(
               Float2ByteOpenHashMap.this.size - this.c,
               (long)((double)Float2ByteOpenHashMap.this.realSize() / Float2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Float2ByteOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Float2ByteOpenHashMap.MapSpliterator<ByteConsumer, Float2ByteOpenHashMap.ValueSpliterator>
      ...
      final Float2ByteOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ByteOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
