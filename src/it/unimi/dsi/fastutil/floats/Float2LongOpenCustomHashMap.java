...
public class Float2LongOpenCustomHashMap extends AbstractFloat2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Float2LongOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      long[] value = this.value;
      Float2LongOpenCustomHashMap.EntryIterator i = new Float2LongOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2LongOpenCustomHashMap.MapIterator<Consumer<? super Float2LongMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2LongMap.Entry> action, int index) {
         action.accept(this.entry = Float2LongOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2LongOpenCustomHashMap.MapSpliterator<Consumer<? super Float2LongMap.Entry>, Float2LongOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2LongMap.Entry> action, int index) {
         action.accept(Float2LongOpenCustomHashMap.this.new MapEntry(index));
      }

      final Float2LongOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2LongOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2LongOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2LongOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2LongOpenCustomHashMap.MapSpliterator<FloatConsumer, Float2LongOpenCustomHashMap.KeySpliterator>
      ...
      final Float2LongOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2LongOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2LongMap.Entry, Entry<Float, Long>, FloatLongPair {
      ...
      public boolean equals(Object o) {
         ...
         return Float2LongOpenCustomHashMap.this.strategy.equals(Float2LongOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float2LongOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2LongMap.Entry> implements Float2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2LongMap.Entry> spliterator() {
         return Float2LongOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Long) {
            ...
            if (Float.floatToIntBits(
                  curr = key[pos = HashCommon.mix(Float2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Float2LongOpenCustomHashMap.this.mask]
               )
               == 0) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Float2LongMap.Entry> consumer) {
         if (Float2LongOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Float2LongOpenCustomHashMap.this.new MapEntry(Float2LongOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2LongOpenCustomHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2LongOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2LongMap.Entry> consumer) {
         Float2LongOpenCustomHashMap.MapEntry entry = Float2LongOpenCustomHashMap.this.new MapEntry();
         if (Float2LongOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2LongOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2LongOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2LongOpenCustomHashMap.this.size - this.c
            : Math.min(
               Float2LongOpenCustomHashMap.this.size - this.c,
               (long)((double)Float2LongOpenCustomHashMap.this.realSize() / Float2LongOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2LongOpenCustomHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Float2LongOpenCustomHashMap.MapSpliterator<LongConsumer, Float2LongOpenCustomHashMap.ValueSpliterator>
      ...
      final Float2LongOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2LongOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
