...
public class Float2FloatOpenCustomHashMap extends AbstractFloat2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Float2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(FloatConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[pos]) != 0) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      float[] value = this.value;
      Float2FloatOpenCustomHashMap.EntryIterator i = new Float2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2FloatOpenCustomHashMap.MapIterator<Consumer<? super Float2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Float2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Float2FloatMap.Entry>, Float2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2FloatMap.Entry> action, int index) {
         action.accept(Float2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Float2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Float2FloatOpenCustomHashMap.MapIterator<Consumer<? super Float2FloatMap.Entry>>
      implements ObjectIterator<Float2FloatMap.Entry> {
      private final Float2FloatOpenCustomHashMap.MapEntry entry = Float2FloatOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Float2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      @Override
      public FloatSpliterator spliterator() {
         return Float2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Float2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Float2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2FloatMap.Entry, Entry<Float, Float>, FloatFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Float2FloatOpenCustomHashMap.this.strategy.hashCode(Float2FloatOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.float2int(Float2FloatOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2FloatMap.Entry> implements Float2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2FloatMap.Entry> spliterator() {
         return Float2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
               return Float2FloatOpenCustomHashMap.this.containsNullKey
                  && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[Float2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }
            ...
            if (Float.floatToIntBits(
                  curr = key[pos = HashCommon.mix(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Float2FloatOpenCustomHashMap.this.mask]
               )
               == 0) {
               return false;
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (Float2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
                  ...
                  if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                     ...
                     while (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask]) != 0) {
                        if (Float2FloatOpenCustomHashMap.this.strategy.equals(curr, k)
                           && Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                           Float2FloatOpenCustomHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Float2FloatMap.Entry> consumer) {
         if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Float2FloatOpenCustomHashMap.this.new MapEntry(Float2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2FloatOpenCustomHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2FloatMap.Entry> consumer) {
         Float2FloatOpenCustomHashMap.MapEntry entry = Float2FloatOpenCustomHashMap.this.new MapEntry();
         if (Float2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Float2FloatOpenCustomHashMap.this.n;
      int last = -1;
      int c = Float2FloatOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            float curr;
            for (pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Float2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Float2FloatOpenCustomHashMap.this.realSize() / Float2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Float2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Float2FloatOpenCustomHashMap.ValueSpliterator>
      implements FloatSpliterator {
      ...
      final Float2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
