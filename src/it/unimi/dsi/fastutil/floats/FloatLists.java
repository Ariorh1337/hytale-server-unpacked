...
public final class FloatLists {
   ...
   public static FloatList synchronize(FloatList l) {
      return l instanceof RandomAccess ? new FloatLists.SynchronizedRandomAccessList(l) : new FloatLists.SynchronizedList(l);
   }

   public static FloatList synchronize(FloatList l, Object sync) {
      return l instanceof RandomAccess ? new FloatLists.SynchronizedRandomAccessList(l, sync) : new FloatLists.SynchronizedList(l, sync);
   }

   public static FloatList unmodifiable(FloatList l) {
      return l instanceof RandomAccess ? new FloatLists.UnmodifiableRandomAccessList(l) : new FloatLists.UnmodifiableList(l);
   }
