...
public class Float2BooleanOpenCustomHashMap extends AbstractFloat2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Float2BooleanOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      boolean[] value = this.value;
      Float2BooleanOpenCustomHashMap.EntryIterator i = new Float2BooleanOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Float2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Float2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2BooleanOpenCustomHashMap.MapSpliterator<Consumer<? super Float2BooleanMap.Entry>, Float2BooleanOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2BooleanMap.Entry> action, int index) {
         action.accept(Float2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }

      final Float2BooleanOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2BooleanOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Float2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Float2BooleanMap.Entry>>
      implements ObjectIterator<Float2BooleanMap.Entry> {
      private final Float2BooleanOpenCustomHashMap.MapEntry entry = Float2BooleanOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Float2BooleanOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2BooleanOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2BooleanOpenCustomHashMap.MapSpliterator<FloatConsumer, Float2BooleanOpenCustomHashMap.KeySpliterator>
      ...
      final Float2BooleanOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2BooleanOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2BooleanMap.Entry, Entry<Float, Boolean>, FloatBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Float2BooleanOpenCustomHashMap.this.strategy.equals(Float2BooleanOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Float2BooleanOpenCustomHashMap.this.strategy.hashCode(Float2BooleanOpenCustomHashMap.this.key[this.index])
            ^ (Float2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2BooleanMap.Entry> implements Float2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2BooleanMap.Entry> spliterator() {
         return Float2BooleanOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Boolean) {
            ...
            if (Float2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
               return Float2BooleanOpenCustomHashMap.this.containsNullKey
                  && Float2BooleanOpenCustomHashMap.this.value[Float2BooleanOpenCustomHashMap.this.n] == v;
            }
            ...
            if (Float.floatToIntBits(
                  curr = key[pos = HashCommon.mix(Float2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Float2BooleanOpenCustomHashMap.this.mask]
               )
               == 0) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
         if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Float2BooleanOpenCustomHashMap.this.new MapEntry(Float2BooleanOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2BooleanOpenCustomHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2BooleanOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2BooleanMap.Entry> consumer) {
         Float2BooleanOpenCustomHashMap.MapEntry entry = Float2BooleanOpenCustomHashMap.this.new MapEntry();
         if (Float2BooleanOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Float2BooleanOpenCustomHashMap.this.n;
      int last = -1;
      int c = Float2BooleanOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2BooleanOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            float curr;
            for (pos = pos + 1 & Float2BooleanOpenCustomHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2BooleanOpenCustomHashMap.this.size - this.c
            : Math.min(
               Float2BooleanOpenCustomHashMap.this.size - this.c,
               (long)((double)Float2BooleanOpenCustomHashMap.this.realSize() / Float2BooleanOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2BooleanOpenCustomHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Float2BooleanOpenCustomHashMap.MapSpliterator<BooleanConsumer, Float2BooleanOpenCustomHashMap.ValueSpliterator>
      ...
      final Float2BooleanOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2BooleanOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
