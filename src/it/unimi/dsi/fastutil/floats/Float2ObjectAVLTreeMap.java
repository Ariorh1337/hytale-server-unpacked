...
public class Float2ObjectAVLTreeMap<V> extends AbstractFloat2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   private Float2ObjectAVLTreeMap.Entry<V> parent(Float2ObjectAVLTreeMap.Entry<V> e) {
      ...
      Float2ObjectAVLTreeMap.Entry<V> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Float2ObjectAVLTreeMap.Entry<V> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2ObjectMap.Entry<V>>() {
            final Comparator<? super Float2ObjectMap.Entry<V>> comparator = Float2ObjectAVLTreeMap.this.actualComparator == null
