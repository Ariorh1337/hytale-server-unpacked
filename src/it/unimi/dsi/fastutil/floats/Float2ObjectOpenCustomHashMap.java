...
public class Float2ObjectOpenCustomHashMap<V> extends AbstractFloat2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Float2ObjectOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      V[] value = this.value;
      Float2ObjectOpenCustomHashMap<V>.EntryIterator i = new Float2ObjectOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super Float2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Float2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Float2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Float2ObjectMap.Entry<V>>, Float2ObjectOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2ObjectMap.Entry<V>> action, int index) {
         action.accept(Float2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }

      final Float2ObjectOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ObjectOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2ObjectOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2ObjectOpenCustomHashMap<V>.MapSpliterator<FloatConsumer, Float2ObjectOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Float2ObjectOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ObjectOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2ObjectMap.Entry<V>, Entry<Float, V>, FloatObjectPair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[this.index], e.getKey())
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Float2ObjectMap.Entry<V>> spliterator() {
         return Float2ObjectOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
         if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Float2ObjectOpenCustomHashMap.this.new MapEntry(Float2ObjectOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2ObjectOpenCustomHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2ObjectOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2ObjectMap.Entry<V>> consumer) {
         Float2ObjectOpenCustomHashMap<V>.MapEntry entry = Float2ObjectOpenCustomHashMap.this.new MapEntry();
         if (Float2ObjectOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2ObjectOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2ObjectOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2ObjectOpenCustomHashMap.this.size - this.c
            : Math.min(
               Float2ObjectOpenCustomHashMap.this.size - this.c,
               (long)((double)Float2ObjectOpenCustomHashMap.this.realSize() / Float2ObjectOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Float2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Float2ObjectOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Float2ObjectOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ObjectOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
