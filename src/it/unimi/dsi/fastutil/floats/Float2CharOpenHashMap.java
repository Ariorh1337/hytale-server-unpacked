...
public class Float2CharOpenHashMap extends AbstractFloat2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Float2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      char[] value = this.value;
      Float2CharOpenHashMap.EntryIterator i = new Float2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2CharOpenHashMap.MapIterator<Consumer<? super Float2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2CharMap.Entry> action, int index) {
         action.accept(this.entry = Float2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2CharOpenHashMap.MapSpliterator<Consumer<? super Float2CharMap.Entry>, Float2CharOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2CharMap.Entry> action, int index) {
         action.accept(Float2CharOpenHashMap.this.new MapEntry(index));
      }

      final Float2CharOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2CharOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2CharOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2CharOpenHashMap.MapSpliterator<FloatConsumer, Float2CharOpenHashMap.KeySpliterator>
      ...
      final Float2CharOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2CharMap.Entry, Entry<Float, Character>, FloatCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Float.floatToIntBits(Float2CharOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey())
            && Float2CharOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2CharMap.Entry> spliterator() {
         return Float2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2CharMap.Entry> consumer) {
         if (Float2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Float2CharOpenHashMap.this.new MapEntry(Float2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2CharOpenHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2CharMap.Entry> consumer) {
         Float2CharOpenHashMap.MapEntry entry = Float2CharOpenHashMap.this.new MapEntry();
         if (Float2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2CharOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2CharOpenHashMap.this.size - this.c
            : Math.min(
               Float2CharOpenHashMap.this.size - this.c,
               (long)((double)Float2CharOpenHashMap.this.realSize() / Float2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Float2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Float2CharOpenHashMap.MapSpliterator<CharConsumer, Float2CharOpenHashMap.ValueSpliterator>
      ...
      final Float2CharOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
