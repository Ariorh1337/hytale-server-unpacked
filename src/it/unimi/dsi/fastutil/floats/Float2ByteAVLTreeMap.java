...
public class Float2ByteAVLTreeMap extends AbstractFloat2ByteSortedMap implements Serializable, Cloneable {
   ...
   private Float2ByteAVLTreeMap.Entry parent(Float2ByteAVLTreeMap.Entry e) {
      ...
      Float2ByteAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Float2ByteAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Float2ByteMap.Entry>() {
            final Comparator<? super Float2ByteMap.Entry> comparator = Float2ByteAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Float.compare(x.getFloatKey(), y.getFloatKey())
               : (x, y) -> Float2ByteAVLTreeMap.this.actualComparator.compare(x.getFloatKey(), y.getFloatKey());
