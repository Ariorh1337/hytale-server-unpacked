...
public class Float2ReferenceOpenHashMap<V> extends AbstractFloat2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Float2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      V[] value = this.value;
      Float2ReferenceOpenHashMap<V>.EntryIterator i = new Float2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Float2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Float2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Float2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super Float2ReferenceMap.Entry<V>>, Float2ReferenceOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Float2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Float2ReferenceOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2ReferenceOpenHashMap<V>.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2ReferenceOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2ReferenceOpenHashMap<V>.MapSpliterator<FloatConsumer, Float2ReferenceOpenHashMap<V>.KeySpliterator>
      ...
      final Float2ReferenceOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2ReferenceMap.Entry<V>, Entry<Float, V>, FloatReferencePair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey())
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>> implements Float2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Float2ReferenceMap.Entry<V>> spliterator() {
         return Float2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
         if (Float2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Float2ReferenceOpenHashMap.this.new MapEntry(Float2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2ReferenceOpenHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2ReferenceMap.Entry<V>> consumer) {
         Float2ReferenceOpenHashMap<V>.MapEntry entry = Float2ReferenceOpenHashMap.this.new MapEntry();
         if (Float2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2ReferenceOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            float curr;
            for (pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2ReferenceOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Float2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Float2ReferenceOpenHashMap.this.realSize() / Float2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Float2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Float2ReferenceOpenHashMap<V>.ValueSpliterator>
      ...
      final Float2ReferenceOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
