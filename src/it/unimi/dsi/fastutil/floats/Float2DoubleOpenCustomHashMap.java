...
public class Float2DoubleOpenCustomHashMap extends AbstractFloat2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Float2DoubleOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(DoubleConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Float.floatToIntBits(Float2DoubleOpenCustomHashMap.this.key[pos]) != 0) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      double[] value = this.value;
      Float2DoubleOpenCustomHashMap.EntryIterator i = new Float2DoubleOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2DoubleOpenCustomHashMap.MapIterator<Consumer<? super Float2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Float2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2DoubleOpenCustomHashMap.MapSpliterator<Consumer<? super Float2DoubleMap.Entry>, Float2DoubleOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2DoubleMap.Entry> action, int index) {
         action.accept(Float2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }

      final Float2DoubleOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Float2DoubleOpenCustomHashMap.MapIterator<Consumer<? super Float2DoubleMap.Entry>>
      implements ObjectIterator<Float2DoubleMap.Entry> {
      private final Float2DoubleOpenCustomHashMap.MapEntry entry = Float2DoubleOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Float2DoubleOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2DoubleOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2DoubleOpenCustomHashMap.MapSpliterator<FloatConsumer, Float2DoubleOpenCustomHashMap.KeySpliterator>
      ...
      final Float2DoubleOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Float2DoubleMap.Entry, Entry<Float, Double>, FloatDoublePair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Float, Double> e = (Entry<Float, Double>)o;
         return Float2DoubleOpenCustomHashMap.this.strategy.equals(Float2DoubleOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Float2DoubleOpenCustomHashMap.this.strategy.hashCode(Float2DoubleOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.double2int(Float2DoubleOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2DoubleMap.Entry> implements Float2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2DoubleMap.Entry> spliterator() {
         return Float2DoubleOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Double) {
            ...
            if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
               return Float2DoubleOpenCustomHashMap.this.containsNullKey
                  && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[Float2DoubleOpenCustomHashMap.this.n]) == Double.doubleToLongBits(v);
            }
            ...
            if (Float.floatToIntBits(
                  curr = key[pos = HashCommon.mix(Float2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Float2DoubleOpenCustomHashMap.this.mask]
               )
               == 0) {
               return false;
            }
            ...
            while (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask]) != 0) {
               if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, curr)) {
                  return Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v);
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Double) {
               ...
               if (Float2DoubleOpenCustomHashMap.this.strategy.equals(k, 0.0F)) {
                  ...
                  if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)) {
                     ...
                     while (Float.floatToIntBits(curr = key[pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask]) != 0) {
                        if (Float2DoubleOpenCustomHashMap.this.strategy.equals(curr, k)
                           && Double.doubleToLongBits(Float2DoubleOpenCustomHashMap.this.value[pos]) == Double.doubleToLongBits(v)) {
                           Float2DoubleOpenCustomHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Float2DoubleMap.Entry> consumer) {
         if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Float2DoubleOpenCustomHashMap.this.new MapEntry(Float2DoubleOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2DoubleOpenCustomHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2DoubleOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2DoubleMap.Entry> consumer) {
         Float2DoubleOpenCustomHashMap.MapEntry entry = Float2DoubleOpenCustomHashMap.this.new MapEntry();
         if (Float2DoubleOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Float2DoubleOpenCustomHashMap.this.n;
      int last = -1;
      int c = Float2DoubleOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2DoubleOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            float curr;
            for (pos = pos + 1 & Float2DoubleOpenCustomHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2DoubleOpenCustomHashMap.this.size - this.c
            : Math.min(
               Float2DoubleOpenCustomHashMap.this.size - this.c,
               (long)((double)Float2DoubleOpenCustomHashMap.this.realSize() / Float2DoubleOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Float2DoubleOpenCustomHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Float2DoubleOpenCustomHashMap.MapSpliterator<DoubleConsumer, Float2DoubleOpenCustomHashMap.ValueSpliterator>
      ...
      final Float2DoubleOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2DoubleOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
