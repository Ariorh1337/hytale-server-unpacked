...
public final class FloatIterators {
   ...
   public static FloatIterator asFloatIterator(Iterator i) {
      return i instanceof FloatIterator ? (FloatIterator)i : new FloatIterators.IteratorWrapper(i);
   }
   ...
   public static FloatListIterator asFloatIterator(ListIterator i) {
      return i instanceof FloatListIterator ? (FloatListIterator)i : new FloatIterators.ListIteratorWrapper(i);
   }
