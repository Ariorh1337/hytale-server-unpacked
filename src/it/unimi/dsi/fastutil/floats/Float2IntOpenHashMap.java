...
public class Float2IntOpenHashMap extends AbstractFloat2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Float2IntOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      float[] key = this.key;
      int[] value = this.value;
      Float2IntOpenHashMap.EntryIterator i = new Float2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Float2IntOpenHashMap.MapIterator<Consumer<? super Float2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Float2IntMap.Entry> action, int index) {
         action.accept(this.entry = Float2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Float2IntOpenHashMap.MapSpliterator<Consumer<? super Float2IntMap.Entry>, Float2IntOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Float2IntMap.Entry> action, int index) {
         action.accept(Float2IntOpenHashMap.this.new MapEntry(index));
      }

      final Float2IntOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Float2IntOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractFloatSet {
      ...
      public FloatSpliterator spliterator() {
         return Float2IntOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Float2IntOpenHashMap.MapSpliterator<FloatConsumer, Float2IntOpenHashMap.KeySpliterator>
      ...
      final Float2IntOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Float2IntMap.Entry, Entry<Float, Integer>, FloatIntPair {
      ...
      public boolean equals(Object o) {
         ...
         return Float.floatToIntBits(Float2IntOpenHashMap.this.key[this.index]) == Float.floatToIntBits(e.getKey())
            && Float2IntOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Float2IntMap.Entry> implements Float2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Float2IntMap.Entry> spliterator() {
         return Float2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Float2IntMap.Entry> consumer) {
         if (Float2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Float2IntOpenHashMap.this.new MapEntry(Float2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Float.floatToIntBits(Float2IntOpenHashMap.this.key[pos]) != 0) {
               consumer.accept(Float2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Float2IntMap.Entry> consumer) {
         Float2IntOpenHashMap.MapEntry entry = Float2IntOpenHashMap.this.new MapEntry();
         if (Float2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Float2IntOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Float2IntOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Float2IntOpenHashMap.this.size - this.c
            : Math.min(
               Float2IntOpenHashMap.this.size - this.c,
               (long)((double)Float2IntOpenHashMap.this.realSize() / Float2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Float2IntOpenHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Float2IntOpenHashMap.MapSpliterator<IntConsumer, Float2IntOpenHashMap.ValueSpliterator>
      ...
      final Float2IntOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Float2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
