...
public final class ShortLists {
   ...
   public static ShortList synchronize(ShortList l) {
      return l instanceof RandomAccess ? new ShortLists.SynchronizedRandomAccessList(l) : new ShortLists.SynchronizedList(l);
   }

   public static ShortList synchronize(ShortList l, Object sync) {
      return l instanceof RandomAccess ? new ShortLists.SynchronizedRandomAccessList(l, sync) : new ShortLists.SynchronizedList(l, sync);
   }

   public static ShortList unmodifiable(ShortList l) {
      return l instanceof RandomAccess ? new ShortLists.UnmodifiableRandomAccessList(l) : new ShortLists.UnmodifiableList(l);
   }
