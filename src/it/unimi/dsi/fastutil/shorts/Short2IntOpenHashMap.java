...
public class Short2IntOpenHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Short2IntOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      int[] value = this.value;
      Short2IntOpenHashMap.EntryIterator i = new Short2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2IntOpenHashMap.MapIterator<Consumer<? super Short2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2IntMap.Entry> action, int index) {
         action.accept(this.entry = Short2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2IntOpenHashMap.MapSpliterator<Consumer<? super Short2IntMap.Entry>, Short2IntOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2IntMap.Entry> action, int index) {
         action.accept(Short2IntOpenHashMap.this.new MapEntry(index));
      }

      final Short2IntOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Short2IntOpenHashMap.MapIterator<Consumer<? super Short2IntMap.Entry>>
      implements ObjectIterator<Short2IntMap.Entry> {
      private final Short2IntOpenHashMap.MapEntry entry = Short2IntOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Short2IntOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2IntOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2IntOpenHashMap.MapSpliterator<ShortConsumer, Short2IntOpenHashMap.KeySpliterator>
      ...
      final Short2IntOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2IntMap.Entry> spliterator() {
         return Short2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
         if (Short2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2IntOpenHashMap.this.new MapEntry(Short2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2IntOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
         Short2IntOpenHashMap.MapEntry entry = Short2IntOpenHashMap.this.new MapEntry();
         if (Short2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Short2IntOpenHashMap.this.n;
      int last = -1;
      int c = Short2IntOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2IntOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            short curr;
            for (pos = pos + 1 & Short2IntOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Short2IntOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2IntOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2IntOpenHashMap.this.size - this.c
            : Math.min(
               Short2IntOpenHashMap.this.size - this.c,
               (long)((double)Short2IntOpenHashMap.this.realSize() / Short2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Short2IntOpenHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Short2IntOpenHashMap.MapSpliterator<IntConsumer, Short2IntOpenHashMap.ValueSpliterator>
      ...
      final Short2IntOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
