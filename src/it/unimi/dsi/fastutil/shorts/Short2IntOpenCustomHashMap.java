...
public class Short2IntOpenCustomHashMap extends AbstractShort2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Short2IntOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      int[] value = this.value;
      Short2IntOpenCustomHashMap.EntryIterator i = new Short2IntOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2IntOpenCustomHashMap.MapIterator<Consumer<? super Short2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2IntMap.Entry> action, int index) {
         action.accept(this.entry = Short2IntOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2IntOpenCustomHashMap.MapSpliterator<Consumer<? super Short2IntMap.Entry>, Short2IntOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2IntMap.Entry> action, int index) {
         action.accept(Short2IntOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2IntOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2IntOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2IntOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2IntOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2IntOpenCustomHashMap.KeySpliterator>
      ...
      final Short2IntOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Short2IntMap.Entry, Entry<Short, Integer>, ShortIntPair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Short, Integer> e = (Entry<Short, Integer>)o;
         return Short2IntOpenCustomHashMap.this.strategy.equals(Short2IntOpenCustomHashMap.this.key[this.index], e.getKey())
            && Short2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2IntMap.Entry> implements Short2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2IntMap.Entry> spliterator() {
         return Short2IntOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2IntMap.Entry> consumer) {
         if (Short2IntOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2IntOpenCustomHashMap.this.new MapEntry(Short2IntOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2IntOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2IntOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2IntMap.Entry> consumer) {
         Short2IntOpenCustomHashMap.MapEntry entry = Short2IntOpenCustomHashMap.this.new MapEntry();
         if (Short2IntOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2IntOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2IntOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2IntOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2IntOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2IntOpenCustomHashMap.this.realSize() / Short2IntOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2IntOpenCustomHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Short2IntOpenCustomHashMap.MapSpliterator<IntConsumer, Short2IntOpenCustomHashMap.ValueSpliterator>
      ...
      final Short2IntOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2IntOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
