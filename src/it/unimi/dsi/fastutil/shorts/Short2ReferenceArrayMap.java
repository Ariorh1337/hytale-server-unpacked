...
public class Short2ReferenceArrayMap<V> extends AbstractShort2ReferenceMap<V> implements Serializable, Cloneable {
   ...
   public Short2ReferenceMap.FastEntrySet<V> short2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new Short2ReferenceArrayMap.EntrySet();
      }
   ...
   public ShortSet keySet() {
      if (this.keys == null) {
         this.keys = new Short2ReferenceArrayMap.KeySet();
      }
   ...
   public ReferenceCollection<V> values() {
      if (this.values == null) {
         this.values = new Short2ReferenceArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> {
         ...
         return new ObjectIterator<Short2ReferenceMap.Entry<V>>() {
            ...
            public Short2ReferenceMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractShort2ReferenceMap.BasicEntry<>(
                     Short2ReferenceArrayMap.this.key[this.curr = this.next], (V)Short2ReferenceArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Short2ReferenceMap.Entry<V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractShort2ReferenceMap.BasicEntry<>(
                        Short2ReferenceArrayMap.this.key[this.curr = this.next], (V)Short2ReferenceArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Short2ReferenceMap.Entry<V>> spliterator() {
         return new Short2ReferenceArrayMap.EntrySet.EntrySetSpliterator(0, Short2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> action) {
         ...
         for (int max = Short2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractShort2ReferenceMap.BasicEntry<>(Short2ReferenceArrayMap.this.key[i], (V)Short2ReferenceArrayMap.this.value[i]));
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> action) {
         ...
         for (int max = Short2ReferenceArrayMap.this.size; i < max; i++) {
            ...
            entry.value = (V)Short2ReferenceArrayMap.this.value[i];
            action.accept(entry);
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Short2ReferenceMap.Entry<V> get(int location) {
            return new AbstractShort2ReferenceMap.BasicEntry<>(Short2ReferenceArrayMap.this.key[location], (V)Short2ReferenceArrayMap.this.value[location]);
         }

         protected final Short2ReferenceArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return new Short2ReferenceArrayMap.KeySet.KeySetSpliterator(0, Short2ReferenceArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator implements ShortSpliterator {
         ...
         protected final Short2ReferenceArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractReferenceCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Short2ReferenceArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Short2ReferenceArrayMap.ValuesCollection.ValuesSpliterator(0, Short2ReferenceArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Short2ReferenceArrayMap.this.size; i < max; i++) {
            action.accept((V)Short2ReferenceArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final V get(int location) {
            return (V)Short2ReferenceArrayMap.this.value[location];
         }

         protected final Short2ReferenceArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
