...
public class Short2BooleanOpenCustomHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Short2BooleanOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      boolean[] value = this.value;
      Short2BooleanOpenCustomHashMap.EntryIterator i = new Short2BooleanOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Short2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Short2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2BooleanOpenCustomHashMap.MapSpliterator<Consumer<? super Short2BooleanMap.Entry>, Short2BooleanOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2BooleanMap.Entry> action, int index) {
         action.accept(Short2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2BooleanOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Short2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Short2BooleanMap.Entry>>
      implements ObjectIterator<Short2BooleanMap.Entry> {
      private final Short2BooleanOpenCustomHashMap.MapEntry entry = Short2BooleanOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Short2BooleanOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2BooleanOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2BooleanOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2BooleanOpenCustomHashMap.KeySpliterator>
      ...
      final Short2BooleanOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Short2BooleanMap.Entry, Entry<Short, Boolean>, ShortBooleanPair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Short, Boolean> e = (Entry<Short, Boolean>)o;
         return Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[this.index], e.getKey())
            && Short2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Short2BooleanOpenCustomHashMap.this.strategy.hashCode(Short2BooleanOpenCustomHashMap.this.key[this.index])
            ^ (Short2BooleanOpenCustomHashMap.this.value[this.index] ? 1231 : 1237);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2BooleanMap.Entry> spliterator() {
         return Short2BooleanOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Boolean) {
            ...
            if (Short2BooleanOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
               return Short2BooleanOpenCustomHashMap.this.containsNullKey
                  && Short2BooleanOpenCustomHashMap.this.value[Short2BooleanOpenCustomHashMap.this.n] == v;
            }
         ...
         if (e.getKey() != null && e.getKey() instanceof Short) {
            if (e.getValue() != null && e.getValue() instanceof Boolean) {
               ...
               if (Short2BooleanOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
                  ...
                  short curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask])
                     == 0) {
                     return false;
                  }
      ...
      public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
         if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2BooleanOpenCustomHashMap.this.new MapEntry(Short2BooleanOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2BooleanOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2BooleanOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
         Short2BooleanOpenCustomHashMap.MapEntry entry = Short2BooleanOpenCustomHashMap.this.new MapEntry();
         if (Short2BooleanOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Short2BooleanOpenCustomHashMap.this.n;
      int last = -1;
      int c = Short2BooleanOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2BooleanOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            short curr;
            for (pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2BooleanOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2BooleanOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2BooleanOpenCustomHashMap.this.realSize() / Short2BooleanOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2BooleanOpenCustomHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Short2BooleanOpenCustomHashMap.MapSpliterator<BooleanConsumer, Short2BooleanOpenCustomHashMap.ValueSpliterator>
      ...
      final Short2BooleanOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
