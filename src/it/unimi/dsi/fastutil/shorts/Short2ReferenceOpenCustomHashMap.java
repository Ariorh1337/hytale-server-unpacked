...
public class Short2ReferenceOpenCustomHashMap<V> extends AbstractShort2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Short2ReferenceOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      V[] value = this.value;
      Short2ReferenceOpenCustomHashMap<V>.EntryIterator i = new Short2ReferenceOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super Short2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Short2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Short2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Short2ReferenceMap.Entry<V>>, Short2ReferenceOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Short2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2ReferenceOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2ReferenceOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2ReferenceOpenCustomHashMap<V>.MapSpliterator<ShortConsumer, Short2ReferenceOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Short2ReferenceOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Short2ReferenceMap.Entry<V>, Entry<Short, V>, ShortReferencePair<V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())
      ...
      public int hashCode() {
         return Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(Short2ReferenceOpenCustomHashMap.this.key[this.index])
            ^ (
               Short2ReferenceOpenCustomHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Short2ReferenceOpenCustomHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Short2ReferenceMap.Entry<V>> spliterator() {
         return Short2ReferenceOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Short) {
            ...
            if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(k, (short)0)) {
               return Short2ReferenceOpenCustomHashMap.this.containsNullKey
                  && Short2ReferenceOpenCustomHashMap.this.value[Short2ReferenceOpenCustomHashMap.this.n] == v;
            }

            short[] key = Short2ReferenceOpenCustomHashMap.this.key;
            short curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask])
               == 0) {
               return false;
            }
      ...
      public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
         if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2ReferenceOpenCustomHashMap.this.new MapEntry(Short2ReferenceOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2ReferenceOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
         Short2ReferenceOpenCustomHashMap<V>.MapEntry entry = Short2ReferenceOpenCustomHashMap.this.new MapEntry();
         if (Short2ReferenceOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2ReferenceOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2ReferenceOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2ReferenceOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2ReferenceOpenCustomHashMap.this.realSize() / Short2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Short2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Short2ReferenceOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Short2ReferenceOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
