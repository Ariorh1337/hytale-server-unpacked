...
public class Short2ObjectOpenHashMap<V> extends AbstractShort2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Short2ObjectOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      V[] value = this.value;
      Short2ObjectOpenHashMap<V>.EntryIterator i = new Short2ObjectOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Short2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Short2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Short2ObjectOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Short2ObjectMap.Entry<V>>, Short2ObjectOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2ObjectMap.Entry<V>> action, int index) {
         action.accept(Short2ObjectOpenHashMap.this.new MapEntry(index));
      }

      final Short2ObjectOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ObjectOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2ObjectOpenHashMap<V>.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2ObjectOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2ObjectOpenHashMap<V>.MapSpliterator<ShortConsumer, Short2ObjectOpenHashMap<V>.KeySpliterator>
      ...
      final Short2ObjectOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ObjectOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2ObjectMap.Entry<V>, Entry<Short, V>, ShortObjectPair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Short2ObjectOpenHashMap.this.key[this.index] == e.getKey() && Objects.equals(Short2ObjectOpenHashMap.this.value[this.index], e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Short2ObjectMap.Entry<V>> spliterator() {
         return Short2ObjectOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
         if (Short2ObjectOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2ObjectOpenHashMap.this.new MapEntry(Short2ObjectOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2ObjectOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2ObjectOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2ObjectMap.Entry<V>> consumer) {
         Short2ObjectOpenHashMap<V>.MapEntry entry = Short2ObjectOpenHashMap.this.new MapEntry();
         if (Short2ObjectOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2ObjectOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Short2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Short2ObjectOpenHashMap.this.realSize() / Short2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Short2ObjectOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Short2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Short2ObjectOpenHashMap<V>.ValueSpliterator>
      ...
      final Short2ObjectOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ObjectOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
