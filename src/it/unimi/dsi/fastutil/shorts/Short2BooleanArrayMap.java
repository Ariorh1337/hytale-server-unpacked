...
public class Short2BooleanArrayMap extends AbstractShort2BooleanMap implements Serializable, Cloneable {
   ...
   public Short2BooleanArrayMap(Map<? extends Short, ? extends Boolean> m) {
      ...
      for (Entry<? extends Short, ? extends Boolean> e : m.entrySet()) {
         this.key[i] = e.getKey();
   ...
   public Short2BooleanMap.FastEntrySet short2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new Short2BooleanArrayMap.EntrySet();
      }
   ...
   public ShortSet keySet() {
      if (this.keys == null) {
         this.keys = new Short2BooleanArrayMap.KeySet();
      }
   ...
   public BooleanCollection values() {
      if (this.values == null) {
         this.values = new Short2BooleanArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
         ...
         return new ObjectIterator<Short2BooleanMap.Entry>() {
            ...
            public Short2BooleanMap.Entry next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractShort2BooleanMap.BasicEntry(
                     Short2BooleanArrayMap.this.key[this.curr = this.next], Short2BooleanArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Short2BooleanMap.Entry> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractShort2BooleanMap.BasicEntry(
                        Short2BooleanArrayMap.this.key[this.curr = this.next], Short2BooleanArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Short2BooleanMap.Entry> spliterator() {
         return new Short2BooleanArrayMap.EntrySet.EntrySetSpliterator(0, Short2BooleanArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Short2BooleanMap.Entry> action) {
         ...
         for (int max = Short2BooleanArrayMap.this.size; i < max; i++) {
      ...
      final class EntrySetSpliterator
         ...
         protected final Short2BooleanArrayMap.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return new Short2BooleanArrayMap.KeySet.KeySetSpliterator(0, Short2BooleanArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends ShortSpliterators.EarlyBindingSizeIndexBasedSpliterator implements ShortSpliterator {
         ...
         protected final Short2BooleanArrayMap.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractBooleanCollection {
      ...
      public BooleanSpliterator spliterator() {
         return new Short2BooleanArrayMap.ValuesCollection.ValuesSpliterator(0, Short2BooleanArrayMap.this.size);
      }
      ...
      final class ValuesSpliterator extends BooleanSpliterators.EarlyBindingSizeIndexBasedSpliterator implements BooleanSpliterator {
         ...
         protected final Short2BooleanArrayMap.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
