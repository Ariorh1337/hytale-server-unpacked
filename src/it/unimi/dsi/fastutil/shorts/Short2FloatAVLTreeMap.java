...
public class Short2FloatAVLTreeMap extends AbstractShort2FloatSortedMap implements Serializable, Cloneable {
   ...
   private Short2FloatAVLTreeMap.Entry parent(Short2FloatAVLTreeMap.Entry e) {
      ...
      Short2FloatAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Short2FloatAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2FloatMap.Entry>() {
            final Comparator<? super Short2FloatMap.Entry> comparator = Short2FloatAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey())
               : (x, y) -> Short2FloatAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
