...
public final class Short2ByteSortedMaps {
   ...
   public static class Singleton extends Short2ByteMaps.Singleton implements Short2ByteSortedMap, Serializable, Cloneable {
      ...
      public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
         if (this.entries == null) {
            this.entries = ObjectSortedSets.singleton(
               new AbstractShort2ByteMap.BasicEntry(this.key, this.value), Short2ByteSortedMaps.entryComparator(this.comparator)
            );
         }

         return (ObjectSortedSet<Short2ByteMap.Entry>)this.entries;
      }
      ...
      @Override
      public Short2ByteSortedMap subMap(short from, short to) {
         return this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Short2ByteSortedMaps.EMPTY_MAP;
      }

      @Override
      public Short2ByteSortedMap headMap(short to) {
         return this.compare(this.key, to) < 0 ? this : Short2ByteSortedMaps.EMPTY_MAP;
      }

      @Override
      public Short2ByteSortedMap tailMap(short from) {
         return this.compare(from, this.key) <= 0 ? this : Short2ByteSortedMaps.EMPTY_MAP;
      }
