...
public class Short2FloatOpenHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Short2FloatOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      float[] value = this.value;
      Short2FloatOpenHashMap.EntryIterator i = new Short2FloatOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2FloatOpenHashMap.MapIterator<Consumer<? super Short2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Short2FloatOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2FloatOpenHashMap.MapSpliterator<Consumer<? super Short2FloatMap.Entry>, Short2FloatOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2FloatMap.Entry> action, int index) {
         action.accept(Short2FloatOpenHashMap.this.new MapEntry(index));
      }

      final Short2FloatOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Short2FloatOpenHashMap.MapIterator<Consumer<? super Short2FloatMap.Entry>>
      implements ObjectIterator<Short2FloatMap.Entry> {
      private final Short2FloatOpenHashMap.MapEntry entry = Short2FloatOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Short2FloatOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2FloatOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2FloatOpenHashMap.MapSpliterator<ShortConsumer, Short2FloatOpenHashMap.KeySpliterator>
      ...
      final Short2FloatOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2FloatMap.Entry, Entry<Short, Float>, ShortFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2FloatOpenHashMap.this.key[this.index] == e.getKey()
            && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2FloatMap.Entry> spliterator() {
         return Short2FloatOpenHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (k == 0) {
               return Short2FloatOpenHashMap.this.containsNullKey
                  && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[Short2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v);
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (k == 0) {
                  ...
                  if (curr == k) {
                     ...
                     while ((curr = key[pos = pos + 1 & Short2FloatOpenHashMap.this.mask]) != 0) {
                        if (curr == k && Float.floatToIntBits(Short2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                           Short2FloatOpenHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
         if (Short2FloatOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2FloatOpenHashMap.this.new MapEntry(Short2FloatOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2FloatOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2FloatOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
         Short2FloatOpenHashMap.MapEntry entry = Short2FloatOpenHashMap.this.new MapEntry();
         if (Short2FloatOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Short2FloatOpenHashMap.this.n;
      int last = -1;
      int c = Short2FloatOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2FloatOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            short curr;
            for (pos = pos + 1 & Short2FloatOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Short2FloatOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2FloatOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2FloatOpenHashMap.this.size - this.c
            : Math.min(
               Short2FloatOpenHashMap.this.size - this.c,
               (long)((double)Short2FloatOpenHashMap.this.realSize() / Short2FloatOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Short2FloatOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Short2FloatOpenHashMap.MapSpliterator<FloatConsumer, Short2FloatOpenHashMap.ValueSpliterator>
      ...
      final Short2FloatOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
