...
public class Short2BooleanOpenHashMap extends AbstractShort2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Short2BooleanOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      boolean[] value = this.value;
      Short2BooleanOpenHashMap.EntryIterator i = new Short2BooleanOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2BooleanOpenHashMap.MapIterator<Consumer<? super Short2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Short2BooleanOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2BooleanOpenHashMap.MapSpliterator<Consumer<? super Short2BooleanMap.Entry>, Short2BooleanOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2BooleanMap.Entry> action, int index) {
         action.accept(Short2BooleanOpenHashMap.this.new MapEntry(index));
      }

      final Short2BooleanOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2BooleanOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2BooleanOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2BooleanOpenHashMap.MapSpliterator<ShortConsumer, Short2BooleanOpenHashMap.KeySpliterator>
      ...
      final Short2BooleanOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2BooleanMap.Entry, Entry<Short, Boolean>, ShortBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2BooleanOpenHashMap.this.key[this.index] == e.getKey() && Short2BooleanOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2BooleanMap.Entry> implements Short2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2BooleanMap.Entry> spliterator() {
         return Short2BooleanOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
         if (Short2BooleanOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2BooleanOpenHashMap.this.new MapEntry(Short2BooleanOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2BooleanOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2BooleanOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2BooleanMap.Entry> consumer) {
         Short2BooleanOpenHashMap.MapEntry entry = Short2BooleanOpenHashMap.this.new MapEntry();
         if (Short2BooleanOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2BooleanOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2BooleanOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2BooleanOpenHashMap.this.size - this.c
            : Math.min(
               Short2BooleanOpenHashMap.this.size - this.c,
               (long)((double)Short2BooleanOpenHashMap.this.realSize() / Short2BooleanOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2BooleanOpenHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Short2BooleanOpenHashMap.MapSpliterator<BooleanConsumer, Short2BooleanOpenHashMap.ValueSpliterator>
      ...
      final Short2BooleanOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2BooleanOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
