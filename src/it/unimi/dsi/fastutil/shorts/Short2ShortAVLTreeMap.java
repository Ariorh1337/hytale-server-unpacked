...
public class Short2ShortAVLTreeMap extends AbstractShort2ShortSortedMap implements Serializable, Cloneable {
   ...
   private Short2ShortAVLTreeMap.Entry parent(Short2ShortAVLTreeMap.Entry e) {
      ...
      Short2ShortAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Short2ShortAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2ShortMap.Entry>() {
            final Comparator<? super Short2ShortMap.Entry> comparator = Short2ShortAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey())
               : (x, y) -> Short2ShortAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
