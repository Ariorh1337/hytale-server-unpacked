...
public final class ShortIterators {
   ...
   public static ShortIterator asShortIterator(Iterator i) {
      return i instanceof ShortIterator ? (ShortIterator)i : new ShortIterators.IteratorWrapper(i);
   }
   ...
   public static ShortListIterator asShortIterator(ListIterator i) {
      return i instanceof ShortListIterator ? (ShortListIterator)i : new ShortIterators.ListIteratorWrapper(i);
   }
