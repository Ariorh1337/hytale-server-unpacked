...
public class Short2ReferenceOpenHashMap<V> extends AbstractShort2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Short2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      V[] value = this.value;
      Short2ReferenceOpenHashMap<V>.EntryIterator i = new Short2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Short2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Short2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Short2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super Short2ReferenceMap.Entry<V>>, Short2ReferenceOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Short2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Short2ReferenceOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2ReferenceOpenHashMap<V>.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2ReferenceOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2ReferenceOpenHashMap<V>.MapSpliterator<ShortConsumer, Short2ReferenceOpenHashMap<V>.KeySpliterator>
      ...
      final Short2ReferenceOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2ReferenceMap.Entry<V>, Entry<Short, V>, ShortReferencePair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Short2ReferenceOpenHashMap.this.key[this.index] == e.getKey() && Short2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Short2ReferenceMap.Entry<V>> spliterator() {
         return Short2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
         if (Short2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2ReferenceOpenHashMap.this.new MapEntry(Short2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2ReferenceOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2ReferenceMap.Entry<V>> consumer) {
         Short2ReferenceOpenHashMap<V>.MapEntry entry = Short2ReferenceOpenHashMap.this.new MapEntry();
         if (Short2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2ReferenceOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2ReferenceOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Short2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Short2ReferenceOpenHashMap.this.realSize() / Short2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Short2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Short2ReferenceOpenHashMap<V>.ValueSpliterator>
      ...
      final Short2ReferenceOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
