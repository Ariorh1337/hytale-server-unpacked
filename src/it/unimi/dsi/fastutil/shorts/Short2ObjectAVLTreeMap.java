...
public class Short2ObjectAVLTreeMap<V> extends AbstractShort2ObjectSortedMap<V> implements Serializable, Cloneable {
   ...
   private Short2ObjectAVLTreeMap.Entry<V> parent(Short2ObjectAVLTreeMap.Entry<V> e) {
      ...
      Short2ObjectAVLTreeMap.Entry<V> x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Short2ObjectAVLTreeMap.Entry<V> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2ObjectMap.Entry<V>>() {
            final Comparator<? super Short2ObjectMap.Entry<V>> comparator = Short2ObjectAVLTreeMap.this.actualComparator == null
