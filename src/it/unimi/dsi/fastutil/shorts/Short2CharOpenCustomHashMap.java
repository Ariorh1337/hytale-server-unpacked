...
public class Short2CharOpenCustomHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Short2CharOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      char[] value = this.value;
      Short2CharOpenCustomHashMap.EntryIterator i = new Short2CharOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2CharOpenCustomHashMap.MapIterator<Consumer<? super Short2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2CharMap.Entry> action, int index) {
         action.accept(this.entry = Short2CharOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2CharOpenCustomHashMap.MapSpliterator<Consumer<? super Short2CharMap.Entry>, Short2CharOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2CharMap.Entry> action, int index) {
         action.accept(Short2CharOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2CharOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2CharOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2CharOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2CharOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2CharOpenCustomHashMap.KeySpliterator>
      ...
      final Short2CharOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2CharMap.Entry, Entry<Short, Character>, ShortCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], e.getKey())
            && Short2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2CharMap.Entry> spliterator() {
         return Short2CharOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
         if (Short2CharOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2CharOpenCustomHashMap.this.new MapEntry(Short2CharOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2CharOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2CharOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
         Short2CharOpenCustomHashMap.MapEntry entry = Short2CharOpenCustomHashMap.this.new MapEntry();
         if (Short2CharOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2CharOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2CharOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2CharOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2CharOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2CharOpenCustomHashMap.this.realSize() / Short2CharOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2CharOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Short2CharOpenCustomHashMap.MapSpliterator<CharConsumer, Short2CharOpenCustomHashMap.ValueSpliterator>
      ...
      final Short2CharOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
