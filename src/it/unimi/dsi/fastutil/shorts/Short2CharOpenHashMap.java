...
public class Short2CharOpenHashMap extends AbstractShort2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Short2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      char[] value = this.value;
      Short2CharOpenHashMap.EntryIterator i = new Short2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2CharOpenHashMap.MapIterator<Consumer<? super Short2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2CharMap.Entry> action, int index) {
         action.accept(this.entry = Short2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2CharOpenHashMap.MapSpliterator<Consumer<? super Short2CharMap.Entry>, Short2CharOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2CharMap.Entry> action, int index) {
         action.accept(Short2CharOpenHashMap.this.new MapEntry(index));
      }

      final Short2CharOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Short2CharOpenHashMap.MapIterator<Consumer<? super Short2CharMap.Entry>>
      implements ObjectIterator<Short2CharMap.Entry> {
      private final Short2CharOpenHashMap.MapEntry entry = Short2CharOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Short2CharOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2CharOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2CharOpenHashMap.MapSpliterator<ShortConsumer, Short2CharOpenHashMap.KeySpliterator>
      ...
      final Short2CharOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Short2CharMap.Entry, Entry<Short, Character>, ShortCharPair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Short, Character> e = (Entry<Short, Character>)o;
         return Short2CharOpenHashMap.this.key[this.index] == e.getKey() && Short2CharOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2CharMap.Entry> spliterator() {
         return Short2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Character) {
            ...
            short curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(k) & Short2CharOpenHashMap.this.mask]) == 0) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Short2CharOpenHashMap.this.mask]) != 0) {
               if (k == curr) {
                  return Short2CharOpenHashMap.this.value[pos] == v;
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Character) {
               ...
               if (k == 0) {
                  ...
                  if (curr == k) {
                     ...
                     while ((curr = key[pos = pos + 1 & Short2CharOpenHashMap.this.mask]) != 0) {
                        if (curr == k && Short2CharOpenHashMap.this.value[pos] == v) {
                           Short2CharOpenHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Short2CharMap.Entry> consumer) {
         if (Short2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2CharOpenHashMap.this.new MapEntry(Short2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2CharOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2CharMap.Entry> consumer) {
         Short2CharOpenHashMap.MapEntry entry = Short2CharOpenHashMap.this.new MapEntry();
         if (Short2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Short2CharOpenHashMap.this.n;
      int last = -1;
      int c = Short2CharOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2CharOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            short curr;
            for (pos = pos + 1 & Short2CharOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Short2CharOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2CharOpenHashMap.this.size - this.c
            : Math.min(
               Short2CharOpenHashMap.this.size - this.c,
               (long)((double)Short2CharOpenHashMap.this.realSize() / Short2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Short2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Short2CharOpenHashMap.MapSpliterator<CharConsumer, Short2CharOpenHashMap.ValueSpliterator>
      ...
      final Short2CharOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
