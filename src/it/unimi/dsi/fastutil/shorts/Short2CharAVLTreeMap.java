...
public class Short2CharAVLTreeMap extends AbstractShort2CharSortedMap implements Serializable, Cloneable {
   ...
   private Short2CharAVLTreeMap.Entry parent(Short2CharAVLTreeMap.Entry e) {
      ...
      Short2CharAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Short2CharAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2CharMap.Entry>() {
            final Comparator<? super Short2CharMap.Entry> comparator = Short2CharAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey())
               : (x, y) -> Short2CharAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
