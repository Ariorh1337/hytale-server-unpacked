...
public class Short2ShortOpenCustomHashMap extends AbstractShort2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Short2ShortOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      short[] value = this.value;
      Short2ShortOpenCustomHashMap.EntryIterator i = new Short2ShortOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2ShortOpenCustomHashMap.MapIterator<Consumer<? super Short2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Short2ShortOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2ShortOpenCustomHashMap.MapSpliterator<Consumer<? super Short2ShortMap.Entry>, Short2ShortOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2ShortMap.Entry> action, int index) {
         action.accept(Short2ShortOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2ShortOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ShortOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2ShortOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      @Override
      public ShortSpliterator spliterator() {
         return Short2ShortOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2ShortOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2ShortOpenCustomHashMap.KeySpliterator>
      ...
      final Short2ShortOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ShortOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2ShortMap.Entry, Entry<Short, Short>, ShortShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[this.index], e.getKey())
            && Short2ShortOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2ShortMap.Entry> spliterator() {
         return Short2ShortOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2ShortMap.Entry> consumer) {
         if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2ShortOpenCustomHashMap.this.new MapEntry(Short2ShortOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2ShortOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2ShortOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2ShortMap.Entry> consumer) {
         Short2ShortOpenCustomHashMap.MapEntry entry = Short2ShortOpenCustomHashMap.this.new MapEntry();
         if (Short2ShortOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2ShortOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2ShortOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2ShortOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2ShortOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2ShortOpenCustomHashMap.this.realSize() / Short2ShortOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2ShortOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Short2ShortOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2ShortOpenCustomHashMap.ValueSpliterator>
      implements ShortSpliterator {
      ...
      final Short2ShortOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2ShortOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
