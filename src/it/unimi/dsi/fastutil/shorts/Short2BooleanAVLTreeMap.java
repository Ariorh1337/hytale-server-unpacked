...
public class Short2BooleanAVLTreeMap extends AbstractShort2BooleanSortedMap implements Serializable, Cloneable {
   ...
   private Short2BooleanAVLTreeMap.Entry parent(Short2BooleanAVLTreeMap.Entry e) {
      ...
      Short2BooleanAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Short2BooleanAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Short2BooleanMap.Entry>() {
            final Comparator<? super Short2BooleanMap.Entry> comparator = Short2BooleanAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Short.compare(x.getShortKey(), y.getShortKey())
               : (x, y) -> Short2BooleanAVLTreeMap.this.actualComparator.compare(x.getShortKey(), y.getShortKey());
