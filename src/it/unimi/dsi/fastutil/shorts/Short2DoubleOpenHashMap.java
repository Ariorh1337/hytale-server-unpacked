...
public class Short2DoubleOpenHashMap extends AbstractShort2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Short2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      double[] value = this.value;
      Short2DoubleOpenHashMap.EntryIterator i = new Short2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2DoubleOpenHashMap.MapIterator<Consumer<? super Short2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Short2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2DoubleOpenHashMap.MapSpliterator<Consumer<? super Short2DoubleMap.Entry>, Short2DoubleOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2DoubleMap.Entry> action, int index) {
         action.accept(Short2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Short2DoubleOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2DoubleOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2DoubleOpenHashMap.MapSpliterator<ShortConsumer, Short2DoubleOpenHashMap.KeySpliterator>
      ...
      final Short2DoubleOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2DoubleMap.Entry, Entry<Short, Double>, ShortDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2DoubleOpenHashMap.this.key[this.index] == e.getKey()
            && Double.doubleToLongBits(Short2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2DoubleMap.Entry> spliterator() {
         return Short2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
         if (Short2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Short2DoubleOpenHashMap.this.new MapEntry(Short2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2DoubleOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Short2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2DoubleMap.Entry> consumer) {
         Short2DoubleOpenHashMap.MapEntry entry = Short2DoubleOpenHashMap.this.new MapEntry();
         if (Short2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2DoubleOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Short2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Short2DoubleOpenHashMap.this.realSize() / Short2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Short2DoubleOpenHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Short2DoubleOpenHashMap.MapSpliterator<DoubleConsumer, Short2DoubleOpenHashMap.ValueSpliterator>
      ...
      final Short2DoubleOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
