...
public class Short2FloatOpenCustomHashMap extends AbstractShort2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Short2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      short[] key = this.key;
      float[] value = this.value;
      Short2FloatOpenCustomHashMap.EntryIterator i = new Short2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Short2FloatOpenCustomHashMap.MapIterator<Consumer<? super Short2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Short2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Short2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Short2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Short2FloatMap.Entry>, Short2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Short2FloatMap.Entry> action, int index) {
         action.accept(Short2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Short2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Short2FloatOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractShortSet {
      ...
      public ShortSpliterator spliterator() {
         return Short2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Short2FloatOpenCustomHashMap.MapSpliterator<ShortConsumer, Short2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Short2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Short2FloatMap.Entry, Entry<Short, Float>, ShortFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Short2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Short2FloatMap.Entry> implements Short2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Short2FloatMap.Entry> spliterator() {
         return Short2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Short2FloatMap.Entry> consumer) {
         if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Short2FloatOpenCustomHashMap.this.new MapEntry(Short2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Short2FloatOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Short2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Short2FloatMap.Entry> consumer) {
         Short2FloatOpenCustomHashMap.MapEntry entry = Short2FloatOpenCustomHashMap.this.new MapEntry();
         if (Short2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Short2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Short2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Short2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Short2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Short2FloatOpenCustomHashMap.this.realSize() / Short2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Short2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Short2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Short2FloatOpenCustomHashMap.ValueSpliterator>
      ...
      final Short2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Short2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
