...
public class Char2ShortOpenCustomHashMap extends AbstractChar2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Char2ShortOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      short[] value = this.value;
      Char2ShortOpenCustomHashMap.EntryIterator i = new Char2ShortOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2ShortOpenCustomHashMap.MapIterator<Consumer<? super Char2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Char2ShortOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2ShortOpenCustomHashMap.MapSpliterator<Consumer<? super Char2ShortMap.Entry>, Char2ShortOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2ShortMap.Entry> action, int index) {
         action.accept(Char2ShortOpenCustomHashMap.this.new MapEntry(index));
      }

      final Char2ShortOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ShortOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2ShortOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2ShortOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2ShortOpenCustomHashMap.MapSpliterator<CharConsumer, Char2ShortOpenCustomHashMap.KeySpliterator>
      ...
      final Char2ShortOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ShortOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2ShortMap.Entry, Entry<Character, Short>, CharShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2ShortOpenCustomHashMap.this.strategy.equals(Char2ShortOpenCustomHashMap.this.key[this.index], e.getKey())
            && Char2ShortOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ShortMap.Entry> implements Char2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2ShortMap.Entry> spliterator() {
         return Char2ShortOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2ShortMap.Entry> consumer) {
         if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Char2ShortOpenCustomHashMap.this.new MapEntry(Char2ShortOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2ShortOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Char2ShortOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2ShortMap.Entry> consumer) {
         Char2ShortOpenCustomHashMap.MapEntry entry = Char2ShortOpenCustomHashMap.this.new MapEntry();
         if (Char2ShortOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2ShortOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2ShortOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2ShortOpenCustomHashMap.this.size - this.c
            : Math.min(
               Char2ShortOpenCustomHashMap.this.size - this.c,
               (long)((double)Char2ShortOpenCustomHashMap.this.realSize() / Char2ShortOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Char2ShortOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Char2ShortOpenCustomHashMap.MapSpliterator<ShortConsumer, Char2ShortOpenCustomHashMap.ValueSpliterator>
      ...
      final Char2ShortOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ShortOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
