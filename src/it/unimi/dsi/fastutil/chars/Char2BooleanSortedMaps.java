...
public final class Char2BooleanSortedMaps {
   ...
   public static class Singleton extends Char2BooleanMaps.Singleton implements Char2BooleanSortedMap, Serializable, Cloneable {
      ...
      public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
         if (this.entries == null) {
            this.entries = ObjectSortedSets.singleton(
               new AbstractChar2BooleanMap.BasicEntry(this.key, this.value), Char2BooleanSortedMaps.entryComparator(this.comparator)
            );
         }

         return (ObjectSortedSet<Char2BooleanMap.Entry>)this.entries;
      }
      ...
      @Override
      public Char2BooleanSortedMap subMap(char from, char to) {
         return this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Char2BooleanSortedMaps.EMPTY_MAP;
      }

      @Override
      public Char2BooleanSortedMap headMap(char to) {
         return this.compare(this.key, to) < 0 ? this : Char2BooleanSortedMaps.EMPTY_MAP;
      }

      @Override
      public Char2BooleanSortedMap tailMap(char from) {
         return this.compare(from, this.key) <= 0 ? this : Char2BooleanSortedMaps.EMPTY_MAP;
      }
