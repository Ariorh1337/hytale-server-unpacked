...
public final class CharIterators {
   ...
   public static CharIterator asCharIterator(Iterator i) {
      return i instanceof CharIterator ? (CharIterator)i : new CharIterators.IteratorWrapper(i);
   }
   ...
   public static CharListIterator asCharIterator(ListIterator i) {
      return i instanceof CharListIterator ? (CharListIterator)i : new CharIterators.ListIteratorWrapper(i);
   }
