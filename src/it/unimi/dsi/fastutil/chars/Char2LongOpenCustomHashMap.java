...
public class Char2LongOpenCustomHashMap extends AbstractChar2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Char2LongOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      long[] value = this.value;
      Char2LongOpenCustomHashMap.EntryIterator i = new Char2LongOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2LongOpenCustomHashMap.MapIterator<Consumer<? super Char2LongMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2LongMap.Entry> action, int index) {
         action.accept(this.entry = Char2LongOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2LongOpenCustomHashMap.MapSpliterator<Consumer<? super Char2LongMap.Entry>, Char2LongOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2LongMap.Entry> action, int index) {
         action.accept(Char2LongOpenCustomHashMap.this.new MapEntry(index));
      }

      final Char2LongOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2LongOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2LongOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2LongOpenCustomHashMap.MapSpliterator<CharConsumer, Char2LongOpenCustomHashMap.KeySpliterator>
      ...
      final Char2LongOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Char2LongMap.Entry, Entry<Character, Long>, CharLongPair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Character, Long> e = (Entry<Character, Long>)o;
         return Char2LongOpenCustomHashMap.this.strategy.equals(Char2LongOpenCustomHashMap.this.key[this.index], e.getKey())
            && Char2LongOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2LongMap.Entry> spliterator() {
         return Char2LongOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
         if (Char2LongOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Char2LongOpenCustomHashMap.this.new MapEntry(Char2LongOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2LongOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Char2LongOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
         Char2LongOpenCustomHashMap.MapEntry entry = Char2LongOpenCustomHashMap.this.new MapEntry();
         if (Char2LongOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2LongOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2LongOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2LongOpenCustomHashMap.this.size - this.c
            : Math.min(
               Char2LongOpenCustomHashMap.this.size - this.c,
               (long)((double)Char2LongOpenCustomHashMap.this.realSize() / Char2LongOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Char2LongOpenCustomHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Char2LongOpenCustomHashMap.MapSpliterator<LongConsumer, Char2LongOpenCustomHashMap.ValueSpliterator>
      ...
      final Char2LongOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
