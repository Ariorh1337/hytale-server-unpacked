...
public class Char2ByteOpenHashMap extends AbstractChar2ByteMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Char2ByteOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      byte[] value = this.value;
      Char2ByteOpenHashMap.EntryIterator i = new Char2ByteOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2ByteOpenHashMap.MapIterator<Consumer<? super Char2ByteMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Char2ByteOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2ByteOpenHashMap.MapSpliterator<Consumer<? super Char2ByteMap.Entry>, Char2ByteOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2ByteMap.Entry> action, int index) {
         action.accept(Char2ByteOpenHashMap.this.new MapEntry(index));
      }

      final Char2ByteOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ByteOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Char2ByteOpenHashMap.MapIterator<Consumer<? super Char2ByteMap.Entry>>
      implements ObjectIterator<Char2ByteMap.Entry> {
      private final Char2ByteOpenHashMap.MapEntry entry = Char2ByteOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Char2ByteOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2ByteOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Char2ByteOpenHashMap.MapSpliterator<CharConsumer, Char2ByteOpenHashMap.KeySpliterator> implements CharSpliterator {
      ...
      final Char2ByteOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ByteOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2ByteMap.Entry, Entry<Character, Byte>, CharBytePair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2ByteOpenHashMap.this.key[this.index] == e.getKey() && Char2ByteOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2ByteMap.Entry> spliterator() {
         return Char2ByteOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2ByteMap.Entry> consumer) {
         if (Char2ByteOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2ByteOpenHashMap.this.new MapEntry(Char2ByteOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2ByteOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2ByteOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2ByteMap.Entry> consumer) {
         Char2ByteOpenHashMap.MapEntry entry = Char2ByteOpenHashMap.this.new MapEntry();
         if (Char2ByteOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Char2ByteOpenHashMap.this.n;
      int last = -1;
      int c = Char2ByteOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2ByteOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            char curr;
            for (pos = pos + 1 & Char2ByteOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Char2ByteOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2ByteOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2ByteOpenHashMap.this.size - this.c
            : Math.min(
               Char2ByteOpenHashMap.this.size - this.c,
               (long)((double)Char2ByteOpenHashMap.this.realSize() / Char2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2ByteOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Char2ByteOpenHashMap.MapSpliterator<ByteConsumer, Char2ByteOpenHashMap.ValueSpliterator>
      ...
      final Char2ByteOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ByteOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
