...
public class Char2CharOpenCustomHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Char2CharOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      char[] value = this.value;
      Char2CharOpenCustomHashMap.EntryIterator i = new Char2CharOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2CharOpenCustomHashMap.MapIterator<Consumer<? super Char2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2CharMap.Entry> action, int index) {
         action.accept(this.entry = Char2CharOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2CharOpenCustomHashMap.MapSpliterator<Consumer<? super Char2CharMap.Entry>, Char2CharOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2CharMap.Entry> action, int index) {
         action.accept(Char2CharOpenCustomHashMap.this.new MapEntry(index));
      }

      final Char2CharOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2CharOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      @Override
      public CharSpliterator spliterator() {
         return Char2CharOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2CharOpenCustomHashMap.MapSpliterator<CharConsumer, Char2CharOpenCustomHashMap.KeySpliterator>
      ...
      final Char2CharOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2CharMap.Entry, Entry<Character, Character>, CharCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], e.getKey())
            && Char2CharOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2CharMap.Entry> spliterator() {
         return Char2CharOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2CharMap.Entry> consumer) {
         if (Char2CharOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Char2CharOpenCustomHashMap.this.new MapEntry(Char2CharOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2CharOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Char2CharOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2CharMap.Entry> consumer) {
         Char2CharOpenCustomHashMap.MapEntry entry = Char2CharOpenCustomHashMap.this.new MapEntry();
         if (Char2CharOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2CharOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2CharOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2CharOpenCustomHashMap.this.size - this.c
            : Math.min(
               Char2CharOpenCustomHashMap.this.size - this.c,
               (long)((double)Char2CharOpenCustomHashMap.this.realSize() / Char2CharOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Char2CharOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Char2CharOpenCustomHashMap.MapSpliterator<CharConsumer, Char2CharOpenCustomHashMap.ValueSpliterator>
      implements CharSpliterator {
      ...
      final Char2CharOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
