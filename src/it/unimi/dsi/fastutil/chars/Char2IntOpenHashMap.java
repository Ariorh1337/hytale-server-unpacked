...
public class Char2IntOpenHashMap extends AbstractChar2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Char2IntOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      int[] value = this.value;
      Char2IntOpenHashMap.EntryIterator i = new Char2IntOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Char2IntOpenHashMap.MapIterator<Consumer<? super Char2IntMap.Entry>> implements ObjectIterator<Char2IntMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Char2IntMap.Entry> action, int index) {
         action.accept(this.entry = Char2IntOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2IntOpenHashMap.MapSpliterator<Consumer<? super Char2IntMap.Entry>, Char2IntOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2IntMap.Entry> action, int index) {
         action.accept(Char2IntOpenHashMap.this.new MapEntry(index));
      }

      final Char2IntOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2IntOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Char2IntOpenHashMap.MapIterator<Consumer<? super Char2IntMap.Entry>>
   ...
   private final class KeyIterator extends Char2IntOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2IntOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Char2IntOpenHashMap.MapSpliterator<CharConsumer, Char2IntOpenHashMap.KeySpliterator> implements CharSpliterator {
      ...
      final Char2IntOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2IntOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2IntMap.Entry, Entry<Character, Integer>, CharIntPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2IntOpenHashMap.this.key[this.index] == e.getKey() && Char2IntOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2IntMap.Entry> spliterator() {
         return Char2IntOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2IntMap.Entry> consumer) {
         if (Char2IntOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2IntOpenHashMap.this.new MapEntry(Char2IntOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2IntOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2IntOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2IntMap.Entry> consumer) {
         Char2IntOpenHashMap.MapEntry entry = Char2IntOpenHashMap.this.new MapEntry();
         if (Char2IntOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2IntOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2IntOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2IntOpenHashMap.this.size - this.c
            : Math.min(
               Char2IntOpenHashMap.this.size - this.c,
               (long)((double)Char2IntOpenHashMap.this.realSize() / Char2IntOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2IntOpenHashMap.MapIterator<IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator extends Char2IntOpenHashMap.MapSpliterator<IntConsumer, Char2IntOpenHashMap.ValueSpliterator> implements IntSpliterator {
      ...
      final Char2IntOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2IntOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
