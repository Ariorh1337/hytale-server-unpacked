...
public class Char2FloatOpenHashMap extends AbstractChar2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Char2FloatOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      float[] value = this.value;
      Char2FloatOpenHashMap.EntryIterator i = new Char2FloatOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2FloatOpenHashMap.MapIterator<Consumer<? super Char2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Char2FloatOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2FloatOpenHashMap.MapSpliterator<Consumer<? super Char2FloatMap.Entry>, Char2FloatOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2FloatMap.Entry> action, int index) {
         action.accept(Char2FloatOpenHashMap.this.new MapEntry(index));
      }

      final Char2FloatOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2FloatOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Char2FloatOpenHashMap.MapIterator<Consumer<? super Char2FloatMap.Entry>>
      implements ObjectIterator<Char2FloatMap.Entry> {
      private final Char2FloatOpenHashMap.MapEntry entry = Char2FloatOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Char2FloatOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2FloatOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2FloatOpenHashMap.MapSpliterator<CharConsumer, Char2FloatOpenHashMap.KeySpliterator>
      ...
      final Char2FloatOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2FloatOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2FloatMap.Entry, Entry<Character, Float>, CharFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2FloatOpenHashMap.this.key[this.index] == e.getKey()
            && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2FloatMap.Entry> spliterator() {
         return Char2FloatOpenHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (k == 0) {
               return Char2FloatOpenHashMap.this.containsNullKey
                  && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[Char2FloatOpenHashMap.this.n]) == Float.floatToIntBits(v);
            }

            char[] key = Char2FloatOpenHashMap.this.key;
            char curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(k) & Char2FloatOpenHashMap.this.mask]) == 0) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != 0) {
               if (k == curr) {
                  return Float.floatToIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v);
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (k == 0) {
                  ...
                  if (curr == k) {
                     ...
                     while ((curr = key[pos = pos + 1 & Char2FloatOpenHashMap.this.mask]) != 0) {
                        if (curr == k && Float.floatToIntBits(Char2FloatOpenHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                           Char2FloatOpenHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Char2FloatMap.Entry> consumer) {
         if (Char2FloatOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2FloatOpenHashMap.this.new MapEntry(Char2FloatOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2FloatOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2FloatOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2FloatMap.Entry> consumer) {
         Char2FloatOpenHashMap.MapEntry entry = Char2FloatOpenHashMap.this.new MapEntry();
         if (Char2FloatOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Char2FloatOpenHashMap.this.n;
      int last = -1;
      int c = Char2FloatOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2FloatOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            char curr;
            for (pos = pos + 1 & Char2FloatOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Char2FloatOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2FloatOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2FloatOpenHashMap.this.size - this.c
            : Math.min(
               Char2FloatOpenHashMap.this.size - this.c,
               (long)((double)Char2FloatOpenHashMap.this.realSize() / Char2FloatOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2FloatOpenHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Char2FloatOpenHashMap.MapSpliterator<FloatConsumer, Char2FloatOpenHashMap.ValueSpliterator>
      ...
      final Char2FloatOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2FloatOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
