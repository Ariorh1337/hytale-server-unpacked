...
public class Char2BooleanOpenCustomHashMap extends AbstractChar2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Char2BooleanOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      boolean[] value = this.value;
      Char2BooleanOpenCustomHashMap.EntryIterator i = new Char2BooleanOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Char2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Char2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2BooleanOpenCustomHashMap.MapSpliterator<Consumer<? super Char2BooleanMap.Entry>, Char2BooleanOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2BooleanMap.Entry> action, int index) {
         action.accept(Char2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }

      final Char2BooleanOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2BooleanOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2BooleanOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2BooleanOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2BooleanOpenCustomHashMap.MapSpliterator<CharConsumer, Char2BooleanOpenCustomHashMap.KeySpliterator>
      ...
      final Char2BooleanOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2BooleanOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2BooleanMap.Entry, Entry<Character, Boolean>, CharBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2BooleanOpenCustomHashMap.this.strategy.equals(Char2BooleanOpenCustomHashMap.this.key[this.index], e.getKey())
            && Char2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2BooleanMap.Entry> implements Char2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2BooleanMap.Entry> spliterator() {
         return Char2BooleanOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getKey() != null && e.getKey() instanceof Character) {
            if (e.getValue() != null && e.getValue() instanceof Boolean) {
               ...
               if (Char2BooleanOpenCustomHashMap.this.strategy.equals(k, '\u0000')) {
                  ...
                  char curr;
                  int pos;
                  if ((curr = key[pos = HashCommon.mix(Char2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Char2BooleanOpenCustomHashMap.this.mask])
                     == 0) {
                     return false;
                  }
      ...
      public void forEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
         if (Char2BooleanOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Char2BooleanOpenCustomHashMap.this.new MapEntry(Char2BooleanOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2BooleanOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Char2BooleanOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2BooleanMap.Entry> consumer) {
         Char2BooleanOpenCustomHashMap.MapEntry entry = Char2BooleanOpenCustomHashMap.this.new MapEntry();
         if (Char2BooleanOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2BooleanOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2BooleanOpenCustomHashMap.this.size - this.c
            : Math.min(
               Char2BooleanOpenCustomHashMap.this.size - this.c,
               (long)((double)Char2BooleanOpenCustomHashMap.this.realSize() / Char2BooleanOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Char2BooleanOpenCustomHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Char2BooleanOpenCustomHashMap.MapSpliterator<BooleanConsumer, Char2BooleanOpenCustomHashMap.ValueSpliterator>
      ...
      final Char2BooleanOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2BooleanOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
