...
public class CharArrayFrontCodedList extends AbstractObjectList<char[]> implements Serializable, Cloneable, RandomAccess {
   ...
   static int readInt(char[][] a, long pos) {
      ...
      return c0 < 32768 ? c0 : (c0 & 32767) << 16 | BigArrays.get(a, pos + 1L);
   }
   ...
   static int writeInt(char[][] a, int length, long pos) {
      if (length < 32768) {
         ...
         BigArrays.set(a, pos++, (char)(length >>> 16 | 32768));
         BigArrays.set(a, pos, (char)(length & 65535));
         return 2;
      }
   }
      ...
      return new ObjectListIterator<char[]>() {
         ...
         public char[] next() {
            ...
            if (this.i % CharArrayFrontCodedList.this.ratio == 0) {
               ...
               BigArrays.copyFromBig(CharArrayFrontCodedList.this.array, this.pos + CharArrayFrontCodedList.count(length), this.s, 0, length);
