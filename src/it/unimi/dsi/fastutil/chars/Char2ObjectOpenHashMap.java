...
public class Char2ObjectOpenHashMap<V> extends AbstractChar2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Char2ObjectOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      V[] value = this.value;
      Char2ObjectOpenHashMap<V>.EntryIterator i = new Char2ObjectOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Char2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Char2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Char2ObjectOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Char2ObjectMap.Entry<V>>, Char2ObjectOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2ObjectMap.Entry<V>> action, int index) {
         action.accept(Char2ObjectOpenHashMap.this.new MapEntry(index));
      }

      final Char2ObjectOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ObjectOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2ObjectOpenHashMap<V>.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2ObjectOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2ObjectOpenHashMap<V>.MapSpliterator<CharConsumer, Char2ObjectOpenHashMap<V>.KeySpliterator>
      ...
      final Char2ObjectOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ObjectOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2ObjectMap.Entry<V>, Entry<Character, V>, CharObjectPair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Char2ObjectOpenHashMap.this.key[this.index] == e.getKey() && Objects.equals(Char2ObjectOpenHashMap.this.value[this.index], e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Char2ObjectMap.Entry<V>> spliterator() {
         return Char2ObjectOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
         if (Char2ObjectOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2ObjectOpenHashMap.this.new MapEntry(Char2ObjectOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2ObjectOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2ObjectOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2ObjectMap.Entry<V>> consumer) {
         Char2ObjectOpenHashMap<V>.MapEntry entry = Char2ObjectOpenHashMap.this.new MapEntry();
         if (Char2ObjectOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2ObjectOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Char2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Char2ObjectOpenHashMap.this.realSize() / Char2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2ObjectOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Char2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Char2ObjectOpenHashMap<V>.ValueSpliterator>
      ...
      final Char2ObjectOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2ObjectOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
