...
public class Char2LongOpenHashMap extends AbstractChar2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Char2LongOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      long[] value = this.value;
      Char2LongOpenHashMap.EntryIterator i = new Char2LongOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2LongOpenHashMap.MapIterator<Consumer<? super Char2LongMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2LongMap.Entry> action, int index) {
         action.accept(this.entry = Char2LongOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2LongOpenHashMap.MapSpliterator<Consumer<? super Char2LongMap.Entry>, Char2LongOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2LongMap.Entry> action, int index) {
         action.accept(Char2LongOpenHashMap.this.new MapEntry(index));
      }

      final Char2LongOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2LongOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2LongOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Char2LongOpenHashMap.MapSpliterator<CharConsumer, Char2LongOpenHashMap.KeySpliterator> implements CharSpliterator {
      ...
      final Char2LongOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2LongMap.Entry, Entry<Character, Long>, CharLongPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2LongOpenHashMap.this.key[this.index] == e.getKey() && Char2LongOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2LongMap.Entry> implements Char2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2LongMap.Entry> spliterator() {
         return Char2LongOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2LongMap.Entry> consumer) {
         if (Char2LongOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2LongOpenHashMap.this.new MapEntry(Char2LongOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2LongOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2LongOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2LongMap.Entry> consumer) {
         Char2LongOpenHashMap.MapEntry entry = Char2LongOpenHashMap.this.new MapEntry();
         if (Char2LongOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2LongOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2LongOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2LongOpenHashMap.this.size - this.c
            : Math.min(
               Char2LongOpenHashMap.this.size - this.c,
               (long)((double)Char2LongOpenHashMap.this.realSize() / Char2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2LongOpenHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Char2LongOpenHashMap.MapSpliterator<LongConsumer, Char2LongOpenHashMap.ValueSpliterator>
      ...
      final Char2LongOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2LongOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
