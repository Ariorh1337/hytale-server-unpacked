...
public class CharBigArrayBigList extends AbstractCharBigList implements RandomAccess, Cloneable, Serializable {
   ...
   public int compareTo(CharBigArrayBigList l) {
      ...
      int i;
      for (i = 0; i < s1 && i < s2; i++) {
         char e1 = BigArrays.get(a1, i);
         char e2 = BigArrays.get(a2, i);
         int r;
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      ...
      for (int i = 0; i < this.size; i++) {
         s.writeChar(BigArrays.get(this.a, i));
      }
   }
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      ...
      for (int i = 0; i < this.size; i++) {
         BigArrays.set(this.a, i, s.readChar());
      }
   }
   ...
   private final class Spliterator implements CharSpliterator {
      ...
      public CharSpliterator trySplit() {
         ...
         this.pos = myNewPos;
         this.hasSplit = true;
         return CharBigArrayBigList.this.new Spliterator(oldPos, retMax, true);
      }
   }
