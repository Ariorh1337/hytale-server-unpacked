...
public final class CharSortedSets {
   ...
   public static class Singleton extends CharSets.Singleton implements CharSortedSet, Serializable, Cloneable {
      ...
      @Override
      public CharSortedSet subSet(char from, char to) {
         return this.compare(from, this.element) <= 0 && this.compare(this.element, to) < 0 ? this : CharSortedSets.EMPTY_SET;
      }

      @Override
      public CharSortedSet headSet(char to) {
         return this.compare(this.element, to) < 0 ? this : CharSortedSets.EMPTY_SET;
      }

      @Override
      public CharSortedSet tailSet(char from) {
         return this.compare(from, this.element) <= 0 ? this : CharSortedSets.EMPTY_SET;
      }
