...
public class CharLinkedOpenCustomHashSet extends AbstractCharSortedSet implements Serializable, Cloneable, Hash {
   ...
   private final class SetIterator implements CharListIterator {
      int prev = -1;
      int next = -1;
      int curr = -1;
      int index = -1;
      ...
      public void remove() {
         ...
         if (this.prev == -1) {
            ...
            CharLinkedOpenCustomHashSet.this.link[this.prev] = CharLinkedOpenCustomHashSet.this.link[this.prev]
               ^ (CharLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 4294967295L) & 4294967295L;
         }
         ...
         if (this.next == -1) {
            ...
            CharLinkedOpenCustomHashSet.this.link[this.next] = CharLinkedOpenCustomHashSet.this.link[this.next]
               ^ (CharLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 4294967295L) << 32) & -4294967296L;
         }
