...
public class Char2BooleanAVLTreeMap extends AbstractChar2BooleanSortedMap implements Serializable, Cloneable {
   ...
   private Char2BooleanAVLTreeMap.Entry parent(Char2BooleanAVLTreeMap.Entry e) {
      ...
      Char2BooleanAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Char2BooleanAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Char2BooleanMap.Entry>() {
            final Comparator<? super Char2BooleanMap.Entry> comparator = Char2BooleanAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Character.compare(x.getCharKey(), y.getCharKey())
               : (x, y) -> Char2BooleanAVLTreeMap.this.actualComparator.compare(x.getCharKey(), y.getCharKey());
