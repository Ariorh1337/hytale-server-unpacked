...
public final class Char2LongSortedMaps {
   ...
   public static class Singleton extends Char2LongMaps.Singleton implements Char2LongSortedMap, Serializable, Cloneable {
      ...
      public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() {
         if (this.entries == null) {
            this.entries = ObjectSortedSets.singleton(
               new AbstractChar2LongMap.BasicEntry(this.key, this.value), Char2LongSortedMaps.entryComparator(this.comparator)
            );
         }

         return (ObjectSortedSet<Char2LongMap.Entry>)this.entries;
      }
      ...
      @Override
      public Char2LongSortedMap subMap(char from, char to) {
         return this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Char2LongSortedMaps.EMPTY_MAP;
      }

      @Override
      public Char2LongSortedMap headMap(char to) {
         return this.compare(this.key, to) < 0 ? this : Char2LongSortedMaps.EMPTY_MAP;
      }

      @Override
      public Char2LongSortedMap tailMap(char from) {
         return this.compare(from, this.key) <= 0 ? this : Char2LongSortedMaps.EMPTY_MAP;
      }
