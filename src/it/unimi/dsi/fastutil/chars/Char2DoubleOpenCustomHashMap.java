...
public class Char2DoubleOpenCustomHashMap extends AbstractChar2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Char2DoubleOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      double[] value = this.value;
      Char2DoubleOpenCustomHashMap.EntryIterator i = new Char2DoubleOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2DoubleOpenCustomHashMap.MapIterator<Consumer<? super Char2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Char2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2DoubleOpenCustomHashMap.MapSpliterator<Consumer<? super Char2DoubleMap.Entry>, Char2DoubleOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2DoubleMap.Entry> action, int index) {
         action.accept(Char2DoubleOpenCustomHashMap.this.new MapEntry(index));
      }

      final Char2DoubleOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2DoubleOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2DoubleOpenCustomHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return Char2DoubleOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Char2DoubleOpenCustomHashMap.MapSpliterator<CharConsumer, Char2DoubleOpenCustomHashMap.KeySpliterator>
      ...
      final Char2DoubleOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2DoubleOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2DoubleMap.Entry, Entry<Character, Double>, CharDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2DoubleOpenCustomHashMap.this.strategy.equals(Char2DoubleOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double.doubleToLongBits(Char2DoubleOpenCustomHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2DoubleMap.Entry> implements Char2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2DoubleMap.Entry> spliterator() {
         return Char2DoubleOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
         if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Char2DoubleOpenCustomHashMap.this.new MapEntry(Char2DoubleOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2DoubleOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Char2DoubleOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2DoubleMap.Entry> consumer) {
         Char2DoubleOpenCustomHashMap.MapEntry entry = Char2DoubleOpenCustomHashMap.this.new MapEntry();
         if (Char2DoubleOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2DoubleOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2DoubleOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2DoubleOpenCustomHashMap.this.size - this.c
            : Math.min(
               Char2DoubleOpenCustomHashMap.this.size - this.c,
               (long)((double)Char2DoubleOpenCustomHashMap.this.realSize() / Char2DoubleOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Char2DoubleOpenCustomHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Char2DoubleOpenCustomHashMap.MapSpliterator<DoubleConsumer, Char2DoubleOpenCustomHashMap.ValueSpliterator>
      ...
      final Char2DoubleOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2DoubleOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
