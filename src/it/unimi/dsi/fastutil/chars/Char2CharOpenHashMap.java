...
public class Char2CharOpenHashMap extends AbstractChar2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Char2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      char[] key = this.key;
      char[] value = this.value;
      Char2CharOpenHashMap.EntryIterator i = new Char2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Char2CharOpenHashMap.MapIterator<Consumer<? super Char2CharMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Char2CharMap.Entry> action, int index) {
         action.accept(this.entry = Char2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Char2CharOpenHashMap.MapSpliterator<Consumer<? super Char2CharMap.Entry>, Char2CharOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Char2CharMap.Entry> action, int index) {
         action.accept(Char2CharOpenHashMap.this.new MapEntry(index));
      }

      final Char2CharOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Char2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      @Override
      public CharSpliterator spliterator() {
         return Char2CharOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator extends Char2CharOpenHashMap.MapSpliterator<CharConsumer, Char2CharOpenHashMap.KeySpliterator> implements CharSpliterator {
      ...
      final Char2CharOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Char2CharMap.Entry, Entry<Character, Character>, CharCharPair {
      ...
      public boolean equals(Object o) {
         ...
         return Char2CharOpenHashMap.this.key[this.index] == e.getKey() && Char2CharOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Char2CharMap.Entry> implements Char2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Char2CharMap.Entry> spliterator() {
         return Char2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Char2CharMap.Entry> consumer) {
         if (Char2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Char2CharOpenHashMap.this.new MapEntry(Char2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Char2CharOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Char2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Char2CharMap.Entry> consumer) {
         Char2CharOpenHashMap.MapEntry entry = Char2CharOpenHashMap.this.new MapEntry();
         if (Char2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Char2CharOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Char2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Char2CharOpenHashMap.this.size - this.c
            : Math.min(
               Char2CharOpenHashMap.this.size - this.c,
               (long)((double)Char2CharOpenHashMap.this.realSize() / Char2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Char2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Char2CharOpenHashMap.MapSpliterator<CharConsumer, Char2CharOpenHashMap.ValueSpliterator>
      ...
      final Char2CharOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Char2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
