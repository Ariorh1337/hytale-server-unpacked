...
public class Char2FloatArrayMap extends AbstractChar2FloatMap implements Serializable, Cloneable {
   ...
   public Char2FloatArrayMap(Map<? extends Character, ? extends Float> m) {
      ...
      for (Entry<? extends Character, ? extends Float> e : m.entrySet()) {
         this.key[i] = e.getKey();
   ...
   public Char2FloatMap.FastEntrySet char2FloatEntrySet() {
      if (this.entries == null) {
         this.entries = new Char2FloatArrayMap.EntrySet();
      }
   ...
   public CharSet keySet() {
      if (this.keys == null) {
         this.keys = new Char2FloatArrayMap.KeySet();
      }
   ...
   public FloatCollection values() {
      if (this.values == null) {
         this.values = new Char2FloatArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet {
      ...
      public ObjectIterator<Char2FloatMap.Entry> iterator() {
         return new ObjectIterator<Char2FloatMap.Entry>() {
            ...
            public void forEachRemaining(Consumer<? super Char2FloatMap.Entry> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractChar2FloatMap.BasicEntry(Char2FloatArrayMap.this.key[this.curr = this.next], Char2FloatArrayMap.this.value[this.next++])
                  );
               }
            }
         };
      ...
      public ObjectSpliterator<Char2FloatMap.Entry> spliterator() {
         return new Char2FloatArrayMap.EntrySet.EntrySetSpliterator(0, Char2FloatArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Char2FloatMap.Entry> action) {
         ...
         for (int max = Char2FloatArrayMap.this.size; i < max; i++) {
         ...
         if (!(o instanceof Entry)) {
            ...
            if (e.getKey() == null || !(e.getKey() instanceof Character)) {
               ...
               return Char2FloatArrayMap.this.containsKey(k)
                  && Float.floatToIntBits(Char2FloatArrayMap.this.get(k)) == Float.floatToIntBits((Float)e.getValue());
            } else {
               return false;
            }
         }
      ...
      final class EntrySetSpliterator
         ...
         protected final Char2FloatArrayMap.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractCharSet {
      ...
      public CharSpliterator spliterator() {
         return new Char2FloatArrayMap.KeySet.KeySetSpliterator(0, Char2FloatArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends CharSpliterators.EarlyBindingSizeIndexBasedSpliterator implements CharSpliterator {
         ...
         protected final Char2FloatArrayMap.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractFloatCollection {
      ...
      public FloatSpliterator spliterator() {
         return new Char2FloatArrayMap.ValuesCollection.ValuesSpliterator(0, Char2FloatArrayMap.this.size);
      }
      ...
      final class ValuesSpliterator extends FloatSpliterators.EarlyBindingSizeIndexBasedSpliterator implements FloatSpliterator {
         ...
         protected final Char2FloatArrayMap.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
