...
public final class CharLists {
   ...
   public static CharList synchronize(CharList l) {
      return l instanceof RandomAccess ? new CharLists.SynchronizedRandomAccessList(l) : new CharLists.SynchronizedList(l);
   }

   public static CharList synchronize(CharList l, Object sync) {
      return l instanceof RandomAccess ? new CharLists.SynchronizedRandomAccessList(l, sync) : new CharLists.SynchronizedList(l, sync);
   }

   public static CharList unmodifiable(CharList l) {
      return l instanceof RandomAccess ? new CharLists.UnmodifiableRandomAccessList(l) : new CharLists.UnmodifiableList(l);
   }
