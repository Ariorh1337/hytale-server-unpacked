...
public class Int2ReferenceOpenCustomHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Int2ReferenceOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      V[] value = this.value;
      Int2ReferenceOpenCustomHashMap<V>.EntryIterator i = new Int2ReferenceOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Int2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Int2ReferenceMap.Entry<V>>, Int2ReferenceOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Int2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2ReferenceOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ReferenceOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ReferenceOpenCustomHashMap<V>.MapSpliterator<java.util.function.IntConsumer, Int2ReferenceOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Int2ReferenceOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Int2ReferenceMap.Entry<V>, Entry<Integer, V>, IntReferencePair<V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())
      ...
      public int hashCode() {
         return Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[this.index])
            ^ (
               Int2ReferenceOpenCustomHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Int2ReferenceOpenCustomHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Int2ReferenceMap.Entry<V>> spliterator() {
         return Int2ReferenceOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Integer) {
            ...
            if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(k, 0)) {
               return Int2ReferenceOpenCustomHashMap.this.containsNullKey
                  && Int2ReferenceOpenCustomHashMap.this.value[Int2ReferenceOpenCustomHashMap.this.n] == v;
            }
      ...
      public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2ReferenceOpenCustomHashMap.this.new MapEntry(Int2ReferenceOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ReferenceOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ReferenceOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
         Int2ReferenceOpenCustomHashMap<V>.MapEntry entry = Int2ReferenceOpenCustomHashMap.this.new MapEntry();
         if (Int2ReferenceOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ReferenceOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ReferenceOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2ReferenceOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2ReferenceOpenCustomHashMap.this.realSize() / Int2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Int2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Int2ReferenceOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Int2ReferenceOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
