...
public class Int2ObjectOpenHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
   ...
   private final class EntryIterator
      extends Int2ObjectOpenHashMap<V>.MapIterator<Consumer<? super Int2ObjectMap.Entry<V>>>
   ...
   private final class EntrySpliterator
      extends Int2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super Int2ObjectMap.Entry<V>>, Int2ObjectOpenHashMap<V>.EntrySpliterator>
   ...
   private final class KeySpliterator
      extends Int2ObjectOpenHashMap<V>.MapSpliterator<java.util.function.IntConsumer, Int2ObjectOpenHashMap<V>.KeySpliterator>
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ObjectOpenHashMap.this.size - this.c
            : Math.min(
               Int2ObjectOpenHashMap.this.size - this.c,
               (long)((double)Int2ObjectOpenHashMap.this.realSize() / Int2ObjectOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueSpliterator
      extends Int2ObjectOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Int2ObjectOpenHashMap<V>.ValueSpliterator>
