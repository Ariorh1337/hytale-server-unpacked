...
public class Int2CharOpenHashMap extends AbstractInt2CharMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractCharCollection() {
            ...
            public CharSpliterator spliterator() {
               return Int2CharOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      char[] value = this.value;
      Int2CharOpenHashMap.EntryIterator i = new Int2CharOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Int2CharOpenHashMap.MapIterator<Consumer<? super Int2CharMap.Entry>> implements ObjectIterator<Int2CharMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Int2CharMap.Entry> action, int index) {
         action.accept(this.entry = Int2CharOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2CharOpenHashMap.MapSpliterator<Consumer<? super Int2CharMap.Entry>, Int2CharOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2CharMap.Entry> action, int index) {
         action.accept(Int2CharOpenHashMap.this.new MapEntry(index));
      }

      final Int2CharOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2CharOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Int2CharOpenHashMap.MapIterator<Consumer<? super Int2CharMap.Entry>>
   ...
   private final class KeyIterator extends Int2CharOpenHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2CharOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2CharOpenHashMap.MapSpliterator<java.util.function.IntConsumer, Int2CharOpenHashMap.KeySpliterator>
      ...
      final Int2CharOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2CharOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2CharMap.Entry> spliterator() {
         return Int2CharOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2CharMap.Entry> consumer) {
         if (Int2CharOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2CharOpenHashMap.this.new MapEntry(Int2CharOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2CharOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2CharOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2CharMap.Entry> consumer) {
         Int2CharOpenHashMap.MapEntry entry = Int2CharOpenHashMap.this.new MapEntry();
         if (Int2CharOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2CharOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2CharOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2CharOpenHashMap.this.size - this.c
            : Math.min(
               Int2CharOpenHashMap.this.size - this.c,
               (long)((double)Int2CharOpenHashMap.this.realSize() / Int2CharOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Int2CharOpenHashMap.MapIterator<CharConsumer> implements CharIterator {
   ...
   private final class ValueSpliterator
      extends Int2CharOpenHashMap.MapSpliterator<CharConsumer, Int2CharOpenHashMap.ValueSpliterator>
      ...
      final Int2CharOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2CharOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
