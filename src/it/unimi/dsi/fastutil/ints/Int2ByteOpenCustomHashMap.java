...
public class Int2ByteOpenCustomHashMap extends AbstractInt2ByteMap implements Serializable, Cloneable, Hash {
   ...
   @Override
   public byte computeIfAbsent(int k, java.util.function.IntUnaryOperator mappingFunction) {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Int2ByteOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      byte[] value = this.value;
      Int2ByteOpenCustomHashMap.EntryIterator i = new Int2ByteOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ByteOpenCustomHashMap.MapIterator<Consumer<? super Int2ByteMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Int2ByteOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ByteOpenCustomHashMap.MapSpliterator<Consumer<? super Int2ByteMap.Entry>, Int2ByteOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ByteMap.Entry> action, int index) {
         action.accept(Int2ByteOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2ByteOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Int2ByteOpenCustomHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ByteOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ByteOpenCustomHashMap.MapSpliterator<java.util.function.IntConsumer, Int2ByteOpenCustomHashMap.KeySpliterator>
      ...
      final Int2ByteOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Int2ByteMap.Entry, Entry<Integer, Byte>, IntBytePair {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Integer, Byte> e = (Entry<Integer, Byte>)o;
         return Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[this.index], e.getKey())
            && Int2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Int2ByteOpenCustomHashMap.this.strategy.hashCode(Int2ByteOpenCustomHashMap.this.key[this.index])
            ^ Int2ByteOpenCustomHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2ByteMap.Entry> spliterator() {
         return Int2ByteOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2ByteMap.Entry> consumer) {
         if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2ByteOpenCustomHashMap.this.new MapEntry(Int2ByteOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ByteOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ByteOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ByteMap.Entry> consumer) {
         Int2ByteOpenCustomHashMap.MapEntry entry = Int2ByteOpenCustomHashMap.this.new MapEntry();
         if (Int2ByteOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ByteOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ByteOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ByteOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2ByteOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2ByteOpenCustomHashMap.this.realSize() / Int2ByteOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2ByteOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Int2ByteOpenCustomHashMap.MapSpliterator<ByteConsumer, Int2ByteOpenCustomHashMap.ValueSpliterator>
      ...
      final Int2ByteOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
