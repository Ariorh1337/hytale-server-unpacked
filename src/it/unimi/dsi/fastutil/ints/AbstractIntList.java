...
public abstract class AbstractIntList extends AbstractIntCollection implements IntList, IntStack {
   ...
   public IntList subList(int from, int to) {
      ...
      if (from > to) {
         ...
         return this instanceof RandomAccess ? new AbstractIntList.IntRandomAccessSubList(this, from, to) : new AbstractIntList.IntSubList(this, from, to);
      }
   }
   ...
   public static class IntSubList extends AbstractIntList implements Serializable {
      ...
      public IntSpliterator spliterator() {
         return this.l instanceof RandomAccess ? new AbstractIntList.IndexBasedSpliterator(this.l, this.from, this.to) : super.spliterator();
      }
