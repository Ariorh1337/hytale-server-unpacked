...
public final class IntIterators {
   ...
   public static IntIterator asIntIterator(Iterator i) {
      if (i instanceof IntIterator) {
         ...
         return i instanceof OfInt ? new IntIterators.PrimitiveIteratorWrapper((OfInt)i) : new IntIterators.IteratorWrapper(i);
      }
   }

   public static IntListIterator asIntIterator(ListIterator i) {
      return i instanceof IntListIterator ? (IntListIterator)i : new IntIterators.ListIteratorWrapper(i);
   }
