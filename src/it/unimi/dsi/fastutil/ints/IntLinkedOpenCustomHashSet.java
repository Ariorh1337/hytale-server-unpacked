...
public class IntLinkedOpenCustomHashSet extends AbstractIntSortedSet implements Serializable, Cloneable, Hash {
   ...
   public IntListIterator iterator(int from) {
      return new IntLinkedOpenCustomHashSet.SetIterator(from);
   }
   ...
   private final class SetIterator implements IntListIterator {
      ...
      SetIterator(int from) {
         if (IntLinkedOpenCustomHashSet.this.strategy.equals(from, 0)) {
            ...
            for (int pos = HashCommon.mix(IntLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & IntLinkedOpenCustomHashSet.this.mask;
               key[pos] != 0;
      ...
      public void remove() {
         ...
         if (this.prev == -1) {
            ...
            IntLinkedOpenCustomHashSet.this.link[this.prev] = IntLinkedOpenCustomHashSet.this.link[this.prev]
               ^ (IntLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 4294967295L) & 4294967295L;
         }

         if (this.next == -1) {
            IntLinkedOpenCustomHashSet.this.last = this.prev;
         } else {
            IntLinkedOpenCustomHashSet.this.link[this.next] = IntLinkedOpenCustomHashSet.this.link[this.next]
               ^ (IntLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 4294967295L) << 32) & -4294967296L;
         }
         ...
         if (pos == IntLinkedOpenCustomHashSet.this.n) {
            ...
            while (true) {
               ...
               int curr;
               for (pos = pos + 1 & IntLinkedOpenCustomHashSet.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & IntLinkedOpenCustomHashSet.this.mask) {
