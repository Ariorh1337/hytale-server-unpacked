...
public final class IntLists {
   ...
   public static IntList synchronize(IntList l) {
      return l instanceof RandomAccess ? new IntLists.SynchronizedRandomAccessList(l) : new IntLists.SynchronizedList(l);
   }

   public static IntList synchronize(IntList l, Object sync) {
      return l instanceof RandomAccess ? new IntLists.SynchronizedRandomAccessList(l, sync) : new IntLists.SynchronizedList(l, sync);
   }

   public static IntList unmodifiable(IntList l) {
      return l instanceof RandomAccess ? new IntLists.UnmodifiableRandomAccessList(l) : new IntLists.UnmodifiableList(l);
   }
