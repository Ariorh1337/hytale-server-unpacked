...
public final class Int2DoubleSortedMaps {
   ...
   public static Int2DoubleSortedMap singleton(Integer key, Double value) {
      return new Int2DoubleSortedMaps.Singleton(key, value);
   }

   public static Int2DoubleSortedMap singleton(Integer key, Double value, IntComparator comparator) {
      return new Int2DoubleSortedMaps.Singleton(key, value, comparator);
   }
   ...
   public static Int2DoubleSortedMap synchronize(Int2DoubleSortedMap m) {
      return new Int2DoubleSortedMaps.SynchronizedSortedMap(m);
   }

   public static Int2DoubleSortedMap synchronize(Int2DoubleSortedMap m, Object sync) {
      return new Int2DoubleSortedMaps.SynchronizedSortedMap(m, sync);
   }

   public static Int2DoubleSortedMap unmodifiable(Int2DoubleSortedMap m) {
      return new Int2DoubleSortedMaps.UnmodifiableSortedMap(m);
   }
   ...
   public static class Singleton extends Int2DoubleMaps.Singleton implements Int2DoubleSortedMap, Serializable, Cloneable {
      ...
      public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
         if (this.entries == null) {
            this.entries = ObjectSortedSets.singleton(
               new AbstractInt2DoubleMap.BasicEntry(this.key, this.value), Int2DoubleSortedMaps.entryComparator(this.comparator)
            );
         }

         return (ObjectSortedSet<Int2DoubleMap.Entry>)this.entries;
      }
      ...
      @Override
      public Int2DoubleSortedMap subMap(int from, int to) {
         return this.compare(from, this.key) <= 0 && this.compare(this.key, to) < 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP;
      }

      @Override
      public Int2DoubleSortedMap headMap(int to) {
         return this.compare(this.key, to) < 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP;
      }

      @Override
      public Int2DoubleSortedMap tailMap(int from) {
         return this.compare(from, this.key) <= 0 ? this : Int2DoubleSortedMaps.EMPTY_MAP;
      }
   ...
   public static class SynchronizedSortedMap extends Int2DoubleMaps.SynchronizedMap implements Int2DoubleSortedMap, Serializable {
      ...
      @Override
      public Int2DoubleSortedMap subMap(int from, int to) {
         return new Int2DoubleSortedMaps.SynchronizedSortedMap(this.sortedMap.subMap(from, to), this.sync);
      }

      @Override
      public Int2DoubleSortedMap headMap(int to) {
         return new Int2DoubleSortedMaps.SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync);
      }

      @Override
      public Int2DoubleSortedMap tailMap(int from) {
         return new Int2DoubleSortedMaps.SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync);
      }
   ...
   public static class UnmodifiableSortedMap extends Int2DoubleMaps.UnmodifiableMap implements Int2DoubleSortedMap, Serializable {
      ...
      @Override
      public Int2DoubleSortedMap subMap(int from, int to) {
         return new Int2DoubleSortedMaps.UnmodifiableSortedMap(this.sortedMap.subMap(from, to));
      }

      @Override
      public Int2DoubleSortedMap headMap(int to) {
         return new Int2DoubleSortedMaps.UnmodifiableSortedMap(this.sortedMap.headMap(to));
      }

      @Override
      public Int2DoubleSortedMap tailMap(int from) {
         return new Int2DoubleSortedMaps.UnmodifiableSortedMap(this.sortedMap.tailMap(from));
      }
