...
public class Int2LongOpenHashMap extends AbstractInt2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Int2LongOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      long[] value = this.value;
      Int2LongOpenHashMap.EntryIterator i = new Int2LongOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Int2LongOpenHashMap.MapIterator<Consumer<? super Int2LongMap.Entry>> implements ObjectIterator<Int2LongMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Int2LongMap.Entry> action, int index) {
         action.accept(this.entry = Int2LongOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2LongOpenHashMap.MapSpliterator<Consumer<? super Int2LongMap.Entry>, Int2LongOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2LongMap.Entry> action, int index) {
         action.accept(Int2LongOpenHashMap.this.new MapEntry(index));
      }

      final Int2LongOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2LongOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Int2LongOpenHashMap.MapIterator<Consumer<? super Int2LongMap.Entry>>
   ...
   private final class KeyIterator extends Int2LongOpenHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2LongOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2LongOpenHashMap.MapSpliterator<java.util.function.IntConsumer, Int2LongOpenHashMap.KeySpliterator>
      ...
      final Int2LongOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2LongOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2LongMap.Entry, Entry<Integer, Long>, IntLongPair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2LongOpenHashMap.this.key[this.index] == e.getKey() && Int2LongOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2LongMap.Entry> spliterator() {
         return Int2LongOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2LongMap.Entry> consumer) {
         if (Int2LongOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2LongOpenHashMap.this.new MapEntry(Int2LongOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2LongOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2LongOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2LongMap.Entry> consumer) {
         Int2LongOpenHashMap.MapEntry entry = Int2LongOpenHashMap.this.new MapEntry();
         if (Int2LongOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2LongOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2LongOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2LongOpenHashMap.this.size - this.c
            : Math.min(
               Int2LongOpenHashMap.this.size - this.c,
               (long)((double)Int2LongOpenHashMap.this.realSize() / Int2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Int2LongOpenHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Int2LongOpenHashMap.MapSpliterator<LongConsumer, Int2LongOpenHashMap.ValueSpliterator>
      ...
      final Int2LongOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2LongOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
