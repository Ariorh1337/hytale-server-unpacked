...
public class Int2DoubleOpenHashMap extends AbstractInt2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Int2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      double[] value = this.value;
      Int2DoubleOpenHashMap.EntryIterator i = new Int2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2DoubleOpenHashMap.MapIterator<Consumer<? super Int2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Int2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2DoubleOpenHashMap.MapSpliterator<Consumer<? super Int2DoubleMap.Entry>, Int2DoubleOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2DoubleMap.Entry> action, int index) {
         action.accept(Int2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Int2DoubleOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Int2DoubleOpenHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2DoubleOpenHashMap.MapSpliterator<java.util.function.IntConsumer, Int2DoubleOpenHashMap.KeySpliterator>
      ...
      final Int2DoubleOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2DoubleMap.Entry, Entry<Integer, Double>, IntDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2DoubleOpenHashMap.this.key[this.index] == e.getKey()
            && Double.doubleToLongBits(Int2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements Int2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2DoubleMap.Entry> spliterator() {
         return Int2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
         if (Int2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2DoubleOpenHashMap.this.new MapEntry(Int2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2DoubleOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2DoubleMap.Entry> consumer) {
         Int2DoubleOpenHashMap.MapEntry entry = Int2DoubleOpenHashMap.this.new MapEntry();
         if (Int2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2DoubleOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Int2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Int2DoubleOpenHashMap.this.realSize() / Int2DoubleOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Int2DoubleOpenHashMap.MapIterator<DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Int2DoubleOpenHashMap.MapSpliterator<DoubleConsumer, Int2DoubleOpenHashMap.ValueSpliterator>
      ...
      final Int2DoubleOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
