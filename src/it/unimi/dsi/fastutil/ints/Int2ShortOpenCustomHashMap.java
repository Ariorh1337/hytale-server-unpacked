...
public class Int2ShortOpenCustomHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Int2ShortOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      short[] value = this.value;
      Int2ShortOpenCustomHashMap.EntryIterator i = new Int2ShortOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ShortOpenCustomHashMap.MapIterator<Consumer<? super Int2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Int2ShortOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ShortOpenCustomHashMap.MapSpliterator<Consumer<? super Int2ShortMap.Entry>, Int2ShortOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ShortMap.Entry> action, int index) {
         action.accept(Int2ShortOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2ShortOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Int2ShortOpenCustomHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ShortOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ShortOpenCustomHashMap.MapSpliterator<java.util.function.IntConsumer, Int2ShortOpenCustomHashMap.KeySpliterator>
      ...
      final Int2ShortOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2ShortMap.Entry, Entry<Integer, Short>, IntShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2ShortOpenCustomHashMap.this.strategy.equals(Int2ShortOpenCustomHashMap.this.key[this.index], e.getKey())
            && Int2ShortOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2ShortMap.Entry> spliterator() {
         return Int2ShortOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2ShortMap.Entry> consumer) {
         if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2ShortOpenCustomHashMap.this.new MapEntry(Int2ShortOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ShortOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ShortOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ShortMap.Entry> consumer) {
         Int2ShortOpenCustomHashMap.MapEntry entry = Int2ShortOpenCustomHashMap.this.new MapEntry();
         if (Int2ShortOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ShortOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ShortOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ShortOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2ShortOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2ShortOpenCustomHashMap.this.realSize() / Int2ShortOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2ShortOpenCustomHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Int2ShortOpenCustomHashMap.MapSpliterator<ShortConsumer, Int2ShortOpenCustomHashMap.ValueSpliterator>
      ...
      final Int2ShortOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
