...
public class IntBigArrayBigList extends AbstractIntBigList implements RandomAccess, Cloneable, Serializable {
   ...
   public int compareTo(IntBigArrayBigList l) {
      ...
      int i;
      for (i = 0; i < s1 && i < s2; i++) {
         int e1 = BigArrays.get(a1, i);
         int e2 = BigArrays.get(a2, i);
         int r;
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      ...
      for (int i = 0; i < this.size; i++) {
         s.writeInt(BigArrays.get(this.a, i));
      }
   }
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      ...
      for (int i = 0; i < this.size; i++) {
         BigArrays.set(this.a, i, s.readInt());
      }
   }
   ...
   private final class Spliterator implements IntSpliterator {
      ...
      public IntSpliterator trySplit() {
         ...
         this.pos = myNewPos;
         this.hasSplit = true;
         return IntBigArrayBigList.this.new Spliterator(oldPos, retMax, true);
      }
   }
