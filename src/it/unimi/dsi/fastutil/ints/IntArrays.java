                  ...
                  while (p <= ix) {
                     ...
                     if (level < 3 && count[c] > 1) {
                        if (count[c] < 1024) {
                           ...
                           queue.add(new IntArrays.Segment(p, count[c], level + 1));
                        }
                     }
               ...
               while (b > c || (comparison = Integer.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new IntArrays.ForkJoinQuickSort(x, this.from, this.from + s));
                     } else {
                        invokeAll(new IntArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = (t = Integer.compare(x[b], v)) == 0 ? Integer.compare(y[b], w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new IntArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s));
                     } else {
                        invokeAll(new IntArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new IntArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp));
                     } else {
                        invokeAll(new IntArrays.ForkJoinQuickSortComp(x, this.to - comparison, this.to, this.comp));
                     }
               ...
               while (b > c || (comparison = Integer.compare(x[this.perm[b]], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new IntArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s));
                     } else {
                        invokeAll(new IntArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - comparison, this.to));
                     }
