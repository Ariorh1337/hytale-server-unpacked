...
public class Int2ObjectOpenCustomHashMap<V> extends AbstractInt2ObjectMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractObjectCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Int2ObjectOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(Consumer<? super V> consumer) {
               ...
               while (pos-- != 0) {
                  if (Int2ObjectOpenCustomHashMap.this.key[pos] != 0) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      V[] value = this.value;
      Int2ObjectOpenCustomHashMap<V>.EntryIterator i = new Int2ObjectOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super Int2ObjectMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ObjectMap.Entry<V>> action, int index) {
         action.accept(this.entry = Int2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Int2ObjectMap.Entry<V>>, Int2ObjectOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ObjectMap.Entry<V>> action, int index) {
         action.accept(Int2ObjectOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2ObjectOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ObjectOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Int2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super Int2ObjectMap.Entry<V>>>
      implements ObjectIterator<Int2ObjectMap.Entry<V>> {
      private final Int2ObjectOpenCustomHashMap<V>.MapEntry entry = Int2ObjectOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ObjectOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator<java.util.function.IntConsumer, Int2ObjectOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Int2ObjectOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ObjectOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Int2ObjectMap.Entry<V>, Entry<Integer, V>, IntObjectPair<V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         Entry<Integer, V> e = (Entry<Integer, V>)o;
         return Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[this.index], e.getKey())
            && Objects.equals(Int2ObjectOpenCustomHashMap.this.value[this.index], e.getValue());
      }

      @Override
      public int hashCode() {
         return Int2ObjectOpenCustomHashMap.this.strategy.hashCode(Int2ObjectOpenCustomHashMap.this.key[this.index])
            ^ (Int2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Int2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Int2ObjectMap.Entry<V>> spliterator() {
         return Int2ObjectOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getKey() != null && e.getKey() instanceof Integer) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
               return Int2ObjectOpenCustomHashMap.this.containsNullKey
                  && Objects.equals(Int2ObjectOpenCustomHashMap.this.value[Int2ObjectOpenCustomHashMap.this.n], v);
            }

            int[] key = Int2ObjectOpenCustomHashMap.this.key;
            int curr;
            int pos;
            if ((curr = key[pos = HashCommon.mix(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask]) == 0) {
               return false;
            }
            ...
            while ((curr = key[pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask]) != 0) {
               if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, curr)) {
                  return Objects.equals(Int2ObjectOpenCustomHashMap.this.value[pos], v);
               }
            }
         ...
         if (e.getKey() != null && e.getKey() instanceof Integer) {
            ...
            if (Int2ObjectOpenCustomHashMap.this.strategy.equals(k, 0)) {
               ...
               if (Int2ObjectOpenCustomHashMap.this.strategy.equals(curr, k)) {
                  ...
                  while ((curr = key[pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask]) != 0) {
                     if (Int2ObjectOpenCustomHashMap.this.strategy.equals(curr, k) && Objects.equals(Int2ObjectOpenCustomHashMap.this.value[pos], v)) {
                        Int2ObjectOpenCustomHashMap.this.removeEntry(pos);
                        return true;
                     }
                  }
      ...
      public void forEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
         if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2ObjectOpenCustomHashMap.this.new MapEntry(Int2ObjectOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ObjectOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ObjectOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ObjectMap.Entry<V>> consumer) {
         Int2ObjectOpenCustomHashMap<V>.MapEntry entry = Int2ObjectOpenCustomHashMap.this.new MapEntry();
         if (Int2ObjectOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Int2ObjectOpenCustomHashMap.this.n;
      int last = -1;
      int c = Int2ObjectOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ObjectOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            int curr;
            for (pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ObjectOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2ObjectOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2ObjectOpenCustomHashMap.this.realSize() / Int2ObjectOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Int2ObjectOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Int2ObjectOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Int2ObjectOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ObjectOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
