...
public class Int2ByteOpenHashMap extends AbstractInt2ByteMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Int2ByteOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      byte[] value = this.value;
      Int2ByteOpenHashMap.EntryIterator i = new Int2ByteOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator extends Int2ByteOpenHashMap.MapIterator<Consumer<? super Int2ByteMap.Entry>> implements ObjectIterator<Int2ByteMap.Entry> {
      ...
      final void acceptOnIndex(Consumer<? super Int2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Int2ByteOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ByteOpenHashMap.MapSpliterator<Consumer<? super Int2ByteMap.Entry>, Int2ByteOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ByteMap.Entry> action, int index) {
         action.accept(Int2ByteOpenHashMap.this.new MapEntry(index));
      }

      final Int2ByteOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }

   private final class FastEntryIterator
      extends Int2ByteOpenHashMap.MapIterator<Consumer<? super Int2ByteMap.Entry>>
   ...
   private final class KeyIterator extends Int2ByteOpenHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ByteOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ByteOpenHashMap.MapSpliterator<java.util.function.IntConsumer, Int2ByteOpenHashMap.KeySpliterator>
      ...
      final Int2ByteOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2ByteMap.Entry, Entry<Integer, Byte>, IntBytePair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2ByteOpenHashMap.this.key[this.index] == e.getKey() && Int2ByteOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2ByteMap.Entry> spliterator() {
         return Int2ByteOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2ByteMap.Entry> consumer) {
         if (Int2ByteOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2ByteOpenHashMap.this.new MapEntry(Int2ByteOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ByteOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ByteOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ByteMap.Entry> consumer) {
         Int2ByteOpenHashMap.MapEntry entry = Int2ByteOpenHashMap.this.new MapEntry();
         if (Int2ByteOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ByteOpenHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ByteOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ByteOpenHashMap.this.size - this.c
            : Math.min(
               Int2ByteOpenHashMap.this.size - this.c,
               (long)((double)Int2ByteOpenHashMap.this.realSize() / Int2ByteOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Int2ByteOpenHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Int2ByteOpenHashMap.MapSpliterator<ByteConsumer, Int2ByteOpenHashMap.ValueSpliterator>
      ...
      final Int2ByteOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ByteOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
