...
public class Int2FloatOpenCustomHashMap extends AbstractInt2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Int2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      float[] value = this.value;
      Int2FloatOpenCustomHashMap.EntryIterator i = new Int2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2FloatOpenCustomHashMap.MapIterator<Consumer<? super Int2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Int2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Int2FloatMap.Entry>, Int2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2FloatMap.Entry> action, int index) {
         action.accept(Int2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Int2FloatOpenCustomHashMap.MapIterator<Consumer<? super Int2FloatMap.Entry>>
      implements ObjectIterator<Int2FloatMap.Entry> {
      private final Int2FloatOpenCustomHashMap.MapEntry entry = Int2FloatOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Int2FloatOpenCustomHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2FloatOpenCustomHashMap.MapSpliterator<java.util.function.IntConsumer, Int2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Int2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2FloatMap.Entry, Entry<Integer, Float>, IntFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Int2FloatOpenCustomHashMap.this.strategy.hashCode(Int2FloatOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.float2int(Int2FloatOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2FloatMap.Entry> spliterator() {
         return Int2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
               return Int2FloatOpenCustomHashMap.this.containsNullKey
                  && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[Int2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (Int2FloatOpenCustomHashMap.this.strategy.equals(k, 0)) {
                  ...
                  if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                     ...
                     while ((curr = key[pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask]) != 0) {
                        if (Int2FloatOpenCustomHashMap.this.strategy.equals(curr, k)
                           && Float.floatToIntBits(Int2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                           Int2FloatOpenCustomHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Int2FloatMap.Entry> consumer) {
         if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2FloatOpenCustomHashMap.this.new MapEntry(Int2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2FloatOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2FloatMap.Entry> consumer) {
         Int2FloatOpenCustomHashMap.MapEntry entry = Int2FloatOpenCustomHashMap.this.new MapEntry();
         if (Int2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Int2FloatOpenCustomHashMap.this.n;
      int last = -1;
      int c = Int2FloatOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            int curr;
            for (pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2FloatOpenCustomHashMap.this.realSize() / Int2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Int2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Int2FloatOpenCustomHashMap.ValueSpliterator>
      ...
      final Int2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
