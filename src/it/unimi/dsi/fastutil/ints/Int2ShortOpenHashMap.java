...
public class Int2ShortOpenHashMap extends AbstractInt2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Int2ShortOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      short[] value = this.value;
      Int2ShortOpenHashMap.EntryIterator i = new Int2ShortOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ShortOpenHashMap.MapIterator<Consumer<? super Int2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Int2ShortOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ShortOpenHashMap.MapSpliterator<Consumer<? super Int2ShortMap.Entry>, Int2ShortOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ShortMap.Entry> action, int index) {
         action.accept(Int2ShortOpenHashMap.this.new MapEntry(index));
      }

      final Int2ShortOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Int2ShortOpenHashMap.MapIterator<Consumer<? super Int2ShortMap.Entry>>
      implements ObjectIterator<Int2ShortMap.Entry> {
      private final Int2ShortOpenHashMap.MapEntry entry = Int2ShortOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Int2ShortOpenHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ShortOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ShortOpenHashMap.MapSpliterator<java.util.function.IntConsumer, Int2ShortOpenHashMap.KeySpliterator>
      ...
      final Int2ShortOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2ShortMap.Entry, Entry<Integer, Short>, IntShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2ShortOpenHashMap.this.key[this.index] == e.getKey() && Int2ShortOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ShortMap.Entry> implements Int2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2ShortMap.Entry> spliterator() {
         return Int2ShortOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2ShortMap.Entry> consumer) {
         if (Int2ShortOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2ShortOpenHashMap.this.new MapEntry(Int2ShortOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ShortOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ShortOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ShortMap.Entry> consumer) {
         Int2ShortOpenHashMap.MapEntry entry = Int2ShortOpenHashMap.this.new MapEntry();
         if (Int2ShortOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Int2ShortOpenHashMap.this.n;
      int last = -1;
      int c = Int2ShortOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ShortOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            int curr;
            for (pos = pos + 1 & Int2ShortOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Int2ShortOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ShortOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ShortOpenHashMap.this.size - this.c
            : Math.min(
               Int2ShortOpenHashMap.this.size - this.c,
               (long)((double)Int2ShortOpenHashMap.this.realSize() / Int2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Int2ShortOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Int2ShortOpenHashMap.MapSpliterator<ShortConsumer, Int2ShortOpenHashMap.ValueSpliterator>
      ...
      final Int2ShortOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ShortOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
