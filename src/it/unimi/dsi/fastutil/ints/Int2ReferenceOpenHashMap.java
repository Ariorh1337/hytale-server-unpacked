...
public class Int2ReferenceOpenHashMap<V> extends AbstractInt2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Int2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      V[] value = this.value;
      Int2ReferenceOpenHashMap<V>.EntryIterator i = new Int2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Int2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super Int2ReferenceMap.Entry<V>>, Int2ReferenceOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Int2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Int2ReferenceOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Int2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Int2ReferenceMap.Entry<V>>>
      implements ObjectIterator<Int2ReferenceMap.Entry<V>> {
      private final Int2ReferenceOpenHashMap<V>.MapEntry entry = Int2ReferenceOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Int2ReferenceOpenHashMap<V>.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      public IntSpliterator spliterator() {
         return Int2ReferenceOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2ReferenceOpenHashMap<V>.MapSpliterator<java.util.function.IntConsumer, Int2ReferenceOpenHashMap<V>.KeySpliterator>
      ...
      final Int2ReferenceOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2ReferenceMap.Entry<V>, Entry<Integer, V>, IntReferencePair<V> {
      ...
      public V setValue(V v) {
         V oldValue = Int2ReferenceOpenHashMap.this.value[this.index];
      ...
      public boolean equals(Object o) {
         ...
         return Int2ReferenceOpenHashMap.this.key[this.index] == e.getKey() && Int2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Int2ReferenceOpenHashMap.this.key[this.index]
            ^ (Int2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceOpenHashMap.this.value[this.index]));
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Int2ReferenceMap.Entry<V>> spliterator() {
         return Int2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
         if (Int2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Int2ReferenceOpenHashMap.this.new MapEntry(Int2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2ReferenceOpenHashMap.this.key[pos] != 0) {
               consumer.accept(Int2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2ReferenceMap.Entry<V>> consumer) {
         Int2ReferenceOpenHashMap<V>.MapEntry entry = Int2ReferenceOpenHashMap.this.new MapEntry();
         if (Int2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Int2ReferenceOpenHashMap.this.n;
      int last = -1;
      int c = Int2ReferenceOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2ReferenceOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            int curr;
            for (pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2ReferenceOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Int2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Int2ReferenceOpenHashMap.this.realSize() / Int2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Int2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Int2ReferenceOpenHashMap<V>.ValueSpliterator>
      ...
      final Int2ReferenceOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
