...
public class Int2IntOpenCustomHashMap extends AbstractInt2IntMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractIntCollection() {
            ...
            public IntSpliterator spliterator() {
               return Int2IntOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int[] key = this.key;
      int[] value = this.value;
      Int2IntOpenCustomHashMap.EntryIterator i = new Int2IntOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Int2IntOpenCustomHashMap.MapIterator<Consumer<? super Int2IntMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Int2IntMap.Entry> action, int index) {
         action.accept(this.entry = Int2IntOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Int2IntOpenCustomHashMap.MapSpliterator<Consumer<? super Int2IntMap.Entry>, Int2IntOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Int2IntMap.Entry> action, int index) {
         action.accept(Int2IntOpenCustomHashMap.this.new MapEntry(index));
      }

      final Int2IntOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2IntOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Int2IntOpenCustomHashMap.MapIterator<Consumer<? super Int2IntMap.Entry>>
      implements ObjectIterator<Int2IntMap.Entry> {
      private final Int2IntOpenCustomHashMap.MapEntry entry = Int2IntOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Int2IntOpenCustomHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractIntSet {
      ...
      @Override
      public IntSpliterator spliterator() {
         return Int2IntOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Int2IntOpenCustomHashMap.MapSpliterator<java.util.function.IntConsumer, Int2IntOpenCustomHashMap.KeySpliterator>
      ...
      final Int2IntOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2IntOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Int2IntMap.Entry, Entry<Integer, Integer>, IntIntPair {
      ...
      public boolean equals(Object o) {
         ...
         return Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[this.index], e.getKey())
            && Int2IntOpenCustomHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return Int2IntOpenCustomHashMap.this.strategy.hashCode(Int2IntOpenCustomHashMap.this.key[this.index])
            ^ Int2IntOpenCustomHashMap.this.value[this.index];
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet {
      ...
      public ObjectSpliterator<Int2IntMap.Entry> spliterator() {
         return Int2IntOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Int2IntMap.Entry> consumer) {
         if (Int2IntOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Int2IntOpenCustomHashMap.this.new MapEntry(Int2IntOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Int2IntOpenCustomHashMap.this.key[pos] != 0) {
               consumer.accept(Int2IntOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Int2IntMap.Entry> consumer) {
         Int2IntOpenCustomHashMap.MapEntry entry = Int2IntOpenCustomHashMap.this.new MapEntry();
         if (Int2IntOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Int2IntOpenCustomHashMap.this.n;
      int last = -1;
      int c = Int2IntOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Int2IntOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            int curr;
            for (pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask; (curr = key[pos]) != 0; pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask) {
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Int2IntOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Int2IntOpenCustomHashMap.this.size - this.c
            : Math.min(
               Int2IntOpenCustomHashMap.this.size - this.c,
               (long)((double)Int2IntOpenCustomHashMap.this.realSize() / Int2IntOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Int2IntOpenCustomHashMap.MapIterator<java.util.function.IntConsumer> implements IntIterator {
   ...
   private final class ValueSpliterator
      extends Int2IntOpenCustomHashMap.MapSpliterator<java.util.function.IntConsumer, Int2IntOpenCustomHashMap.ValueSpliterator>
      implements IntSpliterator {
      ...
      final Int2IntOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Int2IntOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
