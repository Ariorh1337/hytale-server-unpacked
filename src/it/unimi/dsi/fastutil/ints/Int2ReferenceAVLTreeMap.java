...
public class Int2ReferenceAVLTreeMap<V> extends AbstractInt2ReferenceSortedMap<V> implements Serializable, Cloneable {
   ...
   final Int2ReferenceAVLTreeMap.Entry<V> findKey(int k) {
      Int2ReferenceAVLTreeMap.Entry<V> e = this.tree;
   ...
   final Int2ReferenceAVLTreeMap.Entry<V> locateKey(int k) {
      Int2ReferenceAVLTreeMap.Entry<V> e = this.tree;
      Int2ReferenceAVLTreeMap.Entry<V> last = this.tree;
   ...
   public V put(int k, V v) {
      Int2ReferenceAVLTreeMap.Entry<V> e = this.add(k);
      V oldValue = e.value;
      e.value = v;
      return oldValue;
   }

   private Int2ReferenceAVLTreeMap.Entry<V> add(int k) {
      this.modified = false;
      Int2ReferenceAVLTreeMap.Entry<V> e = null;
      if (this.tree == null) {
         this.count++;
         e = this.tree = this.lastEntry = this.firstEntry = new Int2ReferenceAVLTreeMap.Entry<>(k, this.defRetValue);
         this.modified = true;
      } else {
         Int2ReferenceAVLTreeMap.Entry<V> p = this.tree;
         Int2ReferenceAVLTreeMap.Entry<V> q = null;
         Int2ReferenceAVLTreeMap.Entry<V> y = this.tree;
         Int2ReferenceAVLTreeMap.Entry<V> z = null;
         Int2ReferenceAVLTreeMap.Entry<V> w = null;
         int i = 0;
         ...
         while (true) {
            ...
            if (this.dirPath[i++] = cmp > 0) {
               if (p.succ()) {
                  this.count++;
                  e = new Int2ReferenceAVLTreeMap.Entry<>(k, this.defRetValue);
                  this.modified = true;
                  if (p.right == null) {
                     this.lastEntry = e;
                  }
         ...
         if (y.balance() == -2) {
            Int2ReferenceAVLTreeMap.Entry<V> x = y.left;
            if (x.balance() == -1) {
               w = x;
               if (x.succ()) {
                  x.succ(false);
            ...
            Int2ReferenceAVLTreeMap.Entry<V> x = y.right;
            if (x.balance() == 1) {
               w = x;
               if (x.pred()) {
                  x.pred(false);
   ...
   private Int2ReferenceAVLTreeMap.Entry<V> parent(Int2ReferenceAVLTreeMap.Entry<V> e) {
      if (e == this.tree) {
         return null;
      }

      Int2ReferenceAVLTreeMap.Entry<V> y = e;
      Int2ReferenceAVLTreeMap.Entry<V> x = e;

      while (!y.succ()) {
         if (x.pred()) {
            Int2ReferenceAVLTreeMap.Entry<V> p = x.left;
            if (p == null || p.right != e) {
               while (!y.succ()) {
                  y = y.right;
               }
      ...
      Int2ReferenceAVLTreeMap.Entry<V> p = y.right;
      if (p == null || p.left != e) {
         while (!x.pred()) {
            x = x.left;
         }
   ...
   public V remove(int k) {
      ...
      if (p.succ()) {
         ...
         Int2ReferenceAVLTreeMap.Entry<V> r = p.right;
         if (r.pred()) {
            r.left = p.left;
            r.pred(p.pred());
            if (!r.pred()) {
            ...
            while (true) {
               Int2ReferenceAVLTreeMap.Entry<V> s = r.left;
               if (s.pred()) {
                  if (s.succ()) {
                     r.pred(s);
                  } else {
      ...
      while (q != null) {
         Int2ReferenceAVLTreeMap.Entry<V> y = q;
         q = this.parent(y);
         if (!dir) {
            dir = q != null && q.left != y;
            y.incBalance();
            ...
            if (y.balance() == 2) {
               ...
               if (x.balance() == -1) {
                  assert x.balance() == -1;
                  Int2ReferenceAVLTreeMap.Entry<V> w = x.left;
                  x.left = w.right;
                  w.right = x;
                  y.right = w.left;
                  w.left = y;
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Int2ReferenceAVLTreeMap.Entry<V> w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public boolean containsValue(Object v) {
      Int2ReferenceAVLTreeMap<V>.ValueIterator i = new Int2ReferenceAVLTreeMap.ValueIterator();
      int j = this.count;
   ...
   @Override
   public V get(int k) {
      Int2ReferenceAVLTreeMap.Entry<V> e = this.findKey(k);
   ...
   public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Int2ReferenceMap.Entry<V>>() {
            final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = Int2ReferenceAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Integer.compare(x.getIntKey(), y.getIntKey())
            ...
            public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
               return Int2ReferenceAVLTreeMap.this.new EntryIterator(from.getIntKey());
            }
            ...
            public boolean contains(Object o) {
               if (o != null && o instanceof java.util.Map.Entry) {
                  ...
                  Int2ReferenceAVLTreeMap.Entry<V> f = Int2ReferenceAVLTreeMap.this.findKey((Integer)e.getKey());
                  return e.equals(f);
               } else {
                  return false;
               }
   ...
   public Int2ReferenceSortedMap<V> headMap(int to) {
      return new Int2ReferenceAVLTreeMap.Submap(0, true, to, false);
   }

   @Override
   public Int2ReferenceSortedMap<V> tailMap(int from) {
      return new Int2ReferenceAVLTreeMap.Submap(from, false, 0, true);
   }

   @Override
   public Int2ReferenceSortedMap<V> subMap(int from, int to) {
      return new Int2ReferenceAVLTreeMap.Submap(from, false, to, false);
   }
   ...
   public Int2ReferenceAVLTreeMap<V> clone() {
      ...
      Int2ReferenceAVLTreeMap.Entry<V> rp = new Int2ReferenceAVLTreeMap.Entry<>();
      Int2ReferenceAVLTreeMap.Entry<V> rq = new Int2ReferenceAVLTreeMap.Entry<>();
      Int2ReferenceAVLTreeMap.Entry<V> p = rp;
      rp.left(this.tree);
      Int2ReferenceAVLTreeMap.Entry<V> q = rq;
      rq.pred(null);

      while (true) {
         if (!p.pred()) {
            Int2ReferenceAVLTreeMap.Entry<V> e = p.left.clone();
            e.pred(q.left);
            e.succ(q);
            q.left(e);
            p = p.left;
         ...
         if (!p.succ()) {
            Int2ReferenceAVLTreeMap.Entry<V> e = p.right.clone();
            e.succ(q.right);
            e.pred(q);
            q.right(e);
         }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int n = this.count;
      Int2ReferenceAVLTreeMap<V>.EntryIterator i = new Int2ReferenceAVLTreeMap.EntryIterator();
      s.defaultWriteObject();

      while (n-- != 0) {
         Int2ReferenceAVLTreeMap.Entry<V> e = i.nextEntry();
         s.writeInt(e.key);
         s.writeObject(e.value);
      }
   }

   private Int2ReferenceAVLTreeMap.Entry<V> readTree(ObjectInputStream s, int n, Int2ReferenceAVLTreeMap.Entry<V> pred, Int2ReferenceAVLTreeMap.Entry<V> succ) throws IOException, ClassNotFoundException {
      if (n == 1) {
         Int2ReferenceAVLTreeMap.Entry<V> top = new Int2ReferenceAVLTreeMap.Entry<>(s.readInt(), (V)s.readObject());
         top.pred(pred);
         top.succ(succ);
         return top;
      }
      ...
      if (n == 2) {
         Int2ReferenceAVLTreeMap.Entry<V> top = new Int2ReferenceAVLTreeMap.Entry<>(s.readInt(), (V)s.readObject());
         top.right(new Int2ReferenceAVLTreeMap.Entry<>(s.readInt(), (V)s.readObject()));
         top.right.pred(top);
         top.balance(1);
         top.pred(pred);
         top.right.succ(succ);
      ...
      Int2ReferenceAVLTreeMap.Entry<V> top = new Int2ReferenceAVLTreeMap.Entry<>();
   ...
   private static final class Entry<V> extends AbstractInt2ReferenceMap.BasicEntry<V> implements Cloneable {
      ...
      void pred(Int2ReferenceAVLTreeMap.Entry<V> pred) {
         this.info |= 1073741824;
         this.left = pred;
      }

      void succ(Int2ReferenceAVLTreeMap.Entry<V> succ) {
         this.info |= Integer.MIN_VALUE;
         this.right = succ;
      }

      void left(Int2ReferenceAVLTreeMap.Entry<V> left) {
         this.info &= -1073741825;
         this.left = left;
      }

      void right(Int2ReferenceAVLTreeMap.Entry<V> right) {
         this.info &= Integer.MAX_VALUE;
         this.right = right;
      }
      ...
      Int2ReferenceAVLTreeMap.Entry<V> next() {
         Int2ReferenceAVLTreeMap.Entry<V> next = this.right;
      ...
      Int2ReferenceAVLTreeMap.Entry<V> prev() {
         Int2ReferenceAVLTreeMap.Entry<V> prev = this.left;
      ...
      public Int2ReferenceAVLTreeMap.Entry<V> clone() {
         Int2ReferenceAVLTreeMap.Entry<V> c;
         try {
            c = (Int2ReferenceAVLTreeMap.Entry<V>)super.clone();
         } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
         }
   ...
   private class KeySet extends AbstractInt2ReferenceSortedMap<V>.KeySet {
      ...
      public IntBidirectionalIterator iterator(int from) {
         return Int2ReferenceAVLTreeMap.this.new KeyIterator(from);
      }
   }
   ...
   private final class Submap extends AbstractInt2ReferenceSortedMap<V> implements Serializable {
      ...
      @Override
      public void clear() {
         Int2ReferenceAVLTreeMap<V>.Submap.SubmapIterator i = new Int2ReferenceAVLTreeMap.Submap.SubmapIterator();
      ...
      public V remove(int k) {
         ...
         V oldValue = Int2ReferenceAVLTreeMap.this.remove(k);
      ...
      public Int2ReferenceSortedMap<V> headMap(int to) {
         if (this.top) {
            return Int2ReferenceAVLTreeMap.this.new Submap(this.from, this.bottom, to, false);
         } else {
            return Int2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? Int2ReferenceAVLTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Int2ReferenceSortedMap<V> tailMap(int from) {
         if (this.bottom) {
            return Int2ReferenceAVLTreeMap.this.new Submap(from, false, this.to, this.top);
         } else {
            return Int2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? Int2ReferenceAVLTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Int2ReferenceSortedMap<V> subMap(int from, int to) {
         if (this.top && this.bottom) {
            return Int2ReferenceAVLTreeMap.this.new Submap(from, false, to, false);
         }
         ...
         return !this.top && !this.bottom && from == this.from && to == this.to ? this : Int2ReferenceAVLTreeMap.this.new Submap(from, false, to, false);
      }
      ...
      public Int2ReferenceAVLTreeMap.Entry<V> firstEntry() {
         ...
         return e != null && (this.top || Int2ReferenceAVLTreeMap.this.compare(e.key, this.to) < 0) ? e : null;
      }
      ...
      public Int2ReferenceAVLTreeMap.Entry<V> lastEntry() {
         ...
         return e != null && (this.bottom || Int2ReferenceAVLTreeMap.this.compare(e.key, this.from) >= 0) ? e : null;
      }

      @Override
      public int firstIntKey() {
         Int2ReferenceAVLTreeMap.Entry<V> e = this.firstEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      @Override
      public int lastIntKey() {
         Int2ReferenceAVLTreeMap.Entry<V> e = this.lastEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      private class SubmapIterator extends Int2ReferenceAVLTreeMap<V>.TreeIterator {
         ...
         SubmapIterator(int k) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Int2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Int2ReferenceAVLTreeMap.this.compare(k, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
   ...
   private class TreeIterator {
      ...
      TreeIterator(int k) {
         if ((this.next = Int2ReferenceAVLTreeMap.this.locateKey(k)) != null) {
            if (Int2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
