...
public class Double2BooleanOpenCustomHashMap extends AbstractDouble2BooleanMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractBooleanCollection() {
            ...
            public BooleanSpliterator spliterator() {
               return Double2BooleanOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      boolean[] value = this.value;
      Double2BooleanOpenCustomHashMap.EntryIterator i = new Double2BooleanOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2BooleanOpenCustomHashMap.MapIterator<Consumer<? super Double2BooleanMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2BooleanMap.Entry> action, int index) {
         action.accept(this.entry = Double2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2BooleanOpenCustomHashMap.MapSpliterator<Consumer<? super Double2BooleanMap.Entry>, Double2BooleanOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2BooleanMap.Entry> action, int index) {
         action.accept(Double2BooleanOpenCustomHashMap.this.new MapEntry(index));
      }

      final Double2BooleanOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2BooleanOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Double2BooleanOpenCustomHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2BooleanOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2BooleanOpenCustomHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2BooleanOpenCustomHashMap.KeySpliterator>
      ...
      final Double2BooleanOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2BooleanOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2BooleanMap.Entry, Entry<Double, Boolean>, DoubleBooleanPair {
      ...
      public boolean equals(Object o) {
         ...
         return Double2BooleanOpenCustomHashMap.this.strategy.equals(Double2BooleanOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double2BooleanOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2BooleanMap.Entry> spliterator() {
         return Double2BooleanOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Boolean) {
            ...
            if (Double2BooleanOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
               return Double2BooleanOpenCustomHashMap.this.containsNullKey
                  && Double2BooleanOpenCustomHashMap.this.value[Double2BooleanOpenCustomHashMap.this.n] == v;
            }
      ...
      public void forEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
         if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Double2BooleanOpenCustomHashMap.this.new MapEntry(Double2BooleanOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2BooleanOpenCustomHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2BooleanOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2BooleanMap.Entry> consumer) {
         Double2BooleanOpenCustomHashMap.MapEntry entry = Double2BooleanOpenCustomHashMap.this.new MapEntry();
         if (Double2BooleanOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2BooleanOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2BooleanOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2BooleanOpenCustomHashMap.this.size - this.c
            : Math.min(
               Double2BooleanOpenCustomHashMap.this.size - this.c,
               (long)((double)Double2BooleanOpenCustomHashMap.this.realSize() / Double2BooleanOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2BooleanOpenCustomHashMap.MapIterator<BooleanConsumer> implements BooleanIterator {
   ...
   private final class ValueSpliterator
      extends Double2BooleanOpenCustomHashMap.MapSpliterator<BooleanConsumer, Double2BooleanOpenCustomHashMap.ValueSpliterator>
      ...
      final Double2BooleanOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2BooleanOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
