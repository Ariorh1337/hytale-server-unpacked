...
public class Double2ByteOpenCustomHashMap extends AbstractDouble2ByteMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractByteCollection() {
            ...
            public ByteSpliterator spliterator() {
               return Double2ByteOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      byte[] value = this.value;
      Double2ByteOpenCustomHashMap.EntryIterator i = new Double2ByteOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2ByteOpenCustomHashMap.MapIterator<Consumer<? super Double2ByteMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2ByteMap.Entry> action, int index) {
         action.accept(this.entry = Double2ByteOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2ByteOpenCustomHashMap.MapSpliterator<Consumer<? super Double2ByteMap.Entry>, Double2ByteOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2ByteMap.Entry> action, int index) {
         action.accept(Double2ByteOpenCustomHashMap.this.new MapEntry(index));
      }

      final Double2ByteOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ByteOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Double2ByteOpenCustomHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2ByteOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2ByteOpenCustomHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2ByteOpenCustomHashMap.KeySpliterator>
      ...
      final Double2ByteOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ByteOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2ByteMap.Entry, Entry<Double, Byte>, DoubleBytePair {
      ...
      public boolean equals(Object o) {
         ...
         return Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[this.index], e.getKey())
            && Double2ByteOpenCustomHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ByteMap.Entry> implements Double2ByteMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2ByteMap.Entry> spliterator() {
         return Double2ByteOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Double2ByteMap.Entry> consumer) {
         if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Double2ByteOpenCustomHashMap.this.new MapEntry(Double2ByteOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2ByteOpenCustomHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2ByteOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2ByteMap.Entry> consumer) {
         Double2ByteOpenCustomHashMap.MapEntry entry = Double2ByteOpenCustomHashMap.this.new MapEntry();
         if (Double2ByteOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2ByteOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2ByteOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2ByteOpenCustomHashMap.this.size - this.c
            : Math.min(
               Double2ByteOpenCustomHashMap.this.size - this.c,
               (long)((double)Double2ByteOpenCustomHashMap.this.realSize() / Double2ByteOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2ByteOpenCustomHashMap.MapIterator<ByteConsumer> implements ByteIterator {
   ...
   private final class ValueSpliterator
      extends Double2ByteOpenCustomHashMap.MapSpliterator<ByteConsumer, Double2ByteOpenCustomHashMap.ValueSpliterator>
      ...
      final Double2ByteOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ByteOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
