...
public final class DoubleLists {
   ...
   public static DoubleList synchronize(DoubleList l) {
      return l instanceof RandomAccess ? new DoubleLists.SynchronizedRandomAccessList(l) : new DoubleLists.SynchronizedList(l);
   }

   public static DoubleList synchronize(DoubleList l, Object sync) {
      return l instanceof RandomAccess ? new DoubleLists.SynchronizedRandomAccessList(l, sync) : new DoubleLists.SynchronizedList(l, sync);
   }

   public static DoubleList unmodifiable(DoubleList l) {
      return l instanceof RandomAccess ? new DoubleLists.UnmodifiableRandomAccessList(l) : new DoubleLists.UnmodifiableList(l);
   }
