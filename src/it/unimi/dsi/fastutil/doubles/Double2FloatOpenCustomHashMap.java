...
public class Double2FloatOpenCustomHashMap extends AbstractDouble2FloatMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractFloatCollection() {
            ...
            public FloatSpliterator spliterator() {
               return Double2FloatOpenCustomHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(FloatConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) != 0L) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      float[] value = this.value;
      Double2FloatOpenCustomHashMap.EntryIterator i = new Double2FloatOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2FloatOpenCustomHashMap.MapIterator<Consumer<? super Double2FloatMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2FloatMap.Entry> action, int index) {
         action.accept(this.entry = Double2FloatOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2FloatOpenCustomHashMap.MapSpliterator<Consumer<? super Double2FloatMap.Entry>, Double2FloatOpenCustomHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2FloatMap.Entry> action, int index) {
         action.accept(Double2FloatOpenCustomHashMap.this.new MapEntry(index));
      }

      final Double2FloatOpenCustomHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2FloatOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Double2FloatOpenCustomHashMap.MapIterator<Consumer<? super Double2FloatMap.Entry>>
      implements ObjectIterator<Double2FloatMap.Entry> {
      private final Double2FloatOpenCustomHashMap.MapEntry entry = Double2FloatOpenCustomHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Double2FloatOpenCustomHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2FloatOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2FloatOpenCustomHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2FloatOpenCustomHashMap.KeySpliterator>
      ...
      final Double2FloatOpenCustomHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2FloatOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2FloatMap.Entry, Entry<Double, Float>, DoubleFloatPair {
      ...
      public boolean equals(Object o) {
         ...
         return Double2FloatOpenCustomHashMap.this.strategy.equals(Double2FloatOpenCustomHashMap.this.key[this.index], e.getKey())
            && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[this.index]) == Float.floatToIntBits(e.getValue());
      }

      @Override
      public int hashCode() {
         return Double2FloatOpenCustomHashMap.this.strategy.hashCode(Double2FloatOpenCustomHashMap.this.key[this.index])
            ^ HashCommon.float2int(Double2FloatOpenCustomHashMap.this.value[this.index]);
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2FloatMap.Entry> implements Double2FloatMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2FloatMap.Entry> spliterator() {
         return Double2FloatOpenCustomHashMap.this.new EntrySpliterator();
      }
         ...
         if (e.getValue() != null && e.getValue() instanceof Float) {
            ...
            if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
               return Double2FloatOpenCustomHashMap.this.containsNullKey
                  && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[Double2FloatOpenCustomHashMap.this.n]) == Float.floatToIntBits(v);
            }
            ...
            if (Double.doubleToLongBits(
                  curr = key[pos = HashCommon.mix(Double2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Double2FloatOpenCustomHashMap.this.mask]
               )
               == 0L) {
               return false;
            }
            ...
            while (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) {
               if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, curr)) {
                  return Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v);
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Float) {
               ...
               if (Double2FloatOpenCustomHashMap.this.strategy.equals(k, 0.0)) {
                  ...
                  if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)) {
                     ...
                     while (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask]) != 0L) {
                        if (Double2FloatOpenCustomHashMap.this.strategy.equals(curr, k)
                           && Float.floatToIntBits(Double2FloatOpenCustomHashMap.this.value[pos]) == Float.floatToIntBits(v)) {
                           Double2FloatOpenCustomHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Double2FloatMap.Entry> consumer) {
         if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Double2FloatOpenCustomHashMap.this.new MapEntry(Double2FloatOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2FloatOpenCustomHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2FloatOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2FloatMap.Entry> consumer) {
         Double2FloatOpenCustomHashMap.MapEntry entry = Double2FloatOpenCustomHashMap.this.new MapEntry();
         if (Double2FloatOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Double2FloatOpenCustomHashMap.this.n;
      int last = -1;
      int c = Double2FloatOpenCustomHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2FloatOpenCustomHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            double curr;
            for (pos = pos + 1 & Double2FloatOpenCustomHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2FloatOpenCustomHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2FloatOpenCustomHashMap.this.size - this.c
            : Math.min(
               Double2FloatOpenCustomHashMap.this.size - this.c,
               (long)((double)Double2FloatOpenCustomHashMap.this.realSize() / Double2FloatOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2FloatOpenCustomHashMap.MapIterator<FloatConsumer> implements FloatIterator {
   ...
   private final class ValueSpliterator
      extends Double2FloatOpenCustomHashMap.MapSpliterator<FloatConsumer, Double2FloatOpenCustomHashMap.ValueSpliterator>
      ...
      final Double2FloatOpenCustomHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2FloatOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
