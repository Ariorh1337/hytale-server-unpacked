...
public class Double2CharRBTreeMap extends AbstractDouble2CharSortedMap implements Serializable, Cloneable {
   ...
   final Double2CharRBTreeMap.Entry findKey(double k) {
      Double2CharRBTreeMap.Entry e = this.tree;
   ...
   final Double2CharRBTreeMap.Entry locateKey(double k) {
      Double2CharRBTreeMap.Entry e = this.tree;
      Double2CharRBTreeMap.Entry last = this.tree;
   ...
   public char addTo(double k, char incr) {
      Double2CharRBTreeMap.Entry e = this.add(k);
   ...
   private Double2CharRBTreeMap.Entry add(double k) {
      this.modified = false;
      int maxDepth = 0;
      Double2CharRBTreeMap.Entry e;
      if (this.tree == null) {
         this.count++;
         e = this.tree = this.lastEntry = this.firstEntry = new Double2CharRBTreeMap.Entry(k, this.defRetValue);
      } else {
         Double2CharRBTreeMap.Entry p = this.tree;
         int i = 0;
         ...
         while (true) {
            ...
            if (this.dirPath[i++] = cmp > 0) {
               ...
               this.count++;
               e = new Double2CharRBTreeMap.Entry(k, this.defRetValue);
               if (p.right == null) {
                  this.lastEntry = e;
               }
            ...
            while (true) {
               ...
               if (!this.dirPath[i - 1]) {
                  Double2CharRBTreeMap.Entry y = this.nodePath[i - 1].right;
                  if (this.nodePath[i - 1].succ() || y.black()) {
                     if (!this.dirPath[i]) {
                        y = this.nodePath[i];
                     } else {
                        Double2CharRBTreeMap.Entry x = this.nodePath[i];
                        y = x.right;
                        x.right = y.left;
                        y.left = x;
                     ...
                     Double2CharRBTreeMap.Entry x = this.nodePath[i - 1];
                     x.black(false);
                     y.black(true);
                     x.left = y.right;
                     y.right = x;
                  ...
                  Double2CharRBTreeMap.Entry y = this.nodePath[i - 1].left;
   ...
   public char remove(double k) {
      ...
      if (p.succ()) {
         ...
         Double2CharRBTreeMap.Entry r = p.right;
         if (r.pred()) {
            r.left = p.left;
            r.pred(p.pred());
            if (!r.pred()) {
            ...
            while (true) {
               ...
               this.nodePath[i++] = r;
               Double2CharRBTreeMap.Entry s = r.left;
               if (s.pred()) {
                  this.dirPath[j] = true;
                  this.nodePath[j] = s;
                  if (s.succ()) {
      ...
      if (p.black()) {
         for (; i > 0; i--) {
            if (this.dirPath[i - 1] && !this.nodePath[i - 1].succ() || !this.dirPath[i - 1] && !this.nodePath[i - 1].pred()) {
               Double2CharRBTreeMap.Entry x = this.dirPath[i - 1] ? this.nodePath[i - 1].right : this.nodePath[i - 1].left;
               if (!x.black()) {
                  x.black(true);
                  break;
               }
            ...
            if (!this.dirPath[i - 1]) {
               Double2CharRBTreeMap.Entry w = this.nodePath[i - 1].right;
               if (!w.black()) {
                  w.black(true);
                  this.nodePath[i - 1].black(false);
               ...
               if (!w.pred() && !w.left.black() || !w.succ() && !w.right.black()) {
                  if (w.succ() || w.right.black()) {
                     Double2CharRBTreeMap.Entry y = w.left;
                     y.black(true);
                     w.black(false);
                     w.left = y.right;
                     y.right = w;
               ...
               Double2CharRBTreeMap.Entry w = this.nodePath[i - 1].left;
               if (!w.black()) {
                  w.black(true);
                  this.nodePath[i - 1].black(false);
               ...
               if (!w.pred() && !w.left.black() || !w.succ() && !w.right.black()) {
                  if (w.pred() || w.left.black()) {
                     Double2CharRBTreeMap.Entry y = w.right;
                     y.black(true);
                     w.black(false);
                     w.right = y.left;
                     y.left = w;
   ...
   public boolean containsValue(char v) {
      Double2CharRBTreeMap.ValueIterator i = new Double2CharRBTreeMap.ValueIterator();
      int j = this.count;
   ...
   public char get(double k) {
      Double2CharRBTreeMap.Entry e = this.findKey(k);
   ...
   public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2CharMap.Entry>() {
            final Comparator<? super Double2CharMap.Entry> comparator = Double2CharRBTreeMap.this.actualComparator == null
               ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey())
               : (x, y) -> Double2CharRBTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
            ...
            public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
               return Double2CharRBTreeMap.this.new EntryIterator(from.getDoubleKey());
            }
            ...
            public boolean contains(Object o) {
               if (o != null && o instanceof java.util.Map.Entry) {
                  ...
                  if (e.getKey() == null) {
                     ...
                     Double2CharRBTreeMap.Entry f = Double2CharRBTreeMap.this.findKey((Double)e.getKey());
                     return e.equals(f);
                  } else {
                     return false;
                  }
   ...
   public Double2CharSortedMap headMap(double to) {
      return new Double2CharRBTreeMap.Submap(0.0, true, to, false);
   }

   @Override
   public Double2CharSortedMap tailMap(double from) {
      return new Double2CharRBTreeMap.Submap(from, false, 0.0, true);
   }

   @Override
   public Double2CharSortedMap subMap(double from, double to) {
      return new Double2CharRBTreeMap.Submap(from, false, to, false);
   }
   ...
   public Double2CharRBTreeMap clone() {
      ...
      Double2CharRBTreeMap.Entry rp = new Double2CharRBTreeMap.Entry();
      Double2CharRBTreeMap.Entry rq = new Double2CharRBTreeMap.Entry();
      Double2CharRBTreeMap.Entry p = rp;
      rp.left(this.tree);
      Double2CharRBTreeMap.Entry q = rq;
      rq.pred(null);

      while (true) {
         if (!p.pred()) {
            Double2CharRBTreeMap.Entry e = p.left.clone();
            e.pred(q.left);
            e.succ(q);
            q.left(e);
            p = p.left;
         ...
         if (!p.succ()) {
            Double2CharRBTreeMap.Entry e = p.right.clone();
            e.succ(q.right);
            e.pred(q);
            q.right(e);
         }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      int n = this.count;
      Double2CharRBTreeMap.EntryIterator i = new Double2CharRBTreeMap.EntryIterator();
      s.defaultWriteObject();

      while (n-- != 0) {
         Double2CharRBTreeMap.Entry e = i.nextEntry();
         s.writeDouble(e.key);
         s.writeChar(e.value);
      }
   }

   private Double2CharRBTreeMap.Entry readTree(ObjectInputStream s, int n, Double2CharRBTreeMap.Entry pred, Double2CharRBTreeMap.Entry succ) throws IOException, ClassNotFoundException {
      if (n == 1) {
         Double2CharRBTreeMap.Entry top = new Double2CharRBTreeMap.Entry(s.readDouble(), s.readChar());
         top.pred(pred);
         top.succ(succ);
         top.black(true);
         return top;
      ...
      if (n == 2) {
         Double2CharRBTreeMap.Entry top = new Double2CharRBTreeMap.Entry(s.readDouble(), s.readChar());
         top.black(true);
         top.right(new Double2CharRBTreeMap.Entry(s.readDouble(), s.readChar()));
         top.right.pred(top);
         top.pred(pred);
         top.right.succ(succ);
         return top;
      ...
      Double2CharRBTreeMap.Entry top = new Double2CharRBTreeMap.Entry();
   ...
   private static final class Entry extends AbstractDouble2CharMap.BasicEntry implements Cloneable {
      ...
      void pred(Double2CharRBTreeMap.Entry pred) {
         this.info |= 1073741824;
         this.left = pred;
      }

      void succ(Double2CharRBTreeMap.Entry succ) {
         this.info |= Integer.MIN_VALUE;
         this.right = succ;
      }

      void left(Double2CharRBTreeMap.Entry left) {
         this.info &= -1073741825;
         this.left = left;
      }

      void right(Double2CharRBTreeMap.Entry right) {
         this.info &= Integer.MAX_VALUE;
         this.right = right;
      }
      ...
      Double2CharRBTreeMap.Entry next() {
         Double2CharRBTreeMap.Entry next = this.right;
      ...
      Double2CharRBTreeMap.Entry prev() {
         Double2CharRBTreeMap.Entry prev = this.left;
      ...
      public Double2CharRBTreeMap.Entry clone() {
         Double2CharRBTreeMap.Entry c;
         try {
            c = (Double2CharRBTreeMap.Entry)super.clone();
         } catch (CloneNotSupportedException cantHappen) {
            throw new InternalError();
         }
   ...
   private class KeySet extends AbstractDouble2CharSortedMap.KeySet {
      ...
      public DoubleBidirectionalIterator iterator(double from) {
         return Double2CharRBTreeMap.this.new KeyIterator(from);
      }
   }
   ...
   private final class Submap extends AbstractDouble2CharSortedMap implements Serializable {
      ...
      @Override
      public void clear() {
         Double2CharRBTreeMap.Submap.SubmapIterator i = new Double2CharRBTreeMap.Submap.SubmapIterator();
      ...
      public Double2CharSortedMap headMap(double to) {
         if (this.top) {
            return Double2CharRBTreeMap.this.new Submap(this.from, this.bottom, to, false);
         } else {
            return Double2CharRBTreeMap.this.compare(to, this.to) < 0 ? Double2CharRBTreeMap.this.new Submap(this.from, this.bottom, to, false) : this;
         }
      }
      ...
      public Double2CharSortedMap tailMap(double from) {
         if (this.bottom) {
            return Double2CharRBTreeMap.this.new Submap(from, false, this.to, this.top);
         } else {
            return Double2CharRBTreeMap.this.compare(from, this.from) > 0 ? Double2CharRBTreeMap.this.new Submap(from, false, this.to, this.top) : this;
         }
      }
      ...
      public Double2CharSortedMap subMap(double from, double to) {
         if (this.top && this.bottom) {
            return Double2CharRBTreeMap.this.new Submap(from, false, to, false);
         }

         if (!this.top) {
            to = Double2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
         }
         ...
         return !this.top && !this.bottom && from == this.from && to == this.to ? this : Double2CharRBTreeMap.this.new Submap(from, false, to, false);
      }
      ...
      public Double2CharRBTreeMap.Entry firstEntry() {
         ...
         return e != null && (this.top || Double2CharRBTreeMap.this.compare(e.key, this.to) < 0) ? e : null;
      }
      ...
      public Double2CharRBTreeMap.Entry lastEntry() {
         ...
         return e != null && (this.bottom || Double2CharRBTreeMap.this.compare(e.key, this.from) >= 0) ? e : null;
      }

      @Override
      public double firstDoubleKey() {
         Double2CharRBTreeMap.Entry e = this.firstEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      @Override
      public double lastDoubleKey() {
         Double2CharRBTreeMap.Entry e = this.lastEntry();
         if (e == null) {
            throw new NoSuchElementException();
         } else {
            return e.key;
      ...
      private class SubmapIterator extends Double2CharRBTreeMap.TreeIterator {
         ...
         SubmapIterator(double k) {
            this();
            if (this.next != null) {
               if (!Submap.this.bottom && Double2CharRBTreeMap.this.compare(k, this.next.key) < 0) {
                  this.prev = null;
               } else if (!Submap.this.top && Double2CharRBTreeMap.this.compare(k, (this.prev = Submap.this.lastEntry()).key) >= 0) {
                  this.next = null;
               } else {
   ...
   private class TreeIterator {
      ...
      TreeIterator(double k) {
         if ((this.next = Double2CharRBTreeMap.this.locateKey(k)) != null) {
            if (Double2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
               this.prev = this.next;
               this.next = this.next.next();
            } else {
