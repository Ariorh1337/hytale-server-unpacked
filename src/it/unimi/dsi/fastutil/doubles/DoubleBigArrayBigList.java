...
public class DoubleBigArrayBigList extends AbstractDoubleBigList implements RandomAccess, Cloneable, Serializable {
   ...
   public int compareTo(DoubleBigArrayBigList l) {
      ...
      int i;
      for (i = 0; i < s1 && i < s2; i++) {
         double e1 = BigArrays.get(a1, i);
         double e2 = BigArrays.get(a2, i);
         int r;
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      ...
      for (int i = 0; i < this.size; i++) {
         s.writeDouble(BigArrays.get(this.a, i));
      }
   }
   ...
   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
      ...
      for (int i = 0; i < this.size; i++) {
         BigArrays.set(this.a, i, s.readDouble());
      }
   }
   ...
   private final class Spliterator implements DoubleSpliterator {
      ...
      public DoubleSpliterator trySplit() {
         ...
         this.pos = myNewPos;
         this.hasSplit = true;
         return DoubleBigArrayBigList.this.new Spliterator(oldPos, retMax, true);
      }
   }
