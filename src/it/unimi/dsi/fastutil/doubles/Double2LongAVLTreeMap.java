...
public class Double2LongAVLTreeMap extends AbstractDouble2LongSortedMap implements Serializable, Cloneable {
   ...
   private Double2LongAVLTreeMap.Entry parent(Double2LongAVLTreeMap.Entry e) {
      ...
      Double2LongAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Double2LongAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2LongMap.Entry>() {
            final Comparator<? super Double2LongMap.Entry> comparator = Double2LongAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey())
               : (x, y) -> Double2LongAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
