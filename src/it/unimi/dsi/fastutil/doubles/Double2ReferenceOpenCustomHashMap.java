...
public class Double2ReferenceOpenCustomHashMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Double2ReferenceOpenCustomHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      V[] value = this.value;
      Double2ReferenceOpenCustomHashMap<V>.EntryIterator i = new Double2ReferenceOpenCustomHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super Double2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Double2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Double2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super Double2ReferenceMap.Entry<V>>, Double2ReferenceOpenCustomHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Double2ReferenceOpenCustomHashMap.this.new MapEntry(index));
      }

      final Double2ReferenceOpenCustomHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenCustomHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Double2ReferenceOpenCustomHashMap<V>.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2ReferenceOpenCustomHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2ReferenceOpenCustomHashMap<V>.MapSpliterator<java.util.function.DoubleConsumer, Double2ReferenceOpenCustomHashMap<V>.KeySpliterator>
      ...
      final Double2ReferenceOpenCustomHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenCustomHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2ReferenceMap.Entry<V>, Entry<Double, V>, DoubleReferencePair<V> {
      ...
      public boolean equals(Object o) {
         ...
         return Double2ReferenceOpenCustomHashMap.this.strategy.equals(Double2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())
      ...
      public int hashCode() {
         return Double2ReferenceOpenCustomHashMap.this.strategy.hashCode(Double2ReferenceOpenCustomHashMap.this.key[this.index])
            ^ (
               Double2ReferenceOpenCustomHashMap.this.value[this.index] == null
                  ? 0
                  : System.identityHashCode(Double2ReferenceOpenCustomHashMap.this.value[this.index])
            );
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Double2ReferenceMap.Entry<V>> spliterator() {
         return Double2ReferenceOpenCustomHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
         if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
            consumer.accept(Double2ReferenceOpenCustomHashMap.this.new MapEntry(Double2ReferenceOpenCustomHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2ReferenceOpenCustomHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2ReferenceOpenCustomHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
         Double2ReferenceOpenCustomHashMap<V>.MapEntry entry = Double2ReferenceOpenCustomHashMap.this.new MapEntry();
         if (Double2ReferenceOpenCustomHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2ReferenceOpenCustomHashMap.this.n);
            this.c--;
         }
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2ReferenceOpenCustomHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2ReferenceOpenCustomHashMap.this.size - this.c
            : Math.min(
               Double2ReferenceOpenCustomHashMap.this.size - this.c,
               (long)((double)Double2ReferenceOpenCustomHashMap.this.realSize() / Double2ReferenceOpenCustomHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2ReferenceOpenCustomHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Double2ReferenceOpenCustomHashMap<V>.MapSpliterator<Consumer<? super V>, Double2ReferenceOpenCustomHashMap<V>.ValueSpliterator>
      ...
      final Double2ReferenceOpenCustomHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenCustomHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
