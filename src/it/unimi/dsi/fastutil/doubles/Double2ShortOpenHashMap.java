...
public class Double2ShortOpenHashMap extends AbstractDouble2ShortMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractShortCollection() {
            ...
            public ShortSpliterator spliterator() {
               return Double2ShortOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      short[] value = this.value;
      Double2ShortOpenHashMap.EntryIterator i = new Double2ShortOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2ShortOpenHashMap.MapIterator<Consumer<? super Double2ShortMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2ShortMap.Entry> action, int index) {
         action.accept(this.entry = Double2ShortOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2ShortOpenHashMap.MapSpliterator<Consumer<? super Double2ShortMap.Entry>, Double2ShortOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2ShortMap.Entry> action, int index) {
         action.accept(Double2ShortOpenHashMap.this.new MapEntry(index));
      }

      final Double2ShortOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ShortOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Double2ShortOpenHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2ShortOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2ShortOpenHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2ShortOpenHashMap.KeySpliterator>
      ...
      final Double2ShortOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ShortOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2ShortMap.Entry, Entry<Double, Short>, DoubleShortPair {
      ...
      public boolean equals(Object o) {
         ...
         return Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey())
            && Double2ShortOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ShortMap.Entry> implements Double2ShortMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2ShortMap.Entry> spliterator() {
         return Double2ShortOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Double2ShortMap.Entry> consumer) {
         if (Double2ShortOpenHashMap.this.containsNullKey) {
            consumer.accept(Double2ShortOpenHashMap.this.new MapEntry(Double2ShortOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2ShortOpenHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2ShortOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2ShortMap.Entry> consumer) {
         Double2ShortOpenHashMap.MapEntry entry = Double2ShortOpenHashMap.this.new MapEntry();
         if (Double2ShortOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2ShortOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            double curr;
            for (pos = pos + 1 & Double2ShortOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2ShortOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2ShortOpenHashMap.this.size - this.c
            : Math.min(
               Double2ShortOpenHashMap.this.size - this.c,
               (long)((double)Double2ShortOpenHashMap.this.realSize() / Double2ShortOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Double2ShortOpenHashMap.MapIterator<ShortConsumer> implements ShortIterator {
   ...
   private final class ValueSpliterator
      extends Double2ShortOpenHashMap.MapSpliterator<ShortConsumer, Double2ShortOpenHashMap.ValueSpliterator>
      ...
      final Double2ShortOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ShortOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
