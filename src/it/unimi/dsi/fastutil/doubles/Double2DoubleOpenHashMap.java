...
public class Double2DoubleOpenHashMap extends AbstractDouble2DoubleMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractDoubleCollection() {
            ...
            public DoubleSpliterator spliterator() {
               return Double2DoubleOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      double[] value = this.value;
      Double2DoubleOpenHashMap.EntryIterator i = new Double2DoubleOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2DoubleOpenHashMap.MapIterator<Consumer<? super Double2DoubleMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2DoubleMap.Entry> action, int index) {
         action.accept(this.entry = Double2DoubleOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2DoubleOpenHashMap.MapSpliterator<Consumer<? super Double2DoubleMap.Entry>, Double2DoubleOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2DoubleMap.Entry> action, int index) {
         action.accept(Double2DoubleOpenHashMap.this.new MapEntry(index));
      }

      final Double2DoubleOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2DoubleOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class KeyIterator extends Double2DoubleOpenHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      @Override
      public DoubleSpliterator spliterator() {
         return Double2DoubleOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2DoubleOpenHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2DoubleOpenHashMap.KeySpliterator>
      ...
      final Double2DoubleOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2DoubleOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2DoubleMap.Entry, Entry<Double, Double>, DoubleDoublePair {
      ...
      public boolean equals(Object o) {
         ...
         return Double.doubleToLongBits(Double2DoubleOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey())
            && Double.doubleToLongBits(Double2DoubleOpenHashMap.this.value[this.index]) == Double.doubleToLongBits(e.getValue());
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2DoubleMap.Entry> spliterator() {
         return Double2DoubleOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Double2DoubleMap.Entry> consumer) {
         if (Double2DoubleOpenHashMap.this.containsNullKey) {
            consumer.accept(Double2DoubleOpenHashMap.this.new MapEntry(Double2DoubleOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2DoubleOpenHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2DoubleOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2DoubleMap.Entry> consumer) {
         Double2DoubleOpenHashMap.MapEntry entry = Double2DoubleOpenHashMap.this.new MapEntry();
         if (Double2DoubleOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2DoubleOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            double curr;
            for (pos = pos + 1 & Double2DoubleOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2DoubleOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2DoubleOpenHashMap.this.size - this.c
            : Math.min(
               Double2DoubleOpenHashMap.this.size - this.c,
               (long)((double)Double2DoubleOpenHashMap.this.realSize() / Double2DoubleOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2DoubleOpenHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
   ...
   private final class ValueSpliterator
      extends Double2DoubleOpenHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2DoubleOpenHashMap.ValueSpliterator>
      implements DoubleSpliterator {
      ...
      final Double2DoubleOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2DoubleOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
