...
public class Double2LongOpenHashMap extends AbstractDouble2LongMap implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractLongCollection() {
            ...
            public LongSpliterator spliterator() {
               return Double2LongOpenHashMap.this.new ValueSpliterator();
            }
            ...
            public void forEach(LongConsumer consumer) {
               ...
               while (pos-- != 0) {
                  if (Double.doubleToLongBits(Double2LongOpenHashMap.this.key[pos]) != 0L) {
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      long[] value = this.value;
      Double2LongOpenHashMap.EntryIterator i = new Double2LongOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2LongOpenHashMap.MapIterator<Consumer<? super Double2LongMap.Entry>>
      ...
      final void acceptOnIndex(Consumer<? super Double2LongMap.Entry> action, int index) {
         action.accept(this.entry = Double2LongOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2LongOpenHashMap.MapSpliterator<Consumer<? super Double2LongMap.Entry>, Double2LongOpenHashMap.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2LongMap.Entry> action, int index) {
         action.accept(Double2LongOpenHashMap.this.new MapEntry(index));
      }

      final Double2LongOpenHashMap.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2LongOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Double2LongOpenHashMap.MapIterator<Consumer<? super Double2LongMap.Entry>>
      implements ObjectIterator<Double2LongMap.Entry> {
      private final Double2LongOpenHashMap.MapEntry entry = Double2LongOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Double2LongOpenHashMap.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2LongOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2LongOpenHashMap.MapSpliterator<java.util.function.DoubleConsumer, Double2LongOpenHashMap.KeySpliterator>
      ...
      final Double2LongOpenHashMap.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2LongOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   final class MapEntry implements Double2LongMap.Entry, Entry<Double, Long>, DoubleLongPair {
      ...
      public boolean equals(Object o) {
         ...
         return Double.doubleToLongBits(Double2LongOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey())
            && Double2LongOpenHashMap.this.value[this.index] == e.getValue();
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2LongMap.Entry> implements Double2LongMap.FastEntrySet {
      ...
      public ObjectSpliterator<Double2LongMap.Entry> spliterator() {
         return Double2LongOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public boolean contains(Object o) {
         ...
         if (e.getValue() != null && e.getValue() instanceof Long) {
            ...
            double curr;
            int pos;
            if (Double.doubleToLongBits(curr = key[pos = (int)HashCommon.mix(Double.doubleToRawLongBits(k)) & Double2LongOpenHashMap.this.mask]) == 0L) {
               return false;
            }
            ...
            while (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongOpenHashMap.this.mask]) != 0L) {
               if (Double.doubleToLongBits(k) == Double.doubleToLongBits(curr)) {
                  return Double2LongOpenHashMap.this.value[pos] == v;
               }
            }
            ...
            if (e.getValue() != null && e.getValue() instanceof Long) {
               ...
               if (Double.doubleToLongBits(k) == 0L) {
                  ...
                  if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k)) {
                     ...
                     while (Double.doubleToLongBits(curr = key[pos = pos + 1 & Double2LongOpenHashMap.this.mask]) != 0L) {
                        if (Double.doubleToLongBits(curr) == Double.doubleToLongBits(k) && Double2LongOpenHashMap.this.value[pos] == v) {
                           Double2LongOpenHashMap.this.removeEntry(pos);
                           return true;
                        }
                     }
      ...
      public void forEach(Consumer<? super Double2LongMap.Entry> consumer) {
         if (Double2LongOpenHashMap.this.containsNullKey) {
            consumer.accept(Double2LongOpenHashMap.this.new MapEntry(Double2LongOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2LongOpenHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2LongOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2LongMap.Entry> consumer) {
         Double2LongOpenHashMap.MapEntry entry = Double2LongOpenHashMap.this.new MapEntry();
         if (Double2LongOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Double2LongOpenHashMap.this.n;
      int last = -1;
      int c = Double2LongOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2LongOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            double curr;
            for (pos = pos + 1 & Double2LongOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2LongOpenHashMap.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2LongOpenHashMap.this.size - this.c
            : Math.min(
               Double2LongOpenHashMap.this.size - this.c,
               (long)((double)Double2LongOpenHashMap.this.realSize() / Double2LongOpenHashMap.this.n * (this.max - this.pos)) + (this.mustReturnNull ? 1 : 0)
            );
      }
   ...
   private final class ValueIterator extends Double2LongOpenHashMap.MapIterator<LongConsumer> implements LongIterator {
   ...
   private final class ValueSpliterator
      extends Double2LongOpenHashMap.MapSpliterator<LongConsumer, Double2LongOpenHashMap.ValueSpliterator>
      ...
      final Double2LongOpenHashMap.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2LongOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
