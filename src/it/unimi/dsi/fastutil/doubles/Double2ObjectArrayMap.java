...
public class Double2ObjectArrayMap<V> extends AbstractDouble2ObjectMap<V> implements Serializable, Cloneable {
   ...
   public Double2ObjectMap.FastEntrySet<V> double2ObjectEntrySet() {
      if (this.entries == null) {
         this.entries = new Double2ObjectArrayMap.EntrySet();
      }
   ...
   public DoubleSet keySet() {
      if (this.keys == null) {
         this.keys = new Double2ObjectArrayMap.KeySet();
      }
   ...
   public ObjectCollection<V> values() {
      if (this.values == null) {
         this.values = new Double2ObjectArrayMap.ValuesCollection();
      }
   ...
   private final class EntrySet extends AbstractObjectSet<Double2ObjectMap.Entry<V>> implements Double2ObjectMap.FastEntrySet<V> {
         ...
         return new ObjectIterator<Double2ObjectMap.Entry<V>>() {
            ...
            public Double2ObjectMap.Entry<V> next() {
               if (!this.hasNext()) {
                  ...
                  return new AbstractDouble2ObjectMap.BasicEntry<>(
                     Double2ObjectArrayMap.this.key[this.curr = this.next], (V)Double2ObjectArrayMap.this.value[this.next++]
                  );
               }
            }
            ...
            public void forEachRemaining(Consumer<? super Double2ObjectMap.Entry<V>> action) {
               ...
               while (this.next < max) {
                  action.accept(
                     new AbstractDouble2ObjectMap.BasicEntry<>(
                        Double2ObjectArrayMap.this.key[this.curr = this.next], (V)Double2ObjectArrayMap.this.value[this.next++]
                     )
                  );
               }
      ...
      public ObjectSpliterator<Double2ObjectMap.Entry<V>> spliterator() {
         return new Double2ObjectArrayMap.EntrySet.EntrySetSpliterator(0, Double2ObjectArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super Double2ObjectMap.Entry<V>> action) {
         ...
         for (int max = Double2ObjectArrayMap.this.size; i < max; i++) {
            action.accept(new AbstractDouble2ObjectMap.BasicEntry<>(Double2ObjectArrayMap.this.key[i], (V)Double2ObjectArrayMap.this.value[i]));
         }
      }
      ...
      final class EntrySetSpliterator
         ...
         protected final Double2ObjectMap.Entry<V> get(int location) {
            return new AbstractDouble2ObjectMap.BasicEntry<>(Double2ObjectArrayMap.this.key[location], (V)Double2ObjectArrayMap.this.value[location]);
         }

         protected final Double2ObjectArrayMap<V>.EntrySet.EntrySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return new Double2ObjectArrayMap.KeySet.KeySetSpliterator(0, Double2ObjectArrayMap.this.size);
      }
      ...
      final class KeySetSpliterator extends DoubleSpliterators.EarlyBindingSizeIndexBasedSpliterator implements DoubleSpliterator {
         ...
         protected final Double2ObjectArrayMap<V>.KeySet.KeySetSpliterator makeForSplit(int pos, int maxPos) {
   ...
   private final class ValuesCollection extends AbstractObjectCollection<V> {
      ...
      public ObjectIterator<V> iterator() {
         return new ObjectIterator<V>() {
            ...
            public void forEachRemaining(Consumer<? super V> action) {
               ...
               while (this.pos < max) {
                  action.accept((V)Double2ObjectArrayMap.this.value[this.pos++]);
               }
            }
         };
      }
      ...
      public ObjectSpliterator<V> spliterator() {
         return new Double2ObjectArrayMap.ValuesCollection.ValuesSpliterator(0, Double2ObjectArrayMap.this.size);
      }
      ...
      public void forEach(Consumer<? super V> action) {
         ...
         for (int max = Double2ObjectArrayMap.this.size; i < max; i++) {
            action.accept((V)Double2ObjectArrayMap.this.value[i]);
         }
      }
      ...
      final class ValuesSpliterator extends ObjectSpliterators.EarlyBindingSizeIndexBasedSpliterator<V> implements ObjectSpliterator<V> {
         ...
         protected final Double2ObjectArrayMap<V>.ValuesCollection.ValuesSpliterator makeForSplit(int pos, int maxPos) {
