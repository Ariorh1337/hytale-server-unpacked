...
public class Double2BooleanAVLTreeMap extends AbstractDouble2BooleanSortedMap implements Serializable, Cloneable {
   ...
   private Double2BooleanAVLTreeMap.Entry parent(Double2BooleanAVLTreeMap.Entry e) {
      ...
      Double2BooleanAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Double2BooleanAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2BooleanMap.Entry>() {
            final Comparator<? super Double2BooleanMap.Entry> comparator = Double2BooleanAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey())
               : (x, y) -> Double2BooleanAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
   ...
   private final class Submap extends AbstractDouble2BooleanSortedMap implements Serializable {
      ...
      final boolean in(double k) {
         return (this.bottom || Double2BooleanAVLTreeMap.this.compare(k, this.from) >= 0)
            && (this.top || Double2BooleanAVLTreeMap.this.compare(k, this.to) < 0);
      }
