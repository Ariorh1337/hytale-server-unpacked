...
public class Double2IntAVLTreeMap extends AbstractDouble2IntSortedMap implements Serializable, Cloneable {
   ...
   private Double2IntAVLTreeMap.Entry parent(Double2IntAVLTreeMap.Entry e) {
      ...
      Double2IntAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Double2IntAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2IntMap.Entry>() {
            final Comparator<? super Double2IntMap.Entry> comparator = Double2IntAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey())
               : (x, y) -> Double2IntAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
