...
public final class DoubleIterators {
   ...
   public static DoubleIterator asDoubleIterator(Iterator i) {
      if (i instanceof DoubleIterator) {
         ...
         return i instanceof OfDouble ? new DoubleIterators.PrimitiveIteratorWrapper((OfDouble)i) : new DoubleIterators.IteratorWrapper(i);
      }
   }

   public static DoubleListIterator asDoubleIterator(ListIterator i) {
      return i instanceof DoubleListIterator ? (DoubleListIterator)i : new DoubleIterators.ListIteratorWrapper(i);
   }
