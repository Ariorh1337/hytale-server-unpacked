...
public class Double2ReferenceOpenHashMap<V> extends AbstractDouble2ReferenceMap<V> implements Serializable, Cloneable, Hash {
      ...
      if (this.values == null) {
         this.values = new AbstractReferenceCollection<V>() {
            ...
            public ObjectSpliterator<V> spliterator() {
               return Double2ReferenceOpenHashMap.this.new ValueSpliterator();
            }
   ...
   private void writeObject(ObjectOutputStream s) throws IOException {
      double[] key = this.key;
      V[] value = this.value;
      Double2ReferenceOpenHashMap<V>.EntryIterator i = new Double2ReferenceOpenHashMap.EntryIterator();
   ...
   private final class EntryIterator
      extends Double2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Double2ReferenceMap.Entry<V>>>
      ...
      final void acceptOnIndex(Consumer<? super Double2ReferenceMap.Entry<V>> action, int index) {
         action.accept(this.entry = Double2ReferenceOpenHashMap.this.new MapEntry(index));
      }
   ...
   private final class EntrySpliterator
      extends Double2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super Double2ReferenceMap.Entry<V>>, Double2ReferenceOpenHashMap<V>.EntrySpliterator>
      ...
      final void acceptOnIndex(Consumer<? super Double2ReferenceMap.Entry<V>> action, int index) {
         action.accept(Double2ReferenceOpenHashMap.this.new MapEntry(index));
      }

      final Double2ReferenceOpenHashMap<V>.EntrySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenHashMap.this.new EntrySpliterator(pos, max, mustReturnNull, true);
      }
   }
   ...
   private final class FastEntryIterator
      extends Double2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super Double2ReferenceMap.Entry<V>>>
      implements ObjectIterator<Double2ReferenceMap.Entry<V>> {
      private final Double2ReferenceOpenHashMap<V>.MapEntry entry = Double2ReferenceOpenHashMap.this.new MapEntry();
   ...
   private final class KeyIterator extends Double2ReferenceOpenHashMap<V>.MapIterator<java.util.function.DoubleConsumer> implements DoubleIterator {
      public KeyIterator() {
      }
   ...
   private final class KeySet extends AbstractDoubleSet {
      ...
      public DoubleSpliterator spliterator() {
         return Double2ReferenceOpenHashMap.this.new KeySpliterator();
      }
   ...
   private final class KeySpliterator
      extends Double2ReferenceOpenHashMap<V>.MapSpliterator<java.util.function.DoubleConsumer, Double2ReferenceOpenHashMap<V>.KeySpliterator>
      ...
      final Double2ReferenceOpenHashMap<V>.KeySpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenHashMap.this.new KeySpliterator(pos, max, mustReturnNull, true);
      }
   }

   final class MapEntry implements Double2ReferenceMap.Entry<V>, Entry<Double, V>, DoubleReferencePair<V> {
      int index;
      ...
      public boolean equals(Object o) {
         ...
         return Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[this.index]) == Double.doubleToLongBits(e.getKey())
            && Double2ReferenceOpenHashMap.this.value[this.index] == e.getValue();
      }

      @Override
      public int hashCode() {
         return HashCommon.double2int(Double2ReferenceOpenHashMap.this.key[this.index])
            ^ (Double2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Double2ReferenceOpenHashMap.this.value[this.index]));
      }
   ...
   private final class MapEntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> {
      ...
      public ObjectSpliterator<Double2ReferenceMap.Entry<V>> spliterator() {
         return Double2ReferenceOpenHashMap.this.new EntrySpliterator();
      }
      ...
      public void forEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
         if (Double2ReferenceOpenHashMap.this.containsNullKey) {
            consumer.accept(Double2ReferenceOpenHashMap.this.new MapEntry(Double2ReferenceOpenHashMap.this.n));
         }
         ...
         while (pos-- != 0) {
            if (Double.doubleToLongBits(Double2ReferenceOpenHashMap.this.key[pos]) != 0L) {
               consumer.accept(Double2ReferenceOpenHashMap.this.new MapEntry(pos));
            }
         }
      }
      ...
      public void fastForEach(Consumer<? super Double2ReferenceMap.Entry<V>> consumer) {
         Double2ReferenceOpenHashMap<V>.MapEntry entry = Double2ReferenceOpenHashMap.this.new MapEntry();
         if (Double2ReferenceOpenHashMap.this.containsNullKey) {
   ...
   private abstract class MapIterator<ConsumerType> {
      int pos = Double2ReferenceOpenHashMap.this.n;
      int last = -1;
      int c = Double2ReferenceOpenHashMap.this.size;
      ...
      public void forEachRemaining(ConsumerType action) {
         if (this.mustReturnNullKey) {
            this.mustReturnNullKey = false;
            this.acceptOnIndex(action, this.last = Double2ReferenceOpenHashMap.this.n);
            this.c--;
         }
      ...
      private void shiftKeys(int pos) {
         ...
         while (true) {
            ...
            double curr;
            for (pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask;
   ...
   private abstract class MapSpliterator<ConsumerType, SplitType extends Double2ReferenceOpenHashMap<V>.MapSpliterator<ConsumerType, SplitType>> {
      int pos = 0;
      int max;
      int c;
      ...
      public long estimateSize() {
         return !this.hasSplit
            ? Double2ReferenceOpenHashMap.this.size - this.c
            : Math.min(
               Double2ReferenceOpenHashMap.this.size - this.c,
               (long)((double)Double2ReferenceOpenHashMap.this.realSize() / Double2ReferenceOpenHashMap.this.n * (this.max - this.pos))
   ...
   private final class ValueIterator extends Double2ReferenceOpenHashMap<V>.MapIterator<Consumer<? super V>> implements ObjectIterator<V> {
   ...
   private final class ValueSpliterator
      extends Double2ReferenceOpenHashMap<V>.MapSpliterator<Consumer<? super V>, Double2ReferenceOpenHashMap<V>.ValueSpliterator>
      ...
      final Double2ReferenceOpenHashMap<V>.ValueSpliterator makeForSplit(int pos, int max, boolean mustReturnNull) {
         return Double2ReferenceOpenHashMap.this.new ValueSpliterator(pos, max, mustReturnNull, true);
      }
   }
}
