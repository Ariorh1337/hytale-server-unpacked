   ...
   public static void radixSort(double[] a, int from, int to) {
      if (to - from < 1024) {
         ...
         while (stackPos > 0) {
            ...
            while (i-- != first) {
               count[(int)(fixDouble(a[i]) >>> shift & 255L ^ signMask)]++;
            }
            ...
            while (p <= ix) {
               double t = a[p];
               c = (int)(fixDouble(t) >>> shift & 255L ^ signMask);
               if (p < ix) {
                  int d;
                  while ((d = --pos[c]) > p) {
                     double z = t;
         ...
         while (j-- != 0) {
            executorCompletionService.submit(() -> {
               ...
               while (true) {
                  ...
                  DoubleArrays.Segment segment = queue.take();
                  ...
                  while (ixx-- != first) {
                     count[(int)(fixDouble(a[ixx]) >>> shift & 255L ^ signMask)]++;
                  }
                  ...
                  while (p <= ix) {
                     ...
                     if (level < 7 && count[c] > 1) {
                        if (count[c] < 1024) {
                           ...
                           queue.add(new DoubleArrays.Segment(p, count[c], level + 1));
                        }
                     }
   ...
   public static void radixSortIndirect(int[] perm, double[] a, int from, int to, boolean stable) {
      if (to - from < 1024) {
         ...
         while (stackPos > 0) {
            ...
            while (i-- != first) {
               count[(int)(fixDouble(a[perm[i]]) >>> shift & 255L ^ signMask)]++;
            }
            ...
            if (stable) {
               ...
               while (ix-- != first) {
                  support[--pos[(int)(fixDouble(a[perm[ix]]) >>> shift & 255L ^ signMask)]] = perm[ix];
               }
               ...
               while (p <= ix) {
                  int t = perm[p];
                  c = (int)(fixDouble(a[t]) >>> shift & 255L ^ signMask);
                  if (p < ix) {
                     int d;
                     while ((d = --pos[c]) > p) {
                        int z = t;
         ...
         while (j-- != 0) {
            executorCompletionService.submit(() -> {
               ...
               while (true) {
                  ...
                  while (ix-- != first) {
                     count[(int)(fixDouble(a[perm[ix]]) >>> shift & 255L ^ signMask)]++;
                  }
   ...
   public static void radixSort(double[] a, double[] b, int from, int to) {
      if (to - from < 1024) {
         ...
         while (stackPos > 0) {
            ...
            while (i-- != first) {
               count[(int)(fixDouble(k[i]) >>> shift & 255L ^ signMask)]++;
            }
            ...
            while (p <= ix) {
               double t = a[p];
               double u = b[p];
               c = (int)(fixDouble(k[p]) >>> shift & 255L ^ signMask);
               if (p < ix) {
                  int d;
                  while ((d = --pos[c]) > p) {
                     c = (int)(fixDouble(k[d]) >>> shift & 255L ^ signMask);
                     double z = t;
                     t = a[d];
                     a[d] = z;
                     z = u;
         ...
         while (j-- != 0) {
            executorCompletionService.submit(() -> {
               ...
               while (true) {
                  ...
                  while (ixxx-- != first) {
                     count[(int)(fixDouble(k[ixxx]) >>> shift & 255L ^ signMask)]++;
                  }
   ...
   public static void radixSortIndirect(int[] perm, double[] a, double[] b, int from, int to, boolean stable) {
      if (to - from < 64) {
         ...
         while (stackPos > 0) {
            ...
            while (i-- != first) {
               count[(int)(fixDouble(k[perm[i]]) >>> shift & 255L ^ signMask)]++;
            }
            ...
            if (stable) {
               ...
               while (ix-- != first) {
                  support[--pos[(int)(fixDouble(k[perm[ix]]) >>> shift & 255L ^ signMask)]] = perm[ix];
               }
               ...
               while (p <= ix) {
                  int t = perm[p];
                  c = (int)(fixDouble(k[t]) >>> shift & 255L ^ signMask);
                  if (p < ix) {
                     int d;
                     while ((d = --pos[c]) > p) {
                        int z = t;
      ...
      if (to - from < 64) {
         ...
         while (l > 0) {
            ...
            while (px <= ix) {
               ...
               c = (int)(fixDouble(k[px]) >>> shift & 255L ^ signMask);
               if (px < ix) {
                  int d;
                  while ((d = --pos[c]) > px) {
                     c = (int)(fixDouble(k[d]) >>> shift & 255L ^ signMask);
            ...
            while (true) {
               ...
               while (b > c || (comparison = Double.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        invokeAll(
                           new DoubleArrays.ForkJoinQuickSort(x, this.from, this.from + s),
                           new DoubleArrays.ForkJoinQuickSort(x, this.to - comparison, this.to)
                        );
                     } else if (s > 1) {
                        invokeAll(new DoubleArrays.ForkJoinQuickSort(x, this.from, this.from + s));
                     } else {
                        invokeAll(new DoubleArrays.ForkJoinQuickSort(x, this.to - comparison, this.to));
                     }
            ...
            while (true) {
               ...
               while (b > c || (comparison = (t = Double.compare(x[b], v)) == 0 ? Double.compare(y[b], w) : t) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        invokeAll(
                           new DoubleArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s),
                           new DoubleArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to)
                        );
                     } else if (s > 1) {
                        invokeAll(new DoubleArrays.ForkJoinQuickSort2(x, y, this.from, this.from + s));
                     } else {
                        invokeAll(new DoubleArrays.ForkJoinQuickSort2(x, y, this.to - comparison, this.to));
                     }
               ...
               while (b > c || (comparison = this.comp.compare(x[b], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new DoubleArrays.ForkJoinQuickSortComp(x, this.from, this.from + s, this.comp));
                     } else {
                        invokeAll(new DoubleArrays.ForkJoinQuickSortComp(x, this.to - comparison, this.to, this.comp));
                     }
               ...
               while (b > c || (comparison = Double.compare(x[this.perm[b]], v)) > 0) {
                  ...
                  if (b > c) {
                     ...
                     if (s > 1 && comparison > 1) {
                        ...
                        invokeAll(new DoubleArrays.ForkJoinQuickSortIndirect(this.perm, x, this.from, this.from + s));
                     } else {
                        invokeAll(new DoubleArrays.ForkJoinQuickSortIndirect(this.perm, x, this.to - comparison, this.to));
                     }
