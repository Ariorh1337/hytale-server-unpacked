...
public class Double2DoubleAVLTreeMap extends AbstractDouble2DoubleSortedMap implements Serializable, Cloneable {
   ...
   private Double2DoubleAVLTreeMap.Entry parent(Double2DoubleAVLTreeMap.Entry e) {
      ...
      Double2DoubleAVLTreeMap.Entry x = e;
      ...
      while (q != null) {
         ...
         if (!dir) {
            ...
            if (y.balance() == -2) {
               ...
               if (x.balance() == 1) {
                  assert x.balance() == 1;
                  Double2DoubleAVLTreeMap.Entry w = x.right;
                  x.right = w.left;
                  w.left = x;
                  y.left = w.right;
                  w.right = y;
   ...
   public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet() {
      if (this.entries == null) {
         this.entries = new AbstractObjectSortedSet<Double2DoubleMap.Entry>() {
            final Comparator<? super Double2DoubleMap.Entry> comparator = Double2DoubleAVLTreeMap.this.actualComparator == null
               ? (x, y) -> Double.compare(x.getDoubleKey(), y.getDoubleKey())
               : (x, y) -> Double2DoubleAVLTreeMap.this.actualComparator.compare(x.getDoubleKey(), y.getDoubleKey());
