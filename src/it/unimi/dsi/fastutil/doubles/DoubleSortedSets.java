...
public final class DoubleSortedSets {
   ...
   public static class Singleton extends DoubleSets.Singleton implements DoubleSortedSet, Serializable, Cloneable {
      ...
      @Override
      public DoubleSortedSet subSet(double from, double to) {
         return this.compare(from, this.element) <= 0 && this.compare(this.element, to) < 0 ? this : DoubleSortedSets.EMPTY_SET;
      }

      @Override
      public DoubleSortedSet headSet(double to) {
         return this.compare(this.element, to) < 0 ? this : DoubleSortedSets.EMPTY_SET;
      }

      @Override
      public DoubleSortedSet tailSet(double from) {
         return this.compare(from, this.element) <= 0 ? this : DoubleSortedSets.EMPTY_SET;
      }
