...
public final class BooleanIterators {
   ...
   public static BooleanIterator asBooleanIterator(Iterator i) {
      return i instanceof BooleanIterator ? (BooleanIterator)i : new BooleanIterators.IteratorWrapper(i);
   }

   public static BooleanListIterator asBooleanIterator(ListIterator i) {
      return i instanceof BooleanListIterator ? (BooleanListIterator)i : new BooleanIterators.ListIteratorWrapper(i);
   }
