...
public final class BooleanLists {
   ...
   public static BooleanList synchronize(BooleanList l) {
      return l instanceof RandomAccess ? new BooleanLists.SynchronizedRandomAccessList(l) : new BooleanLists.SynchronizedList(l);
   }

   public static BooleanList synchronize(BooleanList l, Object sync) {
      return l instanceof RandomAccess ? new BooleanLists.SynchronizedRandomAccessList(l, sync) : new BooleanLists.SynchronizedList(l, sync);
   }

   public static BooleanList unmodifiable(BooleanList l) {
      return l instanceof RandomAccess ? new BooleanLists.UnmodifiableRandomAccessList(l) : new BooleanLists.UnmodifiableList(l);
   }
