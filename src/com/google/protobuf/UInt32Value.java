...
public final class UInt32Value extends GeneratedMessage implements UInt32ValueOrBuilder {
   ...
   protected UInt32Value.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new UInt32Value.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<UInt32Value.Builder> implements UInt32ValueOrBuilder {
