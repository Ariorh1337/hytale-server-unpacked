      ...
      public Descriptors.EnumValueDescriptor findValueByNumberCreatingIfUnknown(final int number) {
         ...
         synchronized (this) {
            if (this.cleanupQueue == null) {
               ...
               while (true) {
                  Descriptors.EnumDescriptor.UnknownEnumValueReference toClean = (Descriptors.EnumDescriptor.UnknownEnumValueReference)this.cleanupQueue.poll();
                  if (toClean == null) {
                     break;
                  }
      ...
      private static Descriptors.FieldDescriptor.RedactionState isOptionSensitive(Descriptors.FieldDescriptor field, Object value) {
         if (field.getType() == Descriptors.FieldDescriptor.Type.ENUM) {
            ...
            if (field.isRepeated()) {
               ...
               for (Entry<Descriptors.FieldDescriptor, Object> entry : ((Message)value).getAllFields().entrySet()) {
                  Descriptors.FieldDescriptor.RedactionState state = isOptionSensitive(entry.getKey(), entry.getValue());
                  if (state.redact) {
                     return state;
                  }
      ...
      private void crossLink() throws Descriptors.DescriptorValidationException {
         ...
         if (this.proto.hasDefaultValue()) {
            ...
            try {
               switch (this.type) {
                  ...
                  case BYTES:
                     try {
                        ...
                        throw new Descriptors.DescriptorValidationException(this, "Couldn't parse default value: " + e.getMessage(), e);
                     }
                  case ENUM:
               ...
               throw new Descriptors.DescriptorValidationException(this, "Could not parse default value: \"" + this.proto.getDefaultValue() + '"', e);
            }
