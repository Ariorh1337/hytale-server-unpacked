...
public abstract class CodedInputStream {
   ...
   public static CodedInputStream newInstance(final InputStream input, int bufferSize) {
      if (bufferSize <= 0) {
         ...
         return input == null ? newInstance(Internal.EMPTY_BYTE_ARRAY) : new CodedInputStream.StreamDecoder(input, bufferSize);
      }
   }
   ...
   static CodedInputStream newInstance(ByteBuffer buf, boolean bufferIsImmutable) {
      ...
      if (buf.isDirect() && CodedInputStream.UnsafeDirectNioDecoder.isSupported()) {
