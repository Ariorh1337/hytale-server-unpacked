...
public final class EciesAeadHkdfKeyFormat extends GeneratedMessage implements EciesAeadHkdfKeyFormatOrBuilder {
   ...
   private static final Parser<EciesAeadHkdfKeyFormat> PARSER = new AbstractParser<EciesAeadHkdfKeyFormat>() {
      public EciesAeadHkdfKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         EciesAeadHkdfKeyFormat.Builder builder = EciesAeadHkdfKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return EciesAeadHkdf.internal_static_google_crypto_tink_EciesAeadHkdfKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(EciesAeadHkdfKeyFormat.class, EciesAeadHkdfKeyFormat.Builder.class);
   }
   ...
   public EciesAeadHkdfKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static EciesAeadHkdfKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static EciesAeadHkdfKeyFormat.Builder newBuilder(EciesAeadHkdfKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public EciesAeadHkdfKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new EciesAeadHkdfKeyFormat.Builder() : new EciesAeadHkdfKeyFormat.Builder().mergeFrom(this);
   }

   protected EciesAeadHkdfKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new EciesAeadHkdfKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<EciesAeadHkdfKeyFormat.Builder> implements EciesAeadHkdfKeyFormatOrBuilder {
      private int bitField0_;
      private EciesAeadHkdfParams params_;
      ...
      public EciesAeadHkdfKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.params_ = null;
      ...
      public EciesAeadHkdfKeyFormat.Builder mergeFrom(Message other) {
      ...
      public EciesAeadHkdfKeyFormat.Builder mergeFrom(EciesAeadHkdfKeyFormat other) {
      ...
      public EciesAeadHkdfKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public EciesAeadHkdfKeyFormat.Builder setParams(EciesAeadHkdfParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public EciesAeadHkdfKeyFormat.Builder setParams(EciesAeadHkdfParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public EciesAeadHkdfKeyFormat.Builder mergeParams(EciesAeadHkdfParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public EciesAeadHkdfKeyFormat.Builder clearParams() {
         this.bitField0_ &= -2;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
