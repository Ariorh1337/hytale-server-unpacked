...
public final class HmacKey extends GeneratedMessage implements HmacKeyOrBuilder {
   ...
   private static final Parser<HmacKey> PARSER = new AbstractParser<HmacKey>() {
      public HmacKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         HmacKey.Builder builder = HmacKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Hmac.internal_static_google_crypto_tink_HmacKey_fieldAccessorTable.ensureFieldAccessorsInitialized(HmacKey.class, HmacKey.Builder.class);
   }
   ...
   public HmacKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static HmacKey.Builder newBuilder() {
   ...
   public HmacKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new HmacKey.Builder() : new HmacKey.Builder().mergeFrom(this);
   }

   protected HmacKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new HmacKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<HmacKey.Builder> implements HmacKeyOrBuilder {
      private int bitField0_;
      ...
      public HmacKey.Builder mergeFrom(Message other) {
      ...
      public HmacKey.Builder mergeFrom(HmacKey other) {
      ...
      public HmacKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public HmacKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public HmacKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public HmacKey.Builder setParams(HmacParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public HmacKey.Builder setParams(HmacParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public HmacKey.Builder mergeParams(HmacParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public HmacKey.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public HmacKey.Builder setKeyValue(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public HmacKey.Builder clearKeyValue() {
         this.bitField0_ &= -5;
