...
public final class Ed25519PublicKey extends GeneratedMessage implements Ed25519PublicKeyOrBuilder {
   ...
   private static final Parser<Ed25519PublicKey> PARSER = new AbstractParser<Ed25519PublicKey>() {
      public Ed25519PublicKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         Ed25519PublicKey.Builder builder = Ed25519PublicKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ed25519.internal_static_google_crypto_tink_Ed25519PublicKey_fieldAccessorTable
         .ensureFieldAccessorsInitialized(Ed25519PublicKey.class, Ed25519PublicKey.Builder.class);
   }
   ...
   public Ed25519PublicKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static Ed25519PublicKey.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static Ed25519PublicKey.Builder newBuilder(Ed25519PublicKey prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public Ed25519PublicKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new Ed25519PublicKey.Builder() : new Ed25519PublicKey.Builder().mergeFrom(this);
   }

   protected Ed25519PublicKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new Ed25519PublicKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<Ed25519PublicKey.Builder> implements Ed25519PublicKeyOrBuilder {
      ...
      public Ed25519PublicKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.keyValue_ = ByteString.EMPTY;
      ...
      public Ed25519PublicKey.Builder mergeFrom(Message other) {
      ...
      public Ed25519PublicKey.Builder mergeFrom(Ed25519PublicKey other) {
      ...
      public Ed25519PublicKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public Ed25519PublicKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public Ed25519PublicKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public Ed25519PublicKey.Builder setKeyValue(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public Ed25519PublicKey.Builder clearKeyValue() {
         this.bitField0_ &= -3;
