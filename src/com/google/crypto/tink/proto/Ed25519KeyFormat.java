...
public final class Ed25519KeyFormat extends GeneratedMessage implements Ed25519KeyFormatOrBuilder {
   ...
   private static final Ed25519KeyFormat DEFAULT_INSTANCE = new Ed25519KeyFormat();
   private static final Parser<Ed25519KeyFormat> PARSER = new AbstractParser<Ed25519KeyFormat>() {
      public Ed25519KeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         Ed25519KeyFormat.Builder builder = Ed25519KeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ed25519.internal_static_google_crypto_tink_Ed25519KeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(Ed25519KeyFormat.class, Ed25519KeyFormat.Builder.class);
   }
   ...
   public Ed25519KeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static Ed25519KeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static Ed25519KeyFormat.Builder newBuilder(Ed25519KeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public Ed25519KeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new Ed25519KeyFormat.Builder() : new Ed25519KeyFormat.Builder().mergeFrom(this);
   }

   protected Ed25519KeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new Ed25519KeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<Ed25519KeyFormat.Builder> implements Ed25519KeyFormatOrBuilder {
      ...
      public Ed25519KeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         return this;
      ...
      public Ed25519KeyFormat.Builder mergeFrom(Message other) {
      ...
      public Ed25519KeyFormat.Builder mergeFrom(Ed25519KeyFormat other) {
      ...
      public Ed25519KeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public Ed25519KeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public Ed25519KeyFormat.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
