...
public final class EcdsaPublicKey extends GeneratedMessage implements EcdsaPublicKeyOrBuilder {
   ...
   private static final Parser<EcdsaPublicKey> PARSER = new AbstractParser<EcdsaPublicKey>() {
      public EcdsaPublicKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         EcdsaPublicKey.Builder builder = EcdsaPublicKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaPublicKey_fieldAccessorTable
         .ensureFieldAccessorsInitialized(EcdsaPublicKey.class, EcdsaPublicKey.Builder.class);
   }
   ...
   public EcdsaPublicKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static EcdsaPublicKey.Builder newBuilder() {
   ...
   public EcdsaPublicKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new EcdsaPublicKey.Builder() : new EcdsaPublicKey.Builder().mergeFrom(this);
   }

   protected EcdsaPublicKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new EcdsaPublicKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<EcdsaPublicKey.Builder> implements EcdsaPublicKeyOrBuilder {
      private int bitField0_;
      ...
      public EcdsaPublicKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public EcdsaPublicKey.Builder mergeFrom(Message other) {
      ...
      public EcdsaPublicKey.Builder mergeFrom(EcdsaPublicKey other) {
      ...
      public EcdsaPublicKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public EcdsaPublicKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public EcdsaPublicKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public EcdsaPublicKey.Builder setParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public EcdsaPublicKey.Builder setParams(EcdsaParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public EcdsaPublicKey.Builder mergeParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public EcdsaPublicKey.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public EcdsaPublicKey.Builder setX(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public EcdsaPublicKey.Builder clearX() {
         this.bitField0_ &= -5;
      ...
      public EcdsaPublicKey.Builder setY(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public EcdsaPublicKey.Builder clearY() {
         this.bitField0_ &= -9;
