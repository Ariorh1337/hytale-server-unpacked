...
public final class AesCmacPrfKeyFormat extends GeneratedMessage implements AesCmacPrfKeyFormatOrBuilder {
   ...
   private static final AesCmacPrfKeyFormat DEFAULT_INSTANCE = new AesCmacPrfKeyFormat();
   private static final Parser<AesCmacPrfKeyFormat> PARSER = new AbstractParser<AesCmacPrfKeyFormat>() {
      public AesCmacPrfKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesCmacPrfKeyFormat.Builder builder = AesCmacPrfKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesCmacPrf.internal_static_google_crypto_tink_AesCmacPrfKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(AesCmacPrfKeyFormat.class, AesCmacPrfKeyFormat.Builder.class);
   }
   ...
   public AesCmacPrfKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesCmacPrfKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesCmacPrfKeyFormat.Builder newBuilder(AesCmacPrfKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesCmacPrfKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesCmacPrfKeyFormat.Builder() : new AesCmacPrfKeyFormat.Builder().mergeFrom(this);
   }

   protected AesCmacPrfKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesCmacPrfKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesCmacPrfKeyFormat.Builder> implements AesCmacPrfKeyFormatOrBuilder {
      ...
      public AesCmacPrfKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.keySize_ = 0;
      ...
      public AesCmacPrfKeyFormat.Builder mergeFrom(Message other) {
      ...
      public AesCmacPrfKeyFormat.Builder mergeFrom(AesCmacPrfKeyFormat other) {
      ...
      public AesCmacPrfKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AesCmacPrfKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public AesCmacPrfKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public AesCmacPrfKeyFormat.Builder setKeySize(int value) {
         this.keySize_ = value;
         this.bitField0_ |= 2;
         this.onChanged();
         return this;
      ...
      public AesCmacPrfKeyFormat.Builder clearKeySize() {
         this.bitField0_ &= -3;
         this.keySize_ = 0;
         this.onChanged();
         return this;
