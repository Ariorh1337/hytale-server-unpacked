...
public final class KmsAeadKeyFormat extends GeneratedMessage implements KmsAeadKeyFormatOrBuilder {
   ...
   private static final Parser<KmsAeadKeyFormat> PARSER = new AbstractParser<KmsAeadKeyFormat>() {
      public KmsAeadKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         KmsAeadKeyFormat.Builder builder = KmsAeadKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return KmsAead.internal_static_google_crypto_tink_KmsAeadKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(KmsAeadKeyFormat.class, KmsAeadKeyFormat.Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      ...
      return !this.getKeyUri().equals(other.getKeyUri()) ? false : this.getUnknownFields().equals(other.getUnknownFields());
   }
   ...
   public KmsAeadKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static KmsAeadKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static KmsAeadKeyFormat.Builder newBuilder(KmsAeadKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public KmsAeadKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new KmsAeadKeyFormat.Builder() : new KmsAeadKeyFormat.Builder().mergeFrom(this);
   }

   protected KmsAeadKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new KmsAeadKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<KmsAeadKeyFormat.Builder> implements KmsAeadKeyFormatOrBuilder {
      ...
      public KmsAeadKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.keyUri_ = "";
         return this;
      ...
      public KmsAeadKeyFormat.Builder mergeFrom(Message other) {
      ...
      public KmsAeadKeyFormat.Builder mergeFrom(KmsAeadKeyFormat other) {
      ...
      public KmsAeadKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public KmsAeadKeyFormat.Builder setKeyUri(String value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public KmsAeadKeyFormat.Builder clearKeyUri() {
      ...
      public KmsAeadKeyFormat.Builder setKeyUriBytes(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
