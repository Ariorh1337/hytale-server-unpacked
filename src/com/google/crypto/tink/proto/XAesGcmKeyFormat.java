...
public final class XAesGcmKeyFormat extends GeneratedMessage implements XAesGcmKeyFormatOrBuilder {
   ...
   private static final XAesGcmKeyFormat DEFAULT_INSTANCE = new XAesGcmKeyFormat();
   private static final Parser<XAesGcmKeyFormat> PARSER = new AbstractParser<XAesGcmKeyFormat>() {
      public XAesGcmKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         XAesGcmKeyFormat.Builder builder = XAesGcmKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return XAesGcm.internal_static_google_crypto_tink_XAesGcmKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(XAesGcmKeyFormat.class, XAesGcmKeyFormat.Builder.class);
   }
   ...
   public XAesGcmKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static XAesGcmKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static XAesGcmKeyFormat.Builder newBuilder(XAesGcmKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public XAesGcmKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new XAesGcmKeyFormat.Builder() : new XAesGcmKeyFormat.Builder().mergeFrom(this);
   }

   protected XAesGcmKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new XAesGcmKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<XAesGcmKeyFormat.Builder> implements XAesGcmKeyFormatOrBuilder {
      private int bitField0_;
      ...
      public XAesGcmKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public XAesGcmKeyFormat.Builder mergeFrom(Message other) {
      ...
      public XAesGcmKeyFormat.Builder mergeFrom(XAesGcmKeyFormat other) {
      ...
      public XAesGcmKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public XAesGcmKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public XAesGcmKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public XAesGcmKeyFormat.Builder setParams(XAesGcmParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public XAesGcmKeyFormat.Builder setParams(XAesGcmParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public XAesGcmKeyFormat.Builder mergeParams(XAesGcmParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public XAesGcmKeyFormat.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
