...
public final class AesGcmHkdfStreamingKeyFormat extends GeneratedMessage implements AesGcmHkdfStreamingKeyFormatOrBuilder {
   ...
   private static final Parser<AesGcmHkdfStreamingKeyFormat> PARSER = new AbstractParser<AesGcmHkdfStreamingKeyFormat>() {
      public AesGcmHkdfStreamingKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesGcmHkdfStreamingKeyFormat.Builder builder = AesGcmHkdfStreamingKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesGcmHkdfStreaming.internal_static_google_crypto_tink_AesGcmHkdfStreamingKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(AesGcmHkdfStreamingKeyFormat.class, AesGcmHkdfStreamingKeyFormat.Builder.class);
   }
   ...
   public AesGcmHkdfStreamingKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesGcmHkdfStreamingKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesGcmHkdfStreamingKeyFormat.Builder newBuilder(AesGcmHkdfStreamingKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesGcmHkdfStreamingKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesGcmHkdfStreamingKeyFormat.Builder() : new AesGcmHkdfStreamingKeyFormat.Builder().mergeFrom(this);
   }

   protected AesGcmHkdfStreamingKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesGcmHkdfStreamingKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesGcmHkdfStreamingKeyFormat.Builder> implements AesGcmHkdfStreamingKeyFormatOrBuilder {
      private int bitField0_;
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder mergeFrom(Message other) {
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder mergeFrom(AesGcmHkdfStreamingKeyFormat other) {
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder setParams(AesGcmHkdfStreamingParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder setParams(AesGcmHkdfStreamingParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder mergeParams(AesGcmHkdfStreamingParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder setKeySize(int value) {
         this.keySize_ = value;
         this.bitField0_ |= 4;
         this.onChanged();
         return this;
      ...
      public AesGcmHkdfStreamingKeyFormat.Builder clearKeySize() {
         this.bitField0_ &= -5;
         this.keySize_ = 0;
         this.onChanged();
         return this;
