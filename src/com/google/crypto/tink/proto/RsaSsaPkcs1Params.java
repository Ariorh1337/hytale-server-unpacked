...
public final class RsaSsaPkcs1Params extends GeneratedMessage implements RsaSsaPkcs1ParamsOrBuilder {
   ...
   private static final RsaSsaPkcs1Params DEFAULT_INSTANCE = new RsaSsaPkcs1Params();
   private static final Parser<RsaSsaPkcs1Params> PARSER = new AbstractParser<RsaSsaPkcs1Params>() {
      public RsaSsaPkcs1Params parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         RsaSsaPkcs1Params.Builder builder = RsaSsaPkcs1Params.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return RsaSsaPkcs1.internal_static_google_crypto_tink_RsaSsaPkcs1Params_fieldAccessorTable
         .ensureFieldAccessorsInitialized(RsaSsaPkcs1Params.class, RsaSsaPkcs1Params.Builder.class);
   }
   ...
   public boolean equals(final Object obj) {
      ...
      return this.hashType_ != other.hashType_ ? false : this.getUnknownFields().equals(other.getUnknownFields());
   }
   ...
   public RsaSsaPkcs1Params.Builder newBuilderForType() {
      return newBuilder();
   }

   public static RsaSsaPkcs1Params.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static RsaSsaPkcs1Params.Builder newBuilder(RsaSsaPkcs1Params prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public RsaSsaPkcs1Params.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new RsaSsaPkcs1Params.Builder() : new RsaSsaPkcs1Params.Builder().mergeFrom(this);
   }

   protected RsaSsaPkcs1Params.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new RsaSsaPkcs1Params.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<RsaSsaPkcs1Params.Builder> implements RsaSsaPkcs1ParamsOrBuilder {
      ...
      public RsaSsaPkcs1Params.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.hashType_ = 0;
         return this;
      ...
      public RsaSsaPkcs1Params.Builder mergeFrom(Message other) {
      ...
      public RsaSsaPkcs1Params.Builder mergeFrom(RsaSsaPkcs1Params other) {
      ...
      public RsaSsaPkcs1Params.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public RsaSsaPkcs1Params.Builder setHashTypeValue(int value) {
      ...
      public RsaSsaPkcs1Params.Builder setHashType(HashType value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1Params.Builder clearHashType() {
         this.bitField0_ &= -2;
         this.hashType_ = 0;
         this.onChanged();
         return this;
