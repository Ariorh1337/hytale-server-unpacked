...
public final class AesCtrHmacStreamingKeyFormat extends GeneratedMessage implements AesCtrHmacStreamingKeyFormatOrBuilder {
   ...
   private static final Parser<AesCtrHmacStreamingKeyFormat> PARSER = new AbstractParser<AesCtrHmacStreamingKeyFormat>() {
      public AesCtrHmacStreamingKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesCtrHmacStreamingKeyFormat.Builder builder = AesCtrHmacStreamingKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesCtrHmacStreaming.internal_static_google_crypto_tink_AesCtrHmacStreamingKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(AesCtrHmacStreamingKeyFormat.class, AesCtrHmacStreamingKeyFormat.Builder.class);
   }
   ...
   public AesCtrHmacStreamingKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesCtrHmacStreamingKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesCtrHmacStreamingKeyFormat.Builder newBuilder(AesCtrHmacStreamingKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesCtrHmacStreamingKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesCtrHmacStreamingKeyFormat.Builder() : new AesCtrHmacStreamingKeyFormat.Builder().mergeFrom(this);
   }

   protected AesCtrHmacStreamingKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesCtrHmacStreamingKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesCtrHmacStreamingKeyFormat.Builder> implements AesCtrHmacStreamingKeyFormatOrBuilder {
      private int bitField0_;
      ...
      public AesCtrHmacStreamingKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public AesCtrHmacStreamingKeyFormat.Builder mergeFrom(Message other) {
      ...
      public AesCtrHmacStreamingKeyFormat.Builder mergeFrom(AesCtrHmacStreamingKeyFormat other) {
      ...
      public AesCtrHmacStreamingKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AesCtrHmacStreamingKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public AesCtrHmacStreamingKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public AesCtrHmacStreamingKeyFormat.Builder setParams(AesCtrHmacStreamingParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public AesCtrHmacStreamingKeyFormat.Builder setParams(AesCtrHmacStreamingParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesCtrHmacStreamingKeyFormat.Builder mergeParams(AesCtrHmacStreamingParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesCtrHmacStreamingKeyFormat.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public AesCtrHmacStreamingKeyFormat.Builder setKeySize(int value) {
         this.keySize_ = value;
         this.bitField0_ |= 4;
         this.onChanged();
         return this;
      ...
      public AesCtrHmacStreamingKeyFormat.Builder clearKeySize() {
         this.bitField0_ &= -5;
         this.keySize_ = 0;
         this.onChanged();
         return this;
