...
public final class EcdsaKeyFormat extends GeneratedMessage implements EcdsaKeyFormatOrBuilder {
   ...
   private static final Parser<EcdsaKeyFormat> PARSER = new AbstractParser<EcdsaKeyFormat>() {
      public EcdsaKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         EcdsaKeyFormat.Builder builder = EcdsaKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Ecdsa.internal_static_google_crypto_tink_EcdsaKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(EcdsaKeyFormat.class, EcdsaKeyFormat.Builder.class);
   }
   ...
   public EcdsaKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static EcdsaKeyFormat.Builder newBuilder() {
   ...
   public EcdsaKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new EcdsaKeyFormat.Builder() : new EcdsaKeyFormat.Builder().mergeFrom(this);
   }

   protected EcdsaKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new EcdsaKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<EcdsaKeyFormat.Builder> implements EcdsaKeyFormatOrBuilder {
      private int bitField0_;
      private EcdsaParams params_;
      ...
      public EcdsaKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.params_ = null;
      ...
      public EcdsaKeyFormat.Builder mergeFrom(Message other) {
      ...
      public EcdsaKeyFormat.Builder mergeFrom(EcdsaKeyFormat other) {
      ...
      public EcdsaKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public EcdsaKeyFormat.Builder setParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public EcdsaKeyFormat.Builder setParams(EcdsaParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public EcdsaKeyFormat.Builder mergeParams(EcdsaParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public EcdsaKeyFormat.Builder clearParams() {
         this.bitField0_ &= -2;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public EcdsaKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 2;
         this.onChanged();
         return this;
      ...
      public EcdsaKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -3;
         this.version_ = 0;
         this.onChanged();
         return this;
