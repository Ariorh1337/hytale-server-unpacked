...
public final class RsaSsaPkcs1PrivateKey extends GeneratedMessage implements RsaSsaPkcs1PrivateKeyOrBuilder {
   ...
   private static final Parser<RsaSsaPkcs1PrivateKey> PARSER = new AbstractParser<RsaSsaPkcs1PrivateKey>() {
      public RsaSsaPkcs1PrivateKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         RsaSsaPkcs1PrivateKey.Builder builder = RsaSsaPkcs1PrivateKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return RsaSsaPkcs1.internal_static_google_crypto_tink_RsaSsaPkcs1PrivateKey_fieldAccessorTable
         .ensureFieldAccessorsInitialized(RsaSsaPkcs1PrivateKey.class, RsaSsaPkcs1PrivateKey.Builder.class);
   }
   ...
   public RsaSsaPkcs1PrivateKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static RsaSsaPkcs1PrivateKey.Builder newBuilder() {
   ...
   public RsaSsaPkcs1PrivateKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new RsaSsaPkcs1PrivateKey.Builder() : new RsaSsaPkcs1PrivateKey.Builder().mergeFrom(this);
   }

   protected RsaSsaPkcs1PrivateKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new RsaSsaPkcs1PrivateKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<RsaSsaPkcs1PrivateKey.Builder> implements RsaSsaPkcs1PrivateKeyOrBuilder {
      private int bitField0_;
      ...
      public RsaSsaPkcs1PrivateKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
      ...
      public RsaSsaPkcs1PrivateKey.Builder mergeFrom(Message other) {
      ...
      public RsaSsaPkcs1PrivateKey.Builder mergeFrom(RsaSsaPkcs1PrivateKey other) {
      ...
      public RsaSsaPkcs1PrivateKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public RsaSsaPkcs1PrivateKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setPublicKey(RsaSsaPkcs1PublicKey value) {
         if (this.publicKeyBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public RsaSsaPkcs1PrivateKey.Builder setPublicKey(RsaSsaPkcs1PublicKey.Builder builderForValue) {
         if (this.publicKeyBuilder_ == null) {
      ...
      public RsaSsaPkcs1PrivateKey.Builder mergePublicKey(RsaSsaPkcs1PublicKey value) {
         if (this.publicKeyBuilder_ == null) {
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearPublicKey() {
         this.bitField0_ &= -3;
         this.publicKey_ = null;
         if (this.publicKeyBuilder_ != null) {
            this.publicKeyBuilder_.dispose();
      ...
      public RsaSsaPkcs1PrivateKey.Builder setD(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearD() {
         this.bitField0_ &= -5;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setP(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearP() {
         this.bitField0_ &= -9;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setQ(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearQ() {
         this.bitField0_ &= -17;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setDp(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearDp() {
         this.bitField0_ &= -33;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setDq(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearDq() {
         this.bitField0_ &= -65;
      ...
      public RsaSsaPkcs1PrivateKey.Builder setCrt(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PrivateKey.Builder clearCrt() {
         this.bitField0_ &= -129;
