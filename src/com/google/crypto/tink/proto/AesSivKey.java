...
public final class AesSivKey extends GeneratedMessage implements AesSivKeyOrBuilder {
   ...
   private static final AesSivKey DEFAULT_INSTANCE = new AesSivKey();
   private static final Parser<AesSivKey> PARSER = new AbstractParser<AesSivKey>() {
      public AesSivKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesSivKey.Builder builder = AesSivKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesSiv.internal_static_google_crypto_tink_AesSivKey_fieldAccessorTable.ensureFieldAccessorsInitialized(AesSivKey.class, AesSivKey.Builder.class);
   }
   ...
   public AesSivKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesSivKey.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesSivKey.Builder newBuilder(AesSivKey prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesSivKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesSivKey.Builder() : new AesSivKey.Builder().mergeFrom(this);
   }

   protected AesSivKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesSivKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesSivKey.Builder> implements AesSivKeyOrBuilder {
      ...
      @Override
      protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
         return AesSiv.internal_static_google_crypto_tink_AesSivKey_fieldAccessorTable
            .ensureFieldAccessorsInitialized(AesSivKey.class, AesSivKey.Builder.class);
      }
      ...
      public AesSivKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.keyValue_ = ByteString.EMPTY;
      ...
      public AesSivKey.Builder mergeFrom(Message other) {
      ...
      public AesSivKey.Builder mergeFrom(AesSivKey other) {
      ...
      public AesSivKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AesSivKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public AesSivKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public AesSivKey.Builder setKeyValue(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public AesSivKey.Builder clearKeyValue() {
         this.bitField0_ &= -3;
