...
public final class ChaCha20Poly1305Key extends GeneratedMessage implements ChaCha20Poly1305KeyOrBuilder {
   ...
   private static final ChaCha20Poly1305Key DEFAULT_INSTANCE = new ChaCha20Poly1305Key();
   private static final Parser<ChaCha20Poly1305Key> PARSER = new AbstractParser<ChaCha20Poly1305Key>() {
      public ChaCha20Poly1305Key parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         ChaCha20Poly1305Key.Builder builder = ChaCha20Poly1305Key.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return Chacha20Poly1305.internal_static_google_crypto_tink_ChaCha20Poly1305Key_fieldAccessorTable
         .ensureFieldAccessorsInitialized(ChaCha20Poly1305Key.class, ChaCha20Poly1305Key.Builder.class);
   }
   ...
   public ChaCha20Poly1305Key.Builder newBuilderForType() {
      return newBuilder();
   }

   public static ChaCha20Poly1305Key.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static ChaCha20Poly1305Key.Builder newBuilder(ChaCha20Poly1305Key prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public ChaCha20Poly1305Key.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new ChaCha20Poly1305Key.Builder() : new ChaCha20Poly1305Key.Builder().mergeFrom(this);
   }

   protected ChaCha20Poly1305Key.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new ChaCha20Poly1305Key.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<ChaCha20Poly1305Key.Builder> implements ChaCha20Poly1305KeyOrBuilder {
      ...
      public ChaCha20Poly1305Key.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.keyValue_ = ByteString.EMPTY;
      ...
      public ChaCha20Poly1305Key.Builder mergeFrom(Message other) {
      ...
      public ChaCha20Poly1305Key.Builder mergeFrom(ChaCha20Poly1305Key other) {
      ...
      public ChaCha20Poly1305Key.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public ChaCha20Poly1305Key.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public ChaCha20Poly1305Key.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public ChaCha20Poly1305Key.Builder setKeyValue(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public ChaCha20Poly1305Key.Builder clearKeyValue() {
         this.bitField0_ &= -3;
