...
public final class AesCmacKey extends GeneratedMessage implements AesCmacKeyOrBuilder {
   ...
   private static final AesCmacKey DEFAULT_INSTANCE = new AesCmacKey();
   private static final Parser<AesCmacKey> PARSER = new AbstractParser<AesCmacKey>() {
      public AesCmacKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesCmacKey.Builder builder = AesCmacKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesCmac.internal_static_google_crypto_tink_AesCmacKey_fieldAccessorTable
         .ensureFieldAccessorsInitialized(AesCmacKey.class, AesCmacKey.Builder.class);
   }
   ...
   public AesCmacKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesCmacKey.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesCmacKey.Builder newBuilder(AesCmacKey prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesCmacKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesCmacKey.Builder() : new AesCmacKey.Builder().mergeFrom(this);
   }

   protected AesCmacKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesCmacKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesCmacKey.Builder> implements AesCmacKeyOrBuilder {
      private int bitField0_;
      ...
      public AesCmacKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.keyValue_ = ByteString.EMPTY;
      ...
      public AesCmacKey.Builder mergeFrom(Message other) {
      ...
      public AesCmacKey.Builder mergeFrom(AesCmacKey other) {
      ...
      public AesCmacKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
