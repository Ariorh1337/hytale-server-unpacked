...
public final class RsaSsaPkcs1PublicKey extends GeneratedMessage implements RsaSsaPkcs1PublicKeyOrBuilder {
   ...
   private static final RsaSsaPkcs1PublicKey DEFAULT_INSTANCE = new RsaSsaPkcs1PublicKey();
   private static final Parser<RsaSsaPkcs1PublicKey> PARSER = new AbstractParser<RsaSsaPkcs1PublicKey>() {
      public RsaSsaPkcs1PublicKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         RsaSsaPkcs1PublicKey.Builder builder = RsaSsaPkcs1PublicKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return RsaSsaPkcs1.internal_static_google_crypto_tink_RsaSsaPkcs1PublicKey_fieldAccessorTable
         .ensureFieldAccessorsInitialized(RsaSsaPkcs1PublicKey.class, RsaSsaPkcs1PublicKey.Builder.class);
   }
   ...
   public RsaSsaPkcs1PublicKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static RsaSsaPkcs1PublicKey.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static RsaSsaPkcs1PublicKey.Builder newBuilder(RsaSsaPkcs1PublicKey prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public RsaSsaPkcs1PublicKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new RsaSsaPkcs1PublicKey.Builder() : new RsaSsaPkcs1PublicKey.Builder().mergeFrom(this);
   }

   protected RsaSsaPkcs1PublicKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new RsaSsaPkcs1PublicKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<RsaSsaPkcs1PublicKey.Builder> implements RsaSsaPkcs1PublicKeyOrBuilder {
      private int bitField0_;
      ...
      public RsaSsaPkcs1PublicKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public RsaSsaPkcs1PublicKey.Builder mergeFrom(Message other) {
      ...
      public RsaSsaPkcs1PublicKey.Builder mergeFrom(RsaSsaPkcs1PublicKey other) {
      ...
      public RsaSsaPkcs1PublicKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public RsaSsaPkcs1PublicKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public RsaSsaPkcs1PublicKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public RsaSsaPkcs1PublicKey.Builder setParams(RsaSsaPkcs1Params value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public RsaSsaPkcs1PublicKey.Builder setParams(RsaSsaPkcs1Params.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public RsaSsaPkcs1PublicKey.Builder mergeParams(RsaSsaPkcs1Params value) {
         if (this.paramsBuilder_ == null) {
      ...
      public RsaSsaPkcs1PublicKey.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public RsaSsaPkcs1PublicKey.Builder setN(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PublicKey.Builder clearN() {
         this.bitField0_ &= -5;
      ...
      public RsaSsaPkcs1PublicKey.Builder setE(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public RsaSsaPkcs1PublicKey.Builder clearE() {
         this.bitField0_ &= -9;
