...
public final class HkdfPrfKeyFormat extends GeneratedMessage implements HkdfPrfKeyFormatOrBuilder {
   ...
   private static final HkdfPrfKeyFormat DEFAULT_INSTANCE = new HkdfPrfKeyFormat();
   private static final Parser<HkdfPrfKeyFormat> PARSER = new AbstractParser<HkdfPrfKeyFormat>() {
      public HkdfPrfKeyFormat parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         HkdfPrfKeyFormat.Builder builder = HkdfPrfKeyFormat.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return HkdfPrf.internal_static_google_crypto_tink_HkdfPrfKeyFormat_fieldAccessorTable
         .ensureFieldAccessorsInitialized(HkdfPrfKeyFormat.class, HkdfPrfKeyFormat.Builder.class);
   }
   ...
   public HkdfPrfKeyFormat.Builder newBuilderForType() {
      return newBuilder();
   }

   public static HkdfPrfKeyFormat.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static HkdfPrfKeyFormat.Builder newBuilder(HkdfPrfKeyFormat prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public HkdfPrfKeyFormat.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new HkdfPrfKeyFormat.Builder() : new HkdfPrfKeyFormat.Builder().mergeFrom(this);
   }

   protected HkdfPrfKeyFormat.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new HkdfPrfKeyFormat.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<HkdfPrfKeyFormat.Builder> implements HkdfPrfKeyFormatOrBuilder {
      private int bitField0_;
      private HkdfPrfParams params_;
      ...
      public HkdfPrfKeyFormat.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.params_ = null;
      ...
      public HkdfPrfKeyFormat.Builder mergeFrom(Message other) {
      ...
      public HkdfPrfKeyFormat.Builder mergeFrom(HkdfPrfKeyFormat other) {
      ...
      public HkdfPrfKeyFormat.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public HkdfPrfKeyFormat.Builder setParams(HkdfPrfParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public HkdfPrfKeyFormat.Builder setParams(HkdfPrfParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public HkdfPrfKeyFormat.Builder mergeParams(HkdfPrfParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public HkdfPrfKeyFormat.Builder clearParams() {
         this.bitField0_ &= -2;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public HkdfPrfKeyFormat.Builder setKeySize(int value) {
         this.keySize_ = value;
         this.bitField0_ |= 2;
         this.onChanged();
         return this;
      ...
      public HkdfPrfKeyFormat.Builder clearKeySize() {
         this.bitField0_ &= -3;
         this.keySize_ = 0;
         this.onChanged();
         return this;
      ...
      public HkdfPrfKeyFormat.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 4;
         this.onChanged();
         return this;
      ...
      public HkdfPrfKeyFormat.Builder clearVersion() {
         this.bitField0_ &= -5;
         this.version_ = 0;
         this.onChanged();
         return this;
