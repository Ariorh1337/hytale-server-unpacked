...
public final class AesEaxKey extends GeneratedMessage implements AesEaxKeyOrBuilder {
   ...
   private static final Parser<AesEaxKey> PARSER = new AbstractParser<AesEaxKey>() {
      public AesEaxKey parsePartialFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         AesEaxKey.Builder builder = AesEaxKey.newBuilder();
   ...
   protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
      return AesEax.internal_static_google_crypto_tink_AesEaxKey_fieldAccessorTable.ensureFieldAccessorsInitialized(AesEaxKey.class, AesEaxKey.Builder.class);
   }
   ...
   public AesEaxKey.Builder newBuilderForType() {
      return newBuilder();
   }

   public static AesEaxKey.Builder newBuilder() {
      return DEFAULT_INSTANCE.toBuilder();
   }

   public static AesEaxKey.Builder newBuilder(AesEaxKey prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
   }

   public AesEaxKey.Builder toBuilder() {
      return this == DEFAULT_INSTANCE ? new AesEaxKey.Builder() : new AesEaxKey.Builder().mergeFrom(this);
   }

   protected AesEaxKey.Builder newBuilderForType(AbstractMessage.BuilderParent parent) {
      return new AesEaxKey.Builder(parent);
   }
   ...
   public static final class Builder extends GeneratedMessage.Builder<AesEaxKey.Builder> implements AesEaxKeyOrBuilder {
      private int bitField0_;
      ...
      @Override
      protected GeneratedMessage.FieldAccessorTable internalGetFieldAccessorTable() {
         return AesEax.internal_static_google_crypto_tink_AesEaxKey_fieldAccessorTable
            .ensureFieldAccessorsInitialized(AesEaxKey.class, AesEaxKey.Builder.class);
      }
      ...
      public AesEaxKey.Builder clear() {
         super.clear();
         this.bitField0_ = 0;
         this.version_ = 0;
         this.params_ = null;
      ...
      public AesEaxKey.Builder mergeFrom(Message other) {
      ...
      public AesEaxKey.Builder mergeFrom(AesEaxKey other) {
      ...
      public AesEaxKey.Builder mergeFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
      ...
      public AesEaxKey.Builder setVersion(int value) {
         this.version_ = value;
         this.bitField0_ |= 1;
         this.onChanged();
         return this;
      ...
      public AesEaxKey.Builder clearVersion() {
         this.bitField0_ &= -2;
         this.version_ = 0;
         this.onChanged();
         return this;
      ...
      public AesEaxKey.Builder setParams(AesEaxParams value) {
         if (this.paramsBuilder_ == null) {
            if (value == null) {
               throw new NullPointerException();
            }
      ...
      public AesEaxKey.Builder setParams(AesEaxParams.Builder builderForValue) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesEaxKey.Builder mergeParams(AesEaxParams value) {
         if (this.paramsBuilder_ == null) {
      ...
      public AesEaxKey.Builder clearParams() {
         this.bitField0_ &= -3;
         this.params_ = null;
         if (this.paramsBuilder_ != null) {
            this.paramsBuilder_.dispose();
      ...
      public AesEaxKey.Builder setKeyValue(ByteString value) {
         if (value == null) {
            throw new NullPointerException();
         }
      ...
      public AesEaxKey.Builder clearKeyValue() {
         this.bitField0_ &= -5;
