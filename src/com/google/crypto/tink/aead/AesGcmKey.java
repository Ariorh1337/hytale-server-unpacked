...
public final class AesGcmKey extends AeadKey {
   ...
   public static class Builder {
      ...
      public AesGcmKey.Builder setParameters(AesGcmParameters parameters) {
         this.parameters = parameters;
         return this;
      }

      @CanIgnoreReturnValue
      public AesGcmKey.Builder setKeyBytes(SecretBytes keyBytes) {
         this.keyBytes = keyBytes;
         return this;
      }

      @CanIgnoreReturnValue
      public AesGcmKey.Builder setIdRequirement(@Nullable Integer idRequirement) {
         this.idRequirement = idRequirement;
         return this;
      }
