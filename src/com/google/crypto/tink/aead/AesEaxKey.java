...
public final class AesEaxKey extends AeadKey {
   ...
   public static AesEaxKey.Builder builder() {
      return new AesEaxKey.Builder();
   }
   ...
   public static class Builder {
      ...
      public AesEaxKey.Builder setParameters(AesEaxParameters parameters) {
         this.parameters = parameters;
         return this;
      }

      @CanIgnoreReturnValue
      public AesEaxKey.Builder setKeyBytes(SecretBytes keyBytes) {
         this.keyBytes = keyBytes;
         return this;
      }

      @CanIgnoreReturnValue
      public AesEaxKey.Builder setIdRequirement(@Nullable Integer idRequirement) {
         this.idRequirement = idRequirement;
         return this;
      }
