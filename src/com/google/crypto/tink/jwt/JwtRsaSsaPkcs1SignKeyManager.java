...
public final class JwtRsaSsaPkcs1SignKeyManager {
   ...
   private static final PrimitiveConstructor<JwtRsaSsaPkcs1PrivateKey, JwtPublicKeySign> PRIMITIVE_CONSTRUCTOR = PrimitiveConstructor.create(
      JwtRsaSsaPkcs1SignKeyManager::createFullPrimitive, JwtRsaSsaPkcs1PrivateKey.class, JwtPublicKeySign.class
   );
   ...
   static JwtPublicKeySign createFullPrimitive(JwtRsaSsaPkcs1PrivateKey privateKey) throws GeneralSecurityException {
   ...
   private static JwtRsaSsaPkcs1PrivateKey createKey(JwtRsaSsaPkcs1Parameters parameters, @Nullable Integer idRequirement) throws GeneralSecurityException {
      ...
      JwtRsaSsaPkcs1PublicKey.Builder jwtRsaSsaPkcs1PublicKeyBuilder = JwtRsaSsaPkcs1PublicKey.builder()
