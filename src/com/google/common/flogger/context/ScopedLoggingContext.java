...
public abstract class ScopedLoggingContext {
   ...
   private static void closeAndMaybePropagateError(ScopedLoggingContext.LoggingContextCloseable context, boolean callerHasError) {
      try {
         ...
         if (!callerHasError) {
            throw e instanceof ScopedLoggingContext.InvalidLoggingContextStateException
               ? (ScopedLoggingContext.InvalidLoggingContextStateException)e
               : new ScopedLoggingContext.InvalidLoggingContextStateException("invalid logging context state", e);
         }
      }
   }
