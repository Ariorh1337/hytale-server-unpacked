...
public class CombatActionEvaluatorConfig {
   ...
   public String toString() {
      return "CombatActionEvaluatorConfig{availableActions="
         ...
         + this.actionSets
         + ", runConditions="
         + Arrays.toString(this.runConditions)
         + ", minRunUtility="
         + this.minRunUtility
         + ", minActionUtility="
   ...
   public static class ActionSet {
      ...
      @Override
      public String toString() {
         return "ActionSet{basicAttacks=" + this.basicAttacks + ", combatActions=" + Arrays.toString(this.combatActions) + "}";
      }
   }
