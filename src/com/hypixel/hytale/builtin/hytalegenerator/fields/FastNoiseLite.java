...
public class FastNoiseLite {
   ...
   private float SingleOpenSimplex2S(int seed, double x, double y, double z) {
      ...
      if (a2 > 0.0F) {
         ...
         float y2 = y0;
         float z2 = z0;
         value += a2 * a2 * (a2 * a2) * GradCoord(seed, i + (~xNMask & 501125321), j + (yNMask & 1136930381), k + (zNMask & 1720413743), x2, y2, z2);
      } else {
         ...
         if (a3 > 0.0F) {
            ...
            value += a3 * a3 * (a3 * a3) * GradCoord(seed, i + (xNMask & 501125321), j + (~yNMask & 1136930381), k + (~zNMask & 1720413743), x3, y3, z3);
         }
         ...
         if (a4 > 0.0F) {
            ...
            float y4 = y1;
            float z4 = z1;
            value += a4 * a4 * (a4 * a4) * GradCoord(seed2, i + (xNMask & 1002250642), j + 1136930381, k + 1720413743, x4, y4, z4);
            skip5 = true;
         }
      }
      ...
      if (a6 > 0.0F) {
         ...
         float z6 = z0;
         value += a6 * a6 * (a6 * a6) * GradCoord(seed, i + (xNMask & 501125321), j + (~yNMask & 1136930381), k + (zNMask & 1720413743), x6, y6, z6);
      } else {
         ...
         if (a7 > 0.0F) {
            ...
            value += a7 * a7 * (a7 * a7) * GradCoord(seed, i + (~xNMask & 501125321), j + (yNMask & 1136930381), k + (~zNMask & 1720413743), x7, y7, z7);
         }
         ...
         if (a8 > 0.0F) {
            ...
            float z8 = z1;
            value += a8 * a8 * (a8 * a8) * GradCoord(seed2, i + 501125321, j + (yNMask & -2021106534), k + 1720413743, x8, y8, z8);
            skip9 = true;
         }
      }
      ...
      if (aA > 0.0F) {
         ...
         value += aA * aA * (aA * aA) * GradCoord(seed, i + (xNMask & 501125321), j + (yNMask & 1136930381), k + (~zNMask & 1720413743), xA, yA, zA);
      } else {
         ...
         if (aB > 0.0F) {
            ...
            float zB = z0;
            value += aB * aB * (aB * aB) * GradCoord(seed, i + (~xNMask & 501125321), j + (~yNMask & 1136930381), k + (zNMask & 1720413743), xB, yB, zB);
         }
      ...
      if (!skip5) {
         ...
         if (a5 > 0.0F) {
            ...
            value += a5 * a5 * (a5 * a5) * GradCoord(seed2, i + 501125321, j + (yNMask & -2021106534), k + (zNMask & -854139810), x5, y5, z5);
         }
      }
      ...
      if (!skip9) {
         ...
         if (a9 > 0.0F) {
            ...
            value += a9 * a9 * (a9 * a9) * GradCoord(seed2, i + (xNMask & 1002250642), j + 1136930381, k + (zNMask & -854139810), x9, y9, z9);
         }
      }
      ...
      if (!skipD) {
         ...
         if (aD > 0.0F) {
            ...
            float zD = z1;
            value += aD * aD * (aD * aD) * GradCoord(seed2, i + (xNMask & 1002250642), j + (yNMask & -2021106534), k + 1720413743, xD, yD, zD);
         }
      }
