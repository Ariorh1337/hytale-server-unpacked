...
import com.hypixel.hytale.builtin.hytalegenerator.positionproviders.Jitter2dPositionProvider;
...
public class Jitter2dPositionProviderAsset extends PositionProviderAsset {
   @Nonnull
   public static final BuilderCodec<Jitter2dPositionProviderAsset> CODEC = BuilderCodec.builder(
         Jitter2dPositionProviderAsset.class, Jitter2dPositionProviderAsset::new, PositionProviderAsset.ABSTRACT_CODEC
      )
   ...
   public PositionProvider build(@Nonnull PositionProviderAsset.Argument argument) {
      ...
      return new Jitter2dPositionProvider(this.magnitude, seedBox.createSupplier().get(), positionProvider);
   }
