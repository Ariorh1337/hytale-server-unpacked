...
public class PatternDirectionalityAsset extends DirectionalityAsset {
   ...
   public Directionality build(@Nonnull DirectionalityAsset.Argument argument) {
      ...
      Pattern northPattern = this.northPatternAsset == null
         ? ConstantPattern.INSTANCE_FALSE
         : this.northPatternAsset.build(PatternAsset.argumentFrom(argument));
      Pattern southPattern = this.southPatternAsset == null
         ? ConstantPattern.INSTANCE_FALSE
         : this.southPatternAsset.build(PatternAsset.argumentFrom(argument));
      Pattern eastPattern = this.eastPatternAsset == null ? ConstantPattern.INSTANCE_FALSE : this.eastPatternAsset.build(PatternAsset.argumentFrom(argument));
      Pattern westPattern = this.westPatternAsset == null ? ConstantPattern.INSTANCE_FALSE : this.westPatternAsset.build(PatternAsset.argumentFrom(argument));
