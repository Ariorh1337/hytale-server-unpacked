...
public abstract class ContentPredicateAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, ContentPredicateAsset>> {
   @Nonnull
   public static final AssetCodecMapCodec<String, ContentPredicateAsset> CODEC = new AssetCodecMapCodec<>(
      Codec.STRING, (asset, value) -> asset.id = value, asset -> asset.id, (asset, value) -> asset.data = value, asset -> asset.data
   );
   @Nonnull
   private static final Map<String, ContentPredicateAsset> exportedNodes = new ConcurrentHashMap<>();
   @Nonnull
   public static final Codec<String> CHILD_ASSET_CODEC = new ContainedAssetCodec<>(ContentPredicateAsset.class, CODEC);
   @Nonnull
   public static final Codec<String[]> CHILD_ASSET_CODEC_ARRAY = new ArrayCodec<>(CHILD_ASSET_CODEC, String[]::new);
   @Nonnull
   public static final BuilderCodec<ContentPredicateAsset> ABSTRACT_CODEC = BuilderCodec.abstractBuilder(ContentPredicateAsset.class)
   ...
   protected ContentPredicateAsset() {
   }

   @Nonnull
   public abstract Predicate<IntSet> build();

   public boolean skip() {
      return this.skip;
   }

   public static ContentPredicateAsset getExportedAsset(@Nonnull String name) {
