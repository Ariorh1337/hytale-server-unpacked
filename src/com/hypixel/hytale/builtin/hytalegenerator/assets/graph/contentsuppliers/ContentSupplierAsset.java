...
public abstract class ContentSupplierAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, ContentSupplierAsset>> {
   @Nonnull
   public static final AssetCodecMapCodec<String, ContentSupplierAsset> CODEC = new AssetCodecMapCodec<>(
      Codec.STRING, (asset, value) -> asset.id = value, asset -> asset.id, (asset, value) -> asset.data = value, asset -> asset.data
   );
   @Nonnull
   private static final Map<String, ContentSupplierAsset> exportedNodes = new ConcurrentHashMap<>();
   @Nonnull
   public static final Codec<String> CHILD_ASSET_CODEC = new ContainedAssetCodec<>(ContentSupplierAsset.class, CODEC);
   @Nonnull
   public static final Codec<String[]> CHILD_ASSET_CODEC_ARRAY = new ArrayCodec<>(CHILD_ASSET_CODEC, String[]::new);
   @Nonnull
   public static final BuilderCodec<ContentSupplierAsset> ABSTRACT_CODEC = BuilderCodec.abstractBuilder(ContentSupplierAsset.class)
   ...
   protected ContentSupplierAsset() {
   }

   @Nonnull
   public abstract ContentSupplier build(@Nonnull GraphGeneratorAsset.Argument var1);

   public boolean skip() {
      return this.skip;
   }

   public static ContentSupplierAsset getExportedAsset(@Nonnull String name) {
