...
import com.hypixel.hytale.builtin.hytalegenerator.predicates.AndSetPredicate;
...
public class AndContentPredicateAsset extends ContentPredicateAsset {
   @Nonnull
   public static final BuilderCodec<AndContentPredicateAsset> CODEC = BuilderCodec.builder(
         AndContentPredicateAsset.class, AndContentPredicateAsset::new, ContentPredicateAsset.ABSTRACT_CODEC
      )
      .append(
   ...
   public Predicate<IntSet> build() {
      ...
      return new AndSetPredicate(predicates);
   }
