...
public abstract class EdgeSelectorAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, EdgeSelectorAsset>> {
   @Nonnull
   public static final AssetCodecMapCodec<String, EdgeSelectorAsset> CODEC = new AssetCodecMapCodec<>(
      Codec.STRING, (asset, value) -> asset.id = value, asset -> asset.id, (asset, value) -> asset.data = value, asset -> asset.data
   );
   @Nonnull
   private static final Map<String, EdgeSelectorAsset> exportedNodes = new ConcurrentHashMap<>();
   @Nonnull
   public static final Codec<String> CHILD_ASSET_CODEC = new ContainedAssetCodec<>(EdgeSelectorAsset.class, CODEC);
   @Nonnull
   public static final Codec<String[]> CHILD_ASSET_CODEC_ARRAY = new ArrayCodec<>(CHILD_ASSET_CODEC, String[]::new);
   @Nonnull
   public static final BuilderCodec<EdgeSelectorAsset> ABSTRACT_CODEC = BuilderCodec.abstractBuilder(EdgeSelectorAsset.class)
   ...
   protected EdgeSelectorAsset() {
   }

   @Nonnull
   public abstract EdgeSelector build(@Nonnull GraphGeneratorAsset.Argument var1);

   public boolean skip() {
      return this.skip;
   }

   public static EdgeSelectorAsset getExportedAsset(@Nonnull String name) {
