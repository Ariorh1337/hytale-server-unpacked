...
public abstract class NodeActionAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, NodeActionAsset>> {
   @Nonnull
   public static final AssetCodecMapCodec<String, NodeActionAsset> CODEC = new AssetCodecMapCodec<>(
      Codec.STRING, (asset, value) -> asset.id = value, asset -> asset.id, (asset, value) -> asset.data = value, asset -> asset.data
   );
   @Nonnull
   private static final Map<String, NodeActionAsset> exportedNodes = new ConcurrentHashMap<>();
   @Nonnull
   public static final Codec<String> CHILD_ASSET_CODEC = new ContainedAssetCodec<>(NodeActionAsset.class, CODEC);
   @Nonnull
   public static final Codec<String[]> CHILD_ASSET_CODEC_ARRAY = new ArrayCodec<>(CHILD_ASSET_CODEC, String[]::new);
   @Nonnull
   public static final BuilderCodec<NodeActionAsset> ABSTRACT_CODEC = BuilderCodec.abstractBuilder(NodeActionAsset.class)
   ...
   protected NodeActionAsset() {
   }

   @Nonnull
   public abstract NodeAction build(@Nonnull GraphGeneratorAsset.Argument var1);

   public boolean skip() {
      return this.skip;
   }

   public static NodeActionAsset getExportedAsset(@Nonnull String name) {
