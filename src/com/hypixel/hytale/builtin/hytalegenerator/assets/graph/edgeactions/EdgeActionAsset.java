...
public abstract class EdgeActionAsset implements Cleanable, JsonAssetWithMap<String, DefaultAssetMap<String, EdgeActionAsset>> {
   @Nonnull
   public static final AssetCodecMapCodec<String, EdgeActionAsset> CODEC = new AssetCodecMapCodec<>(
      Codec.STRING, (asset, value) -> asset.id = value, asset -> asset.id, (asset, value) -> asset.data = value, asset -> asset.data
   );
   @Nonnull
   private static final Map<String, EdgeActionAsset> exportedNodes = new ConcurrentHashMap<>();
   @Nonnull
   public static final Codec<String> CHILD_ASSET_CODEC = new ContainedAssetCodec<>(EdgeActionAsset.class, CODEC);
   @Nonnull
   public static final Codec<String[]> CHILD_ASSET_CODEC_ARRAY = new ArrayCodec<>(CHILD_ASSET_CODEC, String[]::new);
   @Nonnull
   public static final BuilderCodec<EdgeActionAsset> ABSTRACT_CODEC = BuilderCodec.abstractBuilder(EdgeActionAsset.class)
   ...
   protected EdgeActionAsset() {
   }

   @Nonnull
   public abstract EdgeAction build(@Nonnull GraphGeneratorAsset.Argument var1);

   public boolean skip() {
      return this.skip;
   }

   public static EdgeActionAsset getExportedAsset(@Nonnull String name) {
