...
import com.hypixel.hytale.builtin.hytalegenerator.graph.edgeselectors.OrEdgeSelector;
...
public class OrEdgeSelectorAsset extends EdgeSelectorAsset {
   @Nonnull
   public static final BuilderCodec<OrEdgeSelectorAsset> CODEC = BuilderCodec.builder(
         OrEdgeSelectorAsset.class, OrEdgeSelectorAsset::new, EdgeSelectorAsset.ABSTRACT_CODEC
      )
      .append(
   ...
   public EdgeSelector build(@Nonnull GraphGeneratorAsset.Argument argument) {
      ...
      return new OrEdgeSelector(edgeSelectors);
   }
