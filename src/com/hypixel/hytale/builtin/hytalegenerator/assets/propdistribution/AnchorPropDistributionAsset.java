...
public class AnchorPropDistributionAsset extends PropDistributionAsset {
   @Nonnull
   public static final BuilderCodec<AnchorPropDistributionAsset> CODEC = BuilderCodec.builder(
         AnchorPropDistributionAsset.class, AnchorPropDistributionAsset::new, PropDistributionAsset.ABSTRACT_CODEC
      )
      .append(
   ...
   public PropDistribution build(@Nonnull PropDistributionAsset.Argument argument) {
      ...
      return new AnchorPropDistribution(propDistribution, this.isReversed);
   }
