...
import com.hypixel.hytale.builtin.hytalegenerator.vectorproviders.MultiplierVectorProvider;
...
public class MultiplierVectorProviderAsset extends VectorProviderAsset {
   @Nonnull
   public static final BuilderCodec<MultiplierVectorProviderAsset> CODEC = BuilderCodec.builder(
         MultiplierVectorProviderAsset.class, MultiplierVectorProviderAsset::new, VectorProviderAsset.ABSTRACT_CODEC
      )
      .append(
   ...
   public VectorProvider build(@Nonnull VectorProviderAsset.Argument argument) {
      ...
      return new MultiplierVectorProvider(vectorProviders);
   }
