...
public class CrossVectorProvider extends VectorProvider {
   @Nonnull
   ...
   public CrossVectorProvider(@Nonnull VectorProvider vectorProviderA, @Nonnull VectorProvider vectorProviderB) {
   ...
   public void process(@Nonnull VectorProvider.Context context, @Nonnull Vector3d vector_out) {
      ...
      this.rVectorA.cross(this.rVectorB, vector_out);
   }
}
