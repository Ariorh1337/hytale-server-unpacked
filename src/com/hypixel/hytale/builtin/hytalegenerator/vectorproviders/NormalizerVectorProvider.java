...
public class NormalizerVectorProvider extends VectorProvider {
   @Nonnull
   ...
   public NormalizerVectorProvider(@Nonnull Density density, @Nonnull VectorProvider vectorProvider) {
   ...
   public void process(@Nonnull VectorProvider.Context context, @Nonnull Vector3d vector_out) {
      ...
      this.rVector.normalize(densityValue);
