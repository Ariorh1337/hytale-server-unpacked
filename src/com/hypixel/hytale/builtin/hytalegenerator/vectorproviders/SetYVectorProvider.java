...
public class SetYVectorProvider extends VectorProvider {
   @Nonnull
   ...
   public SetYVectorProvider(@Nonnull Density value, @Nonnull VectorProvider vectorProvider) {
      this.value = value;
   ...
   public void process(@Nonnull VectorProvider.Context context, @Nonnull Vector3d vector_out) {
      ...
      this.rVector.y = this.value.process(this.rDensityContext);
