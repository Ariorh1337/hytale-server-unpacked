...
public class CraftingManager implements Component<EntityStore> {
   ...
   public boolean queueCraft(
      ...
      this.queuedCraftingJobs.offer(new CraftingManager.CraftingJob(window, transactionId, recipe, quantity, recipeTime, inputItemContainer, inputRemovalType));
      return true;
   }
   ...
   public boolean startTierUpgrade(@Nonnull Ref<EntityStore> ref, @Nonnull ComponentAccessor<EntityStore> componentAccessor, @Nonnull BenchWindow window) {
      ...
      if (playerComponent.getGameMode() != GameMode.Creative) {
         ...
         CombinedItemContainer combined = new CombinedItemContainer(combinedBackpackStorageHotbar, window.getExtraResourcesSection().getItemContainer());
         ...
         if (blockEntityRef != null && blockEntityRef.isValid()) {
            ...
            if (benchBlock != null && benchBlock.getTierLevel() != 0) {
               ...
               if (canUpgrade) {
                  ...
                  ProcessingBenchBlock processingBlock = chunkStore.getStore().getComponent(blockEntityRef, ProcessingBenchBlock.getComponentType());
