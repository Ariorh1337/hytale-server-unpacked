...
public class PortalRemovalCondition implements RemovalCondition {
   @Nonnull
   public static final BuilderCodec<PortalRemovalCondition> CODEC = BuilderCodec.<PortalRemovalCondition>builder(
         PortalRemovalCondition.class, PortalRemovalCondition::new
      )
