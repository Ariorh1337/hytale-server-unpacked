   ...
   public void modifyBrushConfig(
      ...
      if (this.repetitionsRemaining == 0) {
         ...
         Vector3i offsetVector = brushConfig.getOriginOffset()
            ...
            .add(new Vector3i(this.offsetsInCircle.get(this.repetitionsRemaining - 1)));
         this.previousCircleOffset.set(this.offsetsInCircle.get(this.repetitionsRemaining - 1));
