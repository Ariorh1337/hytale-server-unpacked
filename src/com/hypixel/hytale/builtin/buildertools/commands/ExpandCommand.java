...
public class ExpandCommand extends AbstractPlayerCommand {
   @Nonnull
   private final DefaultArg<Integer> distanceArg = this.withDefaultArg("distance", "server.commands.expand.distance.desc", ArgTypes.INTEGER, 1, "1");
   @Nonnull
   private final OptionalArg<Axis> axisArg = this.withOptionalArg(
      "axis", "server.commands.expand.axis.desc", new EnumArgumentType<>("server.commands.parsing.argtype.axis.name", Axis.class)
   );
