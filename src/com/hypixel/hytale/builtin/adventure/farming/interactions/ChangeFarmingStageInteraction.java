                     ...
                     if (stages != null && stages.length != 0) {
                        ...
                        if (blockRef == null) {
                           ...
                           if (blockRef != null) {
                              ...
                              LOGGER.atInfo().log("[ChangeFarmingStage] Updated growthProgress to %d (actual final stage)", (int)(stages.length - 1));
                           }
                        } else {
                        ...
                        if (blockRef == null) {
                           ...
                           if (stages != null && stages.length != 0) {
                              ...
                              if (currentStage >= stages.length) {
                                 LOGGER.atInfo()
                                    .log(
                                       "[ChangeFarmingStage] Clamping currentStage from %d to %d (was >= stages.length)",
                                       (int)currentStage,
                                       (int)(stages.length - 1)
                                    );
                              ...
                              if (this.increaseBy != null) {
                                 ...
                                 LOGGER.atInfo().log("[ChangeFarmingStage] Mode=ABSOLUTE: targetStage=%d, resolved=%d", (int)this.targetStage, (int)stageIndex);
                              }
                              ...
                              if (preClampStageIndex != stageIndex) {
                                 LOGGER.atInfo().log("[ChangeFarmingStage] Clamped stageIndex from %d to %d", (int)preClampStageIndex, (int)stageIndex);
                              }
                              ...
                              LOGGER.atInfo()
                                 .log("[ChangeFarmingStage] Previous stage data: index=%d, hasPreviousStage=%s", (int)previousStageIndex, previousStage != null);
                              ...
                              if (sectionRef != null && sectionRef.isValid()) {
                                 ...
                                 LOGGER.atInfo().log("[ChangeFarmingStage] Applied stage %d via stages[%d].apply()", (int)stageIndex, (int)stageIndex);
                              } else {
