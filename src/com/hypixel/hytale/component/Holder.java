...
public class Holder<ECS_TYPE> {
   ...
   public <T extends Component<ECS_TYPE>> T getComponent(@Nonnull ComponentType<ECS_TYPE, T> componentType) {
      ...
      try {
         ...
         return (T)(!this.archetype.contains(componentType) ? null : this.components[componentType.getIndex()]);
      } finally {
   ...
   public boolean equals(@Nullable Object o) {
      ...
      if (o != null && this.getClass() == o.getClass()) {
         ...
         try {
            return !Objects.equals(this.archetype, that.archetype) ? false : Arrays.equals(this.components, that.components);
         } finally {
   ...
   public String toString() {
      ...
      try {
         return "EntityHolder{archetype=" + this.archetype + ", components=" + Arrays.toString(this.components) + "}";
      } finally {
         this.lock.unlockRead(stamp);
      }
   }
