...
public class SpawnMarker implements JsonAssetWithMap<String, DefaultAssetMap<String, SpawnMarker>> {
   public static final AssetBuilderCodec<String, SpawnMarker> CODEC = AssetBuilderCodec.<String, SpawnMarker>builder(
   ...
   public static class SpawnConfiguration implements IWeightedElement {
      public static final BuilderCodec<SpawnMarker.SpawnConfiguration> CODEC = BuilderCodec.<SpawnMarker.SpawnConfiguration>builder(
