...
public class SpawnSuppression implements JsonAssetWithMap<String, IndexedAssetMap<String, SpawnSuppression>> {
   public static final AssetBuilderCodec<String, SpawnSuppression> CODEC = AssetBuilderCodec.<String, SpawnSuppression>builder(
   ...
   public String toString() {
      return "SpawnSuppression{radius="
         + this.radius
         + ", suppressedGroups="
         + Arrays.toString(this.suppressedGroups)
