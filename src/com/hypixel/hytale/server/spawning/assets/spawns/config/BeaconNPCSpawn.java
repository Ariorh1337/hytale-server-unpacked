...
public class BeaconNPCSpawn extends NPCSpawn implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, BeaconNPCSpawn>> {
   public static final AssetBuilderCodec<String, BeaconNPCSpawn> CODEC = AssetBuilderCodec.<String, BeaconNPCSpawn>builder(
   ...
   public String toString() {
      return "BeaconNPCSpawn{id='"
         ...
         + Arrays.toString(this.spawnAfterGameTime)
         + ", spawnAfterRealTime="
         + Arrays.toString(this.spawnAfterRealTime)
         + ", initialSpawnDelay="
