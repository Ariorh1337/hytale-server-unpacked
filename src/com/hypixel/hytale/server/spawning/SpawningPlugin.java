...
public class SpawningPlugin extends JavaPlugin {
   ...
   private void setUpWithAllRoles() {
      ...
      for (Entry<String, BeaconNPCSpawn> entry : beaconSpawnAssetMap.entrySet()) {
         BeaconNPCSpawn value = entry.getValue();
      ...
      this.getLogger().at(Level.INFO).log("Successfully set up %s world spawn configurations", (int)worldSetupCount);
      this.getLogger().at(Level.INFO).log("Successfully set up %s beacon spawn configurations", (int)beaconSetupCount);
   }
   ...
   private void rebuildBeaconSpawnConfigurations(@Nullable IntSet changeSet) {
      if (changeSet != null && !changeSet.isEmpty()) {
         ...
         this.getLogger().at(Level.INFO).log("Successfully rebuilt %s beacon spawn configurations", (int)setupCount);
      }
   }
