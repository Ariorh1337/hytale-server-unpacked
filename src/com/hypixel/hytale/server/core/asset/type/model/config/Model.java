...
public class Model implements NetworkSerializable<com.hypixel.hytale.protocol.Model> {
   ...
   public static class ModelReference {
      public static final BuilderCodec<Model.ModelReference> CODEC = BuilderCodec.<Model.ModelReference>builder(
            Model.ModelReference.class, Model.ModelReference::new
         )
