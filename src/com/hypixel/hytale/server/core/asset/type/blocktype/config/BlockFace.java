...
public enum BlockFace {
   ...
   BlockFace(BlockFace.FaceConnectionType faceConnectionType, BlockNeighbor blockNeighbor, Vector3ic direction) {
   ...
   BlockFace(BlockFace.FaceConnectionType faceConnectionType, BlockNeighbor blockNeighbor, @Nonnull BlockFace... components) {
      this.faceConnectionType = faceConnectionType;
