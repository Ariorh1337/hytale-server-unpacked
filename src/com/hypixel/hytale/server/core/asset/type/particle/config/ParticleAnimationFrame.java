...
public class ParticleAnimationFrame implements NetworkSerializable<com.hypixel.hytale.protocol.ParticleAnimationFrame> {
   ...
   public static final BuilderCodec<ParticleAnimationFrame> CODEC = BuilderCodec.<ParticleAnimationFrame>builder(
         ParticleAnimationFrame.class, ParticleAnimationFrame::new
      )
      .addField(
