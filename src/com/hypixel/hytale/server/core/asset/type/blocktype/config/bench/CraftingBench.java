...
public class CraftingBench extends Bench {
   ...
   public int hashCode() {
      ...
      return 31 * result + Arrays.hashCode(this.categories);
   }

   public static class BenchCategory {
      public static final BuilderCodec<CraftingBench.BenchCategory> CODEC = BuilderCodec.<CraftingBench.BenchCategory>builder(
      ...
      public String toString() {
         return "BenchCategory{id='"
            ...
            + this.icon
            + "', itemCategories='"
            + Arrays.toString(this.itemCategories)
            + "'}";
      }
   }

   public static class BenchItemCategory {
      public static final BuilderCodec<CraftingBench.BenchItemCategory> CODEC = BuilderCodec.<CraftingBench.BenchItemCategory>builder(
