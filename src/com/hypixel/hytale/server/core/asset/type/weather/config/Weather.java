...
public class Weather implements JsonAssetWithMap<String, IndexedLookupTableAssetMap<String, Weather>>, NetworkSerializable<com.hypixel.hytale.protocol.Weather> {
   public static final BuilderCodec<WeatherParticle> PARTICLE_CODEC = BuilderCodec.<WeatherParticle>builder(WeatherParticle.class, WeatherParticle::new)
      ...
      .add()
      .build();
   public static final AssetBuilderCodec<String, Weather> CODEC = AssetBuilderCodec.<String, Weather>builder(
         Weather.class,
         Weather::new,
         Codec.STRING,
