...
public class ModelAsset implements JsonAssetWithMap<String, DefaultAssetMap<String, ModelAsset>> {
   ...
   public static final AssetBuilderCodec<String, ModelAsset> CODEC = AssetBuilderCodec.<String, ModelAsset>builder(
         ModelAsset.class,
         ModelAsset::new,
         Codec.STRING,
   ...
   public static class AnimationSet {
      ...
      @Override
      public String toString() {
         return "AnimationSet{animations=" + Arrays.toString(this.animations) + ", nextAnimationDelay=" + this.nextAnimationDelay + "}";
      }
   }
}
