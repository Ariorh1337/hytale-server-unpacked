...
public class ItemArmor implements NetworkSerializable<com.hypixel.hytale.protocol.ItemArmor> {
   ...
   public com.hypixel.hytale.protocol.ItemArmor toPacket() {
      ...
      if (this.damageClassEnhancement != null && !this.damageClassEnhancement.isEmpty()) {
         ...
         for (Entry<DamageClass, StaticModifier[]> entry : this.damageClassEnhancement.entrySet()) {
            if (entry.getKey() != null && entry.getValue() != null) {
               Modifier[] modifiers = new Modifier[((StaticModifier[])entry.getValue()).length];
               ...
               damageClassEnhancementMap.put(entry.getKey().name().toLowerCase(), modifiers);
            }
         }
      ...
      if (this.damageEnhancementValues != null && !this.damageEnhancementValues.isEmpty()) {
         ...
         for (Entry<DamageCause, StaticModifier[]> entry : this.damageEnhancementValues.entrySet()) {
            if (entry.getKey() != null && entry.getValue() != null) {
               Modifier[] modifiers = new Modifier[((StaticModifier[])entry.getValue()).length];
               ...
               damageEnhancementMap.put(entry.getKey().getId(), modifiers);
            }
         }
   ...
   public String toString() {
      return "ItemArmor{armorSlot="
         ...
         + this.statModifiers
         + ", cosmeticsToHide="
         + Arrays.toString(this.cosmeticsToHide)
         + ", regenerating="
         + this.regenerating
         + ", regeneratingValues="
   ...
   public enum InteractionModifierId {
      Dodge;
   }
}
