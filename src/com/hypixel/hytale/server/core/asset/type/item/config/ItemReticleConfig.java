...
public class ItemReticleConfig
   ...
   public com.hypixel.hytale.protocol.ItemReticleConfig toPacket() {
      ...
      if (this.indexedServerEvents != null) {
         ...
         for (Int2ObjectMap.Entry<ItemReticleConfig.ItemReticleWithDuration> event : this.indexedServerEvents.int2ObjectEntrySet()) {
      ...
      if (this.clientEvents != null) {
         ...
         for (Entry<ItemReticleClientEvent, ItemReticleConfig.ItemReticle> event : this.clientEvents.entrySet()) {
