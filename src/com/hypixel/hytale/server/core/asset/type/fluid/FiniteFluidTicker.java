...
public class FiniteFluidTicker extends FluidTicker {
   ...
   private boolean spreadDownwards(
      ...
      if (isSolid(BlockType.getAssetMap().getAsset(belowBlockSection.get(worldX, worldY - 1, worldZ)))) {
         return false;
      }
   ...
   private int getTopY(
      ...
      int topY = worldY;
      FluidSection aboveFluidSection = fluidSection.getY() != ChunkUtil.chunkCoordinate(topY + 1)
         ? accessor.getFluidSectionByBlock(worldX, topY + 1, worldZ)
         : fluidSection;
