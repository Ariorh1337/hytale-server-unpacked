...
public class ScaledXResponseCurve extends ScaledResponseCurve {
   public static final BuilderCodec<ScaledXResponseCurve> CODEC = BuilderCodec.<ScaledXResponseCurve>builder(
         ScaledXResponseCurve.class, ScaledXResponseCurve::new
      )
