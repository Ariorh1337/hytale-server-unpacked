...
public class MultipleItemDropContainer extends ItemDropContainer {
   public static final BuilderCodec<MultipleItemDropContainer> CODEC = BuilderCodec.<ItemDropContainer>builder(
   ...
   public String toString() {
      return "MultipleItemDropContainer{weight=" + this.weight + ", containers=" + Arrays.toString(this.containers) + "}";
   }
}
