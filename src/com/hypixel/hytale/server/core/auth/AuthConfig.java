...
public class AuthConfig {
   ...
   public static final String OAUTH_AUTH_URL = "https://oauth.accounts.butter.lat/oauth2/auth";
   public static final String OAUTH_TOKEN_URL = "https://oauth.accounts.butter.lat/oauth2/token";
   public static final String DEVICE_AUTH_URL = "https://oauth.accounts.butter.lat/oauth2/device/auth";
   public static final String CONSENT_REDIRECT_URL = "https://accounts.butter.lat/consent/client";
   public static final String SESSION_SERVICE_URL = "https://sessions.butter.lat";
   public static final String ACCOUNT_DATA_URL = "https://account-data.butter.lat";
