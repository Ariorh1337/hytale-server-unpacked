...
public class Inventory implements NetworkSerializable<UpdatePlayerInventory> {
   ...
   public static final BuilderCodec<Inventory> CODEC = BuilderCodec.<Inventory>builder(Inventory.class, () -> new Inventory(null))
      .versioned()
      .codecVersion(4)
   ...
   public Inventory(short storageCapacity, short armorCapacity, short hotbarCapacity, short utilityCapacity, short toolCapacity) {
      this(
         storageCapacity == 0 ? EmptyItemContainer.INSTANCE : new SimpleItemContainer(storageCapacity),
         armorCapacity == 0 ? EmptyItemContainer.INSTANCE : new SimpleItemContainer(armorCapacity),
         hotbarCapacity == 0 ? EmptyItemContainer.INSTANCE : new SimpleItemContainer(hotbarCapacity),
         utilityCapacity == 0 ? EmptyItemContainer.INSTANCE : new SimpleItemContainer(utilityCapacity),
         toolCapacity == 0 ? EmptyItemContainer.INSTANCE : new SimpleItemContainer(toolCapacity),
