      ...
      return itemContainer.writeAction(
         () -> {
            ...
            if ((slotItemStack != null || itemStackToRemove == null)
               ...
               return new ItemStackSlotTransaction(
                  false, ActionType.REMOVE, slot, slotItemStack, slotItemStack, null, allOrNothing, false, filter, false, itemStackToRemove, itemStackToRemove
               );
            }
         }
      );
      ...
      if (itemStacks != null && !itemStacks.isEmpty()) {
         ...
         return itemContainer.writeAction(
            () -> {
               ...
               for (short i = 0; i < itemStacks.size(); i++) {
                  short slot = (short)(offset + i);
                  remainingItemStacks.add(internal_addItemStackToSlot(itemContainer, slot, itemStacks.get(i), allOrNothing, filter));
               }
