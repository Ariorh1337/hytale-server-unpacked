...
public class ShapeCodecs {
   ...
   public static final BuilderCodec<Box> BOX = BuilderCodec.<Box>builder(Box.class, Box::new)
      ...
      .build();
   public static final BuilderCodec<Ellipsoid> ELLIPSOID = BuilderCodec.<Ellipsoid>builder(Ellipsoid.class, Ellipsoid::new)
      ...
      .build();
   public static final BuilderCodec<Cylinder> CYLINDER = BuilderCodec.<Cylinder>builder(Cylinder.class, Cylinder::new)
      ...
      .build();
   public static final BuilderCodec<OriginShape<Shape>> ORIGIN_SHAPE = BuilderCodec.<OriginShape>builder(OriginShape.class, OriginShape::new)
