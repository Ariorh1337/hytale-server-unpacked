...
public final class ProtocolCodecs {
   public static final BuilderCodec<Direction> DIRECTION = BuilderCodec.<Direction>builder(Direction.class, Direction::new)
      ...
      .add()
      .build();
   public static final BuilderCodec<Vector2f> VECTOR2F = BuilderCodec.<Vector2f>builder(Vector2f.class, Vector2f::new)
      .metadata(UIDisplayMode.COMPACT)
      ...
      .add()
      .build();
   public static final BuilderCodec<Vector3f> VECTOR3F = BuilderCodec.<Vector3f>builder(Vector3f.class, Vector3f::new)
      .metadata(UIDisplayMode.COMPACT)
      .appendInherited(new KeyedCodec<>("X", Codec.FLOAT), (o, i) -> o.x = i, o -> o.x, (o, p) -> o.x = p.x)
      .add()
      .appendInherited(new KeyedCodec<>("Y", Codec.FLOAT), (o, i) -> o.y = i, o -> o.y, (o, p) -> o.y = p.y)
   ...
   public static final BuilderCodec<Size> SIZE = BuilderCodec.<Size>builder(Size.class, Size::new)
      .metadata(UIDisplayMode.COMPACT)
      ...
      .build();
   public static final BuilderCodec<Range> RANGE = BuilderCodec.<Range>builder(Range.class, Range::new)
      .metadata(UIDisplayMode.COMPACT)
      ...
      .build();
   public static final BuilderCodec<Rangeb> RANGEB = BuilderCodec.<Rangeb>builder(Rangeb.class, Rangeb::new)
      .metadata(UIDisplayMode.COMPACT)
      ...
      .build();
   public static final BuilderCodec<Rangef> RANGEF = BuilderCodec.<Rangef>builder(Rangef.class, Rangef::new)
      .metadata(UIDisplayMode.COMPACT)
      ...
      .build();
   public static final BuilderCodec<RangeVector2f> RANGE_VECTOR2F = BuilderCodec.<RangeVector2f>builder(RangeVector2f.class, RangeVector2f::new)
      ...
      .build();
   public static final BuilderCodec<RangeVector3f> RANGE_VECTOR3F = BuilderCodec.<RangeVector3f>builder(RangeVector3f.class, RangeVector3f::new)
      ...
      .build();
   public static final BuilderCodec<InitialVelocity> INITIAL_VELOCITY = BuilderCodec.<InitialVelocity>builder(InitialVelocity.class, InitialVelocity::new)
   ...
   public static final BuilderCodec<IntersectionHighlight> INTERSECTION_HIGHLIGHT = BuilderCodec.builder(
      ...
      .build();
   public static final BuilderCodec<SavedMovementStates> SAVED_MOVEMENT_STATES = BuilderCodec.<SavedMovementStates>builder(
      ...
      .build();
   public static final BuilderCodec<ContextMenuItem> CONTEXT_MENU_ITEM = BuilderCodec.<ContextMenuItem>builder(ContextMenuItem.class, ContextMenuItem::new)
   ...
   public static final BuilderCodec<MapMarker> MARKER = BuilderCodec.<MapMarker>builder(MapMarker.class, MapMarker::new)
