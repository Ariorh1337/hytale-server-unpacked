...
public final class ArgTypes {
   ...
   private static final ArgumentType<BlockMask> INDIVIDUAL_BLOCK_MASK = new SingleArgumentType<BlockMask>(
      ...
      public void suggest(@Nonnull CommandSender sender, @Nonnull String textAlreadyEntered, int numParametersTyped, @Nonnull SuggestionResult result) {
         if (textAlreadyEntered.isEmpty()) {
            ...
            if (prefix.isEmpty()) {
               for (String p : ArgTypes.MASK_PREFIXES) {
                  if (!p.equals("#") && stripped.startsWith(p)) {
                     prefix = p;
                     stripped = stripped.substring(p.length());
                     break;
                  }
   ...
   public enum IntegerComparisonOperator {
      ...
      IntegerComparisonOperator(BiFunction<Integer, Integer, Boolean> comparisonFunction, String stringRepresentation) {
   ...
   public enum IntegerOperation {
      ...
      IntegerOperation(@Nonnull final BiFunction<Integer, Integer, Integer> operationFunction, @Nonnull final String stringRepresentation) {
