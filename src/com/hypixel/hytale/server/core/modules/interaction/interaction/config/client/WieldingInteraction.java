   ...
   public static final BuilderCodec<WieldingInteraction> CODEC = BuilderCodec.builder(
      ...
      .afterDecode(i -> {
         ...
         if (i.knockbackModifiersRaw != null) {
            ...
            for (Object2DoubleMap.Entry<String> entry : i.knockbackModifiersRaw.object2DoubleEntrySet()) {
         ...
         if (i.damageModifiersRaw != null) {
            ...
            for (Object2FloatMap.Entry<String> entry : i.damageModifiersRaw.object2FloatEntrySet()) {
               int index = DamageCause.getAssetMap().getIndex(entry.getKey());
      ...
      public static final BuilderCodec<WieldingInteraction.AngledWielding> CODEC = BuilderCodec.builder(
         ...
         .afterDecode(o -> {
            if (o.knockbackModifiersRaw != null) {
               ...
               for (Object2DoubleMap.Entry<String> entry : o.knockbackModifiersRaw.object2DoubleEntrySet()) {
                  int index = DamageCause.getAssetMap().getIndex(entry.getKey());
            ...
            if (o.damageModifiersRaw != null) {
               ...
               for (Object2FloatMap.Entry<String> entry : o.damageModifiersRaw.object2FloatEntrySet()) {
                  int index = DamageCause.getAssetMap().getIndex(entry.getKey());
