      ...
      if (executeTriggers && entity instanceof LivingEntity && !this.lastTriggers.isEmpty()) {
         for (Long old : this.lastTriggers) {
            ...
            if (chunk != null) {
               ...
               String interactions = blockType.getInteractions().get(InteractionType.CollisionLeave);
               if (interactions == null) {
                  interactions = fluidType.getInteractions().get(InteractionType.CollisionLeave);
               }
