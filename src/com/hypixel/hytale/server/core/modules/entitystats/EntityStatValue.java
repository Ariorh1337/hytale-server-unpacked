...
public class EntityStatValue {
   ...
   public static final BuilderCodec<EntityStatValue> CODEC = BuilderCodec.<EntityStatValue>builder(EntityStatValue.class, EntityStatValue::new)
   ...
   public String toString() {
      return "EntityStatValue{id='"
         ...
         + this.max
         + ", regeneratingValues="
         + Arrays.toString(this.regeneratingValues)
         + ", modifiers="
         + this.modifiers
         + "}";
   }
