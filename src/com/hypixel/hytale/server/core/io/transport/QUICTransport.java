...
public class QUICTransport implements Transport {
   ...
   public QUICTransport() throws InterruptedException {
      ...
      try {
         ...
         LOGGER.at(Level.WARNING).withCause(e).log("Failed to set SNI mapping via reflection, SNI support disabled");
   ...
   public void shutdown() {
      ...
      try {
         ...
         LOGGER.at(Level.SEVERE).withCause(e).log("Failed to await for listener to close!");
