...
public class EnvironmentColumn {
   ...
   public int serialize(@Nonnull MemorySegment data, int baseOffset) {
      ...
      int n = this.maxYs.size();
      data.set(MemorySegmentUtil.INT_BE, offset, n);
      offset += 4;
   ...
   public int serializeProtocol(@Nonnull MemorySegment data, int baseOffset) {
      int offset = baseOffset;
      int n = this.maxYs.size();
      data.set(MemorySegmentUtil.SHORT_LE, offset, (short)(n + 1));
      offset += 2;
      int min = Integer.MIN_VALUE;

      for (int i = 0; i < n; i++) {
         data.set(MemorySegmentUtil.SHORT_LE, offset, (short)min);
         offset += 2;
         data.set(MemorySegmentUtil.SHORT_LE, offset, (short)this.values.getInt(i));
         offset += 2;
      ...
      data.set(MemorySegmentUtil.SHORT_LE, offset, (short)min);
      offset += 2;
      data.set(MemorySegmentUtil.SHORT_LE, offset, (short)this.values.getInt(n));
      offset += 2;
      return offset - baseOffset;
   }
   ...
   public int deserialize(@Nonnull MemorySegment data, int baseOffset, @Nonnull Int2IntMap idMapping) {
      ...
      this.values.clear();
      int offset = baseOffset;
      int n = data.get(MemorySegmentUtil.INT_BE, offset);
      offset += 4;
      this.maxYs.size(n);
      ...
      for (int i = 0; i <= n; i++) {
         this.values.add(idMapping.get(data.get(MemorySegmentUtil.INT_BE, offset)));
         offset += 4;
      }
