...
public class BlockChunk implements Component<ChunkStore> {
   ...
   public static final BuilderCodec<BlockChunk> CODEC = BuilderCodec.<BlockChunk>builder(BlockChunk.class, BlockChunk::new)
      .versioned()
      .codecVersion(3)
                     ...
                     throwable -> {
                        if (throwable != null) {
                           BlockChunk.LOGGER
                              .at(Level.SEVERE)
                              .withCause(throwable)
                              .log("Exception while compressing set chunk (%d, %d):", (int)component.x, (int)component.z);
                        }
