...
public class EmptyChunkStorageProvider implements IChunkStorageProvider {
   ...
   @Nonnull
   public static final BuilderCodec<EmptyChunkStorageProvider> CODEC = BuilderCodec.<EmptyChunkStorageProvider>builder(
         EmptyChunkStorageProvider.class, () -> INSTANCE
      )
