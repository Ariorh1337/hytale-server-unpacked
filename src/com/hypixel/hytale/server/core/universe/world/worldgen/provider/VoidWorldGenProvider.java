...
public class VoidWorldGenProvider implements IWorldGenProvider {
   ...
   public static final BuilderCodec<VoidWorldGenProvider> CODEC = BuilderCodec.<VoidWorldGenProvider>builder(
         VoidWorldGenProvider.class, VoidWorldGenProvider::new
      )
