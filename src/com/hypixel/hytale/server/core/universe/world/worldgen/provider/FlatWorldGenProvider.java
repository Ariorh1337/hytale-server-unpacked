...
public class FlatWorldGenProvider implements IWorldGenProvider {
   ...
   public static final BuilderCodec<FlatWorldGenProvider> CODEC = BuilderCodec.<FlatWorldGenProvider>builder(
         FlatWorldGenProvider.class, FlatWorldGenProvider::new
      )
   ...
   public String toString() {
      return "FlatWorldGenProvider{tint=" + this.tint + ", layers=" + Arrays.toString(this.layers) + "}";
   }
   ...
   public static class Layer {
      public static final BuilderCodec<FlatWorldGenProvider.Layer> CODEC = BuilderCodec.<FlatWorldGenProvider.Layer>builder(
