...
public class MigrationChunkStorageProvider implements IChunkStorageProvider<MigrationChunkStorageProvider.MigrationData> {
   ...
   @Nonnull
   public static final BuilderCodec<MigrationChunkStorageProvider> CODEC = BuilderCodec.<MigrationChunkStorageProvider>builder(
   ...
   public String toString() {
      return "MigrationChunkStorageProvider{from=" + Arrays.toString(this.from) + ", to=" + this.to + "}";
   }
