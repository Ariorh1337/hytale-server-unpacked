...
public class FitToHeightMapSpawnProvider implements ISpawnProvider {
   @Nonnull
   public static BuilderCodec<FitToHeightMapSpawnProvider> CODEC = BuilderCodec.<FitToHeightMapSpawnProvider>builder(
         FitToHeightMapSpawnProvider.class, FitToHeightMapSpawnProvider::new
      )
      .documentation(
