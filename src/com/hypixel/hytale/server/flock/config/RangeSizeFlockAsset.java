...
public class RangeSizeFlockAsset extends FlockAsset {
   public static final BuilderCodec<RangeSizeFlockAsset> CODEC = BuilderCodec.<FlockAsset>builder(
         RangeSizeFlockAsset.class, RangeSizeFlockAsset::new, ABSTRACT_CODEC
      )
