...
public final class ChunkThreadPoolExecutor extends ThreadPoolExecutor {
   ...
   public ChunkThreadPoolExecutor(
      ...
      LogUtil.getLogger().at(Level.INFO).log("Initialized ChunkGenerator-%d executor", (int)this.generation);
   }

   @Override
   protected void terminated() {
      this.shutdownHook.run();
      LogUtil.getLogger().at(Level.INFO).log("ChunkGenerator-%d executor shutdown complete", (int)this.generation);
   }
}
