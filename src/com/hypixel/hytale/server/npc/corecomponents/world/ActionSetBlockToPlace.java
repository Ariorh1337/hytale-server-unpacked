...
public class ActionSetBlockToPlace extends ActionBase {
   ...
   public boolean canExecute(
      ...
      return super.canExecute(ref, executionSupport, sensorInfo, dt, store) && BlockType.getAssetMap().getAsset(this.blockType) != null;
   }
   ...
   public boolean execute(
      ...
      executionSupport.getWorldSupport().setBlockToPlace(this.blockType);
      return true;
   }
}
