   ...
   public boolean computeSteering(
      ...
      if (sensorInfo != null && sensorInfo.getPositionProvider() != null) {
         ...
         if (this.state == BodyMotionCharge.ChargeState.Aiming) {
            ...
            boolean startedNewSegment = this.railPath.getCursor() != oldCursor || oldSegmentProgress <= 1.0E-6 && this.railPath.getSegmentProgress() > 1.0E-6;
            ...
            if (this.state != BodyMotionCharge.ChargeState.Obstructed && this.state != BodyMotionCharge.ChargeState.Finished) {
