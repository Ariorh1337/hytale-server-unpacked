...
public class ActionAttack extends ActionBase {
   ...
   public boolean execute(@Nonnull Ref<EntityStore> ref, @Nonnull Role role, @Nullable InfoProvider sensorInfo, double dt, @Nonnull Store<EntityStore> store) {
      ...
      if (!this.checkLineOfSight || target != null && role.getPositionCache().hasLineOfSight(ref, target, store)) {
         ...
         InteractionChain chain = interactionManagerComponent.initChain(
            this.interactionType, context, RootInteraction.getRootInteractionOrUnknown(this.attackInteraction), false
         );
   ...
   public enum AttackType implements Supplier<String> {
      ...
      AttackType(InteractionType interactionType, String description) {
   ...
   public enum BallisticMode implements Supplier<String> {
      ...
      BallisticMode(String description) {
         this.description = description;
      }
