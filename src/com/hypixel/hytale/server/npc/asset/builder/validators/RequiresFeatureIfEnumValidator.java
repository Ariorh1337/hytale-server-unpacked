...
public class RequiresFeatureIfEnumValidator<E extends Enum<E> & Supplier<String>> extends RequiredFeatureValidator {
   ...
   public static <E extends Enum<E> & Supplier<String>> boolean staticValidate(
      @Nonnull FeatureEvaluatorHelper evaluatorHelper, EnumSet<Feature> requiredFeature, E requiredValue, E value
   ) {
   ...
   @Nonnull
   public static <E extends Enum<E> & Supplier<String>> RequiresFeatureIfEnumValidator withAttributes(
      String attribute, E value, @Nonnull EnumSet<Feature> feature
   ) {
