...
public interface Action extends RoleStateChange, IAnnotatedComponent, IComponentExecutionControl {
   ...
   boolean execute(@Nonnull Ref<EntityStore> var1, @Nonnull ExecutionSupport var2, @Nullable InfoProvider var3, double var4, @Nonnull Store<EntityStore> var6);

   void activate(ExecutionSupport var1, InfoProvider var2);

   void deactivate(ExecutionSupport var1, InfoProvider var2);
