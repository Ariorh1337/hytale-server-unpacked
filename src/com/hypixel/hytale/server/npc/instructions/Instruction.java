...
public class Instruction implements RoleStateChange, IAnnotatedComponentCollection {
   ...
   public <T extends BodyMotion> T findNearestPrecedingBodyMotion(@Nonnull Class<T> clazz) {
      ...
      if (this.parent instanceof Instruction parentInstruction) {
   ...
   public IAnnotatedComponent getComponent(int index) {
      ...
      if (index < this.componentCount()) {
         if (this.bodyMotion != null) {
            return this.headMotion != null && index == this.componentCount() - 1 ? this.headMotion : this.bodyMotion;
         } else {
            return this.headMotion != null ? this.headMotion : this.instructionList[index - 1];
         }
      } else {
