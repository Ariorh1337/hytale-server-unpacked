...
public class FrustumProjectionProvider implements MatrixProvider {
   public static final BuilderCodec<FrustumProjectionProvider> CODEC = BuilderCodec.<FrustumProjectionProvider>builder(
         FrustumProjectionProvider.class, FrustumProjectionProvider::new
      )
