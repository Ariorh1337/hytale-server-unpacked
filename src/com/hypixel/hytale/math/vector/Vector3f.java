...
public class Vector3f {
   @Nonnull
   public static final BuilderCodec<Vector3f> CODEC = BuilderCodec.<Vector3f>builder(Vector3f.class, () -> new Vector3f(Float.NaN, Float.NaN, Float.NaN))
      ...
      .build();
   @Nonnull
   public static final BuilderCodec<Vector3f> ROTATION = BuilderCodec.<Vector3f>builder(Vector3f.class, () -> new Vector3f(Float.NaN, Float.NaN, Float.NaN))
      .metadata(UIDisplayMode.COMPACT)
