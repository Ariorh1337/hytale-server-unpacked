...
public class StringSchema extends Schema {
   ...
   public static class CommonAsset {
      public static final BuilderCodec<StringSchema.CommonAsset> CODEC = BuilderCodec.<StringSchema.CommonAsset>builder(
            StringSchema.CommonAsset.class, StringSchema.CommonAsset::new
         )
