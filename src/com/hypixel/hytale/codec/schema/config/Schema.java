...
public class Schema {
   ...
   private static class ArrayOrNull implements Codec<String[]> {
      ...
      public BsonValue encode(@Nullable String[] o, ExtraInfo extraInfo) {
         return o != null ? Codec.STRING_ARRAY.encode(o, extraInfo) : new BsonNull();
      }
   ...
   public static class HytaleMetadata {
      public static final BuilderCodec<Schema.HytaleMetadata> CODEC = BuilderCodec.<Schema.HytaleMetadata>builder(
            Schema.HytaleMetadata.class, Schema.HytaleMetadata::new
         )
                                                   ...
                                                   if (this.uiRebuildCachesForChildProperties != null
                                                      ...
                                                      if (!Arrays.equals(this.uiSidebarButtons, that.uiSidebarButtons)) {
                                                         ...
                                                         return (
                                                            ...
                                                            ? Arrays.equals(this.uiCreateButtons, that.uiCreateButtons)
                                                            : false;
                                                      }
                                                   } else {
                                                      return false;
      ...
      public int hashCode() {
         ...
         return 31 * result + Arrays.hashCode(this.uiCreateButtons);
      }
   }

   public static class InheritSettings {
      public static final BuilderCodec<Schema.InheritSettings> CODEC = BuilderCodec.<Schema.InheritSettings>builder(
            Schema.InheritSettings.class, Schema.InheritSettings::new
         )
   ...
   public static class SchemaTypeField {
      public static final BuilderCodec<Schema.SchemaTypeField> CODEC = BuilderCodec.<Schema.SchemaTypeField>builder(
            Schema.SchemaTypeField.class, Schema.SchemaTypeField::new
         )
