...
public class UIEditor implements Metadata {
   ...
   public static class Dropdown implements UIEditor.EditorComponent {
      public static final BuilderCodec<UIEditor.Dropdown> CODEC = BuilderCodec.<UIEditor.Dropdown>builder(UIEditor.Dropdown.class, UIEditor.Dropdown::new)
   ...
   public static class FormattedNumber implements UIEditor.EditorComponent {
      public static final BuilderCodec<UIEditor.FormattedNumber> CODEC = BuilderCodec.<UIEditor.FormattedNumber>builder(
            UIEditor.FormattedNumber.class, UIEditor.FormattedNumber::new
         )
   ...
   public static class Icon implements UIEditor.EditorComponent {
      public static final BuilderCodec<UIEditor.Icon> CODEC = BuilderCodec.<UIEditor.Icon>builder(UIEditor.Icon.class, UIEditor.Icon::new)
   ...
   public static class LocalizationKeyField implements UIEditor.EditorComponent {
      public static final BuilderCodec<UIEditor.LocalizationKeyField> CODEC = BuilderCodec.<UIEditor.LocalizationKeyField>builder(
   ...
   public static class TextField implements UIEditor.EditorComponent {
      public static final BuilderCodec<UIEditor.TextField> CODEC = BuilderCodec.<UIEditor.TextField>builder(UIEditor.TextField.class, UIEditor.TextField::new)
         .addField(new KeyedCodec<>("dataSet", Codec.STRING, false, true), (o, i) -> o.dataSet = i, o -> o.dataSet)
         .build();
      private String dataSet;
