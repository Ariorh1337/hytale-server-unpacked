...
public class HytaleLogger extends AbstractLogger<HytaleLogger.Api> {
   ...
   public HytaleLogger.Api at(@Nonnull Level level) {
      return this.isLoggable(level) ? new HytaleLogger.Context(level) : NO_OP;
   }
   ...
   private static final class NoOp extends LoggingApi.NoOp<HytaleLogger.Api> implements HytaleLogger.Api {
   }
}
