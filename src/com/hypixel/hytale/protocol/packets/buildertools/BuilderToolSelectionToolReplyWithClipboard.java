...
public class BuilderToolSelectionToolReplyWithClipboard implements Packet {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof BuilderToolSelectionToolReplyWithClipboard other)
            ? false
            : Arrays.equals(this.blocksChange, other.blocksChange) && Arrays.equals(this.fluidsChange, other.fluidsChange);
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * result + Arrays.hashCode(this.fluidsChange);
   }
}
