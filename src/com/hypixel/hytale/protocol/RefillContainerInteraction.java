...
public class RefillContainerInteraction extends SimpleBlockInteraction {
   ...
   public static RefillContainerInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         if (varPos5 + varIntLen + refillFluidsCount * 4L > buf.readableBytes()) {
         ...
         for (int i = 0; i < refillFluidsCount; i++) {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         int pos = offset + 44 + refillFluidsOffset;
         if (pos >= buffer.writerIndex()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof RefillContainerInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Arrays.hashCode(this.refillFluids);
   }
}
