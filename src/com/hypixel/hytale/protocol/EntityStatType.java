...
public class EntityStatType {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         int pos = offset + 26 + minValueEffectsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits & 4) != 0) {
         ...
         int pos = offset + 26 + maxValueEffectsOffset;
         if (pos >= buffer.writerIndex()) {
   ...
   @Override
   public int hashCode() {
      return Objects.hash(this.id, this.value, this.min, this.max, this.minValueEffects, this.maxValueEffects, this.resetBehavior);
   }
}
