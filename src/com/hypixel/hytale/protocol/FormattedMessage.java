...
public class FormattedMessage {
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         int pos = offset + 38 + messageIdOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits & 4) != 0) {
         ...
         int pos = offset + 38 + childrenOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits & 8) != 0) {
         ...
         int pos = offset + 38 + paramsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits & 16) != 0) {
         ...
         int pos = offset + 38 + messageParamsOffset;
         if (pos >= buffer.writerIndex()) {
