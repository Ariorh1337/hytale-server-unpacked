...
public class BoxBreakShape extends BreakShape {
   ...
   @Nonnull
   public static BoxBreakShape deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 27) {
         throw ProtocolException.bufferTooSmall("BoxBreakShape", 27, buf.readableBytes() - offset);
      }

      BoxBreakShape obj = new BoxBreakShape();
   ...
   public static BoxBreakShape toObject(MemorySegment mem, int offset) {
      if (offset + 27 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("BoxBreakShape", offset + 27, (int)mem.byteSize());
      } else {
         return new BoxBreakShape(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof BoxBreakShape other)
            ? false
            : this.width == other.width
               && this.height == other.height
               && this.depth == other.depth
