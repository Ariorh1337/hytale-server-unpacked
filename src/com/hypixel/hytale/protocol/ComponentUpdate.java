...
public class ComponentUpdate {
   ...
   public static ComponentUpdate deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      obj.isProp = buf.getByte(offset + 159) != 0;
      if ((nullBits[0] & 16) != 0) {
      ...
      if ((nullBits[0] & 32) != 0) {
         ...
         if (varPos1 + varIntLen + entityUIComponentsCount * 4L > buf.readableBytes()) {
      ...
      if ((nullBits[1] & 16) != 0) {
         ...
         if (varPos8 + varIntLen + entityEffectUpdatesCount * 12L > buf.readableBytes()) {
      ...
      if ((nullBits[1] & 64) != 0) {
         ...
         if (varPos10 + varIntLen + soundEventIdsCount * 4L > buf.readableBytes()) {
         ...
         for (int i = 0; i < soundEventIdsCount; i++) {
            obj.soundEventIds[i] = buf.getIntLE(varPos10 + varIntLen + i * 4);
         }
      }
      ...
      if ((nullBits[2] & 1) != 0) {
         ...
         for (int i = 0; i < activeAnimationsCount; i++) {
            if ((activeAnimationsBitfield[i / 8] & 1 << i % 8) != 0) {
               ...
               obj.activeAnimations[i] = PacketIO.readVarString(buf, elemPos);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits[0] & 16) != 0) {
         ...
         int pos = offset + 212 + nameplateOffset;
      ...
      if ((nullBits[0] & 32) != 0) {
         ...
         int pos = offset + 212 + entityUIComponentsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[0] & 64) != 0) {
         ...
         int pos = offset + 212 + combatTextUpdateOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[0] & 128) != 0) {
         ...
         int pos = offset + 212 + modelOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 4) != 0) {
         ...
         int pos = offset + 212 + equipmentOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 8) != 0) {
         ...
         int pos = offset + 212 + entityStatUpdatesOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 16) != 0) {
         ...
         int pos = offset + 212 + entityEffectUpdatesOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 32) != 0) {
         ...
         int pos = offset + 212 + interactionsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 64) != 0) {
         ...
         int pos = offset + 212 + soundEventIdsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[1] & 128) != 0) {
         ...
         int pos = offset + 212 + interactionHintOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if ((nullBits[2] & 1) != 0) {
         ...
         int pos = offset + 212 + activeAnimationsOffset;
         if (pos >= buffer.writerIndex()) {
      ...
      if (this == obj) {
         ...
         return !(obj instanceof ComponentUpdate other)
            ...
            : Objects.equals(this.type, other.type)
               ...
               && Arrays.equals(this.entityEffectUpdates, other.entityEffectUpdates)
               ...
               && Arrays.equals(this.activeAnimations, other.activeAnimations)
               && this.isProp == other.isProp;
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * result + Boolean.hashCode(this.isProp);
   }
}
