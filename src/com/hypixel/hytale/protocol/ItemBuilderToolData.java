...
public class ItemBuilderToolData {
   ...
   public static ItemBuilderToolData deserialize(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         if (varPos1 + varIntLen + toolsCount * 2L > buf.readableBytes()) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof ItemBuilderToolData other) ? false : Arrays.equals(this.ui, other.ui) && Arrays.equals(this.tools, other.tools);
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * result + Arrays.hashCode(this.tools);
   }
}
