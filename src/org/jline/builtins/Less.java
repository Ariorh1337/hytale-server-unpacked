...
public class Less {
   ...
   private void addFile() throws IOException, InterruptedException {
      ...
      Less.LineEditor lineEditor = new Less.LineEditor(begPos);
   ...
   void moveForward(int lines) throws IOException {
      ...
      while (--lines >= 0) {
         ...
         Less.Pair<Integer, AttributedString> nextLine = this.nextLine2display(this.firstLineToDisplay, dpCompiled);
         AttributedString line = nextLine.getV();
