...
public class JcaContentSignerBuilder {
   ...
   public ContentSigner build(PrivateKey var1) throws OperatorCreationException {
      ...
      try {
         ...
         return this.signatureDigestAlgorithm != null ? new ExtendedContentSigner() {
   ...
   private ContentSigner buildComposite(CompositePrivateKey var1) throws OperatorCreationException {
      try {
         ...
         OutputStream var8 = OutputStreamFactory.createStream(var4[0]);

         for (int var6 = 1; var6 != var4.length; var6++) {
            var8 = new TeeOutputStream(var8, OutputStreamFactory.createStream(var4[var6]));
         }

         final OutputStream var9 = var8;
         return new ContentSigner() {
            OutputStream stream = var9;
