...
class NTRUPlusCipherSpi extends CipherSpi {
   ...
   NTRUPlusCipherSpi(String var1) throws NoSuchAlgorithmException {
      this.algorithmName = var1;
   }

   NTRUPlusCipherSpi(NTRUPlusParameters var1) {
   ...
   protected void engineInit(int var1, Key var2, AlgorithmParameterSpec var3, SecureRandom var4) throws InvalidKeyException, InvalidAlgorithmParameterException {
      ...
      if (var1 == 3) {
         if (!(var2 instanceof BCNTRUPlusPublicKey)) {
            throw new InvalidKeyException("Only a " + this.algorithmName + " public key can be used for wrapping");
         }

         this.wrapKey = (BCNTRUPlusPublicKey)var2;
         this.kemGen = new NTRUPlusKEMGenerator(CryptoServicesRegistrar.getSecureRandom(var4));
      } else {
         if (var1 != 4) {
            throw new InvalidParameterException("Cipher only valid for wrapping/unwrapping");
         }

         if (!(var2 instanceof BCNTRUPlusPrivateKey)) {
            throw new InvalidKeyException("Only a " + this.algorithmName + " private key can be used for unwrapping");
         }

         this.unwrapKey = (BCNTRUPlusPrivateKey)var2;
      }

      if (this.ntruplusParameters != null) {
         String var5 = Strings.toUpperCase(this.ntruplusParameters.getName());
   ...
   protected byte[] engineWrap(Key var1) throws IllegalBlockSizeException, InvalidKeyException {
      ...
      try {
         ...
         KeyParameter var5 = new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), var3.getSecret()));
         var4.init(true, var5);
   ...
   protected Key engineUnwrap(byte[] var1, String var2, int var3) throws InvalidKeyException, NoSuchAlgorithmException {
      ...
      try {
         NTRUPlusKEMExtractor var4 = new NTRUPlusKEMExtractor(this.unwrapKey.getKeyParams());
         byte[] var5 = var4.extractSecret(Arrays.copyOfRange(var1, 0, var4.getEncapsulationLength()));
         Wrapper var6 = WrapUtil.getWrapper(this.kemParameterSpec.getKeyAlgorithmName());
         KeyParameter var7 = new KeyParameter(WrapUtil.trimSecret(this.kemParameterSpec.getKeyAlgorithmName(), var5));
         Arrays.clear(var5);
   ...
   public static class Base extends NTRUPlusCipherSpi {
      public Base() throws NoSuchAlgorithmException {
         super("NTRU+");
      }
   }

   public static class NTRUPlus1152 extends NTRUPlusCipherSpi {
      public NTRUPlus1152() {
         super(NTRUPlusParameters.ntruplus_kem_1152);
      }
   }

   public static class NTRUPlus768 extends NTRUPlusCipherSpi {
      public NTRUPlus768() {
         super(NTRUPlusParameters.ntruplus_kem_864);
      }
   }

   public static class NTRUPlus864 extends NTRUPlusCipherSpi {
      public NTRUPlus864() {
         super(NTRUPlusParameters.ntruplus_kem_864);
      }
   }
