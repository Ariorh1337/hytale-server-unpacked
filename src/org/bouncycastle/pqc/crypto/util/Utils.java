...
class Utils {
   ...
   static ASN1ObjectIdentifier slhdsaOidLookup(SLHDSAParameters var0) {
      return (ASN1ObjectIdentifier)slhdsaOids.get(var0);
   }

   static SLHDSAParameters slhdsaParamsLookup(ASN1ObjectIdentifier var0) {
      return (SLHDSAParameters)slhdsaParams.get(var0);
   }
   ...
   static ASN1ObjectIdentifier mayoOidLookup(MayoParameters var0) {
      return (ASN1ObjectIdentifier)mayoOids.get(var0);
   }

   static MayoParameters mayoParamsLookup(ASN1ObjectIdentifier var0) {
      return (MayoParameters)mayoParams.get(var0);
   }

   static ASN1ObjectIdentifier snovaOidLookup(SnovaParameters var0) {
      return (ASN1ObjectIdentifier)snovaOids.get(var0);
   }

   static SnovaParameters snovaParamsLookup(ASN1ObjectIdentifier var0) {
      return (SnovaParameters)snovaParams.get(var0);
   }

   static NTRUPlusParameters ntruPlusParamsLookup(ASN1ObjectIdentifier var0) {
      return (NTRUPlusParameters)ntruPlusParams.get(var0);
   }

   static ASN1ObjectIdentifier ntruPlusOidLookup(NTRUPlusParameters var0) {
      return (ASN1ObjectIdentifier)ntruPlusOids.get(var0);
   }

   private static boolean isRaw(byte[] var0) {
      ByteArrayInputStream var1 = new ByteArrayInputStream(var0);
      int var2 = var1.read();
      int var3 = readLen(var1);
      return var3 != var1.available();
   }

   static ASN1OctetString parseOctetData(byte[] var0) {
      return !isRaw(var0) && var0[0] == 4 ? ASN1OctetString.getInstance(var0) : null;
   }

   static ASN1Primitive parseData(byte[] var0) {
      if (!isRaw(var0)) {
         if (var0[0] == 48) {
            return ASN1Sequence.getInstance(var0);
         }

         if (var0[0] == 4) {
            return ASN1OctetString.getInstance(var0);
         }

         if ((var0[0] & 255) == 128) {
            return ASN1OctetString.getInstance(ASN1TaggedObject.getInstance(var0), false);
         }
      }
