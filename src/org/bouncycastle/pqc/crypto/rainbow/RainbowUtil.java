...
class RainbowUtil {
   public static short[] convertArray(byte[] var0) {
      ...
      for (int var2 = 0; var2 < var0.length; var2++) {
         var1[var2] = (short)(var0[var2] & 0xFF);
      }
   ...
   public static short[][] generate_random_2d(SecureRandom var0, int var1, int var2) {
      ...
      for (int var5 = 0; var5 < var2; var5++) {
         for (int var6 = 0; var6 < var1; var6++) {
            var4[var6][var5] = (short)(var3[var5 * var1 + var6] & 0xFF);
         }
      }
      ...
      for (int var9 = 0; var9 < var2; var9++) {
         for (int var10 = 0; var10 < var3; var10++) {
            for (int var11 = 0; var11 < var1; var11++) {
               if (!var4 || var9 <= var10) {
                  var8[var11][var9][var10] = (short)(var6[var7++] & 0xFF);
               }
            }
         }
      }
   ...
   public static int loadEncoded(short[][] var0, byte[] var1, int var2) {
      ...
      for (int var5 = 0; var5 < var4; var5++) {
         for (int var6 = 0; var6 < var3; var6++) {
            var0[var6][var5] = (short)(var1[var2 + var5 * var3 + var6] & 0xFF);
         }
      }
      ...
      for (int var8 = 0; var8 < var5; var8++) {
         for (int var9 = 0; var9 < var6; var9++) {
            for (int var10 = 0; var10 < var4; var10++) {
               if (!var3 || var8 <= var9) {
                  var0[var10][var8][var9] = (short)(var1[var2 + var7++] & 0xFF);
               }
            }
         }
      }
