...
public final class XMSSPublicKeyParameters extends XMSSKeyParameters implements XMSSStoreableObjectInterface, Encodable {
   ...
   private XMSSPublicKeyParameters(XMSSPublicKeyParameters.Builder var1) {
   ...
   public static class Builder {
      ...
      public XMSSPublicKeyParameters.Builder withRoot(byte[] var1) {
         this.root = XMSSUtil.cloneArray(var1);
         return this;
      }

      public XMSSPublicKeyParameters.Builder withPublicSeed(byte[] var1) {
         this.publicSeed = XMSSUtil.cloneArray(var1);
         return this;
      }

      public XMSSPublicKeyParameters.Builder withPublicKey(byte[] var1) {
