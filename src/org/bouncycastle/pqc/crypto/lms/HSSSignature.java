...
class HSSSignature implements Encodable {
   ...
   public static HSSSignature getInstance(Object var0, int var1) throws IOException {
      ...
      if (var0 instanceof DataInputStream) {
         ...
         LMSSignedPubKey[] var3 = new LMSSignedPubKey[var8];
         if (var8 != 0) {
            for (int var4 = 0; var4 < var3.length; var4++) {
               var3[var4] = new LMSSignedPubKey(LMSSignature.getInstance(var0), LMSPublicKeyParameters.getInstance(var0));
            }
         }

         LMSSignature var9 = LMSSignature.getInstance(var0);
         return new HSSSignature(var8, var3, var9);
   ...
   public boolean equals(Object var1) {
      if (this == var1) {
         ...
         return this.lMinus1 == var2.lMinus1 && Arrays.areEqual(this.signedPubKey, var2.signedPubKey) && Objects.areEqual(this.signature, var2.signature);
      } else {
         return false;
      }
   }
   ...
   public int hashCode() {
      ...
      var1 = 31 * var1 + Arrays.hashCode(this.signedPubKey);
      return 31 * var1 + Objects.hashCode(this.signature);
   }
