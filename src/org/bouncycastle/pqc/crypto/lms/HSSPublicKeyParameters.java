...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
   ...
   public static HSSPublicKeyParameters getInstance(Object var0) throws IOException {
      ...
      if (var0 instanceof DataInputStream) {
         ...
         LMSPublicKeyParameters var2 = LMSPublicKeyParameters.getInstance(var0);
         return new HSSPublicKeyParameters(var6, var2);
      }
   ...
   public int hashCode() {
      int var1 = this.l;
      return 31 * var1 + this.lmsPublicKey.hashCode();
   }
