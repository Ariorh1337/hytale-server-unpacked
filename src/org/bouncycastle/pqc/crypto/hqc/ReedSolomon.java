...
class ReedSolomon {
   ...
   static void decode(byte[] var0, byte[] var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      int[] var10 = new int[2 * var4];
      computeSyndromes(var10, var9, var4, var2);
      int[] var11 = new int[var7];
      int var12 = computeELP(var11, var10, var4);
      int[] var13 = new int[256];
      byte[] var14 = new byte[256];
      FastFourierTransform.fastFourierTransform(var13, var11, var4 + 1, var3);
      FastFourierTransform.fastFourierTransformGetError(var14, var13, var8, logArrays);
      int[] var15 = new int[var2];
      computeZx(var15, var11, var12, var10, var4);
      int[] var16 = new int[var2];
      computeErrors(var16, var15, var14, var4, var2);

      for (int var17 = 0; var17 < var2; var17++) {
         var9[var17] = (byte)(var9[var17] ^ var16[var17]);
      }

      byte[] var18 = new byte[var5];
      System.arraycopy(var9, var6 - 1, var18, 0, var5);
      System.arraycopy(var18, 0, var0, 0, var0.length);
   }

   private static void computeSyndromes(int[] var0, byte[] var1, int var2, int var3) {
      if (var3 == 46) {
         computeSyndromes(var0, var1, var2, var3, alpha128);
      } else if (var3 == 56) {
         computeSyndromes(var0, var1, var2, var3, alpha192);
      } else if (var3 == 90) {
         computeSyndromes(var0, var1, var2, var3, alpha256);
      }
   }
   ...
   private static int computeELP(int[] var0, int[] var1, int var2) {
      var0[0] = 1;
      int var3 = 0;
      int var4 = 0;
