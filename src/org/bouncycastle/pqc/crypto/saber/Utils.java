...
class Utils {
   ...
   public void POLT2BS(byte[] var1, int var2, short[] var3) {
      if (this.SABER_ET == 3) {
         ...
         for (short var7 = 0; var7 < this.SABER_N / 2; var7++) {
            short var9 = var7;
            short var11 = (short)(2 * var7);
            var1[var2 + var9] = (byte)(var3[var11] & 15 | (var3[var11 + 1] & 15) << 4);
         }
      } else if (this.SABER_ET == 6) {
         for (short var8 = 0; var8 < this.SABER_N / 4; var8++) {
            short var10 = (short)(3 * var8);
            short var12 = (short)(4 * var8);
            var1[var2 + var10 + 0] = (byte)(var3[var12 + 0] & 63 | (var3[var12 + 1] & 3) << 6);
            var1[var2 + var10 + 1] = (byte)(var3[var12 + 1] >> 2 & 15 | (var3[var12 + 2] & 15) << 4);
            var1[var2 + var10 + 2] = (byte)(var3[var12 + 2] >> 4 & 3 | (var3[var12 + 3] & 63) << 2);
         }
      }
   }
   ...
   public void BS2POLT(byte[] var1, int var2, short[] var3) {
      if (this.SABER_ET == 3) {
         ...
         for (short var7 = 0; var7 < this.SABER_N / 2; var7++) {
            short var9 = var7;
            short var11 = (short)(2 * var7);
            var3[var11] = (short)(var1[var2 + var9] & 15);
            var3[var11 + 1] = (short)(var1[var2 + var9] >> 4 & 15);
         }
      } else if (this.SABER_ET == 6) {
         for (short var8 = 0; var8 < this.SABER_N / 4; var8++) {
            short var10 = (short)(3 * var8);
            short var12 = (short)(4 * var8);
            var3[var12 + 0] = (short)(var1[var2 + var10 + 0] & 63);
            var3[var12 + 1] = (short)(var1[var2 + var10 + 0] >> 6 & 3 | (var1[var2 + var10 + 1] & 15) << 2);
            var3[var12 + 2] = (short)((var1[var2 + var10 + 1] & 255) >> 4 | (var1[var2 + var10 + 2] & 3) << 4);
            var3[var12 + 3] = (short)((var1[var2 + var10 + 2] & 255) >> 2);
         }
      }
   }
   ...
   private void BS2POLq(byte[] var1, int var2, short[] var3) {
      if (!this.usingEffectiveMasking) {
         for (short var4 = 0; var4 < this.SABER_N / 8; var4++) {
            short var5 = (short)(13 * var4);
            short var6 = (short)(8 * var4);
            var3[var6 + 0] = (short)(var1[var2 + var5 + 0] & 0xFF | (var1[var2 + var5 + 1] & 31) << 8);
         ...
         for (short var7 = 0; var7 < this.SABER_N / 2; var7++) {
            short var8 = (short)(3 * var7);
            short var9 = (short)(2 * var7);
            var3[var9 + 0] = (short)(var1[var2 + var8 + 0] & 0xFF | (var1[var2 + var8 + 1] & 15) << 8);
   ...
   private void POLp2BS(byte[] var1, int var2, short[] var3) {
      for (short var4 = 0; var4 < this.SABER_N / 4; var4++) {
         ...
         var1[var2 + var5 + 4] = (byte)(var3[var6 + 3] >> 2 & 0xFF);
      }
   }
   ...
   public void BS2POLp(byte[] var1, int var2, short[] var3) {
      for (short var4 = 0; var4 < this.SABER_N / 4; var4++) {
         short var5 = (short)(5 * var4);
         short var6 = (short)(4 * var4);
         var3[var6 + 0] = (short)(var1[var2 + var5 + 0] & 0xFF | (var1[var2 + var5 + 1] & 3) << 8);
