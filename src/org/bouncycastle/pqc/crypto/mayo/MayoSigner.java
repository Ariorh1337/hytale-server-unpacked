...
public class MayoSigner implements MessageSigner {
      ...
      try {
         ...
         for (int var53 = 0; var53 <= 255; var53++) {
            ...
            for (int var55 = 0; var55 < var2; var55++) {
               GF16.decode(var19, var55 * var7, var20, var55 * var3, var3);
            }
         ...
         for (int var58 = 0; var54 < var2; var58 += var3) {
            GF16Utils.matMul(var30, var24, var56, var52, var4, var3);
            Bytes.xor(var3, var20, var58, var52, var26, var57);
            System.arraycopy(var24, var56, var26, var57 + var3, var4);
            var54++;
            var56 += var4;
            var57 += var5;
         }
         ...
         return Arrays.concatenate(var28, var1);
      } finally {
   ...
   private static void transpose16x16Nibbles(long[] var0, int var1) {
      ...
      for (int var9 = 0; var9 < 4; var9++) {
         var11 = var1 + var9;
         long var18 = (var0[var11] >>> 16 ^ var0[var11 + 4]) & 281470681808895L;
         long var20 = (var0[var11 + 8] >>> 16 ^ var0[var11 + 12]) & 281470681808895L;
         var0[var11] ^= var18 << 16;
         var0[var11 + 8] = var0[var11 + 8] ^ var20 << 16;
         var0[var11 + 4] = var0[var11 + 4] ^ var18;
         var0[var11 + 12] = var0[var11 + 12] ^ var20;
      }

      for (int var10 = 0; var10 < 8; var10++) {
         var11 = var1 + var10;
         long var19 = (var0[var11] >>> 32 ^ var0[var11 + 8]) & 4294967295L;
         var0[var11] ^= var19 << 32;
         var0[var11 + 8] = var0[var11 + 8] ^ var19;
      }
   }
         ...
         for (int var16 = var27; var16 <= var15; var16++) {
            ...
            for (int var21 = var8 - 1; var19 < var27; var21 += var8 << 3) {
               ...
               for (int var25 = 0; var24 < 8; var25 += var8) {
                  var22 ^= (long)(var1[var20 + var25] & 0xFF) << (var24 << 3);
                  var24++;
               }
