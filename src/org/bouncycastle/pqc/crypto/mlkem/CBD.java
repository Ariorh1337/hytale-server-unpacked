...
final class CBD {
   ...
   private static long convertByteTo32BitUnsignedInt(byte[] var0, int var1) {
      long var2 = var0[var1] & 0xFF;
      var2 |= (long)(var0[var1 + 1] & 0xFF) << 8;
      var2 |= (long)(var0[var1 + 2] & 0xFF) << 16;
      return var2 | (long)(var0[var1 + 3] & 0xFF) << 24;
   }

   private static long convertByteTo24BitUnsignedInt(byte[] var0, int var1) {
      long var2 = var0[var1] & 0xFF;
      var2 |= (long)(var0[var1 + 1] & 0xFF) << 8;
      return var2 | (long)(var0[var1 + 2] & 0xFF) << 16;
   }
}
