...
class PolyVec {
         ...
         for (int var1 = 0; var1 < this.kyberK; var1++) {
            for (int var2 = 0; var2 < 64; var2++) {
               for (int var3 = 0; var3 < 4; var3++) {
                  long var7 = this.getVectorIndex(var1).getCoeffIndex(4 * var2 + var3);
                  var7 <<= 10;
                  var7 += 1665L;
                  var7 *= 1290167L;
                  var7 >>= 32;
                  var7 &= 1023L;
                  var4[var3] = (short)var7;
               }
         ...
         for (int var9 = 0; var9 < this.kyberK; var9++) {
            for (int var10 = 0; var10 < 32; var10++) {
               for (int var11 = 0; var11 < 8; var11++) {
                  long var18 = this.getVectorIndex(var9).getCoeffIndex(8 * var10 + var11);
                  var18 <<= 11;
                  var18 += 1664L;
                  var18 *= 645084L;
                  var18 >>= 31;
                  var18 &= 2047L;
                  var12[var11] = (short)var18;
               }
      ...
      if (this.engine.getKyberPolyVecCompressedBytes() == this.kyberK * 320) {
         ...
         for (int var7 = 0; var7 < this.kyberK; var7++) {
            for (int var8 = 0; var8 < 32; var8++) {
               var10[0] = (short)((var1[var5] & 255) >> 0 | (short)(var1[var5 + 1] & 0xFF) << 8);
               var10[1] = (short)((var1[var5 + 1] & 255) >> 3 | (short)(var1[var5 + 2] & 0xFF) << 5);
               var10[2] = (short)((var1[var5 + 2] & 255) >> 6 | (short)(var1[var5 + 3] & 0xFF) << 2 | (short)((var1[var5 + 4] & 255) << 10));
               var10[3] = (short)((var1[var5 + 4] & 255) >> 1 | (short)(var1[var5 + 5] & 0xFF) << 7);
               var10[4] = (short)((var1[var5 + 5] & 255) >> 4 | (short)(var1[var5 + 6] & 0xFF) << 4);
               var10[5] = (short)((var1[var5 + 6] & 255) >> 7 | (short)(var1[var5 + 7] & 0xFF) << 1 | (short)((var1[var5 + 8] & 255) << 9));
               var10[6] = (short)((var1[var5 + 8] & 255) >> 2 | (short)(var1[var5 + 9] & 0xFF) << 6);
               var10[7] = (short)((var1[var5 + 9] & 255) >> 5 | (short)(var1[var5 + 10] & 0xFF) << 3);
               var5 += 11;
   ...
   static int checkModulus(MLKEMEngine var0, byte[] var1) {
      ...
      for (int var4 = var0.getKyberK(); var3 < var4; var3++) {
