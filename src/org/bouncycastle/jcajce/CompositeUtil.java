...
class CompositeUtil {
   ...
   static ASN1ObjectIdentifier getOid(String var0) {
      ASN1ObjectIdentifier var1 = algorithmOids.get(Strings.toUpperCase(var0));
      if (var1 == null) {
         throw new IllegalArgumentException("name " + var0 + " not recognized");
      } else {
         return var1;
      }
   }
