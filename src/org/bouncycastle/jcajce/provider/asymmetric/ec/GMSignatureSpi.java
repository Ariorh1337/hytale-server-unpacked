...
public class GMSignatureSpi extends java.security.SignatureSpi {
   ...
   protected void engineInitVerify(PublicKey var1) throws InvalidKeyException {
      CipherParameters var2 = ECUtils.generatePublicKeyParameter(var1);
      if (this.paramSpec != null) {
         var2 = new ParametersWithID(var2, this.paramSpec.getID());
      }
   ...
   protected void engineInitSign(PrivateKey var1) throws InvalidKeyException {
      CipherParameters var2 = ECUtil.generatePrivateKeyParameter(var1);
      if (this.appRandom != null) {
         var2 = new ParametersWithRandom(var2, this.appRandom);
      }

      if (this.paramSpec != null) {
         this.signer.init(true, new ParametersWithID(var2, this.paramSpec.getID()));
      } else {
