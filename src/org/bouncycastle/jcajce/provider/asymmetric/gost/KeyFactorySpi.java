...
public class KeyFactorySpi extends BaseKeyFactorySpi {
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      return var1 instanceof GOST3410PrivateKeySpec ? new BCGOST3410PrivateKey((GOST3410PrivateKeySpec)var1) : super.engineGeneratePrivate(var1);
   }

   @Override
   protected PublicKey engineGeneratePublic(KeySpec var1) throws InvalidKeySpecException {
      return var1 instanceof GOST3410PublicKeySpec ? new BCGOST3410PublicKey((GOST3410PublicKeySpec)var1) : super.engineGeneratePublic(var1);
   }
