...
public abstract class BaseDeterministicOrRandomSignature extends SignatureSpi {
   ...
   private void reInit() {
      CipherParameters var1 = this.keyParams;
      if (this.keyParams.isPrivate()) {
         if (this.appRandom != null) {
            var1 = new ParametersWithRandom(var1, this.appRandom);
         }

         if (this.paramSpec != null) {
            var1 = new ParametersWithContext(var1, this.paramSpec.getContext());
         }

         this.reInitialize(true, var1);
      } else {
         if (this.paramSpec != null) {
            var1 = new ParametersWithContext(var1, this.paramSpec.getContext());
         }

         this.reInitialize(false, var1);
      }
   }
