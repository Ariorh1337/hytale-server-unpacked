...
public abstract class BasePQCKeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   protected BasePQCKeyFactorySpi(Set<ASN1ObjectIdentifier> var1) {
      this.keyOid = null;
      this.keyOids = var1;
   }

   protected BasePQCKeyFactorySpi(ASN1ObjectIdentifier var1) {
      this.keyOid = var1;
      this.keyOids = null;
   }
   ...
   public PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof PKCS8EncodedKeySpec) {
         ...
         try {
            ...
            throw new InvalidKeySpecException(var5.getMessage());
