...
public class SignatureSpi extends java.security.SignatureSpi {
   ...
   SignatureSpi(ASN1ObjectIdentifier var1, Digest var2, boolean var3) {
      ...
      if (var1 != null) {
         ...
         this.preHashDigest = var3 ? new SignatureSpi.NullDigest(var2.getDigestSize()) : var2;
   ...
   protected void engineInitVerify(PublicKey var1) throws InvalidKeyException {
      ...
      if (this.algorithm != null) {
         ...
         this.preHashDigest = this.isPrehash ? new SignatureSpi.NullDigest(this.baseDigest.getDigestSize()) : this.baseDigest;
