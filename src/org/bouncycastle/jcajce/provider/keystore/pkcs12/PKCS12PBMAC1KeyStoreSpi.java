...
public class PKCS12PBMAC1KeyStoreSpi extends KeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore {
   private final JcaJceHelper helper = new BCJcaJceHelper();
   private static final int SALT_SIZE = 20;
   private static final int MIN_ITERATIONS = 51200;
   private static final PKCS12PBMAC1KeyStoreSpi.DefaultSecretKeyProvider keySizeProvider = new PKCS12PBMAC1KeyStoreSpi.DefaultSecretKeyProvider();
   private PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable keys = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
   private PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable localIds = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
   private PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable certs = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
   ...
   private static boolean isPBKDF2(ASN1ObjectIdentifier var0) {
      return var0.equals(NISTObjectIdentifiers.id_aes256_CBC)
         || var0.equals(NISTObjectIdentifiers.id_aes256_GCM)
         || var0.equals(NISTObjectIdentifiers.id_aes128_CBC)
         || var0.equals(NISTObjectIdentifiers.id_aes128_GCM);
   }

   private static int getKeyLength(ASN1ObjectIdentifier var0) {
      return keySizeProvider.getKeySize(new AlgorithmIdentifier(var0)) / 8;
   }

   public PKCS12PBMAC1KeyStoreSpi(JcaJceHelper var1, ASN1ObjectIdentifier var2, ASN1ObjectIdentifier var3) {
   ...
   public void engineDeleteEntry(String var1) throws KeyStoreException {
      ...
      if (var2 != null) {
         this.chainCerts.remove(new PKCS12PBMAC1KeyStoreSpi.CertId(var2.getPublicKey()));
      }
      ...
      if (var3 != null) {
         ...
         if (var4 != null) {
            ...
            if (var5 != null) {
               this.chainCerts.remove(new PKCS12PBMAC1KeyStoreSpi.CertId(var5.getPublicKey()));
            }
         }
      }
   }
   ...
   public Certificate[] engineGetCertificateChain(String var1) {
      ...
      Certificate var2 = this.engineGetCertificate(var1);
      if (var2 == null) {
         return null;
      }
      ...
      while (var2 != null) {
         ...
         if (var6 != null) {
            AuthorityKeyIdentifier var7 = AuthorityKeyIdentifier.getInstance(ASN1OctetString.getInstance(var6).getOctets());
            byte[] var8 = var7.getKeyIdentifierOctets();
            if (null != var8) {
               var5 = (Certificate)this.chainCerts.get(new PKCS12PBMAC1KeyStoreSpi.CertId(var8));
            }
         }
         ...
         if (var5 == null) {
            ...
            if (!var16.equals(var17)) {
               Enumeration var9 = this.chainCerts.keys();

               while (var9.hasMoreElements()) {
                  X509Certificate var10 = (X509Certificate)this.chainCerts.get(var9.nextElement());
   ...
   public void engineSetCertificateEntry(String var1, Certificate var2) throws KeyStoreException {
      ...
      this.chainCerts.put(new PKCS12PBMAC1KeyStoreSpi.CertId(var2.getPublicKey()), var2);
   }
   ...
   public void engineSetKeyEntry(String var1, Key var2, char[] var3, Certificate[] var4) throws KeyStoreException {
      ...
      if (var4 != null) {
         ...
         for (int var5 = 0; var5 != var4.length; var5++) {
            this.chainCerts.put(new PKCS12PBMAC1KeyStoreSpi.CertId(var4[var5].getPublicKey()), var4[var5]);
         }
      }
   }
   ...
   protected PrivateKey unwrapKey(AlgorithmIdentifier var1, byte[] var2, char[] var3, boolean var4) throws IOException {
      ...
      try {
         if (var5.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
            PKCS12PBEParams var12 = PKCS12PBEParams.getInstance(var1.getParameters());
            PBEParameterSpec var7 = new PBEParameterSpec(var12.getIV(), PKCS12Util.validateIterationCount(var12.getIterations()));
         ...
         throw Exceptions.ioException("exception unwrapping private key:" + var10.getMessage(), new UnrecoverableKeyException(var10.toString()));
      } catch (Exception var11) {
         throw Exceptions.ioException("exception unwrapping private key: " + var11.getMessage(), var11);
      }
   ...
   protected byte[] wrapKey(String var1, Key var2, PKCS12PBEParams var3, char[] var4) throws IOException {
      ...
      try {
         ...
         PBEParameterSpec var8 = new PBEParameterSpec(var3.getIV(), PKCS12Util.validateIterationCount(var3.getIterations()));
         Cipher var9 = this.helper.createCipher(var1);
         var9.init(3, var7.generateSecret(var5), var8);
         return var9.wrap(var2);
      } catch (Exception var10) {
         throw new IOException("exception encrypting data - " + var10.toString());
      }
   }

   protected byte[] wrapKey(AlgorithmIdentifier var1, Key var2, char[] var3) throws IOException {
      try {
         Cipher var5 = this.createCipher(3, var3, var1);
         return var5.wrap(var2);
      } catch (Exception var6) {
         throw new IOException("exception encrypting data - " + var6.toString());
      }
   }
   ...
   protected byte[] cryptData(boolean var1, AlgorithmIdentifier var2, char[] var3, boolean var4, byte[] var5) throws IOException {
      ...
      if (var6.on(PKCSObjectIdentifiers.pkcs_12PbeIds)) {
         PKCS12PBEParams var20 = PKCS12PBEParams.getInstance(var2.getParameters());
         PKCS12Key var9 = new PKCS12Key(var3, var4);

         try {
            PBEParameterSpec var10 = new PBEParameterSpec(var20.getIV(), PKCS12Util.validateIterationCount(var20.getIterations()));
            Cipher var11 = this.helper.createCipher(var6.getId());
            var11.init(var7, var9, var10);
            return var11.doFinal(var5);
         } catch (Exception var17) {
            throw new IOException("exception decrypting data - " + var17.toString());
         } finally {
            Arrays.clear(var9.getPassword());
         }
         ...
         try {
            ...
            throw new IOException("exception decrypting data - " + var19.toString());
         }
      } else {
   ...
   private Cipher createCipher(int var1, char[] var2, AlgorithmIdentifier var3) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidKeyException, InvalidAlgorithmParameterException, NoSuchProviderException {
      ...
      int var9 = PKCS12Util.validateIterationCount(var5.getIterationCount());
      int var10 = keySizeProvider.getKeySize(var6);
      SecretKey var11;
      if (var5.isDefaultPrf()) {
         if ((var1 == 2 || var1 == 4) && this.useISO8859d1ForDecryption) {
            PKCS5S2ParametersGenerator var12 = new PKCS5S2ParametersGenerator(new SHA1Digest());
            var12.init(new String(var2).getBytes(StandardCharsets.ISO_8859_1), var8, var9);
            KeyParameter var13 = (KeyParameter)var12.generateDerivedParameters(var10);
            var11 = new SecretKeySpec(var13.getKey(), "AES");
         } else {
            var11 = var7.generateSecret(new PBEKeySpec(var2, var8, var9, var10));
         }
      } else {
         var11 = var7.generateSecret(new PBKDF2KeySpec(var2, var8, var9, var10, var5.getPrf()));
      }

      Cipher var18 = this.helper.createCipher(var4.getEncryptionScheme().getAlgorithm().getId());
      ASN1Encodable var19 = var4.getEncryptionScheme().getParameters();
      if (var19 instanceof ASN1OctetString) {
         var18.init(var1, var11, new IvParameterSpec(ASN1OctetString.getInstance(var19).getOctets()));
      } else {
         ASN1Sequence var14 = ASN1Sequence.getInstance(var19);
         if (var14.getObjectAt(1) instanceof ASN1ObjectIdentifier) {
            GOST28147Parameters var15 = GOST28147Parameters.getInstance(var19);
            var18.init(var1, var11, new GOST28147ParameterSpec(var15.getEncryptionParamSet(), var15.getIV()));
         } else {
            AlgorithmParameters var20 = this.helper.createAlgorithmParameters(var6.getAlgorithm().getId());

            try {
               var20.init(var14.getEncoded());
            } catch (IOException var17) {
               throw new InvalidKeySpecException(var17.getMessage());
            }

            var18.init(var1, var11, var20);
         }
      }
   ...
   public void engineLoad(LoadStoreParameter var1) throws IOException, NoSuchAlgorithmException, CertificateException {
      ...
      if (var1 == null) {
         ...
         if (var2 instanceof PKCS12LoadStoreParameter) {
            this.useISO8859d1ForDecryption = ((PKCS12LoadStoreParameter)var2).useISO8859d1ForDecryption();
         }
   ...
   public void engineLoad(InputStream var1, char[] var2) throws IOException {
      if (var1 != null) {
         ...
         if (var8.getMacData() == null) {
            this.keys = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
            this.localIds = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
            if (var9.getContentType().equals(data)) {
               ...
               for (int var37 = 0; var37 != var35.length; var37++) {
                  if (var35[var37].getContentType().equals(data)) {
                     ASN1Sequence var41 = ASN1Sequence.getInstance(PKCS12Util.getContentOctets(var35[var37]));

                     for (int var45 = 0; var45 != var41.size(); var45++) {
                        SafeBag var47 = SafeBag.getInstance(var41.getObjectAt(var45));
                        if (var47.getBagId().equals(pkcs8ShroudedKeyBag)) {
                           var11 = this.processShroudedKeyBag(var47, var2, var12);
                           var4 = false;
                        } else if (var47.getBagId().equals(certBag)) {
                           var10.addElement(var47);
                        } else if (var47.getBagId().equals(keyBag)) {
                           this.processKeyBag(var47);
                        } else {
                           System.out.println("extra in data " + var47.getBagId());
                           System.out.println(ASN1Dump.dumpAsString(var47));
                        }
                     }
                  } else if (var35[var37].getContentType().equals(encryptedData)) {
                     EncryptedData var40 = EncryptedData.getInstance(PKCS12Util.getContent(var35[var37]));
                     byte[] var44 = this.cryptData(false, var40.getEncryptionAlgorithm(), var2, var12, PKCS12Util.getEncryptedContent(var40).getOctets());
                     ...
                     System.out.println("extra " + ASN1Dump.dumpAsString(PKCS12Util.getContent(var35[var37])));
                  }
               }
            }

            this.certs = new PKCS12PBMAC1KeyStoreSpi.IgnoresCaseHashtable();
            ...
            for (int var32 = 0; var32 != var10.size(); var32++) {
               ...
               if (var34.getBagAttributes() != null) {
                  ...
                  while (var48.hasMoreElements()) {
                     ASN1Sequence var51 = ASN1Sequence.getInstance(var48.nextElement());
                     ASN1ObjectIdentifier var52 = ASN1ObjectIdentifier.getInstance(var51.getObjectAt(0));
                     ASN1Set var22 = ASN1Set.getInstance(var51.getObjectAt(1));
                     if (var22.size() > 0) {
                        ...
                        if (var38 instanceof PKCS12BagAttributeCarrier) {
                           ...
                           ASN1Encodable var25 = var24.getBagAttribute(var52);
                           if (var25 != null) {
                              if (var52.equals(pkcs_9_at_localKeyId)) {
                              ...
                              var24.setBagAttribute(var52, var22);
                           } else {
                              var24.setBagAttribute(var52, var23);
                           }
                        }

                        if (var52.equals(pkcs_9_at_friendlyName)) {
                           var46 = ((ASN1BMPString)var23).getString();
                        } else if (var52.equals(pkcs_9_at_localKeyId)) {
               ...
               this.chainCerts.put(new PKCS12PBMAC1KeyStoreSpi.CertId(var38.getPublicKey()), var38);
               if (var11) {
            ...
            this.itCount = PKCS12Util.validateIterationCount(var13.getIterationCount());
            this.saltLength = var15.length;
            byte[] var16 = PKCS12Util.getContentOctets(var9);
               ...
               if (!Arrays.constantTimeAreEqual(var17, var18)) {
                  if (var2.length > 0) {
                     throw Exceptions.ioException(
                        "PKCS12 key store mac invalid - wrong password or corrupted file", new UnrecoverableKeyException("PKCS12 key store mac invalid")
                     );
                  }
   ...
   private ASN1Primitive getAlgParams(ASN1ObjectIdentifier var1) {
      if (var1.equals(NISTObjectIdentifiers.id_aes128_CBC) || var1.equals(NISTObjectIdentifiers.id_aes256_CBC)) {
         ...
         return new DEROctetString(var3);
      }
      ...
      return new GCMParameters(var2, 16).toASN1Primitive();
   }
   ...
   public void engineStore(LoadStoreParameter var1) throws IOException, NoSuchAlgorithmException, CertificateException {
      ...
      if (!(var1 instanceof PKCS12StoreParameter) && !(var1 instanceof JDKPKCS12StoreParameter)) {
         throw new IllegalArgumentException("No support for 'param' of type " + var1.getClass().getName());
      }
      ...
      if (var1 instanceof PKCS12StoreParameter) {
         ...
         var2 = new PKCS12StoreParameter(
            ((JDKPKCS12StoreParameter)var1).getOutputStream(),
            var1.getProtectionParameter(),
            ((JDKPKCS12StoreParameter)var1).isUseDEREncoding(),
            ((JDKPKCS12StoreParameter)var1).isOverwriteFriendlyName()
         );
      }
      ...
      if (var2.getMacAlgorithm().getAlgorithm().equals(id_PBMAC1)) {
         this.macAlgorithm = var2.getMacAlgorithm();
         PBMAC1Params var5 = PBMAC1Params.getInstance(this.macAlgorithm.getParameters());
         AlgorithmIdentifier var6 = var5.getKeyDerivationFunc();
         AlgorithmIdentifier var7 = var5.getMessageAuthScheme();
         if (!var6.getAlgorithm().equals(PKCSObjectIdentifiers.id_PBKDF2)) {
            throw new IOException("No support for KDF parameter of type " + var6.getAlgorithm().toString());
         }
      }
   ...
   public void engineStore(OutputStream var1, char[] var2) throws IOException {
      this.doStore(var1, var2, true, true);
   }
   ...
   private void doStore(OutputStream var1, char[] var2, boolean var3, boolean var4) throws IOException {
      ...
      if (this.keys.size() == 0) {
         if (var2 == null) {
            ...
            if (var3) {
               ...
               Pfx var38 = new Pfx(new ContentInfo(PKCSObjectIdentifiers.data, new DEROctetString(new DERSequence(var34).getEncoded())), null);
               ...
               Pfx var39 = new Pfx(new ContentInfo(PKCSObjectIdentifiers.data, new BEROctetString(new BERSequence(var35).getEncoded())), null);
      ...
      while (var33.hasMoreElements()) {
         ...
         if (isPBKDF2(this.keyAlgorithm)) {
            PBKDF2Params var12 = new PBKDF2Params(
               var36, 51200, getKeyLength(this.keyAlgorithm), new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA256, DERNull.INSTANCE)
            );
            EncryptionScheme var13 = new EncryptionScheme(this.keyAlgorithm, this.getAlgParams(this.keyAlgorithm));
            var10 = new AlgorithmIdentifier(
               PKCSObjectIdentifiers.id_PBES2, new PBES2Parameters(new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, var12), var13)
            );
            var11 = this.wrapKey(var10, var42, var2);
         } else {
            PKCS12PBEParams var46 = new PKCS12PBEParams(var36, 51200);
            var11 = this.wrapKey(this.keyAlgorithm.getId(), var42, var46, var2);
      ...
      if (isPBKDF2(this.certAlgorithm)) {
         PBKDF2Params var48 = new PBKDF2Params(
            var43, 51200, getKeyLength(this.certAlgorithm), new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA256, DERNull.INSTANCE)
         );
         var45 = new AlgorithmIdentifier(
            PKCSObjectIdentifiers.id_PBES2,
            new PBES2Parameters(
               new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, var48), new EncryptionScheme(this.certAlgorithm, this.getAlgParams(this.certAlgorithm))
            )
         );
      } else {
      ...
      while (var52.hasMoreElements()) {
         try {
            PKCS12PBMAC1KeyStoreSpi.CertId var63 = (PKCS12PBMAC1KeyStoreSpi.CertId)var52.nextElement();
      ...
      byte[] var90 = PKCS12Util.getContentOctets(var87);
      MacData var24;
   ...
   private SafeBag createSafeBag(String var1, Certificate var2, boolean var3) throws CertificateEncodingException {
      ...
      if (var2 instanceof X509Certificate) {
         ...
         ASN1OctetString var14 = Extensions.getExtensionValue(var13.getExtensions(), Extension.extendedKeyUsage);
         DERSet var15;
         if (var14 != null) {
            var15 = new DERSet(ExtendedKeyUsage.getInstance(var14.getOctets()).getUsages());
         } else {
            var15 = new DERSet(KeyPurposeId.anyExtendedKeyUsage);
         }

         var5.add(new DERSequence(MiscObjectIdentifiers.id_oracle_pkcs12_trusted_key_usage, var15));
      }
   ...
   private byte[] calculatePbeMac(ASN1ObjectIdentifier var1, byte[] var2, int var3, char[] var4, boolean var5, byte[] var6) throws Exception {
      if (PKCSObjectIdentifiers.id_PBMAC1.equals(var1)) {
         if (this.macAlgorithm.getParameters() == null) {
            byte[] var7 = new byte[32];
            this.helper.createSecureRandom("DEFAULT").nextBytes(var7);
            PBKDF2Params var8 = new PBKDF2Params(var7, 65536, 256, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA256));
            AlgorithmIdentifier var9 = new AlgorithmIdentifier(PKCSObjectIdentifiers.id_PBKDF2, var8);
            AlgorithmIdentifier var10 = new AlgorithmIdentifier(id_hmacWithSHA512);
            PBMAC1Params var11 = new PBMAC1Params(var9, var10);
            this.macAlgorithm = new AlgorithmIdentifier(id_PBMAC1, var11);
         }

         PBMAC1Params var16 = PBMAC1Params.getInstance(this.macAlgorithm.getParameters());
         if (var16 == null) {
         ...
         if (PKCSObjectIdentifiers.id_PBKDF2.equals(var16.getKeyDerivationFunc().getAlgorithm())) {
            PBKDF2Params var19 = PBKDF2Params.getInstance(var16.getKeyDerivationFunc().getParameters());
            if (var19.getKeyLength() == null) {
               throw new IOException("Key length must be present when using PBMAC1.");
            }

            HMac var21 = new HMac(getPrf(var16.getMessageAuthScheme().getAlgorithm()));
            PKCS5S2ParametersGenerator var22 = new PKCS5S2ParametersGenerator(getPrf(var19.getPrf().getAlgorithm()));
            var22.init(Strings.toUTF8ByteArray(var4), var19.getSalt(), PKCS12Util.validateIterationCount(var19.getIterationCount()));
            CipherParameters var23 = var22.generateDerivedParameters(BigIntegers.intValueExact(var19.getKeyLength()) * 8);
            Arrays.clear(var22.getPassword());
            var21.init(var23);
            var21.update(var6, 0, var6.length);
            byte[] var12 = new byte[var21.getMacSize()];
            var21.doFinal(var12, 0);
            return var12;
         }
      }

      PBEParameterSpec var17 = new PBEParameterSpec(var2, var3);
      PKCS12Key var18 = new PKCS12Key(var4, var5);

      try {
         Mac var20 = this.helper.createMac(var1.getId());
         var20.init(var18, var17);
         var20.update(var6);
         return var20.doFinal();
      } finally {
         Arrays.clear(var18.getPassword());
      }
   }
   ...
   public static class BCPKCS12KeyStore extends AdaptingKeyStoreSpi {
      public BCPKCS12KeyStore() {
         super(
            new BCJcaJceHelper(), new PKCS12PBMAC1KeyStoreSpi(new BCJcaJceHelper(), NISTObjectIdentifiers.id_aes256_CBC, NISTObjectIdentifiers.id_aes128_CBC)
         );
      }
   }
   ...
   private class CertId {
      ...
      CertId(PublicKey nullx) {
         this.id = PKCS12PBMAC1KeyStoreSpi.this.createSubjectKeyId(nullx).getKeyIdentifier();
      }
      ...
      public boolean equals(Object var1) {
         ...
         if (!(var1 instanceof PKCS12PBMAC1KeyStoreSpi.CertId)) {
            return false;
         }

         PKCS12PBMAC1KeyStoreSpi.CertId var2 = (PKCS12PBMAC1KeyStoreSpi.CertId)var1;
