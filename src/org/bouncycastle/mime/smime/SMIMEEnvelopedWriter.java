...
public class SMIMEEnvelopedWriter extends MimeWriter {
   ...
   public OutputStream getContentStream() throws IOException {
      ...
      try {
         OutputStream var1 = this.mimeOut;
         if ("base64".equals(this.contentTransferEncoding)) {
            var1 = new Base64OutputStream(var1);
         }

         OutputStream var2 = this.envGen.open(SMimeUtils.createUnclosable(var1), this.outEnc);
         return new SMIMEEnvelopedWriter.ContentOutputStream(var2, var1);
