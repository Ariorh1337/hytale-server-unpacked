...
public class CustomNamedCurves {
   static X9ECParametersHolder curve25519 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "042AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9"
         );
   ...
   static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() {
      @Override
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(
            ...
            new ScalarSplitParameters(
               new BigInteger[]{new BigInteger("9162fbe73984472a0a9e", 16), new BigInteger("-96341f1138933bc2f505", 16)},
               new BigInteger[]{new BigInteger("127971af8721782ecffa3", 16), new BigInteger("9162fbe73984472a0a9e", 16)},
   ...
   static X9ECParametersHolder secp192k1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(
            ...
            new ScalarSplitParameters(
               new BigInteger[]{new BigInteger("71169be7330b3038edb025f1", 16), new BigInteger("-b3fb3400dec5c4adceb8655c", 16)},
               new BigInteger[]{new BigInteger("12511cfe811d0f4e6bc688b4d", 16), new BigInteger("71169be7330b3038edb025f1", 16)},
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "04DB4FF10EC057E9AE26B07D0280B7F4341DA5D1B1EAE06C7D9B2F2F6D9C5628A7844163D015BE86344082AA88D95E2F9D"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp192r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "04188DA80EB03090F67CBF20EB43A18800F4FF0AFD82FF101207192B95FFC8DA78631011ED6B24CDD573F977A11E794811"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp224k1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(
            ...
            new ScalarSplitParameters(
               new BigInteger[]{new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16)},
               new BigInteger[]{new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), new BigInteger("6b8cf07d4ca75c88957d9d670591", 16)},
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp224r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "04B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder secp256k1 = new X9ECParametersHolder() {
      ...
      protected ECCurve createCurve() {
         GLVTypeBParameters var1 = new GLVTypeBParameters(
            ...
            new ScalarSplitParameters(
               new BigInteger[]{new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16)},
               new BigInteger[]{new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16)},
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder secp256r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "046B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   ...
   static X9ECParametersHolder sect193r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0401F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E10025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect193r2 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0400D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect233k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   static X9ECParametersHolder sect233r1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0400FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B01006A08A41903350678E58528BEBF8A0BEFF867A7CA36716F7E01F81052"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), var1);
      }
   };
   static X9ECParametersHolder sect239k1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
   ...
   static X9ECParametersHolder sm2p256v1 = new X9ECParametersHolder() {
      ...
      protected X9ECParameters createParameters() {
         ...
         ECCurve var2 = this.getCurve();
         X9ECPoint var3 = CustomNamedCurves.configureBasepoint(
            var2, "0432C4AE2C1F1981195F9904466A39C9948FE30BBFF2660BE1715A4589334C74C7BC3736A2F4F6779C59BDCEE36B692153D0A9877CC62A474002DF32E52139F0A0"
         );
         return new X9ECParameters(var2, var3, var2.getOrder(), var2.getCofactor(), (byte[])var1);
      }
   };
