   ...
   public AsymmetricCipherKeyPair DeserializePrivateKey(byte[] var1, byte[] var2) {
      ...
      switch (this.kemId) {
         ...
         case 18:
            ...
            return new AsymmetricCipherKeyPair(var3, var5);
         case 32:
            ...
            return new AsymmetricCipherKeyPair(var3, var7);
         case 33:
            ...
            return new AsymmetricCipherKeyPair(var3, var6);
         default:
            throw new IllegalStateException("invalid kem id");
      }
   }
   ...
   public AsymmetricCipherKeyPair DeriveKeyPair(byte[] var1) {
      ...
      switch (this.kemId) {
         ...
         case 18:
            ...
            for (int var16 = 0; var16 < 256; var16++) {
               ...
               if (this.validateSk(var7)) {
                  ...
                  return new AsymmetricCipherKeyPair(var10, var9);
               }
            }
         ...
         case 32:
            ...
            return new AsymmetricCipherKeyPair(var15.generatePublicKey(), var15);
         case 33:
            ...
            return new AsymmetricCipherKeyPair(var5.generatePublicKey(), var5);
         default:
            throw new IllegalStateException("invalid kem id");
      }
   }
