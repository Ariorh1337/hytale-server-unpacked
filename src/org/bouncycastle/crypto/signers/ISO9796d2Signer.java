...
public class ISO9796d2Signer implements SignerWithRecovery {
   ...
   public void updateWithRecoveredMessage(byte[] var1) throws InvalidCipherTextException {
      ...
      while (var8 != var2.length && (var2[var8] & 15 ^ 10) != 0) {
         var8++;
      }
   ...
   public byte[] generateSignature() throws CryptoException {
      ...
      if (var3 - 1 > 0) {
         ...
         this.block[var3 - 1] = (byte)(this.block[var3 - 1] ^ 1);
         this.block[0] = 11;
         this.block[0] = (byte)(this.block[0] | var4);
      } else {
         this.block[0] = 10;
         this.block[0] = (byte)(this.block[0] | var4);
      }
   ...
   public boolean verifySignature(byte[] var1) {
      ...
      while (var12 != var2.length && (var2[var12] & 15 ^ 10) != 0) {
         var12++;
      }

      var12++;
      byte[] var15 = new byte[this.digest.getDigestSize()];
      int var16 = var2.length - var3 - var15.length;
      if (var16 - var12 <= 0) {
         return this.returnFalse(var2);
      }
      ...
      if ((var2[0] & 32) == 0) {
         ...
         this.digest.reset();
         this.digest.update(var2, var12, var16 - var12);
         this.digest.doFinal(var15, 0);
         boolean var7 = true;

         for (int var8 = 0; var8 != var15.length; var8++) {
            var2[var16 + var8] = (byte)(var2[var16 + var8] ^ var15[var8]);
            if (var2[var16 + var8] != 0) {
               var7 = false;
            }
         }
         ...
         System.arraycopy(var2, var12, this.recoveredMessage, 0, this.recoveredMessage.length);
      } else {
         this.fullMessage = false;
         this.digest.doFinal(var15, 0);
         boolean var17 = true;
         ...
         for (int var18 = 0; var18 != var15.length; var18++) {
            var2[var16 + var18] = (byte)(var2[var16 + var18] ^ var15[var18]);
            if (var2[var16 + var18] != 0) {
               var17 = false;
            }
         }
