...
class Packing {
   ...
   static void packSignature(byte[] var0, PolyVecL var1, PolyVecK var2, MLDSAEngine var3) {
      int var4 = var3.getDilithiumCTilde();

      for (int var5 = 0; var5 < var3.getDilithiumL(); var5++) {
         var1.getVectorIndex(var5).zPack(var0, var4);
         var4 += var3.getDilithiumPolyZPackedBytes();
      }

      for (int var8 = 0; var8 < var3.getDilithiumOmega() + var3.getDilithiumK(); var8++) {
         var0[var4 + var8] = 0;
      }

      int var9 = 0;

      for (int var6 = 0; var6 < var3.getDilithiumK(); var6++) {
         for (int var7 = 0; var7 < 256; var7++) {
            if (var2.getVectorIndex(var6).getCoeffIndex(var7) != 0) {
               var0[var4 + var9++] = (byte)var7;
            }
         }

         var0[var4 + var3.getDilithiumOmega() + var6] = (byte)var9;
      }
   }
   ...
   static boolean unpackSignature(PolyVecL var0, PolyVecK var1, byte[] var2, MLDSAEngine var3) {
      ...
      for (int var4 = 0; var4 < var3.getDilithiumL(); var4++) {
         var0.getVectorIndex(var4)
            .zUnpack(Arrays.copyOfRange(var2, var7 + var4 * var3.getDilithiumPolyZPackedBytes(), var7 + (var4 + 1) * var3.getDilithiumPolyZPackedBytes()));
      }
