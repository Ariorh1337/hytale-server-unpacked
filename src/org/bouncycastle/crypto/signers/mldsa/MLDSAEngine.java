...
public class MLDSAEngine {
   ...
   public static MLDSAEngine getInstance(MLDSAParameters var0, SecureRandom var1) {
      return new MLDSAEngine(var0.getK(), var1);
   }

   private MLDSAEngine(int var1, SecureRandom var2) {
      switch (var1) {
         case 2:
            this.DilithiumK = 4;
            this.DilithiumL = 4;
   ...
   public byte[] deriveT1(byte[] var1, byte[] var2, byte[] var3, byte[] var4, byte[] var5, byte[] var6) {
      PolyVecMatrix var7 = new PolyVecMatrix(this);
      PolyVecL var8 = new PolyVecL(this);
      PolyVecK var10 = new PolyVecK(this);
      PolyVecK var11 = new PolyVecK(this);
   ...
   public void initSign(byte[] var1, boolean var2, byte[] var3) {
      this.shake256Digest.update(var1, 0, 64);
      this.absorbCtx(var2, var3);
   }

   public void initVerify(byte[] var1, byte[] var2, boolean var3, byte[] var4) {
      byte[] var5 = new byte[64];
   ...
   public byte[] generateMu(SHAKEDigest var1) {
      byte[] var2 = new byte[64];
      var1.doFinal(var2, 0, 64);
      return var2;
   }

   public byte[] generateSignature(byte[] var1, SHAKEDigest var2, byte[] var3, byte[] var4, byte[] var5, byte[] var6, byte[] var7, byte[] var8) {
   ...
   public boolean verifyInternalMu(byte[] var1) {
      byte[] var2 = new byte[64];
      this.shake256Digest.doFinal(var2, 0);
      return Arrays.constantTimeAreEqual(var2, var1);
   }

   public boolean verifyInternalMuSignature(byte[] var1, byte[] var2, int var3, SHAKEDigest var4, byte[] var5, byte[] var6) {
   ...
   private boolean doVerifyInternal(byte[] var1, byte[] var2, int var3, SHAKEDigest var4, byte[] var5, byte[] var6) {
      ...
      if (var8.checkNorm(this.getDilithiumGamma1() - this.getDilithiumBeta())) {
         return false;
      }
