...
public class HashMLDSASigner implements Signer {
   ...
   public void init(boolean var1, CipherParameters var2) {
      ...
      if (var1) {
         ...
         this.engine.initSign(this.privKey.getTr(), true, var3);
      } else {
         ...
         this.engine.initVerify(this.rho, this.t1, true, var3);
      }
   ...
   public byte[] generateSignature() throws CryptoException, DataLengthException {
      ...
      byte[] var3 = this.engine.generateMu(var1);
      return this.engine.generateSignature(var3, var1, this.rho, this.k, this.t0, this.s1, this.s2, var2);
   }

   @Override
   public boolean verifySignature(byte[] var1) {
      SHAKEDigest var2 = this.finishPreHash();
      return this.engine.verifyInternal(var1, var1.length, var2, this.rho, this.t1);
   }
