...
class DHParametersHelper {
   ...
   static BigInteger[] generateSafePrimes(int var0, int var1, SecureRandom var2) {
      ...
      while (true) {
         BigInteger var4 = BigIntegers.createRandomPrime(var5, 2, var2);
         BigInteger var3 = var4.shiftLeft(1).add(ONE);
         if (var3.isProbablePrime(var1)) {
            if ((var1 <= 2 || var4.isProbablePrime(var1 - 2)) && WNafUtil.getNafWeight(var3) >= var6) {
