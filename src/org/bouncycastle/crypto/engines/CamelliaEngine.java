...
public class CamelliaEngine implements BlockCipher {
   ...
   private void camelliaF2(int[] var1, int[] var2, int var3) {
      ...
      int var6 = SBOX4_4404[var4 & 0xFF];
      var6 ^= SBOX3_3033[var4 >>> 8 & 0xFF];
      var6 ^= SBOX2_0222[var4 >>> 16 & 0xFF];
      var6 ^= SBOX1_1110[var4 >>> 24 & 0xFF];
      int var5 = var1[1] ^ var2[1 + var3];
      int var7 = SBOX1_1110[var5 & 0xFF];
      var7 ^= SBOX4_4404[var5 >>> 8 & 0xFF];
      var7 ^= SBOX3_3033[var5 >>> 16 & 0xFF];
      var7 ^= SBOX2_0222[var5 >>> 24 & 0xFF];
      var1[2] ^= var6 ^ var7;
      var1[3] ^= var6 ^ var7 ^ rightRotate(var6, 8);
      var4 = var1[2] ^ var2[2 + var3];
      var6 = SBOX4_4404[var4 & 0xFF];
      var6 ^= SBOX3_3033[var4 >>> 8 & 0xFF];
      var6 ^= SBOX2_0222[var4 >>> 16 & 0xFF];
      var6 ^= SBOX1_1110[var4 >>> 24 & 0xFF];
      var5 = var1[3] ^ var2[3 + var3];
      var7 = SBOX1_1110[var5 & 0xFF];
      var7 ^= SBOX4_4404[var5 >>> 8 & 0xFF];
      var7 ^= SBOX3_3033[var5 >>> 16 & 0xFF];
      var7 ^= SBOX2_0222[var5 >>> 24 & 0xFF];
      var1[0] ^= var6 ^ var7;
