...
public class GiftCofbEngine extends AEADBaseEngine {
   ...
   private void giftb128(byte[] var1, byte[] var2, byte[] var3) {
      ...
      var7[0] = (short)((var2[0] & 255) << 8 | var2[1] & 0xFF);
      var7[1] = (short)((var2[2] & 255) << 8 | var2[3] & 0xFF);
      var7[2] = (short)((var2[4] & 255) << 8 | var2[5] & 0xFF);
      var7[3] = (short)((var2[6] & 255) << 8 | var2[7] & 0xFF);
      var7[4] = (short)((var2[8] & 255) << 8 | var2[9] & 0xFF);
      var7[5] = (short)((var2[10] & 255) << 8 | var2[11] & 0xFF);
      var7[6] = (short)((var2[12] & 255) << 8 | var2[13] & 0xFF);
      var7[7] = (short)((var2[14] & 255) << 8 | var2[15] & 0xFF);
