...
public final class BlowfishEngine implements BlockCipher {
   ...
   public void init(boolean var1, CipherParameters var2) {
      if (var2 instanceof KeyParameter) {
         ...
         CryptoServicesRegistrar.checkConstraints(new DefaultServiceProperties(this.getAlgorithmName(), this.bitsOfSecurity(), var2, this.getPurpose()));
      } else {
         throw new IllegalArgumentException("invalid parameter passed to Blowfish init - " + var2.getClass().getName());
      }
   }
   ...
   private int F(int var1) {
      return (this.S0[var1 >>> 24] + this.S1[var1 >>> 16 & 0xFF] ^ this.S2[var1 >>> 8 & 0xFF]) + this.S3[var1 & 0xFF];
   }
   ...
   private void setKey(byte[] var1) {
      if (var1.length >= 4 && var1.length <= 56) {
   ...
   private void encryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      ...
      int var6 = this.BytesTo32bits(var1, var2 + 4);
      var5 ^= this.P[0];

      for (byte var7 = 1; var7 < 16; var7 += 2) {
         var6 ^= this.F(var5) ^ this.P[var7];
         var5 ^= this.F(var6) ^ this.P[var7 + 1];
      }

      var6 ^= this.P[17];
      this.Bits32ToBytes(var6, var3, var4);
      this.Bits32ToBytes(var5, var3, var4 + 4);
   }
   ...
   private void decryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      ...
      for (byte var7 = 16; var7 > 0; var7 -= 2) {
         var6 ^= this.F(var5) ^ this.P[var7];
         var5 ^= this.F(var6) ^ this.P[var7 - 1];
      }
   ...
   private int BytesTo32bits(byte[] var1, int var2) {
      return (var1[var2] & 0xFF) << 24 | (var1[var2 + 1] & 0xFF) << 16 | (var1[var2 + 2] & 0xFF) << 8 | var1[var2 + 3] & 0xFF;
   }
   ...
   private int bitsOfSecurity() {
      if (this.workingKey == null) {
         ...
         return this.workingKey.length > 32 ? 256 : this.workingKey.length * 8;
      }
   }
