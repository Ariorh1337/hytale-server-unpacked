...
public class SignerInfoGenerator {
   ...
   public OutputStream getCalculatingOutputStream() {
      if (this.digester != null) {
         return this.sAttrGen == null ? new TeeOutputStream(this.digester.getOutputStream(), this.signer.getOutputStream()) : this.digester.getOutputStream();
      } else {
   ...
   public SignerInfo generate(ASN1ObjectIdentifier var1) throws CMSException {
      try {
         ...
         if (this.unsAttrGen != null) {
            Map var13 = this.getBaseParameters(var1, var4, var3, this.calculatedDigest);
         ...
         return new SignerInfo(this.signerIdentifier, var4, var2, var3, new DEROctetString(var11), var12);
