...
public class Element {
   ...
   public boolean equals(Object var1) {
      ...
      if (var1 != null && this.getClass() == var1.getClass()) {
         ...
         if (this.extensionsInDefinition != var2.extensionsInDefinition) {
            return false;
         }

         if (this.defaultValuesInChildren != var2.defaultValuesInChildren) {
            return false;
         }

         if (this.mayRecurse != var2.mayRecurse) {
            return false;
         }

         if (this.optionals != var2.optionals) {
            return false;
         }

         if (this.block != var2.block) {
            return false;
         }

         if (this.baseType != var2.baseType) {
            return false;
         }

         if (this.children != null ? this.children.equals(var2.children) : var2.children == null) {
