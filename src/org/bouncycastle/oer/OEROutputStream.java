         ...
         if (var1 instanceof OEROptional) {
            ...
            switch (var2.getBaseType()) {
               ...
               case SEQ:
                  ...
                  for (int var42 = 0; var42 < var2.getChildren().size(); var42++) {
                     ...
                     if (var48.getBaseType() != OERDefinition.BaseType.EXTENSION) {
                        ...
                        if (!var48.isExplicit()) {
                           ASN1Encodable var59 = var13.getObjectAt(var42);
                           if (var48.getDefaultValue() != null) {
                              if (var59 instanceof OEROptional) {
                                 if (((OEROptional)var59).isDefined() && !((OEROptional)var59).get().equals(var48.getDefaultValue())) {
                                    var25 |= bits[var14];
                                 }
                              } else if (!var48.getDefaultValue().equals(var59)) {
                                 var25 |= bits[var14];
                              }
                  ...
                  for (var51 = 0; var51 < var43.size(); var51++) {
                     ...
                     if (var57.getBaseType() != OERDefinition.BaseType.EXTENSION) {
                        ...
                        ASN1Encodable var60 = var13.getObjectAt(var51);
                        if (var57.getaSwitch() != null) {
                           var57 = var57.getaSwitch().result(new SwitchIndexer.Asn1SequenceIndexer(var13));
                        }

                        if (var57.getDefaultValue() == null || !var57.getDefaultValue().equals(var60)) {
                           this.write(var60, var57);
                        }
                     }
                  }
                  ...
                  if (var34) {
                     int var58 = var51;
                     ByteArrayOutputStream var61 = new ByteArrayOutputStream();
                     var14 = 7;
                     var25 = 0;

                     for (int var11 = var58; var11 < var43.size(); var11++) {
                        if (var14 < 0) {
                           var61.write(var25);
                           var14 = 7;
                           var25 = 0;
                     ...
                     this.encodeLength(var61.size() + 1);
                     if (var14 == 7) {
                        this.write(0);
                     } else {
                        this.write(var14 + 1);
               ...
               case CHOICE:
                  ...
                  if (var55.getBlock() > 0) {
                     this.writePlainType(var45, var55);
                  } else {
                     this.write(var45, var55);
                  }
