...
class X509CRLStoreSelector extends X509CRLSelector implements Selector {
   ...
   public boolean match(Object var1) {
      ...
      try {
         ...
         if (var4 != null) {
            var3 = ASN1Integer.getInstance(JcaX509ExtensionUtils.parseExtensionValue(var4));
         }
      ...
      if (this.isCompleteCRLEnabled() && var3 != null) {
         return false;
      }

      if (var3 != null && this.maxBaseCRLNumber != null && var3.getPositiveValue().compareTo(this.maxBaseCRLNumber) == 1) {
         return false;
      }
