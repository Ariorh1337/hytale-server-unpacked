...
class LongArray implements Cloneable {
   ...
   private void addShiftedByBitsSafe(LongArray var1, int var2, int var3) {
      ...
      if (var6 == 0) {
         ...
         if (var7 != 0L) {
            this.m_ints[var4 + var5] = this.m_ints[var4 + var5] ^ var7;
         }
      }
   }
   ...
   private static long addShiftedUp(long[] var0, int var1, long[] var2, int var3, int var4, int var5) {
      ...
      for (int var9 = 0; var9 < var4; var9++) {
         ...
         var0[var1 + var9] = var0[var1 + var9] ^ (var10 << var5 | var7);
         var7 = var10 >>> var6;
      }
   ...
   private static void add(long[] var0, int var1, long[] var2, int var3, int var4) {
      for (int var5 = 0; var5 < var4; var5++) {
         var0[var1 + var5] = var0[var1 + var5] ^ var2[var3 + var5];
      }
   }
   ...
   private static void addBoth(long[] var0, int var1, long[] var2, int var3, long[] var4, int var5, int var6) {
      for (int var7 = 0; var7 < var6; var7++) {
         var0[var1 + var7] = var0[var1 + var7] ^ var2[var3 + var7] ^ var4[var5 + var7];
      }
   }
   ...
   private static void distribute(long[] var0, int var1, int var2, int var3, int var4) {
      for (int var5 = 0; var5 < var4; var5++) {
         ...
         var0[var2 + var5] = var0[var2 + var5] ^ var6;
         var0[var3 + var5] = var0[var3 + var5] ^ var6;
      }
   }
   ...
   private static void flipBit(long[] var0, int var1, int var2) {
      ...
      int var4 = var2 & 63;
      long var5 = 1L << var4;
      var0[var1 + var3] = var0[var1 + var3] ^ var5;
   }
   ...
   private static void multiplyWord(long var0, long[] var2, int var3, long[] var4, int var5) {
      ...
      for (int var6 = 1; (var0 >>>= 1) != 0L; var6++) {
         if ((var0 & 1L) != 0L) {
            ...
            if (var7 != 0L) {
               var4[var5 + var3] = var4[var5 + var3] ^ var7;
            }
         }
      }
   }
   ...
   public LongArray modMultiplyLD(LongArray var1, int var2, int[] var3) {
      ...
      if (var24 == 1) {
         ...
         for (byte var19 = 56; var19 >= 0; var19 -= 8) {
            for (byte var20 = 1; var20 < var24; var20 += 2) {
         ...
         for (byte var28 = 56; var28 >= 0; var28 -= 8) {
            for (byte var29 = 0; var29 < var24; var29 += 2) {
   ...
   public LongArray modMultiplyAlt(LongArray var1, int var2, int[] var3) {
      ...
      if (var30 == 1) {
         ...
         var20 += var10;
         long[] var36 = new long[++var20];
         interleave(var6.m_ints, 0, var36, 0, var30, (int)var11);
         int var22 = var30;
         System.arraycopy(var7.m_ints, 0, var36, var22, var9);

         for (int var23 = 1; var23 < var14; var23++) {
            shiftUp(var36, var30, var36, var22 += var16, var16, var23);
         }
         ...
         while (true) {
            ...
            while (true) {
               ...
               while (true) {
                  ...
                  if (var29 != 0) {
                     add(var36, var24 + var19[var29], var36, var28, var16);
                  }

                  if (++var27 == var14) {
                     if (++var24 >= var30) {
                        if ((var38 += var18) >= var13) {
                           if (var38 >= 64) {
                              var24 = var19.length;

                              while (--var24 > 1) {
                                 if ((var24 & 1L) == 0L) {
                                    addShiftedUp(var36, var19[var24 >>> 1], var36, var19[var24], var10, var12);
                                 } else {
                                    distribute(var36, var19[var24], var19[var24 - 1], var19[1], var10);
                                 }
                              }

                              return reduceResult(var36, var19[1], var10, var2, var3);
                           }

                           var38 = 64 - var11;
                           var22 &= var22 << var13 - var38;
                        }

                        shiftUp(var36, var30, var17, var14);
                        continue label77;
                     }
                     break;
                  }
   ...
   private static void reduceWordWise(long[] var0, int var1, int var2, int var3, int var4, int[] var5) {
      ...
      if (var8 != 0L) {
         var0[var1 + var6] = var0[var1 + var6] ^ var8 << var10;
   ...
   public LongArray modSquare(int var1, int[] var2) {
      ...
      while (var6 < var4) {
         long var7 = this.m_ints[var6 >>> 1];
         var5[var6++] = interleave2_32to64((int)var7);
         var5[var6++] = interleave2_32to64((int)(var7 >>> 32));
      }
   ...
   private static long interleave3(long var0) {
      ...
      return var2
         | interleave3_21to63((int)var0 & 2097151)
         | interleave3_21to63((int)(var0 >>> 21) & 2097151) << 1
         | interleave3_21to63((int)(var0 >>> 42) & 2097151) << 2;
   }
   ...
   private static long interleave3_21to63(int var0) {
      ...
      return (var3 & 4294967295L) << 42 | (var2 & 4294967295L) << 21 | var1 & 4294967295L;
   }
   ...
   private static long interleave5(long var0) {
      return interleave3_13to65((int)var0 & 8191)
         | interleave3_13to65((int)(var0 >>> 13) & 8191) << 1
         | interleave3_13to65((int)(var0 >>> 26) & 8191) << 2
         | interleave3_13to65((int)(var0 >>> 39) & 8191) << 3
         | interleave3_13to65((int)(var0 >>> 52) & 8191) << 4;
   }

   private static long interleave3_13to65(int var0) {
      int var1 = INTERLEAVE5_TABLE[var0 & 127];
      int var2 = INTERLEAVE5_TABLE[var0 >>> 7];
      return (var2 & 4294967295L) << 35 | var1 & 4294967295L;
   }
   ...
   private static long interleave7(long var0) {
      long var2 = var0 & Long.MIN_VALUE;
      return var2
         | INTERLEAVE7_TABLE[(int)var0 & 511]
         | INTERLEAVE7_TABLE[(int)(var0 >>> 9) & 511] << 1
         | INTERLEAVE7_TABLE[(int)(var0 >>> 18) & 511] << 2
         | INTERLEAVE7_TABLE[(int)(var0 >>> 27) & 511] << 3
         | INTERLEAVE7_TABLE[(int)(var0 >>> 36) & 511] << 4
         | INTERLEAVE7_TABLE[(int)(var0 >>> 45) & 511] << 5
         | INTERLEAVE7_TABLE[(int)(var0 >>> 54) & 511] << 6;
   }
   ...
   private static long interleave2_n(long var0, int var2) {
      while (var2 > 1) {
         var2 -= 2;
         var0 = interleave4_16to64((int)var0 & 65535)
            | interleave4_16to64((int)(var0 >>> 16) & 65535) << 1
            | interleave4_16to64((int)(var0 >>> 32) & 65535) << 2
            | interleave4_16to64((int)(var0 >>> 48) & 65535) << 3;
      }
   ...
   private static long interleave4_16to64(int var0) {
      int var1 = INTERLEAVE4_TABLE[var0 & 0xFF];
      int var2 = INTERLEAVE4_TABLE[var0 >>> 8];
      return (var2 & 4294967295L) << 32 | var1 & 4294967295L;
   }

   private static long interleave2_32to64(int var0) {
      int var1 = INTERLEAVE2_TABLE[var0 & 0xFF] | INTERLEAVE2_TABLE[var0 >>> 8 & 0xFF] << 16;
      int var2 = INTERLEAVE2_TABLE[var0 >>> 16 & 0xFF] | INTERLEAVE2_TABLE[var0 >>> 24] << 16;
      return (var2 & 4294967295L) << 32 | var1 & 4294967295L;
   }
