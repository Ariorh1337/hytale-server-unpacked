...
public class SM2P256V1Field {
   ...
   public static void reduce(int[] var0, int[] var1) {
      long var2 = var0[8] & 4294967295L;
      long var4 = var0[9] & 4294967295L;
      long var6 = var0[10] & 4294967295L;
      long var8 = var0[11] & 4294967295L;
      long var10 = var0[12] & 4294967295L;
      long var12 = var0[13] & 4294967295L;
      long var14 = var0[14] & 4294967295L;
      long var16 = var0[15] & 4294967295L;
      ...
      long var32 = 0L;
      var32 += (var0[0] & 4294967295L) + var30 + var12 + var14 + var16;
      var1[0] = (int)var32;
      var32 >>= 32;
      var32 += (var0[1] & 4294967295L) + var30 - var2 + var14 + var16;
      var1[1] = (int)var32;
      var32 >>= 32;
      var32 += (var0[2] & 4294967295L) - var28;
      var1[2] = (int)var32;
      var32 >>= 32;
      var32 += (var0[3] & 4294967295L) + var30 - var4 - var6 + var12;
      var1[3] = (int)var32;
      var32 >>= 32;
      var32 += (var0[4] & 4294967295L) + var30 - var20 - var2 + var14;
      var1[4] = (int)var32;
      var32 >>= 32;
      var32 += (var0[5] & 4294967295L) + var26 + var6;
      var1[5] = (int)var32;
      var32 >>= 32;
      var32 += (var0[6] & 4294967295L) + var8 + var14 + var16;
      var1[6] = (int)var32;
      var32 >>= 32;
      var32 += (var0[7] & 4294967295L) + var30 + var26 + var10;
      var1[7] = (int)var32;
      var32 >>= 32;
   ...
   public static void reduce32(int var0, int[] var1) {
      ...
      if (var0 != 0) {
         ...
         var2 >>= 32;
         if (var2 != 0L) {
            var2 += var1[1] & 4294967295L;
            var1[1] = (int)var2;
            var2 >>= 32;
         }

         var2 += (var1[2] & 4294967295L) - var4;
         var1[2] = (int)var2;
         var2 >>= 32;
         ...
         var2 >>= 32;
         if (var2 != 0L) {
            var2 += var1[4] & 4294967295L;
            var1[4] = (int)var2;
            var2 >>= 32;
            var2 += var1[5] & 4294967295L;
            var1[5] = (int)var2;
            var2 >>= 32;
            var2 += var1[6] & 4294967295L;
            var1[6] = (int)var2;
            var2 >>= 32;
         }

         var2 += (var1[7] & 4294967295L) + var4;
         var1[7] = (int)var2;
         var2 >>= 32;
      }
   ...
   private static void addPInvTo(int[] var0) {
      ...
      var1 >>= 32;
      if (var1 != 0L) {
         var1 += var0[1] & 4294967295L;
         var0[1] = (int)var1;
         var1 >>= 32;
      }

      var1 += (var0[2] & 4294967295L) - 1L;
      var0[2] = (int)var1;
      var1 >>= 32;
      ...
      var1 >>= 32;
      if (var1 != 0L) {
         var1 += var0[4] & 4294967295L;
         var0[4] = (int)var1;
         var1 >>= 32;
         var1 += var0[5] & 4294967295L;
         var0[5] = (int)var1;
         var1 >>= 32;
         var1 += var0[6] & 4294967295L;
         var0[6] = (int)var1;
         var1 >>= 32;
      }

      var1 += (var0[7] & 4294967295L) + 1L;
      var0[7] = (int)var1;
   }
