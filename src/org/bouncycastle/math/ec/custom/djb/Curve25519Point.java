...
public class Curve25519Point extends ECPoint.AbstractFp {
   ...
   public ECFieldElement getZCoord(int var1) {
      return var1 == 1 ? this.getJacobianModifiedW() : super.getZCoord(var1);
   }
   ...
   public ECPoint add(ECPoint var1) {
      ...
      if (var14) {
         ...
         var16 = var12;
         Curve25519Field.square(var5.x, var16);
         var15 = var11;
         Curve25519Field.multiply(var16, var6.x, var15);
         Curve25519Field.multiply(var16, var5.x, var16);
         Curve25519Field.multiply(var16, var7.x, var16);
      }
      ...
      if (var17) {
         ...
         var19 = var13;
         Curve25519Field.square(var8.x, var19);
         var18 = var10;
         Curve25519Field.multiply(var19, var3.x, var18);
         Curve25519Field.multiply(var19, var8.x, var19);
         Curve25519Field.multiply(var19, var4.x, var19);
      }

      int[] var20 = Nat256.create();
      Curve25519Field.subtract(var18, var15, var20);
      int[] var21 = var11;
      Curve25519Field.subtract(var19, var16, var21);
      ...
      int[] var24 = var12;
      Curve25519Field.multiply(var22, var18, var24);
      ...
      Curve25519Field.square(var21, var25.x);
      Curve25519Field.subtract(var25.x, var23, var25.x);
      Curve25519FieldElement var26 = new Curve25519FieldElement(var23);
      Curve25519Field.subtract(var24, var25.x, var26.x);
      Curve25519Field.multiplyAddToExt(var26.x, var21, var10);
   ...
   protected Curve25519FieldElement getJacobianModifiedW() {
      ...
      if (var1 == null) {
         this.zs[1] = var1 = this.calculateJacobianModifiedW((Curve25519FieldElement)this.zs[0], null);
      }
