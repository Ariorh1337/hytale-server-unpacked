...
public class SecP224K1Point extends ECPoint.AbstractFp {
   ...
   public ECPoint add(ECPoint var1) {
      ...
      if (var14) {
         ...
         var16 = var12;
         SecP224K1Field.square(var7.x, var16);
         var15 = var11;
         SecP224K1Field.multiply(var16, var5.x, var15);
         SecP224K1Field.multiply(var16, var7.x, var16);
         SecP224K1Field.multiply(var16, var6.x, var16);
      }
      ...
      if (var17) {
         ...
         var19 = var13;
         SecP224K1Field.square(var8.x, var19);
         var18 = var10;
         SecP224K1Field.multiply(var19, var3.x, var18);
         SecP224K1Field.multiply(var19, var8.x, var19);
         SecP224K1Field.multiply(var19, var4.x, var19);
      }

      int[] var20 = Nat224.create();
      SecP224K1Field.subtract(var18, var15, var20);
      int[] var21 = var11;
      SecP224K1Field.subtract(var19, var16, var21);
      if (Nat224.isZero(var20)) {
         return Nat224.isZero(var21) ? this.twice() : var2.getInfinity();
      }

      int[] var22 = var12;
      SecP224K1Field.square(var20, var22);
      int[] var23 = Nat224.create();
      SecP224K1Field.multiply(var22, var20, var23);
      int[] var24 = var12;
      SecP224K1Field.multiply(var22, var18, var24);
      ...
      SecP224K1Field.square(var21, var25.x);
      SecP224K1Field.subtract(var25.x, var23, var25.x);
      SecP224K1FieldElement var26 = new SecP224K1FieldElement(var23);
      SecP224K1Field.subtract(var24, var25.x, var26.x);
      SecP224K1Field.multiplyAddToExt(var26.x, var21, var10);
   ...
   public ECPoint twice() {
      ...
      int[] var9 = var6;
      SecP224K1Field.multiply(var6, var3.x, var9);
      var5 = Nat.shiftUpBits(7, var9, 2, 0);
      SecP224K1Field.reduce32(var5, var9);
      ...
      SecP224K1Field.subtract(var11.x, var9, var11.x);
      SecP224K1Field.subtract(var11.x, var9, var11.x);
      SecP224K1FieldElement var12 = new SecP224K1FieldElement(var9);
      SecP224K1Field.subtract(var9, var11.x, var12.x);
