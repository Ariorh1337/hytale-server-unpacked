...
public class SecP384R1Field {
   ...
   public static int isZero(int[] var0) {
      return Nat.equalToZero(12, var0);
   }
   ...
   public static void reduce(int[] var0, int[] var1) {
      long var2 = var0[16] & 4294967295L;
      long var4 = var0[17] & 4294967295L;
      long var6 = var0[18] & 4294967295L;
      long var8 = var0[19] & 4294967295L;
      long var10 = var0[20] & 4294967295L;
      long var12 = var0[21] & 4294967295L;
      long var14 = var0[22] & 4294967295L;
      long var16 = var0[23] & 4294967295L;
      long var18 = (var0[12] & 4294967295L) + var10 - 1L;
      long var20 = (var0[13] & 4294967295L) + var14;
      long var22 = (var0[14] & 4294967295L) + var14 + var16;
      long var24 = (var0[15] & 4294967295L) + var16;
      long var26 = var4 + var12;
      long var28 = var12 - var16;
      long var30 = var14 - var16;
      long var32 = var18 + var28;
      long var34 = 0L;
      var34 += (var0[0] & 4294967295L) + var32;
      var1[0] = (int)var34;
      var34 >>= 32;
      var34 += (var0[1] & 4294967295L) + var16 - var18 + var20;
      var1[1] = (int)var34;
      var34 >>= 32;
      var34 += (var0[2] & 4294967295L) - var12 - var20 + var22;
      var1[2] = (int)var34;
      var34 >>= 32;
      var34 += (var0[3] & 4294967295L) - var22 + var24 + var32;
      var1[3] = (int)var34;
      var34 >>= 32;
      var34 += (var0[4] & 4294967295L) + var2 + var12 + var20 - var24 + var32;
      var1[4] = (int)var34;
      var34 >>= 32;
      var34 += (var0[5] & 4294967295L) - var2 + var20 + var22 + var26;
      var1[5] = (int)var34;
      var34 >>= 32;
      var34 += (var0[6] & 4294967295L) + var6 - var4 + var22 + var24;
      var1[6] = (int)var34;
      var34 >>= 32;
      var34 += (var0[7] & 4294967295L) + var2 + var8 - var6 + var24;
      var1[7] = (int)var34;
      var34 >>= 32;
      var34 += (var0[8] & 4294967295L) + var2 + var4 + var10 - var8;
      var1[8] = (int)var34;
      var34 >>= 32;
      var34 += (var0[9] & 4294967295L) + var6 - var10 + var26;
      var1[9] = (int)var34;
      var34 >>= 32;
      var34 += (var0[10] & 4294967295L) + var6 + var8 - var28 + var30;
      var1[10] = (int)var34;
      var34 >>= 32;
      var34 += (var0[11] & 4294967295L) + var8 + var10 - var30;
      var1[11] = (int)var34;
      var34 >>= 32;
   ...
   public static void reduce32(int var0, int[] var1) {
      ...
      if (var0 != 0) {
         ...
         var2 += (var1[0] & 4294967295L) + var4;
         var1[0] = (int)var2;
         var2 >>= 32;
         var2 += (var1[1] & 4294967295L) - var4;
         var1[1] = (int)var2;
         var2 >>= 32;
         if (var2 != 0L) {
            var2 += var1[2] & 4294967295L;
            var1[2] = (int)var2;
            var2 >>= 32;
         }

         var2 += (var1[3] & 4294967295L) + var4;
         var1[3] = (int)var2;
         var2 >>= 32;
         var2 += (var1[4] & 4294967295L) + var4;
         var1[4] = (int)var2;
         var2 >>= 32;
      }
   ...
   private static void addPInvTo(int[] var0) {
      long var1 = (var0[0] & 4294967295L) + 1L;
      var0[0] = (int)var1;
      var1 >>= 32;
      var1 += (var0[1] & 4294967295L) - 1L;
      var0[1] = (int)var1;
      var1 >>= 32;
      if (var1 != 0L) {
         var1 += var0[2] & 4294967295L;
         var0[2] = (int)var1;
         var1 >>= 32;
      }

      var1 += (var0[3] & 4294967295L) + 1L;
      var0[3] = (int)var1;
      var1 >>= 32;
      var1 += (var0[4] & 4294967295L) + 1L;
      var0[4] = (int)var1;
      var1 >>= 32;
      if (var1 != 0L) {
         Nat.incAt(12, var0, 5);
