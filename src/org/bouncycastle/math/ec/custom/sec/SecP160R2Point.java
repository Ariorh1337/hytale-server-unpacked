...
public class SecP160R2Point extends ECPoint.AbstractFp {
   ...
   public ECPoint add(ECPoint var1) {
      ...
      if (var14) {
         ...
         var16 = var12;
         SecP160R2Field.square(var7.x, var16);
         var15 = var11;
         SecP160R2Field.multiply(var16, var5.x, var15);
         SecP160R2Field.multiply(var16, var7.x, var16);
         SecP160R2Field.multiply(var16, var6.x, var16);
      }
      ...
      if (var17) {
         ...
         var19 = var13;
         SecP160R2Field.square(var8.x, var19);
         var18 = var10;
         SecP160R2Field.multiply(var19, var3.x, var18);
         SecP160R2Field.multiply(var19, var8.x, var19);
         SecP160R2Field.multiply(var19, var4.x, var19);
      }

      int[] var20 = Nat160.create();
      SecP160R2Field.subtract(var18, var15, var20);
      int[] var21 = var11;
      SecP160R2Field.subtract(var19, var16, var21);
      if (Nat160.isZero(var20)) {
         return Nat160.isZero(var21) ? this.twice() : var2.getInfinity();
      }

      int[] var22 = var12;
      SecP160R2Field.square(var20, var22);
      int[] var23 = Nat160.create();
      SecP160R2Field.multiply(var22, var20, var23);
      int[] var24 = var12;
      SecP160R2Field.multiply(var22, var18, var24);
      SecP160R2Field.negate(var23, var23);
      Nat160.mul(var19, var23, var10);
      int var9 = Nat160.addBothTo(var24, var24, var23);
      SecP160R2Field.reduce32(var9, var23);
      SecP160R2FieldElement var25 = new SecP160R2FieldElement(var13);
      SecP160R2Field.square(var21, var25.x);
      SecP160R2Field.subtract(var25.x, var23, var25.x);
      SecP160R2FieldElement var26 = new SecP160R2FieldElement(var23);
      SecP160R2Field.subtract(var24, var25.x, var26.x);
      SecP160R2Field.multiplyAddToExt(var26.x, var21, var10);
   ...
   public ECPoint twice() {
      ...
      if (!var10) {
         var11 = var7;
         SecP160R2Field.square(var4.x, var11);
      }

      SecP160R2Field.subtract(var3.x, var11, var6);
      int[] var12 = var7;
      SecP160R2Field.add(var3.x, var11, var12);
      SecP160R2Field.multiply(var12, var6, var12);
      int var5 = Nat160.addBothTo(var12, var12, var12);
      SecP160R2Field.reduce32(var5, var12);
      int[] var13 = var8;
      SecP160R2Field.multiply(var8, var3.x, var13);
      var5 = Nat.shiftUpBits(5, var13, 2, 0);
      SecP160R2Field.reduce32(var5, var13);
      ...
      SecP160R2Field.square(var12, var14.x);
      SecP160R2Field.subtract(var14.x, var13, var14.x);
      SecP160R2Field.subtract(var14.x, var13, var14.x);
      SecP160R2FieldElement var15 = new SecP160R2FieldElement(var13);
      SecP160R2Field.subtract(var13, var14.x, var15.x);
      SecP160R2Field.multiply(var15.x, var12, var15.x);
      SecP160R2Field.subtract(var15.x, var6, var15.x);
      SecP160R2FieldElement var16 = new SecP160R2FieldElement(var12);
