...
public class SecP384R1FieldElement extends ECFieldElement.AbstractFp {
   public static final BigInteger Q = new BigInteger(
      1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFF0000000000000000FFFFFFFF")
   );
   protected int[] x;
   ...
   public ECFieldElement sqrt() {
      ...
      if (!Nat.isZero(12, var1) && !Nat.isOne(12, var1)) {
         ...
         SecP384R1Field.multiply(var5, var4, var5, var2);
         int[] var7 = var4;
         SecP384R1Field.squareN(var5, 120, var7, var2);
         SecP384R1Field.multiply(var7, var5, var7, var2);
         SecP384R1Field.squareN(var7, 15, var7, var2);
         SecP384R1Field.multiply(var7, var6, var7, var2);
         SecP384R1Field.squareN(var7, 33, var7, var2);
         SecP384R1Field.multiply(var7, var3, var7, var2);
         SecP384R1Field.squareN(var7, 64, var7, var2);
         SecP384R1Field.multiply(var7, var1, var7, var2);
         SecP384R1Field.squareN(var7, 30, var3, var2);
   ...
   public boolean equals(Object var1) {
      ...
      if (!(var1 instanceof SecP384R1FieldElement)) {
         return false;
      }
