...
public class SecP384R1Point extends ECPoint.AbstractFp {
   ...
   public ECPoint add(ECPoint var1) {
      ...
      if (var15) {
         ...
         var17 = var13;
         SecP384R1Field.square(var7.x, var17, var10);
         var16 = var12;
         SecP384R1Field.multiply(var17, var5.x, var16, var10);
         SecP384R1Field.multiply(var17, var7.x, var17, var10);
         SecP384R1Field.multiply(var17, var6.x, var17, var10);
      }
      ...
      if (var18) {
         ...
         var20 = var14;
         SecP384R1Field.square(var8.x, var20, var10);
         var19 = var11;
         SecP384R1Field.multiply(var20, var3.x, var19, var10);
         SecP384R1Field.multiply(var20, var8.x, var20, var10);
         SecP384R1Field.multiply(var20, var4.x, var20, var10);
      }
      ...
      int[] var23 = var13;
      SecP384R1Field.square(var21, var23, var10);
      int[] var24 = Nat.create(12);
      SecP384R1Field.multiply(var23, var21, var24, var10);
      int[] var25 = var13;
      SecP384R1Field.multiply(var23, var19, var25, var10);
      SecP384R1Field.negate(var24, var24);
      Nat384.mul(var20, var24, var11);
      int var9 = Nat.addBothTo(12, var25, var25, var24);
      ...
      SecP384R1Field.subtract(var25, var26.x, var27.x);
   ...
   public ECPoint twice() {
      ...
      if (!var11) {
         var12 = var8;
         SecP384R1Field.square(var4.x, var12, var6);
      }

      SecP384R1Field.subtract(var3.x, var12, var7);
      int[] var13 = var8;
      SecP384R1Field.add(var3.x, var12, var13);
      SecP384R1Field.multiply(var13, var7, var13, var6);
      int var5 = Nat.addBothTo(12, var13, var13, var13);
      SecP384R1Field.reduce32(var5, var13);
      int[] var14 = var9;
      SecP384R1Field.multiply(var9, var3.x, var14, var6);
      var5 = Nat.shiftUpBits(12, var14, 2, 0);
      SecP384R1Field.reduce32(var5, var14);
      ...
      SecP384R1Field.square(var13, var15.x, var6);
      SecP384R1Field.subtract(var15.x, var14, var15.x);
      SecP384R1Field.subtract(var15.x, var14, var15.x);
      SecP384R1FieldElement var16 = new SecP384R1FieldElement(var14);
      SecP384R1Field.subtract(var14, var15.x, var16.x);
      SecP384R1Field.multiply(var16.x, var13, var16.x, var6);
      SecP384R1Field.subtract(var16.x, var7, var16.x);
      SecP384R1FieldElement var17 = new SecP384R1FieldElement(var13);
