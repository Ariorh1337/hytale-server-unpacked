...
public class SecT233K1Point extends ECPoint.AbstractF2m {
   ...
   public ECPoint add(ECPoint var1) {
      ...
      if (!var9) {
         var10 = var10.multiply(var6);
         var11 = var11.multiply(var6);
      }
      ...
      if (var4.isZero()) {
         ...
         ECFieldElement var22 = var7;
         ECFieldElement var23 = var21.add(var22).divide(var3);
         ...
         ECFieldElement var29 = var15.multiply(var16);
         if (!var12) {
            var29 = var29.multiply(var8);
         }

         var18 = var28.add(var16).squarePlusProduct(var29, var5.add(var6));
         var19 = var29;
         if (!var9) {
            var19 = var19.multiply(var6);
         }
      }
