...
public class SecP128R1FieldElement extends ECFieldElement.AbstractFp {
   ...
   public ECFieldElement sqrt() {
      ...
      if (!Nat128.isZero(var1) && !Nat128.isOne(var1)) {
         ...
         int[] var5 = var3;
         SecP128R1Field.squareN(var4, 2, var5);
         SecP128R1Field.multiply(var5, var2, var5);
         int[] var6 = var2;
         SecP128R1Field.squareN(var5, 10, var6);
         SecP128R1Field.multiply(var6, var5, var6);
         int[] var7 = var4;
         SecP128R1Field.squareN(var6, 10, var7);
         SecP128R1Field.multiply(var7, var5, var7);
         int[] var8 = var5;
         SecP128R1Field.square(var7, var8);
         SecP128R1Field.multiply(var8, var1, var8);
         int[] var9 = var8;
         SecP128R1Field.squareN(var9, 95, var9);
         int[] var10 = var7;
         SecP128R1Field.square(var9, var10);
         return Nat128.eq(var1, var10) ? new SecP128R1FieldElement(var9) : null;
      } else {
         return this;
      }
   }
   ...
   public boolean equals(Object var1) {
      ...
      if (!(var1 instanceof SecP128R1FieldElement)) {
         return false;
      }
