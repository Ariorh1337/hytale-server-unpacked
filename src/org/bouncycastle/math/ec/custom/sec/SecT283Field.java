...
public class SecT283Field {
   ...
   public static void halfTrace(long[] var0, long[] var1) {
      ...
      for (byte var3 = 1; var3 < 283; var3 += 2) {
   ...
   protected static void implMultiply(long[] var0, long[] var1, long[] var2) {
      ...
      implMulw(var5, var3[0], var4[0], var6, 0);
      implMulw(var5, var3[1], var4[1], var6, 2);
      implMulw(var5, var3[2], var4[2], var6, 4);
      implMulw(var5, var3[3], var4[3], var6, 6);
      implMulw(var5, var3[4], var4[4], var6, 8);
      ...
      implMulw(var5, var11 ^ var3[3], var13 ^ var4[3], var6, 18);
      implMulw(var5, var15 ^ var3[1], var17 ^ var4[1], var6, 20);
      long var23 = var7 ^ var19;
      long var25 = var9 ^ var21;
      long var27 = var23 ^ var3[2];
      long var29 = var25 ^ var4[2];
      implMulw(var5, var23, var25, var6, 22);
      implMulw(var5, var27, var29, var6, 24);
      implMulw(var5, var7, var9, var6, 10);
      implMulw(var5, var11, var13, var6, 12);
      implMulw(var5, var15, var17, var6, 14);
      implMulw(var5, var19, var21, var6, 16);
      var2[0] = var6[0];
      var2[9] = var6[9];
