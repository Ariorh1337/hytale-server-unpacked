...
public abstract class ECPoint {
      ...
      if (!var6 && !var7) {
         ...
         if (!var4 || !var5) {
            if (var4) {
               ...
               ECPoint[] var10 = new ECPoint[]{this, var2.importPoint(var9)};
   ...
   public abstract static class AbstractF2m extends ECPoint {
      ...
      protected boolean satisfiesCurveEquation() {
         ...
         if (var5 == 6) {
            ...
            if (var2.isZero()) {
               ...
               if (!var15) {
                  var23 = var23.multiply(var14.square());
               }
      ...
      protected boolean satisfiesOrder() {
         ...
         if (ECConstants.FOUR.equals(var1)) {
            ECPoint var2 = this.normalize();
      ...
      public ECPoint subtract(ECPoint var1) {
         return var1.isInfinity() ? this : this.add(var1.negate());
      }
      ...
      public ECPoint.AbstractF2m tau() {
         ...
         switch (var2) {
            ...
            case 5:
               ECFieldElement var6 = this.y;
               return (ECPoint.AbstractF2m)var1.createRawPoint(var3.square(), var6.square());
            case 1:
            case 6:
               ECFieldElement var4 = this.y;
               ECFieldElement var5 = this.zs[0];
               return (ECPoint.AbstractF2m)var1.createRawPoint(var3.square(), var4.square(), new ECFieldElement[]{var5.square()});
            case 2:
            case 3:
            case 4:
            default:
      ...
      public ECPoint.AbstractF2m tauPow(int var1) {
         ...
         switch (var3) {
            ...
            case 5:
               ...
               return (ECPoint.AbstractF2m)var2.createRawPoint(var4.squarePow(var1), var7.squarePow(var1));
            case 1:
            case 6:
               ECFieldElement var5 = this.y;
               ECFieldElement var6 = this.zs[0];
               return (ECPoint.AbstractF2m)var2.createRawPoint(var4.squarePow(var1), var5.squarePow(var1), new ECFieldElement[]{var6.squarePow(var1)});
            case 2:
            case 3:
            case 4:
            default:
   ...
   public static class F2m extends ECPoint.AbstractF2m {
      ...
      protected ECPoint detach() {
         return new ECPoint.F2m(null, this.getAffineXCoord(), this.getAffineYCoord());
      }
      ...
      public ECPoint add(ECPoint var1) {
         ...
         switch (var3) {
            case 0:
               ...
               return new ECPoint.F2m(var2, var38, var40);
            case 1:
               ...
               ECFieldElement var55 = var35 ? var46 : var46.multiply(var33);
               ECFieldElement var56 = var41.multiplyPlusProduct(var4, var44, var27).multiplyPlusProduct(var55, var49, var51);
               ECFieldElement var57 = var47.multiply(var48);
               return new ECPoint.F2m(var2, var53, var56, new ECFieldElement[]{var57});
            case 6:
               if (var4.isZero()) {
                  if (var5.isZero()) {
                     return var2.getInfinity();
                  ...
                  if (!var10) {
                     var11 = var11.multiply(var7);
                     var12 = var12.multiply(var7);
                  }
                  ...
                  if (!var13) {
                     var14 = var14.multiply(var9);
                     var15 = var15.multiply(var9);
                  }
                  ...
                  if (var17.isZero()) {
                     ...
                     if (var5.isZero()) {
                        ...
                        ECFieldElement var23 = var8;
                        ECFieldElement var24 = var22.add(var23).divide(var4);
                        var18 = var24.square().add(var24).add(var4).add(var2.getA());
                        if (var18.isZero()) {
                           return new ECPoint.F2m(var2, var18, var2.getB().sqrt());
                        }
                        ...
                        ECFieldElement var54 = var16.multiply(var17);
                        if (!var13) {
                           var54 = var54.multiply(var9);
                        }

                        var19 = var52.add(var17).squarePlusProduct(var54, var6.add(var7));
                        var20 = var54;
                        if (!var10) {
                           var20 = var20.multiply(var7);
                        }
                     }

                     return new ECPoint.F2m(var2, var18, var19, new ECFieldElement[]{var20});
                  }
               }
            default:
               throw new IllegalStateException("unsupported coordinate system");
      ...
      public ECPoint twice() {
         ...
         switch (var3) {
            case 0:
               ...
               return new ECPoint.F2m(var1, var23, var25);
            case 1:
               ECFieldElement var18 = this.y;
               ...
               ECFieldElement var29 = var24;
               ECFieldElement var30 = var29.square();
               ECFieldElement var31 = var28.add(var29);
               ECFieldElement var32 = var31.multiplyPlusProduct(var28, var30, var1.getA());
               ECFieldElement var33 = var29.multiply(var32);
               ECFieldElement var35 = var27.square().multiplyPlusProduct(var29, var32, var31);
               ECFieldElement var36 = var29.multiply(var30);
               return new ECPoint.F2m(var1, var33, var35, new ECFieldElement[]{var36});
            case 6:
               ECFieldElement var4 = this.y;
               ECFieldElement var5 = this.zs[0];
               ...
               if (var11.isZero()) {
                  return new ECPoint.F2m(var1, var11, var1.getB().sqrt());
               }
               ...
               if (var14.bitLength() < var1.getFieldSize() >> 1) {
                  ...
                  ECFieldElement var34 = var6 ? var2 : var2.multiply(var5);
                  var15 = var34.squarePlusProduct(var11, var7).add(var12).add(var13);
               }

               return new ECPoint.F2m(var1, var12, var15, new ECFieldElement[]{var13});
            default:
               throw new IllegalStateException("unsupported coordinate system");
         }
      }
         ...
         switch (var4) {
            case 6:
               ...
               if (!var5.isZero() && var6.isOne()) {
                  ...
                  if (var16.isZero()) {
                     return new ECPoint.F2m(var2, var16, var2.getB().sqrt());
                  }
                  ...
                  return new ECPoint.F2m(var2, var19, var21, new ECFieldElement[]{var20});
               }
      ...
      public ECPoint negate() {
         ...
         switch (this.getCurveCoordinateSystem()) {
            case 0:
               ECFieldElement var6 = this.y;
               return new ECPoint.F2m(this.curve, var1, var6.add(var1));
            case 1:
               ECFieldElement var5 = this.y;
               ECFieldElement var7 = this.zs[0];
               return new ECPoint.F2m(this.curve, var1, var5.add(var1), new ECFieldElement[]{var7});
            case 2:
            case 3:
            case 4:
            default:
            ...
            case 5:
               ECFieldElement var4 = this.y;
               return new ECPoint.F2m(this.curve, var1, var4.addOne());
            case 6:
               ECFieldElement var2 = this.y;
               ECFieldElement var3 = this.zs[0];
               return new ECPoint.F2m(this.curve, var1, var2.add(var3), new ECFieldElement[]{var3});
         }
      }
   }
   ...
   public static class Fp extends ECPoint.AbstractFp {
      ...
      public ECPoint add(ECPoint var1) {
         ...
         switch (var3) {
            case 0:
               ...
               return new ECPoint.Fp(var2, var34, var36);
            case 1:
               ...
               ECFieldElement var38 = var33 ? var5 : var5.multiply(var29);
               ECFieldElement var39 = var35.subtract(var38);
               ECFieldElement var42 = var31 ? var6 : var6.multiply(var27);
               ECFieldElement var45 = var33 ? var4 : var4.multiply(var29);
               ECFieldElement var47 = var42.subtract(var45);
               if (var47.isZero()) {
                  if (var39.isZero()) {
                     return this.twice();
                  }
               ...
               ECFieldElement var50 = var31 ? var29 : (var33 ? var27 : var27.multiply(var29));
               ECFieldElement var52 = var47.square();
               ECFieldElement var54 = var52.multiply(var47);
               ECFieldElement var55 = var52.multiply(var45);
               ECFieldElement var57 = var39.square().multiply(var50).subtract(var54).subtract(this.two(var55));
               ECFieldElement var58 = var47.multiply(var57);
               ECFieldElement var59 = var55.subtract(var57).multiplyMinusProduct(var39, var38, var54);
               ECFieldElement var60 = var54.multiply(var50);
               return new ECPoint.Fp(var2, var58, var59, new ECFieldElement[]{var60});
            case 2:
            case 4:
               ECFieldElement var8 = this.zs[0];
               ECFieldElement var9 = var1.zs[0];
               ...
               if (!var10 && var8.equals(var9)) {
                  ECFieldElement var40 = var4.subtract(var6);
                  ECFieldElement var43 = var5.subtract(var7);
                  if (var40.isZero()) {
                     if (var43.isZero()) {
                        return this.twice();
                     }
                  ...
                  ECFieldElement var46 = var40.square();
                  ECFieldElement var49 = var4.multiply(var46);
                  ECFieldElement var51 = var6.multiply(var46);
                  ECFieldElement var53 = var49.subtract(var51).multiply(var5);
                  var11 = var43.square().subtract(var49).subtract(var51);
                  var12 = var49.subtract(var11).multiply(var43).subtract(var53);
                  var13 = var40;
                  var13 = var13.multiply(var8);
               } else {
                  ...
                  ECFieldElement var56 = var20.subtract(var16);
                  ...
                  ECFieldElement var24 = var56.square();
                  ECFieldElement var25 = var24.multiply(var56);
               ...
               ECFieldElement[] var41;
               if (var3 == 4) {
                  ECFieldElement var44 = this.calculateJacobianModifiedW(var13, var14);
                  var41 = new ECFieldElement[]{var13, var44};
               } else {
                  var41 = new ECFieldElement[]{var13};
               }

               return new ECPoint.Fp(var2, var11, var12, var41);
            case 3:
            default:
               throw new IllegalStateException("unsupported coordinate system");
         }
      ...
      public ECPoint twice() {
         ...
         switch (var3) {
            case 0:
               ...
               return new ECPoint.Fp(var1, var25, var27);
            case 1:
               ...
               return new ECPoint.Fp(var1, var36, var16, new ECFieldElement[]{var18});
            case 2:
               ECFieldElement var5 = this.zs[0];
               boolean var6 = var5.isOne();
               ...
               return new ECPoint.Fp(var1, var33, var35, new ECFieldElement[]{var37});
            case 3:
            default:
               throw new IllegalStateException("unsupported coordinate system");
            case 4:
         ...
         switch (var4) {
            case 0:
               ...
               if (var8.isZero()) {
                  ...
                  return new ECPoint.Fp(var3, var17, var18);
               }
            case 4:
      ...
      public ECPoint threeTimes() {
         ...
         switch (var3) {
            case 0:
               ...
               return new ECPoint.Fp(var2, var14, var15);
            case 4:
         ...
         if (var1 != 0 && !this.isInfinity()) {
            ...
            if (!var7.isOne()) {
               switch (var4) {
                  ...
                  case 1:
                     ...
                     break;
                  case 2:
                     var5 = this.calculateJacobianModifiedW(var7, null);
                     break;
                  case 3:
                  default:
                     throw new IllegalStateException("unsupported coordinate system");
            ...
            switch (var4) {
               case 0:
                  ...
                  return new ECPoint.Fp(var2, var6.multiply(var20), var3.multiply(var21));
               case 1:
                  var6 = var6.multiply(var7);
                  var7 = var7.multiply(var7.square());
                  return new ECPoint.Fp(var2, var6, var3, new ECFieldElement[]{var7});
               case 2:
                  return new ECPoint.Fp(var2, var6, var3, new ECFieldElement[]{var7});
               case 3:
               default:
                  throw new IllegalStateException("unsupported coordinate system");
               case 4:
                  return new ECPoint.Fp(var2, var6, var3, new ECFieldElement[]{var7, var5});
            }
         } else {
            return this;
         }
      ...
      public ECPoint negate() {
         ...
         ECCurve var1 = this.getCurve();
         int var2 = var1.getCoordinateSystem();
         return 0 != var2 ? new ECPoint.Fp(var1, this.x, this.y.negate(), this.zs) : new ECPoint.Fp(var1, this.x, this.y.negate());
      }
      ...
      protected ECFieldElement getJacobianModifiedW() {
         ...
         if (var1 == null) {
            this.zs[1] = var1 = this.calculateJacobianModifiedW(this.zs[0], null);
         }
      ...
      protected ECPoint.Fp twiceJacobianModified(boolean var1) {
         ...
         return new ECPoint.Fp(this.getCurve(), var11, var14, new ECFieldElement[]{var16, var15});
      }
   }
}
