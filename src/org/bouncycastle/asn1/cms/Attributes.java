...
public class Attributes extends ASN1Object {
   ...
   public static Attributes getInstance(ASN1TaggedObject var0, boolean var1) {
      return new Attributes(ASN1Set.getInstance(var0, var1));
   }

   public static Attributes getTagged(ASN1TaggedObject var0, boolean var1) {
      return new Attributes(ASN1Set.getTagged(var0, var1));
   }
