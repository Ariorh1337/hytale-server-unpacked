   ...
   public static class MemUtilUnsafe extends MemUtil.MemUtilNIO {
      ...
      public static void getTransposed(Matrix4f m, long srcAddr) {
         ...
         m._m00(u.getFloat(srcAddr))
            ._m10(u.getFloat(srcAddr + 4L))
            ._m20(u.getFloat(srcAddr + 8L))
            ._m30(u.getFloat(srcAddr + 12L))
            ._m01(u.getFloat(srcAddr + 16L))
            ._m11(u.getFloat(srcAddr + 20L))
            ._m21(u.getFloat(srcAddr + 24L))
            ._m31(u.getFloat(srcAddr + 28L))
            ._m02(u.getFloat(srcAddr + 32L))
            ._m12(u.getFloat(srcAddr + 36L))
            ._m22(u.getFloat(srcAddr + 40L))
            ._m32(u.getFloat(srcAddr + 44L))
            ._m03(u.getFloat(srcAddr + 48L))
            ._m13(u.getFloat(srcAddr + 52L))
            ._m23(u.getFloat(srcAddr + 56L))
            ._m33(u.getFloat(srcAddr + 60L));
      }
      ...
      public static void getTransposed(Matrix3f m, long srcAddr) {
         ...
         m._m00(u.getFloat(srcAddr))
            ._m10(u.getFloat(srcAddr + 4L))
            ._m20(u.getFloat(srcAddr + 8L))
            ._m01(u.getFloat(srcAddr + 12L))
            ._m11(u.getFloat(srcAddr + 16L))
            ._m21(u.getFloat(srcAddr + 20L))
            ._m02(u.getFloat(srcAddr + 24L))
            ._m12(u.getFloat(srcAddr + 28L))
            ._m22(u.getFloat(srcAddr + 32L));
      }
      ...
      public static void getTransposed(Matrix4x3d m, long srcAddr) {
         ...
         m._m00(u.getDouble(srcAddr))
            ._m10(u.getDouble(srcAddr + 8L))
            ._m20(u.getDouble(srcAddr + 16L))
            ._m30(u.getDouble(srcAddr + 24L))
            ._m01(u.getDouble(srcAddr + 32L))
            ._m11(u.getDouble(srcAddr + 40L))
            ._m21(u.getDouble(srcAddr + 48L))
            ._m31(u.getDouble(srcAddr + 56L))
            ._m02(u.getDouble(srcAddr + 64L))
            ._m12(u.getDouble(srcAddr + 72L))
            ._m22(u.getDouble(srcAddr + 80L))
      ...
      public static void getTransposed(Matrix3x2d m, long srcAddr) {
         ...
         m._m00(u.getDouble(srcAddr))
            ._m10(u.getDouble(srcAddr + 8L))
            ._m20(u.getDouble(srcAddr + 16L))
            ._m01(u.getDouble(srcAddr + 24L))
            ._m11(u.getDouble(srcAddr + 32L))
            ._m21(u.getDouble(srcAddr + 40L));
      }
      ...
      public static void getTransposed(Matrix3d m, long srcAddr) {
         ...
         m._m00(u.getDouble(srcAddr))
            ...
            ._m11(u.getDouble(srcAddr + 32L))
            ._m21(u.getDouble(srcAddr + 40L))
            ._m02(u.getDouble(srcAddr + 48L))
            ._m12(u.getDouble(srcAddr + 56L))
            ._m22(u.getDouble(srcAddr + 64L));
      }
      ...
      public static void getTransposed(Matrix4d m, long srcAddr) {
         ...
         m._m00(u.getDouble(srcAddr))
            ...
            ._m22(u.getDouble(srcAddr + 80L))
            ._m32(u.getDouble(srcAddr + 88L))
            ._m03(u.getDouble(srcAddr + 96L))
            ._m13(u.getDouble(srcAddr + 104L))
            ._m23(u.getDouble(srcAddr + 112L))
            ._m33(u.getDouble(srcAddr + 120L));
      }
      ...
      public float get(Matrix3f m, int column, int row) {
         return UNSAFE.getFloat(m, Matrix3f_m00 + column * 12L + ((long)row << 2));
      }

      public Matrix3f set(Matrix3f m, int column, int row, float value) {
         UNSAFE.putFloat(m, Matrix3f_m00 + column * 12L + ((long)row << 2), value);
         return m;
      }

      public double get(Matrix3d m, int column, int row) {
         return UNSAFE.getDouble(m, Matrix3d_m00 + column * 24L + ((long)row << 3));
      }

      public Matrix3d set(Matrix3d m, int column, int row, double value) {
         UNSAFE.putDouble(m, Matrix3d_m00 + column * 24L + ((long)row << 3), value);
         return m;
      }
