...
public interface Vector4fc {
   ...
   Vector4f mulGeneric(Matrix4fc var1, Vector4f var2);

   Vector4f mulTranspose(Matrix4fc var1, Vector4f var2);

   Vector4f mulTranslation(Matrix4fc var1, Vector4f var2);

   Vector4f mulAffine(Matrix4fc var1, Vector4f var2);

   Vector4f mulAffineTranspose(Matrix4fc var1, Vector4f var2);

   Vector4f mulGenericTranspose(Matrix4fc var1, Vector4f var2);

   Vector4f mul(Matrix4x3fc var1, Vector4f var2);

   Vector4f mulTranslation(Matrix4x3fc var1, Vector4f var2);

   Vector4f mulGeneric(Matrix4x3fc var1, Vector4f var2);
   ...
   Vector4f mulProjectGeneric(Matrix4fc var1, Vector4f var2);

   Vector3f mulProjectTranslation(Matrix4fc var1, Vector3f var2);

   Vector4f mulProjectTranslation(Matrix4fc var1, Vector4f var2);

   Vector3f mulProjectAffine(Matrix4fc var1, Vector3f var2);

   Vector4f mulProjectAffine(Matrix4fc var1, Vector4f var2);
