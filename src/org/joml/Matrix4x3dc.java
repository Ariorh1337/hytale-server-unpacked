...
public interface Matrix4x3dc {
   ...
   Matrix4x3d mul3x3(double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, double var17, Matrix4x3d var19);
   ...
   Matrix4x3dc getTransposedToAddress(long var1);
   ...
   Matrix4x3d scaleAround(double var1, double var3, double var5, double var7, double var9, double var11, Matrix4x3d var13);

   Matrix4x3d scaleAround(double var1, double var3, double var5, double var7, Matrix4x3d var9);
   ...
   Matrix4x3d lookAtLH(
      double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, double var17, Matrix4x3d var19
   );
   ...
   Matrix4x3d mapXZY(Matrix4x3d var1);

   Matrix4x3d mapXZnY(Matrix4x3d var1);

   Matrix4x3d mapXnYnZ(Matrix4x3d var1);

   Matrix4x3d mapXnZY(Matrix4x3d var1);

   Matrix4x3d mapXnZnY(Matrix4x3d var1);

   Matrix4x3d mapYXZ(Matrix4x3d var1);

   Matrix4x3d mapYXnZ(Matrix4x3d var1);

   Matrix4x3d mapYZX(Matrix4x3d var1);

   Matrix4x3d mapYZnX(Matrix4x3d var1);

   Matrix4x3d mapYnXZ(Matrix4x3d var1);

   Matrix4x3d mapYnXnZ(Matrix4x3d var1);

   Matrix4x3d mapYnZX(Matrix4x3d var1);

   Matrix4x3d mapYnZnX(Matrix4x3d var1);

   Matrix4x3d mapZXY(Matrix4x3d var1);

   Matrix4x3d mapZXnY(Matrix4x3d var1);

   Matrix4x3d mapZYX(Matrix4x3d var1);

   Matrix4x3d mapZYnX(Matrix4x3d var1);

   Matrix4x3d mapZnXY(Matrix4x3d var1);

   Matrix4x3d mapZnXnY(Matrix4x3d var1);

   Matrix4x3d mapZnYX(Matrix4x3d var1);

   Matrix4x3d mapZnYnX(Matrix4x3d var1);

   Matrix4x3d mapnXYnZ(Matrix4x3d var1);

   Matrix4x3d mapnXZY(Matrix4x3d var1);

   Matrix4x3d mapnXZnY(Matrix4x3d var1);

   Matrix4x3d mapnXnYZ(Matrix4x3d var1);

   Matrix4x3d mapnXnYnZ(Matrix4x3d var1);

   Matrix4x3d mapnXnZY(Matrix4x3d var1);

   Matrix4x3d mapnXnZnY(Matrix4x3d var1);

   Matrix4x3d mapnYXZ(Matrix4x3d var1);

   Matrix4x3d mapnYXnZ(Matrix4x3d var1);

   Matrix4x3d mapnYZX(Matrix4x3d var1);

   Matrix4x3d mapnYZnX(Matrix4x3d var1);

   Matrix4x3d mapnYnXZ(Matrix4x3d var1);

   Matrix4x3d mapnYnXnZ(Matrix4x3d var1);

   Matrix4x3d mapnYnZX(Matrix4x3d var1);

   Matrix4x3d mapnYnZnX(Matrix4x3d var1);

   Matrix4x3d mapnZXY(Matrix4x3d var1);

   Matrix4x3d mapnZXnY(Matrix4x3d var1);

   Matrix4x3d mapnZYX(Matrix4x3d var1);

   Matrix4x3d mapnZYnX(Matrix4x3d var1);

   Matrix4x3d mapnZnXY(Matrix4x3d var1);

   Matrix4x3d mapnZnXnY(Matrix4x3d var1);

   Matrix4x3d mapnZnYX(Matrix4x3d var1);

   Matrix4x3d mapnZnYnX(Matrix4x3d var1);

   Matrix4x3d negateX(Matrix4x3d var1);

   Matrix4x3d negateY(Matrix4x3d var1);

   Matrix4x3d negateZ(Matrix4x3d var1);
