...
public interface Vector4dc {
   ...
   Vector4d mulGeneric(Matrix4x3dc var1, Vector4d var2);

   Vector4d mulTranslation(Matrix4x3dc var1, Vector4d var2);

   Vector4d mul(Matrix4x3fc var1, Vector4d var2);

   Vector4d mulTranslation(Matrix4x3fc var1, Vector4d var2);

   Vector4d mulGeneric(Matrix4x3fc var1, Vector4d var2);

   Vector4d mul(Matrix4fc var1, Vector4d var2);

   Vector4d mulGeneric(Matrix4dc var1, Vector4d var2);

   Vector4d mulGeneric(Matrix4fc var1, Vector4d var2);

   Vector4d mulTranspose(Matrix4dc var1, Vector4d var2);

   Vector4d mulTranslation(Matrix4dc var1, Vector4d var2);

   Vector4d mulTranslation(Matrix4fc var1, Vector4d var2);

   Vector4d mulAffine(Matrix4dc var1, Vector4d var2);

   Vector4d mulAffine(Matrix4fc var1, Vector4d var2);

   Vector4d mulAffineTranspose(Matrix4dc var1, Vector4d var2);

   Vector4d mulGenericTranspose(Matrix4dc var1, Vector4d var2);

   Vector4d mulProject(Matrix4dc var1, Vector4d var2);

   Vector3d mulProject(Matrix4dc var1, Vector3d var2);

   Vector3d mulProjectGeneric(Matrix4dc var1, Vector3d var2);

   Vector4d mulProjectGeneric(Matrix4dc var1, Vector4d var2);

   Vector3d mulProjectTranslation(Matrix4dc var1, Vector3d var2);

   Vector4d mulProjectTranslation(Matrix4dc var1, Vector4d var2);

   Vector3d mulProjectAffine(Matrix4dc var1, Vector3d var2);

   Vector4d mulProjectAffine(Matrix4dc var1, Vector4d var2);
