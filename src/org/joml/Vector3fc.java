...
public interface Vector3fc {
   ...
   Vector3f mulProjectTranslation(Matrix4fc var1, Vector3f var2);

   Vector3f mulProjectTranslation(Matrix4dc var1, Vector3f var2);

   Vector3f mulProjectAffine(Matrix4fc var1, Vector3f var2);

   Vector3f mulProjectAffine(Matrix4dc var1, Vector3f var2);

   Vector3f mulProjectGeneric(Matrix4fc var1, Vector3f var2);

   Vector3f mulProjectGeneric(Matrix4dc var1, Vector3f var2);
   ...
   Vector3f mul(Matrix3x2dc var1, Vector3f var2);

   Vector3f mulTranspose(Matrix3fc var1, Vector3f var2);

   Vector3f mulPosition(Matrix4fc var1, Vector3f var2);

   Vector3f mulPosition(Matrix4dc var1, Vector3f var2);

   Vector3f mulPosition(Matrix4x3fc var1, Vector3f var2);

   Vector3f mulPosition(Matrix4x3dc var1, Vector3f var2);

   Vector3f mulPositionGeneric(Matrix4fc var1, Vector3f var2);

   Vector3f mulPositionGeneric(Matrix4dc var1, Vector3f var2);

   Vector3f mulPositionTranslation(Matrix4fc var1, Vector3f var2);

   Vector3f mulPositionTranslation(Matrix4dc var1, Vector3f var2);

   Vector3f mulPositionTranslation(Matrix4x3fc var1, Vector3f var2);

   Vector3f mulPositionTranslation(Matrix4x3dc var1, Vector3f var2);

   Vector3f mulTransposePosition(Matrix4fc var1, Vector3f var2);

   Vector3f mulTransposePosition(Matrix4dc var1, Vector3f var2);

   float mulPositionW(Matrix4fc var1, Vector3f var2);

   float mulPositionW(Matrix4dc var1, Vector3f var2);
   ...
   Vector3f mulDirection(Matrix4x3dc var1, Vector3f var2);
