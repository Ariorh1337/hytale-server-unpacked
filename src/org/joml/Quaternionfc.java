...
public interface Quaternionfc {
   ...
   Quaternionf sub(float var1, float var2, float var3, float var4, Quaternionf var5);

   Quaternionf sub(Quaternionfc var1, Quaternionf var2);
   ...
   Quaternionf mul(float var1, Quaternionf var2);
   ...
   Quaternionf div(float var1, Quaternionf var2);
   ...
   Vector3f getEulerAnglesZXY(Vector3f var1);
