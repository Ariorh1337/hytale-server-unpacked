...
public class Matrix4d implements Externalizable, Cloneable, Matrix4dc {
   ...
   public Matrix4d invertOrtho(Matrix4d dest) {
      ...
      dest.set(invM00, 0.0, 0.0, 0.0, 0.0, invM11, 0.0, 0.0, 0.0, 0.0, invM22, 0.0, -this.m30 * invM00, -this.m31 * invM11, -this.m32 * invM22, 1.0)
   ...
   public Matrix4d setTranslation(double x, double y, double z) {
      this._m30(x)._m31(y)._m32(z).properties &= -6;
      return this;
   }
   ...
   public Vector4d transform(double x, double y, double z, double w, Vector4d dest) {
      return dest.set(
         ...
         this.m03 * x + this.m13 * y + this.m23 * z + this.m33 * w
      );
   }
   ...
   public Vector4d transformProject(double x, double y, double z, double w, Vector4d dest) {
      ...
      return dest.set(
         (this.m00 * x + this.m10 * y + this.m20 * z + this.m30 * w) * invW,
         (this.m01 * x + this.m11 * y + this.m21 * z + this.m31 * w) * invW,
         (this.m02 * x + this.m12 * y + this.m22 * z + this.m32 * w) * invW,
         1.0
      );
   }
   ...
   public Vector3d transformProject(double x, double y, double z, Vector3d dest) {
      ...
      return dest.set(
         (this.m00 * x + this.m10 * y + this.m20 * z + this.m30) * invW,
         (this.m01 * x + this.m11 * y + this.m21 * z + this.m31) * invW,
         (this.m02 * x + this.m12 * y + this.m22 * z + this.m32) * invW
      );
   }
   ...
   public Vector3d transformPosition(Vector3d dest) {
      return dest.set(
         this.m00 * dest.x + this.m10 * dest.y + this.m20 * dest.z + this.m30,
         this.m01 * dest.x + this.m11 * dest.y + this.m21 * dest.z + this.m31,
         this.m02 * dest.x + this.m12 * dest.y + this.m22 * dest.z + this.m32
      );
   }
   ...
   public Vector3d transformDirection(Vector3d dest) {
      return dest.set(
         this.m00 * dest.x + this.m10 * dest.y + this.m20 * dest.z,
         this.m01 * dest.x + this.m11 * dest.y + this.m21 * dest.z,
         this.m02 * dest.x + this.m12 * dest.y + this.m22 * dest.z
      );
   }
   ...
   public Matrix4d scaleAroundLocal(double sx, double sy, double sz, double ox, double oy, double oz, Matrix4d dest) {
      boolean one = Math.absEqualsOne(sx) && Math.absEqualsOne(sy) && Math.absEqualsOne(sz);
      dest._m00(sx * (this.m00 - ox * this.m03) + ox * this.m03)
   ...
   private Matrix4d translateGeneric(double x, double y, double z, Matrix4d dest) {
      dest._m00(this.m00)
         ...
         ._m22(this.m22)
         ._m23(this.m23)
         ._m30(Math.fma(this.m00, x, Math.fma(this.m10, y, Math.fma(this.m20, z, this.m30))))
   ...
   public Matrix4d rotateLocalY(double ang, Matrix4d dest) {
      ...
      dest._m00(cos * this.m00 + sin * this.m02)
         ._m01(this.m01)
         ._m02(nm02)
         ._m03(this.m03)
   ...
   public Matrix4d rotateLocalZ(double ang, Matrix4d dest) {
      ...
      dest._m00(cos * this.m00 - sin * this.m01)
         ._m01(nm01)
         ._m02(this.m02)
         ._m03(this.m03)
   ...
   private Matrix4d rotateXInternal(double ang, Matrix4d dest) {
      ...
      dest._m20(this.m10 * rm21 + this.m20 * rm22)
         ._m21(this.m11 * rm21 + this.m21 * rm22)
         ._m22(this.m12 * rm21 + this.m22 * rm22)
         ._m23(this.m13 * rm21 + this.m23 * rm22)
         ._m10(nm10)
         ._m11(nm11)
         ._m12(nm12)
         ._m13(nm13)
   ...
   private Matrix4d rotateYInternal(double ang, Matrix4d dest) {
      ...
      dest._m20(this.m00 * rm20 + this.m20 * rm22)
         ._m21(this.m01 * rm20 + this.m21 * rm22)
         ._m22(this.m02 * rm20 + this.m22 * rm22)
         ._m23(this.m03 * rm20 + this.m23 * rm22)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4d rotateTowardsXY(double dirX, double dirY, Matrix4d dest) {
      ...
      dest._m10(this.m00 * rm10 + this.m10 * rm11)
         ._m11(this.m01 * rm10 + this.m11 * rm11)
         ._m12(this.m02 * rm10 + this.m12 * rm11)
         ._m13(this.m03 * rm10 + this.m13 * rm11)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   private Matrix4d rotateXYZInternal(double angleX, double angleY, double angleZ, Matrix4d dest) {
      ...
      dest._m20(this.m00 * sinY + nm20 * cosY)
         ._m21(this.m01 * sinY + nm21 * cosY)
         ._m22(this.m02 * sinY + nm22 * cosY)
         ._m23(this.m03 * sinY + nm23 * cosY)
         ._m00(nm00 * cosZ + nm10 * sinZ)
         ._m01(nm01 * cosZ + nm11 * sinZ)
         ._m02(nm02 * cosZ + nm12 * sinZ)
   ...
   private Matrix4d rotateZYXInternal(double angleZ, double angleY, double angleX, Matrix4d dest) {
      ...
      dest._m00(nm00 * cosY + this.m20 * m_sinY)
   ...
   private Matrix4d rotateYXZInternal(double angleY, double angleX, double angleZ, Matrix4d dest) {
      ...
      dest._m20(this.m10 * m_sinX + nm20 * cosX)
   ...
   public Matrix4d translationRotateScaleMulAffine(
      double tx, double ty, double tz, double qx, double qy, double qz, double qw, double sx, double sy, double sz, Matrix4d m
   ) {
      double w2 = qw * qw;
      double x2 = qx * qx;
      double y2 = qy * qy;
   ...
   public Vector4d project(double x, double y, double z, int[] viewport, Vector4d winCoordsDest) {
      ...
      return winCoordsDest.set(
         Math.fma(Math.fma(nx, 0.5, 0.5), viewport[2], viewport[0]), Math.fma(Math.fma(ny, 0.5, 0.5), viewport[3], viewport[1]), Math.fma(0.5, nz, 0.5), 1.0
      );
   }
   ...
   private Matrix4d reflectAffine(double a, double b, double c, double d, Matrix4d dest) {
      ...
      dest._m30(this.m00 * rm30 + this.m10 * rm31 + this.m20 * rm32 + this.m30)
         ...
         ._m33(this.m33)
         ._m20(this.m00 * rm20 + this.m10 * rm21 + this.m20 * rm22)
         ._m21(this.m01 * rm20 + this.m11 * rm21 + this.m21 * rm22)
         ._m22(this.m02 * rm20 + this.m12 * rm21 + this.m22 * rm22)
         ._m23(0.0)
         ._m00(nm00)
   ...
   public Matrix4d lookAt(
      double eyeX, double eyeY, double eyeZ, double centerX, double centerY, double centerZ, double upX, double upY, double upZ, Matrix4d dest
   ) {
      if ((this.properties & 4) != 0) {
   ...
   public Matrix4d perspectiveOffCenter(
      double fovy, double offAngleX, double offAngleY, double aspect, double zNear, double zFar, boolean zZeroToOne, Matrix4d dest
   ) {
      return (this.properties & 4) != 0
   ...
   private Matrix4d perspectiveOffCenterGeneric(
      ...
      dest._m00(this.m00 * rm00)
         ...
         ._m22(nm22)
         ._m23(nm23)
         ._properties(this.properties & ~(30 | (rm20 == 0.0 && rm21 == 0.0 ? 0 : 1)));
      return dest;
   }
   ...
   public Matrix4d perspectiveOffCenterFov(
      double angleLeft, double angleRight, double angleDown, double angleUp, double zNear, double zFar, boolean zZeroToOne, Matrix4d dest
   ) {
      return this.frustum(
   ...
   public Matrix4d perspectiveOffCenterFovLH(
      double angleLeft, double angleRight, double angleDown, double angleUp, double zNear, double zFar, boolean zZeroToOne
   ) {
   ...
   public Matrix4d setPerspectiveOffCenterFov(
      double angleLeft, double angleRight, double angleDown, double angleUp, double zNear, double zFar, boolean zZeroToOne
   ) {
   ...
   public Matrix4d setPerspectiveOffCenterFovLH(
      double angleLeft, double angleRight, double angleDown, double angleUp, double zNear, double zFar, boolean zZeroToOne
   ) {
   ...
   private Vector3d positiveZGeneric(Vector3d dir) {
      return dir.set(this.m10 * this.m21 - this.m11 * this.m20, this.m20 * this.m01 - this.m21 * this.m00, this.m00 * this.m11 - this.m01 * this.m10)
         .normalize();
   }
   ...
   private Vector3d positiveXGeneric(Vector3d dir) {
      return dir.set(this.m11 * this.m22 - this.m12 * this.m21, this.m02 * this.m21 - this.m01 * this.m22, this.m01 * this.m12 - this.m02 * this.m11)
         .normalize();
   }
   ...
   private Vector3d positiveYGeneric(Vector3d dir) {
      return dir.set(this.m12 * this.m20 - this.m10 * this.m22, this.m00 * this.m22 - this.m02 * this.m20, this.m02 * this.m10 - this.m00 * this.m12)
         .normalize();
   }
      ...
      if (this == obj) {
         ...
         if (Double.doubleToLongBits(this.m00) != Double.doubleToLongBits(other.m00)) {
            ...
            return Double.doubleToLongBits(this.m32) != Double.doubleToLongBits(other.m32)
               ? false
               : Double.doubleToLongBits(this.m33) == Double.doubleToLongBits(other.m33);
         }
      }
   }
   ...
   public Matrix4d affineSpan(Vector3d corner, Vector3d xDir, Vector3d yDir, Vector3d zDir) {
      ...
      double s = 1.0 / (this.m00 * this.m11 - this.m01 * this.m10) * this.m22
         + (this.m02 * this.m10 - this.m00 * this.m12) * this.m21
         + (this.m01 * this.m12 - this.m02 * this.m11) * this.m20;
      double nm00 = (e - i) * s;
      double nm01 = (o - q) * s;
   ...
   public boolean testPoint(double x, double y, double z) {
      ...
      return nxX * x + nxY * y + nxZ * z + nxW >= 0.0
         && pxX * x + pxY * y + pxZ * z + pxW >= 0.0
         && nyX * x + nyY * y + nyZ * z + nyW >= 0.0
         && pyX * x + pyY * y + pyZ * z + pyW >= 0.0
         && nzX * x + nzY * y + nzZ * z + nzW >= 0.0
         && pzX * x + pzY * y + pzZ * z + pzW >= 0.0;
   }
   ...
   public boolean testAab(double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
      ...
      double pzZ = this.m23 - this.m22;
      double pzW = this.m33 - this.m32;
      return nxX * (nxX < 0.0 ? minX : maxX) + nxY * (nxY < 0.0 ? minY : maxY) + nxZ * (nxZ < 0.0 ? minZ : maxZ) >= -nxW
         && pxX * (pxX < 0.0 ? minX : maxX) + pxY * (pxY < 0.0 ? minY : maxY) + pxZ * (pxZ < 0.0 ? minZ : maxZ) >= -pxW
         && nyX * (nyX < 0.0 ? minX : maxX) + nyY * (nyY < 0.0 ? minY : maxY) + nyZ * (nyZ < 0.0 ? minZ : maxZ) >= -nyW
         && pyX * (pyX < 0.0 ? minX : maxX) + pyY * (pyY < 0.0 ? minY : maxY) + pyZ * (pyZ < 0.0 ? minZ : maxZ) >= -pyW
         && nzX * (nzX < 0.0 ? minX : maxX) + nzY * (nzY < 0.0 ? minY : maxY) + nzZ * (nzZ < 0.0 ? minZ : maxZ) >= -nzW
         && pzX * (pzX < 0.0 ? minX : maxX) + pzY * (pzY < 0.0 ? minY : maxY) + pzZ * (pzZ < 0.0 ? minZ : maxZ) >= -pzW;
   }
   ...
   public static void perspectiveOffCenterViewFromRectangle(
      Vector3d eye, Vector3d p, Vector3d x, Vector3d y, double nearFarDist, boolean zeroToOne, Matrix4d projDest, Matrix4d viewDest
   ) {
