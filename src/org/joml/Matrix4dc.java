...
public interface Matrix4dc {
   ...
   Matrix4dc getTransposedToAddress(long var1);
   ...
   Matrix4d lookAtPerspective(
      double var1, double var3, double var5, double var7, double var9, double var11, double var13, double var15, double var17, Matrix4d var19
   );
   ...
   Matrix4d tile(int var1, int var2, int var3, int var4, Matrix4d var5);
   ...
   Matrix4d perspectiveOffCenterFov(double var1, double var3, double var5, double var7, double var9, double var11, boolean var13, Matrix4d var14);

   Matrix4d perspectiveOffCenterFov(double var1, double var3, double var5, double var7, double var9, double var11, Matrix4d var13);

   Matrix4d perspectiveOffCenterFovLH(double var1, double var3, double var5, double var7, double var9, double var11, boolean var13, Matrix4d var14);

   Matrix4d perspectiveOffCenterFovLH(double var1, double var3, double var5, double var7, double var9, double var11, Matrix4d var13);
   ...
   Vector3d getEulerAnglesYXZ(Vector3d var1);
   ...
   Matrix4d mapXZY(Matrix4d var1);

   Matrix4d mapXZnY(Matrix4d var1);

   Matrix4d mapXnYnZ(Matrix4d var1);

   Matrix4d mapXnZY(Matrix4d var1);

   Matrix4d mapXnZnY(Matrix4d var1);

   Matrix4d mapYXZ(Matrix4d var1);

   Matrix4d mapYXnZ(Matrix4d var1);

   Matrix4d mapYZX(Matrix4d var1);

   Matrix4d mapYZnX(Matrix4d var1);

   Matrix4d mapYnXZ(Matrix4d var1);

   Matrix4d mapYnXnZ(Matrix4d var1);

   Matrix4d mapYnZX(Matrix4d var1);

   Matrix4d mapYnZnX(Matrix4d var1);

   Matrix4d mapZXY(Matrix4d var1);

   Matrix4d mapZXnY(Matrix4d var1);

   Matrix4d mapZYX(Matrix4d var1);

   Matrix4d mapZYnX(Matrix4d var1);

   Matrix4d mapZnXY(Matrix4d var1);

   Matrix4d mapZnXnY(Matrix4d var1);

   Matrix4d mapZnYX(Matrix4d var1);

   Matrix4d mapZnYnX(Matrix4d var1);

   Matrix4d mapnXYnZ(Matrix4d var1);

   Matrix4d mapnXZY(Matrix4d var1);

   Matrix4d mapnXZnY(Matrix4d var1);

   Matrix4d mapnXnYZ(Matrix4d var1);

   Matrix4d mapnXnYnZ(Matrix4d var1);

   Matrix4d mapnXnZY(Matrix4d var1);

   Matrix4d mapnXnZnY(Matrix4d var1);

   Matrix4d mapnYXZ(Matrix4d var1);

   Matrix4d mapnYXnZ(Matrix4d var1);

   Matrix4d mapnYZX(Matrix4d var1);

   Matrix4d mapnYZnX(Matrix4d var1);

   Matrix4d mapnYnXZ(Matrix4d var1);

   Matrix4d mapnYnXnZ(Matrix4d var1);

   Matrix4d mapnYnZX(Matrix4d var1);

   Matrix4d mapnYnZnX(Matrix4d var1);

   Matrix4d mapnZXY(Matrix4d var1);

   Matrix4d mapnZXnY(Matrix4d var1);

   Matrix4d mapnZYX(Matrix4d var1);

   Matrix4d mapnZYnX(Matrix4d var1);

   Matrix4d mapnZnXY(Matrix4d var1);

   Matrix4d mapnZnXnY(Matrix4d var1);

   Matrix4d mapnZnYX(Matrix4d var1);

   Matrix4d mapnZnYnX(Matrix4d var1);

   Matrix4d negateX(Matrix4d var1);

   Matrix4d negateY(Matrix4d var1);

   Matrix4d negateZ(Matrix4d var1);
