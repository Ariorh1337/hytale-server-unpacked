...
public interface Matrix4x3fc {
   ...
   Matrix4x3f mul3x3(float var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, Matrix4x3f var10);
   ...
   Matrix4x3fc getTransposedToAddress(long var1);
   ...
   Matrix4x3f scaleAround(float var1, float var2, float var3, float var4, float var5, float var6, Matrix4x3f var7);

   Matrix4x3f scaleAround(float var1, float var2, float var3, float var4, Matrix4x3f var5);
   ...
   Matrix4x3f mapXZY(Matrix4x3f var1);

   Matrix4x3f mapXZnY(Matrix4x3f var1);

   Matrix4x3f mapXnYnZ(Matrix4x3f var1);

   Matrix4x3f mapXnZY(Matrix4x3f var1);

   Matrix4x3f mapXnZnY(Matrix4x3f var1);

   Matrix4x3f mapYXZ(Matrix4x3f var1);

   Matrix4x3f mapYXnZ(Matrix4x3f var1);

   Matrix4x3f mapYZX(Matrix4x3f var1);

   Matrix4x3f mapYZnX(Matrix4x3f var1);

   Matrix4x3f mapYnXZ(Matrix4x3f var1);

   Matrix4x3f mapYnXnZ(Matrix4x3f var1);

   Matrix4x3f mapYnZX(Matrix4x3f var1);

   Matrix4x3f mapYnZnX(Matrix4x3f var1);

   Matrix4x3f mapZXY(Matrix4x3f var1);

   Matrix4x3f mapZXnY(Matrix4x3f var1);

   Matrix4x3f mapZYX(Matrix4x3f var1);

   Matrix4x3f mapZYnX(Matrix4x3f var1);

   Matrix4x3f mapZnXY(Matrix4x3f var1);

   Matrix4x3f mapZnXnY(Matrix4x3f var1);

   Matrix4x3f mapZnYX(Matrix4x3f var1);

   Matrix4x3f mapZnYnX(Matrix4x3f var1);

   Matrix4x3f mapnXYnZ(Matrix4x3f var1);

   Matrix4x3f mapnXZY(Matrix4x3f var1);

   Matrix4x3f mapnXZnY(Matrix4x3f var1);

   Matrix4x3f mapnXnYZ(Matrix4x3f var1);

   Matrix4x3f mapnXnYnZ(Matrix4x3f var1);

   Matrix4x3f mapnXnZY(Matrix4x3f var1);

   Matrix4x3f mapnXnZnY(Matrix4x3f var1);

   Matrix4x3f mapnYXZ(Matrix4x3f var1);

   Matrix4x3f mapnYXnZ(Matrix4x3f var1);

   Matrix4x3f mapnYZX(Matrix4x3f var1);

   Matrix4x3f mapnYZnX(Matrix4x3f var1);

   Matrix4x3f mapnYnXZ(Matrix4x3f var1);

   Matrix4x3f mapnYnXnZ(Matrix4x3f var1);

   Matrix4x3f mapnYnZX(Matrix4x3f var1);

   Matrix4x3f mapnYnZnX(Matrix4x3f var1);

   Matrix4x3f mapnZXY(Matrix4x3f var1);

   Matrix4x3f mapnZXnY(Matrix4x3f var1);

   Matrix4x3f mapnZYX(Matrix4x3f var1);

   Matrix4x3f mapnZYnX(Matrix4x3f var1);

   Matrix4x3f mapnZnXY(Matrix4x3f var1);

   Matrix4x3f mapnZnXnY(Matrix4x3f var1);

   Matrix4x3f mapnZnYX(Matrix4x3f var1);

   Matrix4x3f mapnZnYnX(Matrix4x3f var1);

   Matrix4x3f negateX(Matrix4x3f var1);

   Matrix4x3f negateY(Matrix4x3f var1);

   Matrix4x3f negateZ(Matrix4x3f var1);
