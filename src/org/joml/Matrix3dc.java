...
public interface Matrix3dc {
   ...
   Matrix3dc getTransposedToAddress(long var1);
   ...
   Matrix3d mapXZY(Matrix3d var1);

   Matrix3d mapXZnY(Matrix3d var1);

   Matrix3d mapXnYnZ(Matrix3d var1);

   Matrix3d mapXnZY(Matrix3d var1);

   Matrix3d mapXnZnY(Matrix3d var1);

   Matrix3d mapYXZ(Matrix3d var1);

   Matrix3d mapYXnZ(Matrix3d var1);

   Matrix3d mapYZX(Matrix3d var1);

   Matrix3d mapYZnX(Matrix3d var1);

   Matrix3d mapYnXZ(Matrix3d var1);

   Matrix3d mapYnXnZ(Matrix3d var1);

   Matrix3d mapYnZX(Matrix3d var1);

   Matrix3d mapYnZnX(Matrix3d var1);

   Matrix3d mapZXY(Matrix3d var1);

   Matrix3d mapZXnY(Matrix3d var1);

   Matrix3d mapZYX(Matrix3d var1);

   Matrix3d mapZYnX(Matrix3d var1);

   Matrix3d mapZnXY(Matrix3d var1);

   Matrix3d mapZnXnY(Matrix3d var1);

   Matrix3d mapZnYX(Matrix3d var1);

   Matrix3d mapZnYnX(Matrix3d var1);

   Matrix3d mapnXYnZ(Matrix3d var1);

   Matrix3d mapnXZY(Matrix3d var1);

   Matrix3d mapnXZnY(Matrix3d var1);

   Matrix3d mapnXnYZ(Matrix3d var1);

   Matrix3d mapnXnYnZ(Matrix3d var1);

   Matrix3d mapnXnZY(Matrix3d var1);

   Matrix3d mapnXnZnY(Matrix3d var1);

   Matrix3d mapnYXZ(Matrix3d var1);

   Matrix3d mapnYXnZ(Matrix3d var1);

   Matrix3d mapnYZX(Matrix3d var1);

   Matrix3d mapnYZnX(Matrix3d var1);

   Matrix3d mapnYnXZ(Matrix3d var1);

   Matrix3d mapnYnXnZ(Matrix3d var1);

   Matrix3d mapnYnZX(Matrix3d var1);

   Matrix3d mapnYnZnX(Matrix3d var1);

   Matrix3d mapnZXY(Matrix3d var1);

   Matrix3d mapnZXnY(Matrix3d var1);

   Matrix3d mapnZYX(Matrix3d var1);

   Matrix3d mapnZYnX(Matrix3d var1);

   Matrix3d mapnZnXY(Matrix3d var1);

   Matrix3d mapnZnXnY(Matrix3d var1);

   Matrix3d mapnZnYX(Matrix3d var1);

   Matrix3d mapnZnYnX(Matrix3d var1);

   Matrix3d negateX(Matrix3d var1);

   Matrix3d negateY(Matrix3d var1);

   Matrix3d negateZ(Matrix3d var1);
}
