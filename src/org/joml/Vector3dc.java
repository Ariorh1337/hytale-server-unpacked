...
public interface Vector3dc {
   ...
   Vector3d mulProjectTranslation(Matrix4fc var1, Vector3d var2);

   Vector3d mulProjectTranslation(Matrix4dc var1, Vector3d var2);

   Vector3d mulProjectAffine(Matrix4fc var1, Vector3d var2);

   Vector3d mulProjectGeneric(Matrix4fc var1, Vector3d var2);
   ...
   Vector3d mulPositionGeneric(Matrix4dc var1, Vector3d var2);

   Vector3d mulPositionTranslation(Matrix4dc var1, Vector3d var2);

   Vector3d mulPosition(Matrix4fc var1, Vector3d var2);

   Vector3d mulPositionGeneric(Matrix4fc var1, Vector3d var2);

   Vector3d mulPositionTranslation(Matrix4fc var1, Vector3d var2);

   Vector3d mulPosition(Matrix4x3dc var1, Vector3d var2);

   Vector3d mulPositionGeneric(Matrix4x3dc var1, Vector3d var2);

   Vector3d mulPositionTranslation(Matrix4x3dc var1, Vector3d var2);

   Vector3d mulPosition(Matrix4x3fc var1, Vector3d var2);

   Vector3d mulPositionGeneric(Matrix4x3fc var1, Vector3d var2);

   Vector3d mulPositionTranslation(Matrix4x3fc var1, Vector3d var2);
