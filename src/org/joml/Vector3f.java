...
public class Vector3f implements Externalizable, Cloneable, Vector3fc {
   ...
   public Vector3f mulProject(Matrix4fc mat) {
      ...
      if ((prop & 4) != 0) {
         ...
         return (prop & 2) != 0 ? this.mulProjectAffine(mat, this) : this.mulProjectGeneric(mat, this);
      }
   }
   ...
   public Vector3f mulProject(Matrix4fc mat, Vector3f dest) {
      ...
      if ((prop & 4) != 0) {
         ...
         return (prop & 2) != 0 ? this.mulProjectAffine(mat, dest) : this.mulProjectGeneric(mat, dest);
      }
   }
   ...
   public Vector3f mulPosition(Matrix4fc mat) {
      ...
      if ((prop & 4) != 0) {
         ...
         return (prop & 8) != 0 ? this.mulPositionTranslation(mat, this) : this.mulPositionGeneric(mat, this);
      }
   }
   ...
   public Vector3f mulPosition(Matrix4fc mat, Vector3f dest) {
      ...
      if ((prop & 4) != 0) {
         ...
         return (prop & 8) != 0 ? this.mulPositionTranslation(mat, dest) : this.mulPositionGeneric(mat, dest);
      }
   }
   ...
   public Vector3f mulPositionTranslation(Matrix4x3fc mat, Vector3f dest) {
      float rx = Math.fma(mat.m00(), this.x, Math.fma(mat.m10(), this.y, Math.fma(mat.m20(), this.z, mat.m30())));
      float ry = Math.fma(mat.m01(), this.x, Math.fma(mat.m11(), this.y, Math.fma(mat.m21(), this.z, mat.m31())));
      float rz = Math.fma(mat.m02(), this.x, Math.fma(mat.m12(), this.y, Math.fma(mat.m22(), this.z, mat.m32())));
      dest.x = rx;
      dest.y = ry;
      dest.z = rz;
      return dest;
   ...
   public Vector3f mulPositionTranslation(Matrix4x3dc mat, Vector3f dest) {
      float rx = (float)Math.fma(mat.m00(), this.x, Math.fma(mat.m10(), this.y, Math.fma(mat.m20(), this.z, mat.m30())));
      float ry = (float)Math.fma(mat.m01(), this.x, Math.fma(mat.m11(), this.y, Math.fma(mat.m21(), this.z, mat.m31())));
      float rz = (float)Math.fma(mat.m02(), this.x, Math.fma(mat.m12(), this.y, Math.fma(mat.m22(), this.z, mat.m32())));
      dest.x = rx;
      dest.y = ry;
      dest.z = rz;
      return dest;
   ...
   public Vector3f mulPosition(Matrix4x3fc mat) {
      ...
      if ((prop & 4) != 0) {
         ...
         return (prop & 8) != 0 ? this.mulPositionTranslation(mat, this) : this.mulPositionGeneric(mat);
      }
   }
   ...
   public Vector3f mulTransposePosition(Matrix4fc mat, Vector3f dest) {
      int prop = mat.properties();
      return (prop & 4) != 0 ? dest.set(this) : this.mulTransposePositionGeneric(mat, dest);
   }
   ...
   public Vector3f mulTransposePosition(Matrix4dc mat, Vector3f dest) {
      ...
      return (properties & 4) != 0 ? dest.set(this) : this.mulTransposePositionGeneric(mat, dest);
   }
