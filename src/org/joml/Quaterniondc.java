...
public interface Quaterniondc {
   ...
   Quaterniond sub(double var1, double var3, double var5, double var7, Quaterniond var9);

   Quaterniond sub(Quaterniondc var1, Quaterniond var2);
   ...
   Quaterniond mul(double var1, Quaterniond var3);
   ...
   Quaterniond div(double var1, Quaterniond var3);
   ...
   Vector3d getEulerAnglesZXY(Vector3d var1);
