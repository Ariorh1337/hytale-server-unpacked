...
public class Matrix2d implements Externalizable, Cloneable, Matrix2dc {
   ...
   public int hashCode() {
      ...
      return 31 * result + (int)(temp >>> 32 ^ temp);
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         if (Double.doubleToLongBits(this.m00) != Double.doubleToLongBits(other.m00)) {
            ...
            return Double.doubleToLongBits(this.m10) != Double.doubleToLongBits(other.m10)
               ? false
               : Double.doubleToLongBits(this.m11) == Double.doubleToLongBits(other.m11);
         }
      }
   }
