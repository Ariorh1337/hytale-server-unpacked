...
public interface Matrix3fc {
   ...
   Matrix3fc getTransposedToAddress(long var1);
   ...
   Matrix3f mapXZY(Matrix3f var1);

   Matrix3f mapXZnY(Matrix3f var1);

   Matrix3f mapXnYnZ(Matrix3f var1);

   Matrix3f mapXnZY(Matrix3f var1);

   Matrix3f mapXnZnY(Matrix3f var1);

   Matrix3f mapYXZ(Matrix3f var1);

   Matrix3f mapYXnZ(Matrix3f var1);

   Matrix3f mapYZX(Matrix3f var1);

   Matrix3f mapYZnX(Matrix3f var1);

   Matrix3f mapYnXZ(Matrix3f var1);

   Matrix3f mapYnXnZ(Matrix3f var1);

   Matrix3f mapYnZX(Matrix3f var1);

   Matrix3f mapYnZnX(Matrix3f var1);

   Matrix3f mapZXY(Matrix3f var1);

   Matrix3f mapZXnY(Matrix3f var1);

   Matrix3f mapZYX(Matrix3f var1);

   Matrix3f mapZYnX(Matrix3f var1);

   Matrix3f mapZnXY(Matrix3f var1);

   Matrix3f mapZnXnY(Matrix3f var1);

   Matrix3f mapZnYX(Matrix3f var1);

   Matrix3f mapZnYnX(Matrix3f var1);

   Matrix3f mapnXYnZ(Matrix3f var1);

   Matrix3f mapnXZY(Matrix3f var1);

   Matrix3f mapnXZnY(Matrix3f var1);

   Matrix3f mapnXnYZ(Matrix3f var1);

   Matrix3f mapnXnYnZ(Matrix3f var1);

   Matrix3f mapnXnZY(Matrix3f var1);

   Matrix3f mapnXnZnY(Matrix3f var1);

   Matrix3f mapnYXZ(Matrix3f var1);

   Matrix3f mapnYXnZ(Matrix3f var1);

   Matrix3f mapnYZX(Matrix3f var1);

   Matrix3f mapnYZnX(Matrix3f var1);

   Matrix3f mapnYnXZ(Matrix3f var1);

   Matrix3f mapnYnXnZ(Matrix3f var1);

   Matrix3f mapnYnZX(Matrix3f var1);

   Matrix3f mapnYnZnX(Matrix3f var1);

   Matrix3f mapnZXY(Matrix3f var1);

   Matrix3f mapnZXnY(Matrix3f var1);

   Matrix3f mapnZYX(Matrix3f var1);

   Matrix3f mapnZYnX(Matrix3f var1);

   Matrix3f mapnZnXY(Matrix3f var1);

   Matrix3f mapnZnXnY(Matrix3f var1);

   Matrix3f mapnZnYX(Matrix3f var1);

   Matrix3f mapnZnYnX(Matrix3f var1);

   Matrix3f negateX(Matrix3f var1);

   Matrix3f negateY(Matrix3f var1);

   Matrix3f negateZ(Matrix3f var1);
}
