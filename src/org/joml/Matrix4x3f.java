...
public class Matrix4x3f implements Externalizable, Cloneable, Matrix4x3fc {
   ...
   public Matrix4x3f scaleAround(float sx, float sy, float sz, float ox, float oy, float oz, Matrix4x3f dest) {
      ...
      return dest._m00(this.m00 * sx)
         ...
         ._properties(this.properties & ~(12 | (one ? 0 : 16)));
   }
   ...
   public Matrix4x3f rotateLocal(float ang, float x, float y, float z, Matrix4x3f dest) {
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z) ? this.rotateLocalZ(z * ang, dest) : this.rotateLocalInternal(ang, x, y, z, dest);
      }
   }
   ...
   private Matrix4x3f lookAtGeneric(
      float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ, Matrix4x3f dest
   ) {
      float dirX = eyeX - centerX;
      float dirY = eyeY - centerY;
      float dirZ = eyeZ - centerZ;
   ...
   public int hashCode() {
      ...
      return 31 * result + Float.floatToIntBits(this.m32);
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         if (Float.floatToIntBits(this.m00) != Float.floatToIntBits(other.m00)) {
            ...
            return Float.floatToIntBits(this.m31) != Float.floatToIntBits(other.m31)
               ? false
               : Float.floatToIntBits(this.m32) == Float.floatToIntBits(other.m32);
         }
      }
   }
   ...
   public Matrix4x3f mapXZY(Matrix4x3f dest) {
      ...
      return dest._m00(this.m00)
         ...
         ._m31(this.m31)
         ._m32(this.m32)
         ._properties(this.properties & 16);
   }
