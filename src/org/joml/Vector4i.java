...
public class Vector4i implements Externalizable, Cloneable, Vector4ic {
   ...
   public double length() {
      return Math.sqrt((float)((long)this.x * this.x + (long)this.y * this.y + (long)this.z * this.z + (long)this.w * this.w));
   }

   public static double length(int x, int y, int z, int w) {
      return Math.sqrt((float)((long)x * x + (long)y * y + (long)z * z + (long)w * w));
   }
   ...
   public static double distance(int x1, int y1, int z1, int w1, int x2, int y2, int z2, int w2) {
      ...
      int dz = z1 - z2;
      int dw = w1 - w2;
      return Math.sqrt((float)((long)dx * dx + (long)dy * dy + (long)dz * dz + (long)dw * dw));
   }
   ...
   public long dot(Vector4ic v) {
      return (long)this.x * v.x() + (long)this.y * v.y() + (long)this.z * v.z() + (long)this.w * v.w();
   }
