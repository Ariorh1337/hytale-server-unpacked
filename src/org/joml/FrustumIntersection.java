...
public class FrustumIntersection {
   ...
   public FrustumIntersection set(Matrix4fc m, boolean allowTestSpheres) {
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.nxX * this.nxX + this.nxY * this.nxY + this.nxZ * this.nxZ);
         this.nxX *= invl;
         this.nxY *= invl;
         this.nxZ *= invl;
         this.nxW *= invl;
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.pxX * this.pxX + this.pxY * this.pxY + this.pxZ * this.pxZ);
         this.pxX *= invl;
         this.pxY *= invl;
         this.pxZ *= invl;
         this.pxW *= invl;
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.nyX * this.nyX + this.nyY * this.nyY + this.nyZ * this.nyZ);
         this.nyX *= invl;
         this.nyY *= invl;
         this.nyZ *= invl;
         this.nyW *= invl;
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.pyX * this.pyX + this.pyY * this.pyY + this.pyZ * this.pyZ);
         this.pyX *= invl;
         this.pyY *= invl;
         this.pyZ *= invl;
         this.pyW *= invl;
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.nzX * this.nzX + this.nzY * this.nzY + this.nzZ * this.nzZ);
         this.nzX *= invl;
         this.nzY *= invl;
         this.nzZ *= invl;
         this.nzW *= invl;
      ...
      if (allowTestSpheres) {
         float invl = Math.invsqrt(this.pzX * this.pzX + this.pzY * this.pzY + this.pzZ * this.pzZ);
         this.pzX *= invl;
         this.pzY *= invl;
         this.pzZ *= invl;
         this.pzW *= invl;
   ...
   public boolean testPoint(float x, float y, float z) {
      return this.nxX * x + this.nxY * y + this.nxZ * z + this.nxW >= 0.0F
         && this.pxX * x + this.pxY * y + this.pxZ * z + this.pxW >= 0.0F
         && this.nyX * x + this.nyY * y + this.nyZ * z + this.nyW >= 0.0F
         && this.pyX * x + this.pyY * y + this.pyZ * z + this.pyW >= 0.0F
         && this.nzX * x + this.nzY * y + this.nzZ * z + this.nzW >= 0.0F
         && this.pzX * x + this.pzY * y + this.pzZ * z + this.pzW >= 0.0F;
   }
   ...
   public boolean testSphere(float x, float y, float z, float r) {
      return this.nxX * x + this.nxY * y + this.nxZ * z + this.nxW >= -r
         && this.pxX * x + this.pxY * y + this.pxZ * z + this.pxW >= -r
         && this.nyX * x + this.nyY * y + this.nyZ * z + this.nyW >= -r
         && this.pyX * x + this.pyY * y + this.pyZ * z + this.pyW >= -r
         && this.nzX * x + this.nzY * y + this.nzZ * z + this.nzW >= -r
         && this.pzX * x + this.pzY * y + this.pzZ * z + this.pzW >= -r;
   }
   ...
   public boolean testAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      return this.nxX * (this.nxX < 0.0F ? minX : maxX) + this.nxY * (this.nxY < 0.0F ? minY : maxY) + this.nxZ * (this.nxZ < 0.0F ? minZ : maxZ) >= -this.nxW
         && this.pxX * (this.pxX < 0.0F ? minX : maxX) + this.pxY * (this.pxY < 0.0F ? minY : maxY) + this.pxZ * (this.pxZ < 0.0F ? minZ : maxZ) >= -this.pxW
         && this.nyX * (this.nyX < 0.0F ? minX : maxX) + this.nyY * (this.nyY < 0.0F ? minY : maxY) + this.nyZ * (this.nyZ < 0.0F ? minZ : maxZ) >= -this.nyW
         && this.pyX * (this.pyX < 0.0F ? minX : maxX) + this.pyY * (this.pyY < 0.0F ? minY : maxY) + this.pyZ * (this.pyZ < 0.0F ? minZ : maxZ) >= -this.pyW
         && this.nzX * (this.nzX < 0.0F ? minX : maxX) + this.nzY * (this.nzY < 0.0F ? minY : maxY) + this.nzZ * (this.nzZ < 0.0F ? minZ : maxZ) >= -this.nzW
         && this.pzX * (this.pzX < 0.0F ? minX : maxX) + this.pzY * (this.pzY < 0.0F ? minY : maxY) + this.pzZ * (this.pzZ < 0.0F ? minZ : maxZ) >= -this.pzW;
   }
   ...
   public boolean testPlaneXY(float minX, float minY, float maxX, float maxY) {
      return this.nxX * (this.nxX < 0.0F ? minX : maxX) + this.nxY * (this.nxY < 0.0F ? minY : maxY) >= -this.nxW
         && this.pxX * (this.pxX < 0.0F ? minX : maxX) + this.pxY * (this.pxY < 0.0F ? minY : maxY) >= -this.pxW
         && this.nyX * (this.nyX < 0.0F ? minX : maxX) + this.nyY * (this.nyY < 0.0F ? minY : maxY) >= -this.nyW
         && this.pyX * (this.pyX < 0.0F ? minX : maxX) + this.pyY * (this.pyY < 0.0F ? minY : maxY) >= -this.pyW
         && this.nzX * (this.nzX < 0.0F ? minX : maxX) + this.nzY * (this.nzY < 0.0F ? minY : maxY) >= -this.nzW
         && this.pzX * (this.pzX < 0.0F ? minX : maxX) + this.pzY * (this.pzY < 0.0F ? minY : maxY) >= -this.pzW;
   }

   public boolean testPlaneXZ(float minX, float minZ, float maxX, float maxZ) {
      return this.nxX * (this.nxX < 0.0F ? minX : maxX) + this.nxZ * (this.nxZ < 0.0F ? minZ : maxZ) >= -this.nxW
         && this.pxX * (this.pxX < 0.0F ? minX : maxX) + this.pxZ * (this.pxZ < 0.0F ? minZ : maxZ) >= -this.pxW
         && this.nyX * (this.nyX < 0.0F ? minX : maxX) + this.nyZ * (this.nyZ < 0.0F ? minZ : maxZ) >= -this.nyW
         && this.pyX * (this.pyX < 0.0F ? minX : maxX) + this.pyZ * (this.pyZ < 0.0F ? minZ : maxZ) >= -this.pyW
         && this.nzX * (this.nzX < 0.0F ? minX : maxX) + this.nzZ * (this.nzZ < 0.0F ? minZ : maxZ) >= -this.nzW
         && this.pzX * (this.pzX < 0.0F ? minX : maxX) + this.pzZ * (this.pzZ < 0.0F ? minZ : maxZ) >= -this.pzW;
   }
   ...
   public int intersectAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      ...
      if (this.nxX * (this.nxX < 0.0F ? minX : maxX) + this.nxY * (this.nxY < 0.0F ? minY : maxY) + this.nxZ * (this.nxZ < 0.0F ? minZ : maxZ) >= -this.nxW) {
         plane = 1;
         inside &= this.nxX * (this.nxX < 0.0F ? maxX : minX) + this.nxY * (this.nxY < 0.0F ? maxY : minY) + this.nxZ * (this.nxZ < 0.0F ? maxZ : minZ)
            >= -this.nxW;
         if (this.pxX * (this.pxX < 0.0F ? minX : maxX) + this.pxY * (this.pxY < 0.0F ? minY : maxY) + this.pxZ * (this.pxZ < 0.0F ? minZ : maxZ) >= -this.pxW) {
            plane = 2;
            inside &= this.pxX * (this.pxX < 0.0F ? maxX : minX) + this.pxY * (this.pxY < 0.0F ? maxY : minY) + this.pxZ * (this.pxZ < 0.0F ? maxZ : minZ)
               >= -this.pxW;
            if (this.nyX * (this.nyX < 0.0F ? minX : maxX) + this.nyY * (this.nyY < 0.0F ? minY : maxY) + this.nyZ * (this.nyZ < 0.0F ? minZ : maxZ)
               >= -this.nyW) {
               plane = 3;
               inside &= this.nyX * (this.nyX < 0.0F ? maxX : minX) + this.nyY * (this.nyY < 0.0F ? maxY : minY) + this.nyZ * (this.nyZ < 0.0F ? maxZ : minZ)
                  >= -this.nyW;
               if (this.pyX * (this.pyX < 0.0F ? minX : maxX) + this.pyY * (this.pyY < 0.0F ? minY : maxY) + this.pyZ * (this.pyZ < 0.0F ? minZ : maxZ)
                  >= -this.pyW) {
                  plane = 4;
                  inside &= this.pyX * (this.pyX < 0.0F ? maxX : minX)
                        + this.pyY * (this.pyY < 0.0F ? maxY : minY)
                        + this.pyZ * (this.pyZ < 0.0F ? maxZ : minZ)
                     >= -this.pyW;
                  if (this.nzX * (this.nzX < 0.0F ? minX : maxX) + this.nzY * (this.nzY < 0.0F ? minY : maxY) + this.nzZ * (this.nzZ < 0.0F ? minZ : maxZ)
                     >= -this.nzW) {
                     plane = 5;
                     inside &= this.nzX * (this.nzX < 0.0F ? maxX : minX)
                           + this.nzY * (this.nzY < 0.0F ? maxY : minY)
                           + this.nzZ * (this.nzZ < 0.0F ? maxZ : minZ)
                        >= -this.nzW;
                     if (this.pzX * (this.pzX < 0.0F ? minX : maxX) + this.pzY * (this.pzY < 0.0F ? minY : maxY) + this.pzZ * (this.pzZ < 0.0F ? minZ : maxZ)
                        >= -this.pzW) {
                        inside &= this.pzX * (this.pzX < 0.0F ? maxX : minX)
                              + this.pzY * (this.pzY < 0.0F ? maxY : minY)
                              + this.pzZ * (this.pzZ < 0.0F ? maxZ : minZ)
                           >= -this.pzW;
                        return inside ? -2 : -1;
                     }
                  }
   ...
   public float distanceToPlane(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, int plane) {
      return this.planes[plane].x * (this.planes[plane].x < 0.0F ? maxX : minX)
         + this.planes[plane].y * (this.planes[plane].y < 0.0F ? maxY : minY)
         + this.planes[plane].z * (this.planes[plane].z < 0.0F ? maxZ : minZ)
         + this.planes[plane].w;
   }
   ...
   public int intersectAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, int mask) {
      ...
      boolean inside = true;
      if ((mask & 1) == 0
         || this.nxX * (this.nxX < 0.0F ? minX : maxX) + this.nxY * (this.nxY < 0.0F ? minY : maxY) + this.nxZ * (this.nxZ < 0.0F ? minZ : maxZ) >= -this.nxW) {
         plane = 1;
         inside &= this.nxX * (this.nxX < 0.0F ? maxX : minX) + this.nxY * (this.nxY < 0.0F ? maxY : minY) + this.nxZ * (this.nxZ < 0.0F ? maxZ : minZ)
            >= -this.nxW;
         if ((mask & 2) == 0
            || this.pxX * (this.pxX < 0.0F ? minX : maxX) + this.pxY * (this.pxY < 0.0F ? minY : maxY) + this.pxZ * (this.pxZ < 0.0F ? minZ : maxZ)
               >= -this.pxW) {
            plane = 2;
            inside &= this.pxX * (this.pxX < 0.0F ? maxX : minX) + this.pxY * (this.pxY < 0.0F ? maxY : minY) + this.pxZ * (this.pxZ < 0.0F ? maxZ : minZ)
               >= -this.pxW;
            if ((mask & 4) == 0
               || this.nyX * (this.nyX < 0.0F ? minX : maxX) + this.nyY * (this.nyY < 0.0F ? minY : maxY) + this.nyZ * (this.nyZ < 0.0F ? minZ : maxZ)
                  >= -this.nyW) {
               plane = 3;
               inside &= this.nyX * (this.nyX < 0.0F ? maxX : minX) + this.nyY * (this.nyY < 0.0F ? maxY : minY) + this.nyZ * (this.nyZ < 0.0F ? maxZ : minZ)
                  >= -this.nyW;
               if ((mask & 8) == 0
                  || this.pyX * (this.pyX < 0.0F ? minX : maxX) + this.pyY * (this.pyY < 0.0F ? minY : maxY) + this.pyZ * (this.pyZ < 0.0F ? minZ : maxZ)
                     >= -this.pyW) {
                  plane = 4;
                  inside &= this.pyX * (this.pyX < 0.0F ? maxX : minX)
                        + this.pyY * (this.pyY < 0.0F ? maxY : minY)
                     ...
                     >= -this.pyW;
                  if ((mask & 16) == 0
                     || this.nzX * (this.nzX < 0.0F ? minX : maxX) + this.nzY * (this.nzY < 0.0F ? minY : maxY) + this.nzZ * (this.nzZ < 0.0F ? minZ : maxZ)
                        >= -this.nzW) {
                     plane = 5;
                     inside &= this.nzX * (this.nzX < 0.0F ? maxX : minX)
                           + this.nzY * (this.nzY < 0.0F ? maxY : minY)
                        ...
                        >= -this.nzW;
                     if ((mask & 32) == 0
                        || this.pzX * (this.pzX < 0.0F ? minX : maxX) + this.pzY * (this.pzY < 0.0F ? minY : maxY) + this.pzZ * (this.pzZ < 0.0F ? minZ : maxZ)
                           >= -this.pzW) {
                        inside &= this.pzX * (this.pzX < 0.0F ? maxX : minX)
                              + this.pzY * (this.pzY < 0.0F ? maxY : minY)
                              + this.pzZ * (this.pzZ < 0.0F ? maxZ : minZ)
   ...
   public int intersectAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ, int mask, int startPlane) {
      ...
      if ((mask & 1 << startPlane) != 0 && p.x * (p.x < 0.0F ? minX : maxX) + p.y * (p.y < 0.0F ? minY : maxY) + p.z * (p.z < 0.0F ? minZ : maxZ) < -p.w) {
         return plane;
      }
   ...
   public boolean testLineSegment(float aX, float aY, float aZ, float bX, float bY, float bZ) {
      ...
      if (da * db < 0.0F) {
         ...
         float dx = Math.fma(bX - aX, p, aX);
         float dy = Math.fma(bY - aY, p, aY);
         float dz = Math.fma(bZ - aZ, p, aZ);
         if (da < 0.0F) {
            aX = dx;
            aY = dy;
            aZ = dz;
