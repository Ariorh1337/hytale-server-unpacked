...
public interface Matrix4fc {
   ...
   Matrix4fc getTransposedToAddress(long var1);
   ...
   Matrix4f tile(int var1, int var2, int var3, int var4, Matrix4f var5);
   ...
   Matrix4f perspectiveOffCenterFov(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7, Matrix4f var8);

   Matrix4f perspectiveOffCenterFov(float var1, float var2, float var3, float var4, float var5, float var6, Matrix4f var7);

   Matrix4f perspectiveOffCenterFovLH(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7, Matrix4f var8);

   Matrix4f perspectiveOffCenterFovLH(float var1, float var2, float var3, float var4, float var5, float var6, Matrix4f var7);
   ...
   Vector3f getEulerAnglesYXZ(Vector3f var1);
   ...
   Matrix4f mapXZY(Matrix4f var1);

   Matrix4f mapXZnY(Matrix4f var1);

   Matrix4f mapXnYnZ(Matrix4f var1);

   Matrix4f mapXnZY(Matrix4f var1);

   Matrix4f mapXnZnY(Matrix4f var1);

   Matrix4f mapYXZ(Matrix4f var1);

   Matrix4f mapYXnZ(Matrix4f var1);

   Matrix4f mapYZX(Matrix4f var1);

   Matrix4f mapYZnX(Matrix4f var1);

   Matrix4f mapYnXZ(Matrix4f var1);

   Matrix4f mapYnXnZ(Matrix4f var1);

   Matrix4f mapYnZX(Matrix4f var1);

   Matrix4f mapYnZnX(Matrix4f var1);

   Matrix4f mapZXY(Matrix4f var1);

   Matrix4f mapZXnY(Matrix4f var1);

   Matrix4f mapZYX(Matrix4f var1);

   Matrix4f mapZYnX(Matrix4f var1);

   Matrix4f mapZnXY(Matrix4f var1);

   Matrix4f mapZnXnY(Matrix4f var1);

   Matrix4f mapZnYX(Matrix4f var1);

   Matrix4f mapZnYnX(Matrix4f var1);

   Matrix4f mapnXYnZ(Matrix4f var1);

   Matrix4f mapnXZY(Matrix4f var1);

   Matrix4f mapnXZnY(Matrix4f var1);

   Matrix4f mapnXnYZ(Matrix4f var1);

   Matrix4f mapnXnYnZ(Matrix4f var1);

   Matrix4f mapnXnZY(Matrix4f var1);

   Matrix4f mapnXnZnY(Matrix4f var1);

   Matrix4f mapnYXZ(Matrix4f var1);

   Matrix4f mapnYXnZ(Matrix4f var1);

   Matrix4f mapnYZX(Matrix4f var1);

   Matrix4f mapnYZnX(Matrix4f var1);

   Matrix4f mapnYnXZ(Matrix4f var1);

   Matrix4f mapnYnXnZ(Matrix4f var1);

   Matrix4f mapnYnZX(Matrix4f var1);

   Matrix4f mapnYnZnX(Matrix4f var1);

   Matrix4f mapnZXY(Matrix4f var1);

   Matrix4f mapnZXnY(Matrix4f var1);

   Matrix4f mapnZYX(Matrix4f var1);

   Matrix4f mapnZYnX(Matrix4f var1);

   Matrix4f mapnZnXY(Matrix4f var1);

   Matrix4f mapnZnXnY(Matrix4f var1);

   Matrix4f mapnZnYX(Matrix4f var1);

   Matrix4f mapnZnYnX(Matrix4f var1);

   Matrix4f negateX(Matrix4f var1);

   Matrix4f negateY(Matrix4f var1);

   Matrix4f negateZ(Matrix4f var1);
