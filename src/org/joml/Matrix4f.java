...
public class Matrix4f implements Externalizable, Cloneable, Matrix4fc {
   ...
   public Matrix4f set(Matrix4x3fc m) {
      return this._m00(m.m00())
         ...
         ._m32(m.m32())
         ._m33(1.0F)
         ._properties(m.properties() | 2);
   }

   public Matrix4f set(Matrix4dc m) {
      return this._m00((float)m.m00())
         ._m01((float)m.m01())
         ._m02((float)m.m02())
         ._m03((float)m.m03())
         ._m10((float)m.m10())
   ...
   public Matrix4f set(AxisAngle4d axisAngle) {
      ...
      tmp1 = y * z * omc;
      tmp2 = x * s;
      return this._m21((float)(tmp1 - tmp2))
   ...
   public Matrix4f set(Quaterniondc q) {
      ...
      double yz = q.y() * q.z();
      double xw = q.x() * q.w();
      return this._m00((float)(w2 + x2 - z2 - y2))
   ...
   public Matrix4f set4x3(Matrix4x3fc mat) {
      return this._m00(mat.m00())
         ...
         ._m31(mat.m31())
         ._m32(mat.m32())
         ._properties(this.properties & mat.properties() & -2);
   }
   ...
   public Matrix4f mul(
      ...
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 2) != 0
            ? this.mulAffineL(r00, r01, r02, r03, r10, r11, r12, r13, r20, r21, r22, r23, r30, r31, r32, r33, dest)
            : this.mulGeneric(r00, r01, r02, r03, r10, r11, r12, r13, r20, r21, r22, r23, r30, r31, r32, r33, dest);
      }
   }
   ...
   public Matrix4f mul3x3(float r00, float r01, float r02, float r10, float r11, float r12, float r20, float r21, float r22, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.set(r00, r01, r02, 0.0F, r10, r11, r12, 0.0F, r20, r21, r22, 0.0F, 0.0F, 0.0F, 0.0F, 1.0F)
         : this.mulGeneric3x3(r00, r01, r02, r10, r11, r12, r20, r21, r22, dest);
   }
   ...
   public Matrix4f mulLocalAffine(Matrix4fc left, Matrix4f dest) {
      ...
      return dest._m00(nm00)
         ...
         ._m32(nm32)
         ._m33(nm33)
         ._properties(2 | this.properties() & left.properties() & 16);
   }
   ...
   private Matrix4f mulTranslation(Matrix4x3fc right, Matrix4f dest) {
      return dest._m00(right.m00())
         ...
         ._m33(this.m33())
         ._properties(2 | right.properties() & 16);
   }
   ...
   public Matrix4f mulPerspectiveAffine(Matrix4x3fc view, Matrix4f dest) {
      ...
      float lm22 = this.m22();
      float lm23 = this.m23();
      return dest._m00(lm00 * view.m00())
         ._m01(lm11 * view.m01())
         ._m02(lm22 * view.m02())
         ._m03(lm23 * view.m02())
         ._m10(lm00 * view.m10())
   ...
   public Matrix4f add(Matrix4fc other, Matrix4f dest) {
      dest._m00(this.m00() + other.m00())
         ._m01(this.m01() + other.m01())
         ._m02(this.m02() + other.m02())
         ._m03(this.m03() + other.m03())
         ._m10(this.m10() + other.m10())
         ._m11(this.m11() + other.m11())
         ._m12(this.m12() + other.m12())
         ._m13(this.m13() + other.m13())
         ._m20(this.m20() + other.m20())
         ._m21(this.m21() + other.m21())
         ._m22(this.m22() + other.m22())
         ._m23(this.m23() + other.m23())
         ._m30(this.m30() + other.m30())
         ._m31(this.m31() + other.m31())
         ._m32(this.m32() + other.m32())
         ._m33(this.m33() + other.m33())
         ._properties(0);
      return dest;
   }
   ...
   public Matrix4f sub(Matrix4fc subtrahend, Matrix4f dest) {
      dest._m00(this.m00() - subtrahend.m00())
         ._m01(this.m01() - subtrahend.m01())
         ._m02(this.m02() - subtrahend.m02())
         ._m03(this.m03() - subtrahend.m03())
         ._m10(this.m10() - subtrahend.m10())
         ._m11(this.m11() - subtrahend.m11())
         ._m12(this.m12() - subtrahend.m12())
         ._m13(this.m13() - subtrahend.m13())
         ._m20(this.m20() - subtrahend.m20())
         ._m21(this.m21() - subtrahend.m21())
         ._m22(this.m22() - subtrahend.m22())
         ._m23(this.m23() - subtrahend.m23())
         ._m30(this.m30() - subtrahend.m30())
         ._m31(this.m31() - subtrahend.m31())
         ._m32(this.m32() - subtrahend.m32())
         ._m33(this.m33() - subtrahend.m33())
         ._properties(0);
      return dest;
   }
   ...
   private Matrix4f invertGenericNonThis(Matrix4f dest) {
      ...
      det = 1.0F / det;
      return dest._m00(Math.fma(this.m11(), l, Math.fma(-this.m12(), k, this.m13() * j)) * det)
         ._m01(Math.fma(-this.m01(), l, Math.fma(this.m02(), k, -this.m03() * j)) * det)
         ._m02(Math.fma(this.m31(), f, Math.fma(-this.m32(), e, this.m33() * d)) * det)
         ._m03(Math.fma(-this.m21(), f, Math.fma(this.m22(), e, -this.m23() * d)) * det)
         ._m10(Math.fma(-this.m10(), l, Math.fma(this.m12(), i, -this.m13() * h)) * det)
         ._m11(Math.fma(this.m00(), l, Math.fma(-this.m02(), i, this.m03() * h)) * det)
         ._m12(Math.fma(-this.m30(), f, Math.fma(this.m32(), c, -this.m33() * b)) * det)
         ._m13(Math.fma(this.m20(), f, Math.fma(-this.m22(), c, this.m23() * b)) * det)
         ._m20(Math.fma(this.m10(), k, Math.fma(-this.m11(), i, this.m13() * g)) * det)
         ._m21(Math.fma(-this.m00(), k, Math.fma(this.m01(), i, -this.m03() * g)) * det)
         ._m22(Math.fma(this.m30(), e, Math.fma(-this.m31(), c, this.m33() * a)) * det)
         ._m23(Math.fma(-this.m20(), e, Math.fma(this.m21(), c, -this.m23() * a)) * det)
         ._m30(Math.fma(-this.m10(), j, Math.fma(this.m11(), h, -this.m12() * g)) * det)
         ._m31(Math.fma(this.m00(), j, Math.fma(-this.m01(), h, this.m02() * g)) * det)
         ._m32(Math.fma(-this.m30(), d, Math.fma(this.m31(), b, -this.m32() * a)) * det)
         ._m33(Math.fma(this.m20(), d, Math.fma(-this.m21(), b, this.m22() * a)) * det)
         ._properties(0);
   }
   ...
   public Matrix4f invertPerspective(Matrix4f dest) {
      ...
      return dest.set(
            this.m11() * a, 0.0F, 0.0F, 0.0F, 0.0F, this.m00() * a, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -this.m23() * l, 0.0F, 0.0F, -this.m32() * l, this.m22() * l
         )
         ._properties(0);
   }
   ...
   public Matrix4f invertPerspectiveView(Matrix4fc view, Matrix4f dest) {
      ...
      return dest._m00(view.m00() * pm00)
         ._m01(view.m10() * pm00)
         ._m02(view.m20() * pm00)
         ._m03(0.0F)
         ._m10(nm10)
   ...
   public Matrix4f invertAffine(Matrix4f dest) {
      ...
      return dest._m00((m11m22 - m12m21) * s)
         ...
         ._m23(0.0F)
         ._m30((m10m22 * this.m31() - m10m21 * this.m32() + m11m20 * this.m32() - m11m22 * this.m30() + m12m21 * this.m30() - m12m20 * this.m31()) * s)
         ._m31(nm31)
         ._m32(nm32)
         ._m33(1.0F)
         ._properties(2);
   ...
   public String toString(NumberFormat formatter) {
      return Runtime.format(this.m00(), formatter)
         ...
         + "\n"
         + Runtime.format(this.m03(), formatter)
         + " "
         + Runtime.format(this.m13(), formatter)
         + " "
         + Runtime.format(this.m23(), formatter)
         + " "
         + Runtime.format(this.m33(), formatter)
         + "\n";
   }
   ...
   public Matrix4f rotation(float angle, float x, float y, float z) {
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z) ? this.rotationZ(z * angle) : this.rotationInternal(angle, x, y, z);
      }
   }
   ...
   public Matrix4f translationRotateScale(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz) {
      ...
      return this._m00(sx - (q11 + q22) * sx)
         ._m01((q01 + q23) * sx)
         ._m02((q02 - q13) * sx)
         ._m03(0.0F)
         ._m10((q01 - q23) * sy)
   ...
   public Matrix4f translationRotateScaleInvert(float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz) {
      ...
      float isy = 1.0F / sy;
      float isz = 1.0F / sz;
      return this._m00(isx * (1.0F - q11 - q22))
         ._m01(isy * (q01 + q23))
         ._m02(isz * (q02 - q13))
         ._m03(0.0F)
         ._m10(isx * (q01 - q23))
         ...
         ._m23(0.0F)
         ._m30(-this.m00() * tx - this.m10() * ty - this.m20() * tz)
         ._m31(-this.m01() * tx - this.m11() * ty - this.m21() * tz)
         ._m32(-this.m02() * tx - this.m12() * ty - this.m22() * tz)
         ._m33(1.0F)
         ._properties(2);
   }
   ...
   public Matrix4f translationRotateScaleMulAffine(
      float tx, float ty, float tz, float qx, float qy, float qz, float qw, float sx, float sy, float sz, Matrix4f m
   ) {
      float w2 = qw * qw;
      float x2 = qx * qx;
      float y2 = qy * qy;
      ...
      this._m02(nm02 * m.m00() + nm12 * m.m01() + nm22 * m.m02())._m00(m00)._m01(m01)._m03(0.0F);
      float m10 = nm00 * m.m10() + nm10 * m.m11() + nm20 * m.m12();
      float m11 = nm01 * m.m10() + nm11 * m.m11() + nm21 * m.m12();
      this._m12(nm02 * m.m10() + nm12 * m.m11() + nm22 * m.m12())._m10(m10)._m11(m11)._m13(0.0F);
      float m20 = nm00 * m.m20() + nm10 * m.m21() + nm20 * m.m22();
      float m21 = nm01 * m.m20() + nm11 * m.m21() + nm21 * m.m22();
      this._m22(nm02 * m.m20() + nm12 * m.m21() + nm22 * m.m22())._m20(m20)._m21(m21)._m23(0.0F);
      float m30 = nm00 * m.m30() + nm10 * m.m31() + nm20 * m.m32() + tx;
      float m31 = nm01 * m.m30() + nm11 * m.m31() + nm21 * m.m32() + ty;
      this._m32(nm02 * m.m30() + nm12 * m.m31() + nm22 * m.m32() + tz)._m30(m30)._m31(m31)._m33(1.0F);
      boolean one = Math.absEqualsOne(sx) && Math.absEqualsOne(sy) && Math.absEqualsOne(sz);
   ...
   public Matrix4f set3x3(Matrix3fc mat) {
      return this.set3x3Matrix3fc(mat)._properties(this.properties & -30);
   }
   ...
   private Matrix4f scaleGeneric(float x, float y, float z, Matrix4f dest) {
      ...
      return dest._m00(this.m00() * x)
         ...
         ._m32(this.m32())
         ._m33(this.m33())
         ._properties(this.properties & ~(13 | (one ? 0 : 16)));
   }
   ...
   public Matrix4f scaleAroundLocal(float sx, float sy, float sz, float ox, float oy, float oz, Matrix4f dest) {
      boolean one = Math.absEqualsOne(sx) && Math.absEqualsOne(sy) && Math.absEqualsOne(sz);
      return dest._m00(sx * (this.m00() - ox * this.m03()) + ox * this.m03())
         ._m01(sy * (this.m01() - oy * this.m03()) + oy * this.m03())
         ._m02(sz * (this.m02() - oz * this.m03()) + oz * this.m03())
         ._m03(this.m03())
         ._m10(sx * (this.m10() - ox * this.m13()) + ox * this.m13())
         ._m11(sy * (this.m11() - oy * this.m13()) + oy * this.m13())
         ._m12(sz * (this.m12() - oz * this.m13()) + oz * this.m13())
         ._m13(this.m13())
         ._m20(sx * (this.m20() - ox * this.m23()) + ox * this.m23())
         ._m21(sy * (this.m21() - oy * this.m23()) + oy * this.m23())
         ._m22(sz * (this.m22() - oz * this.m23()) + oz * this.m23())
         ._m23(this.m23())
         ._m30(sx * (this.m30() - ox * this.m33()) + ox * this.m33())
         ._m31(sy * (this.m31() - oy * this.m33()) + oy * this.m33())
         ._m32(sz * (this.m32() - oz * this.m33()) + oz * this.m33())
         ._m33(this.m33())
         ._properties(this.properties & ~(13 | (one ? 0 : 16)));
   }
   ...
   private Matrix4f rotateXInternal(float ang, Matrix4f dest) {
      ...
      float lm22 = this.m22();
      float lm23 = this.m23();
      return dest._m20(Math.fma(lm10, -sin, lm20 * cos))
   ...
   private Matrix4f rotateYInternal(float ang, Matrix4f dest) {
      ...
      return dest._m20(Math.fma(this.m00(), sin, this.m20() * cos))
         ._m21(Math.fma(this.m01(), sin, this.m21() * cos))
         ._m22(Math.fma(this.m02(), sin, this.m22() * cos))
         ._m23(Math.fma(this.m03(), sin, this.m23() * cos))
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f rotateTowardsXY(float dirX, float dirY, Matrix4f dest) {
      ...
      return dest._m10(Math.fma(this.m00(), -dirX, this.m10() * dirY))
         ._m11(Math.fma(this.m01(), -dirX, this.m11() * dirY))
         ._m12(Math.fma(this.m02(), -dirX, this.m12() * dirY))
         ._m13(Math.fma(this.m03(), -dirX, this.m13() * dirY))
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f rotateXYZ(float angleX, float angleY, float angleZ, Matrix4f dest) {
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 2) != 0 ? this.rotateAffineXYZ(angleX, angleY, angleZ, dest) : this.rotateXYZInternal(angleX, angleY, angleZ, dest);
      }
   }
   ...
   private Matrix4f rotateXYZInternal(float angleX, float angleY, float angleZ, Matrix4f dest) {
      ...
      return dest._m20(Math.fma(this.m00(), sinY, nm20 * cosY))
         ._m21(Math.fma(this.m01(), sinY, nm21 * cosY))
         ._m22(Math.fma(this.m02(), sinY, nm22 * cosY))
         ._m23(Math.fma(this.m03(), sinY, nm23 * cosY))
   ...
   public Matrix4f rotateZYX(float angleZ, float angleY, float angleX, Matrix4f dest) {
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 2) != 0 ? this.rotateAffineZYX(angleZ, angleY, angleX, dest) : this.rotateZYXInternal(angleZ, angleY, angleX, dest);
      }
   }
   ...
   private Matrix4f rotateZYXInternal(float angleZ, float angleY, float angleX, Matrix4f dest) {
      ...
      return dest._m00(nm00 * cosY + this.m20() * m_sinY)
         ._m01(nm01 * cosY + this.m21() * m_sinY)
         ._m02(nm02 * cosY + this.m22() * m_sinY)
         ._m03(nm03 * cosY + this.m23() * m_sinY)
   ...
   public Matrix4f rotateYXZ(float angleY, float angleX, float angleZ, Matrix4f dest) {
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 2) != 0 ? this.rotateAffineYXZ(angleY, angleX, angleZ, dest) : this.rotateYXZInternal(angleY, angleX, angleZ, dest);
      }
   }
   ...
   private Matrix4f rotateYXZInternal(float angleY, float angleX, float angleZ, Matrix4f dest) {
      ...
      return dest._m20(this.m10() * m_sinX + nm20 * cosX)
         ._m21(this.m11() * m_sinX + nm21 * cosX)
         ._m22(this.m12() * m_sinX + nm22 * cosX)
         ._m23(this.m13() * m_sinX + nm23 * cosX)
   ...
   private Matrix4f rotateGeneric(float ang, float x, float y, float z, Matrix4f dest) {
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z) ? this.rotateZ(z * ang, dest) : this.rotateGenericInternal(ang, x, y, z, dest);
      }
   }
   ...
   private Matrix4f rotateGenericInternal(float ang, float x, float y, float z, Matrix4f dest) {
      ...
      return dest._m20(this.m00() * rm20 + this.m10() * rm21 + this.m20() * rm22)
         ...
         ._m23(this.m03() * rm20 + this.m13() * rm21 + this.m23() * rm22)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f rotateTranslation(float ang, float x, float y, float z, Matrix4f dest) {
      ...
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z)
   ...
   public Matrix4f rotateAffine(float ang, float x, float y, float z, Matrix4f dest) {
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z) ? this.rotateZ(z * ang, dest) : this.rotateAffineInternal(ang, x, y, z, dest);
      }
   }
   ...
   private Matrix4f rotateLocalGeneric(float ang, float x, float y, float z, Matrix4f dest) {
      if (y == 0.0F && z == 0.0F && Math.absEqualsOne(x)) {
         ...
         return x == 0.0F && y == 0.0F && Math.absEqualsOne(z) ? this.rotateLocalZ(z * ang, dest) : this.rotateLocalGenericInternal(ang, x, y, z, dest);
      }
   }
   ...
   public Matrix4f rotateLocalX(float ang, Matrix4f dest) {
      ...
      return dest._m00(this.m00())
         ._m01(cos * this.m01() - sin * this.m02())
         ._m02(nm02)
         ._m03(this.m03())
         ._m10(this.m10())
         ._m11(cos * this.m11() - sin * this.m12())
         ._m12(nm12)
         ._m13(this.m13())
         ._m20(this.m20())
         ._m21(cos * this.m21() - sin * this.m22())
         ._m22(nm22)
         ._m23(this.m23())
         ._m30(this.m30())
         ._m31(cos * this.m31() - sin * this.m32())
         ._m32(nm32)
         ._m33(this.m33())
         ._properties(this.properties & -14);
   }
   ...
   public Matrix4f rotateLocalY(float ang, Matrix4f dest) {
      ...
      return dest._m00(cos * this.m00() + sin * this.m02())
         ._m01(this.m01())
         ._m02(nm02)
         ._m03(this.m03())
         ._m10(cos * this.m10() + sin * this.m12())
         ._m11(this.m11())
         ._m12(nm12)
         ._m13(this.m13())
         ._m20(cos * this.m20() + sin * this.m22())
         ._m21(this.m21())
         ._m22(nm22)
         ._m23(this.m23())
         ._m30(cos * this.m30() + sin * this.m32())
         ._m31(this.m31())
         ._m32(nm32)
         ._m33(this.m33())
         ._properties(this.properties & -14);
   ...
   public Matrix4f rotateLocalZ(float ang, Matrix4f dest) {
      ...
      return dest._m00(cos * this.m00() - sin * this.m01())
         ._m01(nm01)
         ._m02(this.m02())
         ._m03(this.m03())
         ._m10(cos * this.m10() - sin * this.m11())
         ._m11(nm11)
         ._m12(this.m12())
         ._m13(this.m13())
         ._m20(cos * this.m20() - sin * this.m21())
         ._m21(nm21)
         ._m22(this.m22())
         ._m23(this.m23())
         ._m30(cos * this.m30() - sin * this.m31())
         ._m31(nm31)
         ._m32(this.m32())
         ._m33(this.m33())
         ._properties(this.properties & -14);
   ...
   private Matrix4f translateGeneric(float x, float y, float z, Matrix4f dest) {
      ...
      return dest._m30(Math.fma(this.m00(), x, Math.fma(this.m10(), y, Math.fma(this.m20(), z, this.m30()))))
         ._m31(Math.fma(this.m01(), x, Math.fma(this.m11(), y, Math.fma(this.m21(), z, this.m31()))))
         ._m32(Math.fma(this.m02(), x, Math.fma(this.m12(), y, Math.fma(this.m22(), z, this.m32()))))
         ._m33(Math.fma(this.m03(), x, Math.fma(this.m13(), y, Math.fma(this.m23(), z, this.m33()))))
   ...
   private Matrix4f translateGeneric(float x, float y, float z) {
      return this._m30(Math.fma(this.m00(), x, Math.fma(this.m10(), y, Math.fma(this.m20(), z, this.m30()))))
         ._m31(Math.fma(this.m01(), x, Math.fma(this.m11(), y, Math.fma(this.m21(), z, this.m31()))))
         ._m32(Math.fma(this.m02(), x, Math.fma(this.m12(), y, Math.fma(this.m22(), z, this.m32()))))
         ._m33(Math.fma(this.m03(), x, Math.fma(this.m13(), y, Math.fma(this.m23(), z, this.m33()))))
         ._properties(this.properties & -6);
   ...
   public Matrix4f ortho(float left, float right, float bottom, float top, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setOrtho(left, right, bottom, top, zNear, zFar, zZeroToOne)
         : this.orthoGeneric(left, right, bottom, top, zNear, zFar, zZeroToOne, dest);
   }
   ...
   private Matrix4f orthoGeneric(float left, float right, float bottom, float top, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      ...
      dest._m30(this.m00() * rm30 + this.m10() * rm31 + this.m20() * rm32 + this.m30())
         ._m31(this.m01() * rm30 + this.m11() * rm31 + this.m21() * rm32 + this.m31())
         ._m32(this.m02() * rm30 + this.m12() * rm31 + this.m22() * rm32 + this.m32())
         ._m33(this.m03() * rm30 + this.m13() * rm31 + this.m23() * rm32 + this.m33())
         ._m00(this.m00() * rm00)
         ._m01(this.m01() * rm00)
         ._m02(this.m02() * rm00)
         ._m03(this.m03() * rm00)
   ...
   public Matrix4f orthoLH(float left, float right, float bottom, float top, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ...
         : this.orthoLHGeneric(left, right, bottom, top, zNear, zFar, zZeroToOne, dest);
   }
   ...
   public Matrix4f orthoSymmetric(float width, float height, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setOrthoSymmetric(width, height, zNear, zFar, zZeroToOne)
         : this.orthoSymmetricGeneric(width, height, zNear, zFar, zZeroToOne, dest);
   }
   ...
   private Matrix4f orthoSymmetricGeneric(float width, float height, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      ...
      float rm22 = (zZeroToOne ? 1.0F : 2.0F) / (zNear - zFar);
      float rm32 = (zZeroToOne ? zNear : zFar + zNear) / (zNear - zFar);
      dest._m30(this.m20() * rm32 + this.m30())
         ._m31(this.m21() * rm32 + this.m31())
         ._m32(this.m22() * rm32 + this.m32())
         ._m33(this.m23() * rm32 + this.m33())
         ._m00(this.m00() * rm00)
         ._m01(this.m01() * rm00)
         ._m02(this.m02() * rm00)
         ._m03(this.m03() * rm00)
   ...
   public Matrix4f orthoSymmetricLH(float width, float height, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setOrthoSymmetricLH(width, height, zNear, zFar, zZeroToOne)
         : this.orthoSymmetricLHGeneric(width, height, zNear, zFar, zZeroToOne, dest);
   }
   ...
   private Matrix4f ortho2DGeneric(float left, float right, float bottom, float top, Matrix4f dest) {
      ...
      float rm31 = (top + bottom) / (bottom - top);
      dest._m30(this.m00() * rm30 + this.m10() * rm31 + this.m30())
         ._m31(this.m01() * rm30 + this.m11() * rm31 + this.m31())
         ._m32(this.m02() * rm30 + this.m12() * rm31 + this.m32())
         ._m33(this.m03() * rm30 + this.m13() * rm31 + this.m33())
         ._m00(this.m00() * rm00)
         ._m01(this.m01() * rm00)
         ._m02(this.m02() * rm00)
         ._m03(this.m03() * rm00)
   ...
   private Matrix4f lookAlongGeneric(float dirX, float dirY, float dirZ, float upX, float upY, float upZ, Matrix4f dest) {
      ...
      return dest._m20(this.m00() * leftZ + this.m10() * upnZ + this.m20() * dirZ)
         ._m21(this.m01() * leftZ + this.m11() * upnZ + this.m21() * dirZ)
         ._m22(this.m02() * leftZ + this.m12() * upnZ + this.m22() * dirZ)
         ._m23(this.m03() * leftZ + this.m13() * upnZ + this.m23() * dirZ)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f lookAt(float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ, Matrix4f dest) {
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 1) != 0
            ? this.lookAtPerspective(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ, dest)
            : this.lookAtGeneric(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ, dest);
      }
   }

   private Matrix4f lookAtGeneric(
      float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ, Matrix4f dest
   ) {
      float dirX = eyeX - centerX;
      float dirY = eyeY - centerY;
      float dirZ = eyeZ - centerZ;
      ...
      float nm12 = this.m02() * leftY + this.m12() * upnY + this.m22() * dirY;
      float nm13 = this.m03() * leftY + this.m13() * upnY + this.m23() * dirY;
      return dest._m30(this.m00() * rm30 + this.m10() * rm31 + this.m20() * rm32 + this.m30())
         ._m31(this.m01() * rm30 + this.m11() * rm31 + this.m21() * rm32 + this.m31())
         ._m32(this.m02() * rm30 + this.m12() * rm31 + this.m22() * rm32 + this.m32())
         ._m33(this.m03() * rm30 + this.m13() * rm31 + this.m23() * rm32 + this.m33())
         ._m20(this.m00() * leftZ + this.m10() * upnZ + this.m20() * dirZ)
         ._m21(this.m01() * leftZ + this.m11() * upnZ + this.m21() * dirZ)
         ._m22(this.m02() * leftZ + this.m12() * upnZ + this.m22() * dirZ)
         ._m23(this.m03() * leftZ + this.m13() * upnZ + this.m23() * dirZ)
         ._m00(nm00)
   ...
   public Matrix4f lookAtPerspective(
      float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ, Matrix4f dest
   ) {
      float dirX = eyeX - centerX;
      float dirY = eyeY - centerY;
      ...
      return dest._m00(this.m00() * leftX)
         ._m01(this.m11() * upnX)
         ._m02(this.m22() * dirX)
         ._m03(this.m23() * dirX)
         ._m10(nm10)
   ...
   public Matrix4f lookAtLH(float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ, Matrix4f dest) {
      if ((this.properties & 4) != 0) {
         ...
         return (this.properties & 1) != 0
            ? this.lookAtPerspectiveLH(eyeX, eyeY, eyeZ, centerX, centerY, centerZ, upX, upY, upZ, dest)
   ...
   public Matrix4f tile(int x, int y, int w, int h, Matrix4f dest) {
      float tx = w - 1 - (x << 1);
      float ty = h - 1 - (y << 1);
      return dest._m30(Math.fma(this.m00(), tx, Math.fma(this.m10(), ty, this.m30())))
         ._m31(Math.fma(this.m01(), tx, Math.fma(this.m11(), ty, this.m31())))
         ._m32(Math.fma(this.m02(), tx, Math.fma(this.m12(), ty, this.m32())))
         ._m33(Math.fma(this.m03(), tx, Math.fma(this.m13(), ty, this.m33())))
         ._m00(this.m00() * w)
         ._m01(this.m01() * w)
         ._m02(this.m02() * w)
         ._m03(this.m03() * w)
   ...
   public Matrix4f perspective(float fovy, float aspect, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setPerspective(fovy, aspect, zNear, zFar, zZeroToOne)
         : this.perspectiveGeneric(fovy, aspect, zNear, zFar, zZeroToOne, dest);
   }
   ...
   public Matrix4f perspectiveRect(float width, float height, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setPerspectiveRect(width, height, zNear, zFar, zZeroToOne)
         : this.perspectiveRectGeneric(width, height, zNear, zFar, zZeroToOne, dest);
   }
   ...
   public Matrix4f perspectiveOffCenter(float fovy, float offAngleX, float offAngleY, float aspect, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setPerspectiveOffCenter(fovy, offAngleX, offAngleY, aspect, zNear, zFar, zZeroToOne)
         : this.perspectiveOffCenterGeneric(fovy, offAngleX, offAngleY, aspect, zNear, zFar, zZeroToOne, dest);
   }

   private Matrix4f perspectiveOffCenterGeneric(
      float fovy, float offAngleX, float offAngleY, float aspect, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest
   ) {
      float h = Math.tan(fovy * 0.5F);
      ...
      dest._m00(this.m00() * xScale)
         ._m01(this.m01() * xScale)
         ._m02(this.m02() * xScale)
         ._m03(this.m03() * xScale)
         ._m10(this.m10() * yScale)
         ._m11(this.m11() * yScale)
         ._m12(this.m12() * yScale)
         ._m13(this.m13() * yScale)
         ._m30(this.m20() * rm32)
         ._m31(this.m21() * rm32)
         ._m32(this.m22() * rm32)
         ._m33(this.m23() * rm32)
         ...
         ._m22(nm22)
         ._m23(nm23)
         ._properties(this.properties & ~(30 | (rm20 == 0.0F && rm21 == 0.0F ? 0 : 1)));
      return dest;
   }
   ...
   public Matrix4f perspectiveOffCenterFov(
      float angleLeft, float angleRight, float angleDown, float angleUp, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest
   ) {
      return this.frustum(
         Math.tan(angleLeft) * zNear, Math.tan(angleRight) * zNear, Math.tan(angleDown) * zNear, Math.tan(angleUp) * zNear, zNear, zFar, zZeroToOne, dest
      );
   }
   ...
   public Matrix4f perspectiveOffCenterFovLH(
      float angleLeft, float angleRight, float angleDown, float angleUp, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest
   ) {
   ...
   public Matrix4f perspectiveOffCenterFovLH(float angleLeft, float angleRight, float angleDown, float angleUp, float zNear, float zFar, Matrix4f dest) {
      return this.frustumLH(
         Math.tan(angleLeft) * zNear, Math.tan(angleRight) * zNear, Math.tan(angleDown) * zNear, Math.tan(angleUp) * zNear, zNear, zFar, dest
      );
   }
   ...
   public Matrix4f setPerspectiveOffCenterFov(float angleLeft, float angleRight, float angleDown, float angleUp, float zNear, float zFar, boolean zZeroToOne) {
      return this.setFrustum(
         Math.tan(angleLeft) * zNear, Math.tan(angleRight) * zNear, Math.tan(angleDown) * zNear, Math.tan(angleUp) * zNear, zNear, zFar, zZeroToOne
      );
   }
   ...
   public Matrix4f perspectiveLH(float fovy, float aspect, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setPerspectiveLH(fovy, aspect, zNear, zFar, zZeroToOne)
         : this.perspectiveLHGeneric(fovy, aspect, zNear, zFar, zZeroToOne, dest);
   }
   ...
   public Matrix4f frustum(float left, float right, float bottom, float top, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setFrustum(left, right, bottom, top, zNear, zFar, zZeroToOne)
         : this.frustumGeneric(left, right, bottom, top, zNear, zFar, zZeroToOne, dest);
   }
   ...
   public Matrix4f frustumLH(float left, float right, float bottom, float top, float zNear, float zFar, boolean zZeroToOne, Matrix4f dest) {
      return (this.properties & 4) != 0
         ? dest.setFrustumLH(left, right, bottom, top, zNear, zFar, zZeroToOne)
         : this.frustumLHGeneric(left, right, bottom, top, zNear, zFar, zZeroToOne, dest);
   }
   ...
   private Matrix4f rotateGeneric(Quaternionfc quat, Matrix4f dest) {
      ...
      return dest._m20(Math.fma(this.m00(), rm20, Math.fma(this.m10(), rm21, this.m20() * rm22)))
         ._m21(Math.fma(this.m01(), rm20, Math.fma(this.m11(), rm21, this.m21() * rm22)))
         ._m22(Math.fma(this.m02(), rm20, Math.fma(this.m12(), rm21, this.m22() * rm22)))
         ._m23(Math.fma(this.m03(), rm20, Math.fma(this.m13(), rm21, this.m23() * rm22)))
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public Matrix4f rotationAround(Quaternionfc quat, float ox, float oy, float oz) {
      ...
      this._m20(dyw + dxz)
         ...
         ._m12(dyz + dxw)
         ._m13(0.0F)
         ._m30(-this.m00() * ox - this.m10() * oy - this.m20() * oz + ox)
         ._m31(-this.m01() * ox - this.m11() * oy - this.m21() * oz + oy)
         ._m32(-this.m02() * ox - this.m12() * oy - this.m22() * oz + oz)
         ._m33(1.0F)
         ._properties(18);
      return this;
   }
   ...
   public Matrix4f rotateAroundLocal(Quaternionfc quat, float ox, float oy, float oz, Matrix4f dest) {
      ...
      dest._m00(lm00 * tm00 + lm10 * tm01 + lm20 * tm02 + ox * this.m03())
         ._m01(lm01 * tm00 + lm11 * tm01 + lm21 * tm02 + oy * this.m03())
         ._m02(lm02 * tm00 + lm12 * tm01 + lm22 * tm02 + oz * this.m03())
         ._m03(this.m03())
         ._m10(lm00 * tm10 + lm10 * tm11 + lm20 * tm12 + ox * this.m13())
         ._m11(lm01 * tm10 + lm11 * tm11 + lm21 * tm12 + oy * this.m13())
         ._m12(lm02 * tm10 + lm12 * tm11 + lm22 * tm12 + oz * this.m13())
         ._m13(this.m13())
         ._m20(lm00 * tm20 + lm10 * tm21 + lm20 * tm22 + ox * this.m23())
         ._m21(lm01 * tm20 + lm11 * tm21 + lm21 * tm22 + oy * this.m23())
         ._m22(lm02 * tm20 + lm12 * tm21 + lm22 * tm22 + oz * this.m23())
         ._m23(this.m23())
         ._m30(lm00 * tm30 + lm10 * tm31 + lm20 * tm32 + ox * this.m33())
         ._m31(lm01 * tm30 + lm11 * tm31 + lm21 * tm32 + oy * this.m33())
         ._m32(lm02 * tm30 + lm12 * tm31 + lm22 * tm32 + oz * this.m33())
         ._m33(this.m33())
         ._properties(this.properties & -14);
      return dest;
   }
   ...
   public Vector4f unprojectInv(float winX, float winY, float winZ, int[] viewport, Vector4f dest) {
      ...
      return dest.set(
         (this.m00() * ndcX + this.m10() * ndcY + this.m20() * ndcZ + this.m30()) * invW,
         (this.m01() * ndcX + this.m11() * ndcY + this.m21() * ndcZ + this.m31()) * invW,
         (this.m02() * ndcX + this.m12() * ndcY + this.m22() * ndcZ + this.m32()) * invW,
         1.0F
      );
   }
   ...
   public Vector4f project(float x, float y, float z, int[] viewport, Vector4f winCoordsDest) {
      ...
      return winCoordsDest.set(
         Math.fma(Math.fma(nx, 0.5F, 0.5F), viewport[2], viewport[0]),
   ...
   public Matrix4f setColumn(int column, Vector4fc src) throws IndexOutOfBoundsException {
      return src instanceof Vector4f
         ? MemUtil.INSTANCE.setColumn((Vector4f)src, column, this)._properties(0)
         : MemUtil.INSTANCE.setColumn(src, column, this)._properties(0);
   }
   ...
   private Matrix3f normalGeneric(Matrix3f dest) {
      float det = (this.m00() * this.m11() - this.m01() * this.m10()) * this.m22()
         + (this.m02() * this.m10() - this.m00() * this.m12()) * this.m21()
         + (this.m01() * this.m12() - this.m02() * this.m11()) * this.m20();
      float s = 1.0F / det;
      return dest._m00((this.m11() * this.m22() - this.m21() * this.m12()) * s)
         ._m01((this.m20() * this.m12() - this.m10() * this.m22()) * s)
         ._m02((this.m10() * this.m21() - this.m20() * this.m11()) * s)
         ._m10((this.m21() * this.m02() - this.m01() * this.m22()) * s)
         ._m11((this.m00() * this.m22() - this.m20() * this.m02()) * s)
         ._m12((this.m20() * this.m01() - this.m00() * this.m21()) * s)
         ._m20((this.m01() * this.m12() - this.m02() * this.m11()) * s)
         ._m21((this.m02() * this.m10() - this.m00() * this.m12()) * s)
         ._m22((this.m00() * this.m11() - this.m01() * this.m10()) * s);
   }
   ...
   public Matrix3f cofactor3x3(Matrix3f dest) {
      return dest._m00(this.m11() * this.m22() - this.m21() * this.m12())
   ...
   public Matrix4f normalize3x3(Matrix4f dest) {
      ...
      return dest._m00(this.m00() * invXlen)
         ._m01(this.m01() * invXlen)
         ._m02(this.m02() * invXlen)
         ._m10(this.m10() * invYlen)
         ._m11(this.m11() * invYlen)
         ._m12(this.m12() * invYlen)
         ._m20(this.m20() * invZlen)
         ._m21(this.m21() * invZlen)
         ._m22(this.m22() * invZlen)
         ._m30(this.m30())
         ._m31(this.m31())
         ._m32(this.m32())
         ._m33(this.m33())
   ...
   public Vector3f originAffine(Vector3f origin) {
      ...
      float j = this.m21() * this.m32() - this.m22() * this.m31();
      return origin.set(
         -this.m10() * j + this.m11() * h - this.m12() * g, this.m00() * j - this.m01() * h + this.m02() * g, -this.m30() * d + this.m31() * b - this.m32() * a
      );
   }
   ...
   public Matrix4f shadow(float lightX, float lightY, float lightZ, float lightW, float a, float b, float c, float d, Matrix4f dest) {
      ...
      dest._m30(this.m00() * rm30 + this.m10() * rm31 + this.m20() * rm32 + this.m30() * rm33)
         ._m31(this.m01() * rm30 + this.m11() * rm31 + this.m21() * rm32 + this.m31() * rm33)
         ._m32(this.m02() * rm30 + this.m12() * rm31 + this.m22() * rm32 + this.m32() * rm33)
         ._m33(this.m03() * rm30 + this.m13() * rm31 + this.m23() * rm32 + this.m33() * rm33)
         ._m00(nm00)
         ._m01(nm01)
         ._m02(nm02)
         ._m03(nm03)
   ...
   public int hashCode() {
      ...
      return 31 * result + Float.floatToIntBits(this.m33());
   }
      ...
      if (this == obj) {
         ...
         if (Float.floatToIntBits(this.m00()) != Float.floatToIntBits(other.m00())) {
            ...
            return Float.floatToIntBits(this.m32()) != Float.floatToIntBits(other.m32())
               ? false
               : Float.floatToIntBits(this.m33()) == Float.floatToIntBits(other.m33());
         }
      }
   }
   ...
   public boolean equals(Matrix4fc m, float delta) {
      if (this == m) {
         ...
         return !Runtime.equals(this.m32(), m.m32(), delta) ? false : Runtime.equals(this.m33(), m.m33(), delta);
      }
   }
   ...
   public Matrix4f pick(float x, float y, float width, float height, int[] viewport, Matrix4f dest) {
      ...
      dest._m30(this.m00() * tx + this.m10() * ty + this.m30())
         ._m31(this.m01() * tx + this.m11() * ty + this.m31())
         ._m32(this.m02() * tx + this.m12() * ty + this.m32())
         ._m33(this.m03() * tx + this.m13() * ty + this.m33())
         ._m00(this.m00() * sx)
         ._m01(this.m01() * sx)
         ._m02(this.m02() * sx)
         ._m03(this.m03() * sx)
   ...
   public Matrix4f perspectiveFrustumSlice(float near, float far, Matrix4f dest) {
      ...
      float invNearFar = 1.0F / (near - far);
      dest._m00(this.m00() * invOldNear * near)
         ._m01(this.m01())
         ._m02(this.m02())
         ._m03(this.m03())
         ._m10(this.m10())
         ._m11(this.m11() * invOldNear * near)
         ._m12(this.m12())
         ._m13(this.m13())
         ._m20(this.m20())
         ._m21(this.m21())
   ...
   public Matrix4f lerp(Matrix4fc other, float t, Matrix4f dest) {
      dest._m00(Math.fma(other.m00() - this.m00(), t, this.m00()))
         ._m01(Math.fma(other.m01() - this.m01(), t, this.m01()))
         ._m02(Math.fma(other.m02() - this.m02(), t, this.m02()))
         ._m03(Math.fma(other.m03() - this.m03(), t, this.m03()))
         ._m10(Math.fma(other.m10() - this.m10(), t, this.m10()))
         ._m11(Math.fma(other.m11() - this.m11(), t, this.m11()))
         ._m12(Math.fma(other.m12() - this.m12(), t, this.m12()))
         ._m13(Math.fma(other.m13() - this.m13(), t, this.m13()))
         ._m20(Math.fma(other.m20() - this.m20(), t, this.m20()))
         ._m21(Math.fma(other.m21() - this.m21(), t, this.m21()))
         ._m22(Math.fma(other.m22() - this.m22(), t, this.m22()))
         ._m23(Math.fma(other.m23() - this.m23(), t, this.m23()))
         ._m30(Math.fma(other.m30() - this.m30(), t, this.m30()))
         ._m31(Math.fma(other.m31() - this.m31(), t, this.m31()))
         ._m32(Math.fma(other.m32() - this.m32(), t, this.m32()))
         ._m33(Math.fma(other.m33() - this.m33(), t, this.m33()))
         ._properties(this.properties & other.properties());
      return dest;
   }
   ...
   public Matrix4f affineSpan(Vector3f corner, Vector3f xDir, Vector3f yDir, Vector3f zDir) {
      ...
      float s = 1.0F / (this.m00() * this.m11() - this.m01() * this.m10()) * this.m22()
         + (this.m02() * this.m10() - this.m00() * this.m12()) * this.m21()
         + (this.m01() * this.m12() - this.m02() * this.m11()) * this.m20();
      float nm00 = (e - i) * s;
      float nm01 = (o - q) * s;
   ...
   public boolean testPoint(float x, float y, float z) {
      ...
      return nxX * x + nxY * y + nxZ * z + nxW >= 0.0F
         && pxX * x + pxY * y + pxZ * z + pxW >= 0.0F
         && nyX * x + nyY * y + nyZ * z + nyW >= 0.0F
         && pyX * x + pyY * y + pyZ * z + pyW >= 0.0F
         && nzX * x + nzY * y + nzZ * z + nzW >= 0.0F
         && pzX * x + pzY * y + pzZ * z + pzW >= 0.0F;
   }
   ...
   public boolean testAab(float minX, float minY, float minZ, float maxX, float maxY, float maxZ) {
      ...
      float pzZ = this.m23() - this.m22();
      float pzW = this.m33() - this.m32();
      return nxX * (nxX < 0.0F ? minX : maxX) + nxY * (nxY < 0.0F ? minY : maxY) + nxZ * (nxZ < 0.0F ? minZ : maxZ) >= -nxW
         && pxX * (pxX < 0.0F ? minX : maxX) + pxY * (pxY < 0.0F ? minY : maxY) + pxZ * (pxZ < 0.0F ? minZ : maxZ) >= -pxW
         && nyX * (nyX < 0.0F ? minX : maxX) + nyY * (nyY < 0.0F ? minY : maxY) + nyZ * (nyZ < 0.0F ? minZ : maxZ) >= -nyW
         && pyX * (pyX < 0.0F ? minX : maxX) + pyY * (pyY < 0.0F ? minY : maxY) + pyZ * (pyZ < 0.0F ? minZ : maxZ) >= -pyW
         && nzX * (nzX < 0.0F ? minX : maxX) + nzY * (nzY < 0.0F ? minY : maxY) + nzZ * (nzZ < 0.0F ? minZ : maxZ) >= -nzW
         && pzX * (pzX < 0.0F ? minX : maxX) + pzY * (pzY < 0.0F ? minY : maxY) + pzZ * (pzZ < 0.0F ? minZ : maxZ) >= -pzW;
   }

   public Matrix4f obliqueZ(float a, float b) {
      return this._m20(this.m00() * a + this.m10() * b + this.m20())
         ._m21(this.m01() * a + this.m11() * b + this.m21())
         ._m22(this.m02() * a + this.m12() * b + this.m22())
         ._properties(this.properties & 2);
   }
   ...
   public Matrix4f obliqueZ(float a, float b, Matrix4f dest) {
      dest._m00(this.m00())
         ...
         ._m12(this.m12())
         ._m13(this.m13())
         ._m20(this.m00() * a + this.m10() * b + this.m20())
         ._m21(this.m01() * a + this.m11() * b + this.m21())
         ._m22(this.m02() * a + this.m12() * b + this.m22())
         ._m23(this.m23())
         ._m30(this.m30())
   ...
   public static void perspectiveOffCenterViewFromRectangle(
      Vector3f eye, Vector3f p, Vector3f x, Vector3f y, float nearFarDist, boolean zeroToOne, Matrix4f projDest, Matrix4f viewDest
   ) {
      float zx = y.y * x.z - y.z * x.y;
      float zy = y.z * x.x - y.x * x.z;
      float zz = y.x * x.y - y.y * x.x;
      float zd = zx * (p.x - eye.x) + zy * (p.y - eye.y) + zz * (p.z - eye.z);
      float zs = zd >= 0.0F ? 1.0F : -1.0F;
      zx *= zs;
      zy *= zs;
      zz *= zs;
      zd *= zs;
   ...
   public Matrix4f withLookAtUp(float upX, float upY, float upZ, Matrix4f dest) {
      float y = (upY * this.m21() - upZ * this.m11()) * this.m02()
   ...
   public Matrix4f mapXZY(Matrix4f dest) {
      ...
      return dest._m00(this.m00())
         ...
         ._m32(this.m32())
         ._m33(this.m33())
         ._properties(this.properties & 18);
   }
