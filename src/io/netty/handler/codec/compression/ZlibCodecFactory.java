...
public final class ZlibCodecFactory {
   ...
   public static ZlibEncoder newZlibEncoder(int compressionLevel) {
      return noJdkZlibEncoder ? new JZlibEncoder(compressionLevel) : new JdkZlibEncoder(compressionLevel);
   }

   public static ZlibEncoder newZlibEncoder(ZlibWrapper wrapper) {
      return noJdkZlibEncoder ? new JZlibEncoder(wrapper) : new JdkZlibEncoder(wrapper);
   }

   public static ZlibEncoder newZlibEncoder(ZlibWrapper wrapper, int compressionLevel) {
      return noJdkZlibEncoder ? new JZlibEncoder(wrapper, compressionLevel) : new JdkZlibEncoder(wrapper, compressionLevel);
   }

   public static ZlibEncoder newZlibEncoder(ZlibWrapper wrapper, int compressionLevel, int windowBits, int memLevel) {
      return !noJdkZlibEncoder && windowBits == 15 && memLevel == 8
         ? new JdkZlibEncoder(wrapper, compressionLevel)
         : new JZlibEncoder(wrapper, compressionLevel, windowBits, memLevel);
   }

   public static ZlibEncoder newZlibEncoder(byte[] dictionary) {
      return noJdkZlibEncoder ? new JZlibEncoder(dictionary) : new JdkZlibEncoder(dictionary);
   }

   public static ZlibEncoder newZlibEncoder(int compressionLevel, byte[] dictionary) {
      return noJdkZlibEncoder ? new JZlibEncoder(compressionLevel, dictionary) : new JdkZlibEncoder(compressionLevel, dictionary);
   }
   ...
   public static ZlibDecoder newZlibDecoder(int maxAllocation) {
      return noJdkZlibDecoder ? new JZlibDecoder(maxAllocation) : new JdkZlibDecoder(true, maxAllocation);
   }
   ...
   public static ZlibDecoder newZlibDecoder(ZlibWrapper wrapper, int maxAllocation) {
      return noJdkZlibDecoder ? new JZlibDecoder(wrapper, maxAllocation) : new JdkZlibDecoder(wrapper, true, maxAllocation);
   }
   ...
   public static ZlibDecoder newZlibDecoder(byte[] dictionary, int maxAllocation) {
      return noJdkZlibDecoder ? new JZlibDecoder(dictionary, maxAllocation) : new JdkZlibDecoder(dictionary, maxAllocation);
   }
