            ...
            if ((b & 128) == 128) {
               ...
               if (streamId >= 0L) {
                  try {
                     ...
                     Http3CodecUtils.connectionError(
                        ctx, new Http3Exception(Http3ErrorCode.QPACK_DECODER_STREAM_ERROR, "Section acknowledgment decode failed.", e), true
                     );
                  }
               }
            } else if ((b & 192) == 64) {
               ...
               if (streamId >= 0L) {
                  try {
                     ...
                     Http3CodecUtils.connectionError(
                        ctx, new Http3Exception(Http3ErrorCode.QPACK_DECODER_STREAM_ERROR, "Stream cancellation decode failed.", e), true
                     );
                  }
               }
            } else if ((b & 192) == 0) {
               ...
               if (increment == 0) {
                  ...
                  try {
                     ...
                     Http3CodecUtils.connectionError(
                        ctx, new Http3Exception(Http3ErrorCode.QPACK_DECODER_STREAM_ERROR, "Insert count increment decode failed.", e), true
                     );
                  }
               }
            } else {
