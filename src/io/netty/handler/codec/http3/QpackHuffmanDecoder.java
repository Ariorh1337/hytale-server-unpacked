...
final class QpackHuffmanDecoder implements ByteProcessor {
   ...
   private static final QpackException BAD_ENCODING = QpackException.newStatic(QpackHuffmanDecoder.class, "decode(...)", "QPACK - Bad Encoding");
   private byte[] dest;
   private int k;
   private int state;
   ...
   private boolean processNibble(int input) {
      int index = this.state >> 12 | input & 15;
      this.state = HUFFS[index];
