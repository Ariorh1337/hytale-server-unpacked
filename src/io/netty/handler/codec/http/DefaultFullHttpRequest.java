...
public class DefaultFullHttpRequest extends DefaultHttpRequest implements FullHttpRequest {
   ...
   public DefaultFullHttpRequest(
      HttpVersion httpVersion, HttpMethod method, String uri, ByteBuf content, HttpHeadersFactory headersFactory, HttpHeadersFactory trailersFactory
   ) {
   ...
   public DefaultFullHttpRequest(
      HttpVersion httpVersion, HttpMethod method, String uri, ByteBuf content, HttpHeaders headers, HttpHeaders trailingHeader, boolean validateRequestLine
   ) {
