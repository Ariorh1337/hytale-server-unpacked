...
public abstract class Recycler<T> {
   ...
   protected Recycler(int maxCapacity, boolean unguarded) {
      ...
      if (maxCapacity == 0) {
         ...
         this.localPool = unguarded ? new Recycler.UnguardedLocalPool(maxCapacity) : new Recycler.GuardedLocalPool<>(maxCapacity);
      }
   }
