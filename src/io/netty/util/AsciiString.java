      ...
      if (cs == null || string == null) {
         ...
         return cs instanceof AsciiString
            ...
            : regionMatchesCharSequences(
               ...
               start,
               length,
               ignoreCase ? AsciiString.GeneralCaseInsensitiveCharEqualityComparator.INSTANCE : AsciiString.DefaultCharEqualityComparator.INSTANCE
            );
      }
   }
      ...
      if (cs == null || string == null) {
         ...
         return cs instanceof AsciiString
            ...
            : regionMatchesCharSequences(
               ...
               start,
               length,
               ignoreCase ? AsciiString.AsciiCaseInsensitiveCharEqualityComparator.INSTANCE : AsciiString.DefaultCharEqualityComparator.INSTANCE
            );
      }
   }
