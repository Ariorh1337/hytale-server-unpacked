                  ...
                  try {
                     ...
                     try {
                        if (shutdown) {
                           ...
                           int currentState;
                           do {
                              currentState = SingleThreadEventExecutor.this.state;
                           } while (currentState < 6 && !SingleThreadEventExecutor.STATE_UPDATER.compareAndSet(SingleThreadEventExecutor.this, currentState, 6));
