...
public final class NonStickyEventExecutorGroup implements EventExecutorGroup {
   ...
   private static final class NonStickyOrderedEventExecutor extends AbstractEventExecutor implements Runnable, OrderedEventExecutor {
      ...
      public void run() {
         ...
         //   at org.jetbrains.java.decompiler.main.rels.MethodProcessor.codeToJava(MethodProcessor.java:191)
         //
         // Bytecode:
         // 000: aload 0
         ...
         // 10e: athrow
         // 10f: goto 019
         // try (35 -> 49): 50 java/lang/Throwable
         // try (15 -> 31): 81 null
         // try (86 -> 100): 101 java/lang/Throwable
         // try (81 -> 82): 81 null
      }
