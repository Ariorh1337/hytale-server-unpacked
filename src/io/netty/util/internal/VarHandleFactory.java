...
final class VarHandleFactory {
   ...
   private static Lookup privateLookup(Lookup lookup, Class<?> targetClass) {
      try {
         return (Lookup)PRIVATE_LOOKUP_IN.invokeExact((Class)targetClass, (Lookup)lookup);
      } catch (Throwable e) {
         throw new RuntimeException(e);
      }
   }

   public static VarHandle privateFindVarHandle(Lookup lookup, Class<?> declaringClass, String name, Class<?> type) {
      try {
         return (VarHandle)FIND_VAR_HANDLE.invokeExact((Lookup)privateLookup(lookup, declaringClass), (Class)declaringClass, (String)name, (Class)type);
      } catch (Throwable e) {
         throw new RuntimeException(e);
      }
   }
   ...
   static {
      ...
      try {
         ...
         findVarHandle = lookup.findVirtual(Lookup.class, "findVarHandle", MethodType.methodType(VarHandle.class, Class.class, String.class, Class.class));
         privateLookupIn = lookup.findStatic(MethodHandles.class, "privateLookupIn", MethodType.methodType(Lookup.class, Class.class, Lookup.class));
         MethodHandle byteArrayViewHandle = lookup.findStatic(
            MethodHandles.class, "byteArrayViewVarHandle", MethodType.methodType(VarHandle.class, Class.class, ByteOrder.class)
         );
         longLeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)long[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         longBeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)long[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         intLeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)int[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         intBeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)int[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         shortLeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)short[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         shortBeArrayViewHandle = (VarHandle)byteArrayViewHandle.invokeExact((Class)short[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         MethodHandle byteBufferViewHandle = lookup.findStatic(
            MethodHandles.class, "byteBufferViewVarHandle", MethodType.methodType(VarHandle.class, Class.class, ByteOrder.class)
         );
         longLeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)long[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         longBeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)long[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         intLeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)int[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         intBeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)int[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         shortLeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)short[].class, (ByteOrder)ByteOrder.LITTLE_ENDIAN);
         shortBeByteBufferViewHandle = (VarHandle)byteBufferViewHandle.invokeExact((Class)short[].class, (ByteOrder)ByteOrder.BIG_ENDIAN);
         error = null;
      } catch (Throwable e) {
         error = e;
         findVarHandle = null;
