...
public final class ObjectCleaner {
   private static final int REFERENCE_QUEUE_POLL_TIMEOUT_MS = Math.max(
      500, SystemPropertyUtil.getInt("io.netty.util.internal.ObjectCleaner.refQueuePollTimeout", 10000)
   );
   static final String CLEANER_THREAD_NAME = ObjectCleaner.class.getSimpleName() + "Thread";
   private static final Set<ObjectCleaner.AutomaticCleanerReference> LIVE_SET = ConcurrentHashMap.newKeySet();
   ...
   public static void register(Object object, Runnable cleanupTask) {
      ObjectCleaner.AutomaticCleanerReference reference = new ObjectCleaner.AutomaticCleanerReference(
         object, ObjectUtil.checkNotNull(cleanupTask, "cleanupTask")
      );
