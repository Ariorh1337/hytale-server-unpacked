...
public class CombinedChannelDuplexHandler<I extends ChannelInboundHandler, O extends ChannelOutboundHandler> extends ChannelDuplexHandler {
   ...
   public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
      ...
      this.outboundCtx = new CombinedChannelDuplexHandler.DelegatingChannelHandlerContext(ctx, this.outboundHandler);
      this.inboundCtx = new CombinedChannelDuplexHandler.DelegatingChannelHandlerContext(ctx, this.inboundHandler) {
         @Override
               ...
               try {
                  ...
                  if (CombinedChannelDuplexHandler.logger.isDebugEnabled()) {
                     CombinedChannelDuplexHandler.logger
                        .debug("An exception was thrown by a user handler's exceptionCaught() method while handling the following exception:", cause);
