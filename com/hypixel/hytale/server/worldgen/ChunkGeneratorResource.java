...
public class ChunkGeneratorResource {
    ...
    public final TimeoutCache<WorldGenPrefabSupplier, IPrefabBuffer> prefabs = new TimeoutCache<WorldGenPrefabSupplier, IPrefabBuffer>(30L, TimeUnit.SECONDS, this::getPrefab, (key, value) -> value.release());
    @Nonnull
