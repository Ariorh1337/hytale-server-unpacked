...
public class RateLimitConfig {
    ...
    @Nonnull
    public static final Codec<RateLimitConfig> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(RateLimitConfig.class, RateLimitConfig::new).append(new KeyedCodec<Boolean>("Enabled", Codec.BOOLEAN), (o, b) -> {
        o.enabled = b;
    }, o -> o.enabled).documentation("Determines whether packet rate limiting is enabled.").add()).append(new KeyedCodec<Integer>("PacketsPerSecond", Codec.INTEGER), (o, i) -> {
        o.packetsPerSecond = i;
    }, o -> o.packetsPerSecond).documentation("The number of packets allowed per second.").add()).append(new KeyedCodec<Integer>("BurstCapacity", Codec.INTEGER), (o, i) -> {
        o.burstCapacity = i;
    }, o -> o.burstCapacity).documentation("The number of packets that can be sent in a burst before rate limiting is applied.").add()).build();
