...
public class ModConfig {
    ...
    }, modConfig -> modConfig.enabled).documentation("Determines whether the mod/plugin is enabled.").add()).append(new KeyedCodec<SemverRange>("RequiredVersion", SemverRange.CODEC), (modConfig, semverRange) -> {
        modConfig.requiredVersion = semverRange;
    }, modConfig -> modConfig.requiredVersion).documentation("The required version range for the mod/plugin.").add()).build();
    @Nullable
