...
public class UIGalleryPage
extends InteractiveCustomUIPage<UIGalleryEventData> {
    ...
    private Category selectedCategory = Category.BUTTONS;
    ...
    public void handleDataEvent(@Nonnull Ref<EntityStore> ref, @Nonnull Store<EntityStore> store, @Nonnull UIGalleryEventData data) {
        ...
        if (data.category != null) {
            Category newCategory = Category.fromId(data.category);
    ...
    public static class UIGalleryEventData {
        ...
        public static final BuilderCodec<UIGalleryEventData> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(UIGalleryEventData.class, UIGalleryEventData::new).addField(new KeyedCodec<String>("Category", Codec.STRING), (entry, s) -> {
            entry.category = s;
        }, entry -> entry.category)).addField(new KeyedCodec<String>("ToggleCode", Codec.STRING), (entry, s) -> {
            entry.toggleCode = s;
        }, entry -> entry.toggleCode)).build();
