...
implements RandomTickProcedure {
    public static final BuilderCodec<ChangeIntoBlockProcedure> CODEC = ((BuilderCodec.Builder)BuilderCodec.builder(ChangeIntoBlockProcedure.class, ChangeIntoBlockProcedure::new).appendInherited(new KeyedCodec<String>("TargetBlock", Codec.STRING), (o, i) -> {
        o.targetBlock = i;
    }, o -> o.targetBlock, (o, p) -> {
        o.targetBlock = p.targetBlock;
    }).addValidatorLate(() -> BlockType.VALIDATOR_CACHE.getValidator().late()).add()).build();
