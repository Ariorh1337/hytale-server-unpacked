...
public class BrushConfig {
    ...
    public Material getNextMaterial() {
        ...
        if (blockEntry != null && (fluidInfo = FluidPatternHelper.getFluidInfo(blockEntry.blockTypeKey())) != null) {
    ...
    public String toString() {
        return "BrushConfig{, interactionType=" + String.valueOf((Object)this.interactionType) + ", origin=" + String.valueOf(this.origin) + ", originOffset=" + String.valueOf(this.originOffset) + ", originAfterOffset=" + String.valueOf(this.originAfterOffset) + ", shapeWidth=" + this.shapeWidth + ", shapeHeight=" + this.shapeHeight + ", shapeThickness=" + this.shapeThickness + ", capped=" + this.capped + ", density=" + this.density + ", shape=" + String.valueOf((Object)this.shape) + ", pattern=" + String.valueOf(this.pattern) + ", historyMask=" + String.valueOf((Object)this.historyMask) + ", brushMask=" + String.valueOf(this.brushMask) + ", operationMask=" + String.valueOf(this.operationMask) + ", combinedMasks=" + String.valueOf(this.combinedMasks) + ", enableOperationMask=" + this.enableOperationMask + ", enableBrushMask=" + this.enableBrushMask + ", random=" + String.valueOf(random) + ", isCurrentlyExecuting=" + this.isCurrentlyExecuting + "}";
    }
