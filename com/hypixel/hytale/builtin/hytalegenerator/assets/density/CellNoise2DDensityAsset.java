...
public class CellNoise2DDensityAsset
extends DensityAsset {
    ...
    static {
        ...
        CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(CellNoise2DDensityAsset.class, CellNoise2DDensityAsset::new, DensityAsset.ABSTRACT_CODEC).append(new KeyedCodec<Double>("ScaleX", Codec.DOUBLE, true), (asset, scale) -> {
            asset.scaleX = scale;
        }, asset -> asset.scaleX).addValidator(Validators.greaterThan(0.0)).add()).append(new KeyedCodec<Double>("ScaleZ", Codec.DOUBLE, true), (asset, scale) -> {
            asset.scaleZ = scale;
        }, asset -> asset.scaleZ).addValidator(Validators.greaterThan(0.0)).add()).append(new KeyedCodec<Double>("Jitter", Codec.DOUBLE, true), (asset, v) -> {
            asset.jitter = v;
        }, asset -> asset.scaleZ).add()).append(new KeyedCodec<Integer>("Octaves", Codec.INTEGER, true), (asset, octaves) -> {
            ...
            asset.seedKey = seed;
        }, asset -> asset.seedKey).add()).append(new KeyedCodec<FastNoiseLite.CellularReturnType>("CellType", FastNoiseLite.CellularReturnType.CODEC, true), (asset, cellType) -> {
            asset.cellType = cellType;
        }, asset -> asset.cellType).add()).build();
    }
}
