...
extends PropAsset {
    ...
    public static final BuilderCodec<PrefabPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PrefabPropAsset.class, PrefabPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec<T[]>("WeightedPrefabPaths", new ArrayCodec(WeightedPathAsset.CODEC, WeightedPathAsset[]::new), true), (asset, v) -> {
        ...
        asset.legacyPath = v;
    }, asset -> asset.legacyPath).add()).append(new KeyedCodec("Directionality", DirectionalityAsset.CODEC, true), (asset, v) -> {
        asset.directionalityAsset = v;
    }, asset -> asset.directionalityAsset).add()).append(new KeyedCodec("Scanner", ScannerAsset.CODEC, true), (asset, v) -> {
        asset.scannerAsset = v;
    }, asset -> asset.scannerAsset).add()).append(new KeyedCodec("BlockMask", BlockMaskAsset.CODEC, false), (asset, v) -> {
        asset.blockMaskAsset = v;
    }, asset -> asset.blockMaskAsset).add()).append(new KeyedCodec<MoldingDirection>("MoldingDirection", MoldingDirection.CODEC, false), (t, k) -> {
        t.moldingDirectionName = k;
    }, k -> k.moldingDirectionName).add()).append(new KeyedCodec("MoldingPattern", PatternAsset.CODEC, false), (asset, v) -> {
        asset.moldingPatternAsset = v;
    }, asset -> asset.moldingPatternAsset).add()).append(new KeyedCodec("MoldingScanner", ScannerAsset.CODEC, false), (asset, v) -> {
        asset.moldingScannerAsset = v;
    }, asset -> asset.moldingScannerAsset).add()).append(new KeyedCodec<Boolean>("MoldingChildren", Codec.BOOLEAN, false), (asset, v) -> {
        asset.moldChildren = v;
    }, asset -> asset.moldChildren).add()).append(new KeyedCodec<Boolean>("LoadEntities", Codec.BOOLEAN, false), (asset, v) -> {
        asset.loadEntities = v;
    }, asset -> asset.loadEntities).add()).build();
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        BlockMask blockMask = this.blockMaskAsset == null ? new BlockMask() : this.blockMaskAsset.build(voxelCache);
    ...
    implements JsonAssetWithMap<String, DefaultAssetMap<String, WeightedPathAsset>> {
        ...
        public static final AssetBuilderCodec<String, WeightedPathAsset> CODEC = ((AssetBuilderCodec.Builder)((AssetBuilderCodec.Builder)AssetBuilderCodec.builder(WeightedPathAsset.class, WeightedPathAsset::new, Codec.STRING, (asset, id) -> {
            ...
            t.weight = y;
        }, t -> t.weight).addValidator(Validators.greaterThanOrEqual(0.0)).add()).append(new KeyedCodec<String>("Path", Codec.STRING, true), (t, out) -> {
            t.path = out;
        }, t -> t.path).add()).build();
        private String id;
