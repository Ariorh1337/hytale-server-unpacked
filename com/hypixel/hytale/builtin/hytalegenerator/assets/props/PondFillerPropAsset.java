...
extends PropAsset {
    ...
    public static final BuilderCodec<PondFillerPropAsset> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(PondFillerPropAsset.class, PondFillerPropAsset::new, PropAsset.ABSTRACT_CODEC).append(new KeyedCodec<Vector3i>("BoundingMin", Vector3i.CODEC, true), (asset, v) -> {
        ...
        asset.boundingMax = v;
    }, asset -> asset.boundingMax).add()).append(new KeyedCodec("FillMaterial", MaterialProviderAsset.CODEC, true), (asset, v) -> {
        asset.fluidMaterialProviderAsset = v;
    }, asset -> asset.fluidMaterialProviderAsset).add()).append(new KeyedCodec("BarrierBlockSet", MaterialSetAsset.CODEC, true), (asset, v) -> {
        asset.solidSetAsset = v;
    }, asset -> asset.solidSetAsset).add()).append(new KeyedCodec("Pattern", PatternAsset.CODEC, true), (asset, v) -> {
    ...
    public Prop build(@Nonnull PropAsset.Argument argument) {
        ...
        if (this.scannerAsset == null || this.patternAsset == null || this.fluidMaterialProviderAsset == null || this.solidSetAsset == null) {
            return Prop.noProp();
        }
