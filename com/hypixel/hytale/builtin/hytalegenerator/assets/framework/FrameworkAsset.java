...
JsonAssetWithMap<String, DefaultAssetMap<String, FrameworkAsset>> {
    @Nonnull
    public static final AssetCodecMapCodec<String, FrameworkAsset> CODEC = new AssetCodecMapCodec<String, FrameworkAsset>(Codec.STRING, (t, k) -> {
        t.id = k;
    }, t -> t.id, (t, data) -> {
        t.data = data;
    }, t -> t.data);
