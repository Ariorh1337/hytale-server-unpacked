...
extends DelayedSystem<EntityStore> {
    ...
    private boolean isEveryoneReadyToSleep(@Nonnull ComponentAccessor<EntityStore> store) {
        ...
        for (PlayerRef playerRef : playerRefs) {
            ...
            if (ref == null || !ref.isValid() || StartSlumberSystem.isReadyToSleep(store, ref)) continue;
            return false;
        }
        return true;
    }
    ...
    public static boolean isReadyToSleep(@Nonnull ComponentAccessor<EntityStore> store, @Nullable Ref<EntityStore> ref) {
        ...
        PlayerSleep playerSleep = sleepState = somnolenceComponent.getSleepState();
        ...
        return switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{PlayerSleep.FullyAwake.class, PlayerSleep.MorningWakeUp.class, PlayerSleep.NoddingOff.class, PlayerSleep.Slumber.class}, (Object)playerSleep2, n)) {
            ...
            case 0 -> {
                PlayerSleep.FullyAwake fullAwake = (PlayerSleep.FullyAwake)playerSleep2;
                yield false;
            }
            case 1 -> {
