...
public class HarvestCropInteraction
extends SimpleBlockInteraction {
    @Nonnull
    public static final BuilderCodec<HarvestCropInteraction> CODEC = ((BuilderCodec.Builder)((BuilderCodec.Builder)BuilderCodec.builder(HarvestCropInteraction.class, HarvestCropInteraction::new, SimpleBlockInteraction.CODEC).documentation("Harvests the resources from the target farmable block.")).appendInherited(new KeyedCodec<Boolean>("RequireNotBroken", Codec.BOOLEAN), (interaction, s) -> {
        interaction.requireNotBroken = s;
    }, interaction -> interaction.requireNotBroken, (interaction, parent) -> {
        interaction.requireNotBroken = parent.requireNotBroken;
    }).documentation("If true, the interaction will fail if the held item is broken (durability = 0).").add()).build();
    ...
    protected void interactWithBlock(@Nonnull World world, @Nonnull CommandBuffer<EntityStore> commandBuffer, @Nonnull InteractionType type, @Nonnull InteractionContext context, @Nullable ItemStack itemInHand, @Nonnull Vector3i targetBlock, @Nonnull CooldownHandler cooldownHandler) {
        ...
        Ref<ChunkStore> chunkRef = chunkStore.getChunkReference(chunkIndex = ChunkUtil.indexChunkFromBlock(targetBlock.x, targetBlock.z));
