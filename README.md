...
To regenerate the unpacked sources from a fresh `HytaleServer.jar`:

  

> **Note:** `vineflower-1.12.0.jar` shipped in this repo is the Vineflower build `https://github.com/Vineflower/vineflower/releases`.
 

1. Place `HytaleServer.jar` in the repository root next to `vineflower-1.12.0.jar`.

2. Run the Fernflower decompiler:

```bash
java -jar vineflower-1.12.0.jar HytaleServer.jar ./src
```
